...
public class AvcDecoderConfigurationRecord {
    ...
    public String[] getSPS() {
        ...
        for (byte[] bArr : this.sequenceParameterSets) {
            try {
                string = SeqParameterSet.read(new CleanInputStream(new ByteArrayInputStream(bArr, 1, bArr.length - 1))).toString();
