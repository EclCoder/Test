...
public class AlbumArtistBox extends AbstractFullBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_2 = bVar.h("method-execution", bVar.g("1", "setLanguage", "com.coremedia.iso.boxes.vodafone.AlbumArtistBox", "java.lang.String", "language", "", "void"), 50);
    ...
    protected long getContentSize() {
        return Utf8.utf8StringLengthInBytes(this.albumArtist) + 7;
    }
