...
public final class AppleLosslessSpecificBox extends AbstractFullBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_0 = bVar.h("method-execution", bVar.g("1", "getMaxSamplePerFrame", "com.coremedia.iso.boxes.apple.AppleLosslessSpecificBox", "", "", "", "long"), 34);
        ...
        ajc$tjp_16 = bVar.h("method-execution", bVar.g("1", "getMaxCodedFrameSize", "com.coremedia.iso.boxes.apple.AppleLosslessSpecificBox", "", "", "", "long"), 98);
        ...
        ajc$tjp_18 = bVar.h("method-execution", bVar.g("1", "getBitRate", "com.coremedia.iso.boxes.apple.AppleLosslessSpecificBox", "", "", "", "long"), 106);
        ...
        ajc$tjp_20 = bVar.h("method-execution", bVar.g("1", "getSampleRate", "com.coremedia.iso.boxes.apple.AppleLosslessSpecificBox", "", "", "", "long"), Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE);
        ajc$tjp_21 = bVar.h("method-execution", bVar.g("1", "setSampleRate", "com.coremedia.iso.boxes.apple.AppleLosslessSpecificBox", "int", "sampleRate", "", "void"), Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE);
        ajc$tjp_3 = bVar.h("method-execution", bVar.g("1", "setUnknown1", "com.coremedia.iso.boxes.apple.AppleLosslessSpecificBox", "int", giNWGaNAgVQoO.SmdELhijOkn, "", "void"), 46);
        ...
        ajc$tjp_7 = bVar.h("method-execution", bVar.g("1", "setHistoryMult", Saucuwx.BoTL, "int", "historyMult", "", "void"), 62);
        ...
        ajc$tjp_9 = bVar.h("method-execution", bVar.g(FuoITeVPeXAj.pviCnHmbGWjxZ, "setInitialHistory", "com.coremedia.iso.boxes.apple.AppleLosslessSpecificBox", "int", "initialHistory", "", "void"), 70);
    }
}
