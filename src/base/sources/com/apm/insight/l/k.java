...
public final class k {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f10862a[com.apm.insight.k.e.b.MOBILE_2G.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f10862a[com.apm.insight.k.e.b.MOBILE_3G.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f10862a[com.apm.insight.k.e.b.MOBILE_4G.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f10862a[com.apm.insight.k.e.b.MOBILE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f10862a[com.apm.insight.k.e.b.MOBILE_5G.ordinal()] = 6;
    ...
    private static String a(com.apm.insight.k.e.b bVar) {
        try {
            switch (AnonymousClass1.f10862a[bVar.ordinal()]) {
                case 1:
                    return "wifi";
                case 2:
                    return "2g";
                ...
                case 4:
                    return "4g";
                case 5:
                    return giNWGaNAgVQoO.sCyLEsyHm;
                case 6:
                    return "5g";
                default:
                    return "";
