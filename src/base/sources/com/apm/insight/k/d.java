...
public final class d {
    ...
    private volatile Context f10789b;
    ...
    public static d a() {
        if (f10788a == null) {
            f10788a = new d(com.apm.insight.e.g());
        }
        return f10788a;
    }
    ...
    public final void b(JSONObject jSONObject) {
        ...
        try {
            String strF = e.f();
            File file = new File(com.apm.insight.l.j.a(this.f10789b), com.apm.insight.l.j.c());
    ...
    public final void a(JSONObject jSONObject, long j10, boolean z10) {
        ...
        try {
            String strC = e.c();
            int i10 = 0;
            File file = new File(com.apm.insight.l.j.a(this.f10789b), com.apm.insight.e.a(j10, CrashType.ANR, false, false));
            ...
            if (z10 && !Npth.isStopUpload()) {
                ...
                if (com.apm.insight.runtime.a.h()) {
                    ...
                    for (Map.Entry<String, n.a> entry : mapA.entrySet()) {
                        if (!entry.getKey().equals(com.apm.insight.l.a.b())) {
                            fileArr[i10] = com.apm.insight.l.j.a(this.f10789b, entry.getValue().f11007a);
                            i10++;
                        }
                    }
                } else {
                ...
                fileArr[fileArr.length - 1] = com.apm.insight.l.j.a(this.f10789b, com.apm.insight.e.f());
    ...
    public final boolean a(JSONObject jSONObject) {
        if (jSONObject != null && jSONObject.length() > 0) {
            try {
                String strC = e.c();
                File file = new File(com.apm.insight.l.j.a(this.f10789b), com.apm.insight.l.j.a(com.apm.insight.e.e()));
