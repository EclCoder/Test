...
public final class e {
    ...
    public static boolean f10792a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static com.apm.insight.b.h.a f10793b;
    ...
    public static final class a {
        ...
        private static a f10796c = new a("NONE", 0, 0);

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final a f10794a = new a("GZIP", 1, 1);

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public static final a f10795b = new a("DEFLATER", 2, 2);
    ...
    private static com.apm.insight.l.f a(String str, byte[] bArr, a aVar, String str2) throws IOException {
        ...
        if (a.f10794a == aVar && length > 128) {
            bArr = a(bArr);
            str3 = "gzip";
        } else if (a.f10795b != aVar || length <= 128) {
            str3 = null;
        } else {
        ...
        return bArr == null ? new com.apm.insight.l.f(202) : a(str, bArr, str2, str3, HttpMethods.POST);
    }
    ...
    private static com.apm.insight.l.f d(String str, String str2) {
        try {
            if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str)) {
                return a(str, str2.getBytes(), a.f10794a, "application/json; charset=utf-8");
            }
            return new com.apm.insight.l.f(201);
        } catch (Throwable th2) {
            com.apm.insight.a.b(th2);
            return new com.apm.insight.l.f(Sdk$SDKError.b.PLACEMENT_AD_TYPE_MISMATCH_VALUE, th2);
        }
    }
    ...
    private static com.apm.insight.l.f b(String str, String str2, File... fileArr) throws Throwable {
        ...
        try {
            ...
            e11.printStackTrace();
            return new com.apm.insight.l.f(Sdk$SDKError.b.PLACEMENT_AD_TYPE_MISMATCH_VALUE);
        }
    }
    ...
    private static com.apm.insight.l.f a(String str, byte[] bArr, String str2, String str3, String str4) {
        ...
        try {
            com.apm.insight.b.h.a aVar = f10793b;
            if (aVar != null) {
                try {
                    str = aVar.c();
                } catch (Throwable unused) {
                ...
                if (responseCode == 200) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            return new com.apm.insight.l.f(Sdk$SDKError.b.PLACEMENT_AD_TYPE_MISMATCH_VALUE, th);
                        } finally {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                if (file.exists()) {
                    ...
                    map.put(XTkUEXuiK.XMIxByu, "Crash");
    ...
    public static byte[] a(String str, byte[] bArr) {
        try {
            ...
            return a(str, bArr, a.f10794a, "application/json; charset=utf-8").b();
        } catch (IOException e10) {
            e10.printStackTrace();
            return null;
        }
