...
public final /* data */ class HomophoneReplacerConfig {
    ...
    public static /* synthetic */ HomophoneReplacerConfig copy$default(HomophoneReplacerConfig homophoneReplacerConfig, String str, String str2, String str3, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return s.c(this.dictDir, homophoneReplacerConfig.dictDir) && s.c(this.lexicon, homophoneReplacerConfig.lexicon) && s.c(this.ruleFsts, homophoneReplacerConfig.ruleFsts);
    }
    ...
    public /* synthetic */ HomophoneReplacerConfig(String str, String str2, String str3, int i10, DefaultConstructorMarker defaultConstructorMarker) {
