...
public final /* data */ class OfflinePunctuationConfig {
    ...
    public static /* synthetic */ OfflinePunctuationConfig copy$default(OfflinePunctuationConfig offlinePunctuationConfig, OfflinePunctuationModelConfig offlinePunctuationModelConfig, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof OfflinePunctuationConfig) && s.c(this.model, ((OfflinePunctuationConfig) other).model);
    }
    ...
    public final void setModel(OfflinePunctuationModelConfig offlinePunctuationModelConfig) {
        s.h(offlinePunctuationModelConfig, "<set-?>");
