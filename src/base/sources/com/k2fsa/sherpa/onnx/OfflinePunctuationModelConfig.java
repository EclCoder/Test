...
public final /* data */ class OfflinePunctuationModelConfig {
    ...
    public static /* synthetic */ OfflinePunctuationModelConfig copy$default(OfflinePunctuationModelConfig offlinePunctuationModelConfig, String str, int i10, boolean z10, String str2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = offlinePunctuationModelConfig.ctTransformer;
        }
        if ((i11 & 2) != 0) {
            i10 = offlinePunctuationModelConfig.numThreads;
        }
        if ((i11 & 4) != 0) {
            z10 = offlinePunctuationModelConfig.debug;
        }
        if ((i11 & 8) != 0) {
            str2 = offlinePunctuationModelConfig.provider;
        }
        return offlinePunctuationModelConfig.copy(str, i10, z10, str2);
    }
    ...
    public final OfflinePunctuationModelConfig copy(String ctTransformer, int numThreads, boolean debug, String provider) {
        s.h(ctTransformer, "ctTransformer");
    ...
    public boolean equals(Object other) {
        ...
        return s.c(this.ctTransformer, offlinePunctuationModelConfig.ctTransformer) && this.numThreads == offlinePunctuationModelConfig.numThreads && this.debug == offlinePunctuationModelConfig.debug && s.c(this.provider, offlinePunctuationModelConfig.provider);
    }
    ...
    public OfflinePunctuationModelConfig(String ctTransformer, int i10, boolean z10, String provider) {
        s.h(ctTransformer, "ctTransformer");
        s.h(provider, "provider");
    ...
    public /* synthetic */ OfflinePunctuationModelConfig(String str, int i10, boolean z10, String str2, int i11, DefaultConstructorMarker defaultConstructorMarker) {
