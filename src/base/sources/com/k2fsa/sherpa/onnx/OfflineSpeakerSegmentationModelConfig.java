...
public final /* data */ class OfflineSpeakerSegmentationModelConfig {
    ...
    public static /* synthetic */ OfflineSpeakerSegmentationModelConfig copy$default(OfflineSpeakerSegmentationModelConfig offlineSpeakerSegmentationModelConfig, OfflineSpeakerSegmentationPyannoteModelConfig offlineSpeakerSegmentationPyannoteModelConfig, int i10, boolean z10, String str, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            offlineSpeakerSegmentationPyannoteModelConfig = offlineSpeakerSegmentationModelConfig.pyannote;
        }
        if ((i11 & 2) != 0) {
            i10 = offlineSpeakerSegmentationModelConfig.numThreads;
        }
        if ((i11 & 4) != 0) {
            z10 = offlineSpeakerSegmentationModelConfig.debug;
        }
        if ((i11 & 8) != 0) {
            str = offlineSpeakerSegmentationModelConfig.provider;
        }
        return offlineSpeakerSegmentationModelConfig.copy(offlineSpeakerSegmentationPyannoteModelConfig, i10, z10, str);
    }
    ...
    public boolean equals(Object other) {
        ...
        return s.c(this.pyannote, offlineSpeakerSegmentationModelConfig.pyannote) && this.numThreads == offlineSpeakerSegmentationModelConfig.numThreads && this.debug == offlineSpeakerSegmentationModelConfig.debug && s.c(this.provider, offlineSpeakerSegmentationModelConfig.provider);
    }
    ...
    public final void setPyannote(OfflineSpeakerSegmentationPyannoteModelConfig offlineSpeakerSegmentationPyannoteModelConfig) {
        s.h(offlineSpeakerSegmentationPyannoteModelConfig, "<set-?>");
    ...
    public OfflineSpeakerSegmentationModelConfig(OfflineSpeakerSegmentationPyannoteModelConfig pyannote, int i10, boolean z10, String provider) {
        s.h(pyannote, "pyannote");
        s.h(provider, "provider");
    ...
    public /* synthetic */ OfflineSpeakerSegmentationModelConfig(OfflineSpeakerSegmentationPyannoteModelConfig offlineSpeakerSegmentationPyannoteModelConfig, int i10, boolean z10, String str, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? new OfflineSpeakerSegmentationPyannoteModelConfig(null, 1, null) : offlineSpeakerSegmentationPyannoteModelConfig, (i11 & 2) != 0 ? 1 : i10, (i11 & 4) != 0 ? false : z10, (i11 & 8) != 0 ? "cpu" : str);
    }
}
