...
public final /* data */ class TenVadModelConfig {
    ...
    public static /* synthetic */ TenVadModelConfig copy$default(TenVadModelConfig tenVadModelConfig, String str, float f10, float f11, float f12, int i10, float f13, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = tenVadModelConfig.model;
        }
        if ((i11 & 2) != 0) {
            f10 = tenVadModelConfig.threshold;
        }
        if ((i11 & 4) != 0) {
            f11 = tenVadModelConfig.minSilenceDuration;
        }
        if ((i11 & 8) != 0) {
            f12 = tenVadModelConfig.minSpeechDuration;
        }
        if ((i11 & 16) != 0) {
            i10 = tenVadModelConfig.windowSize;
        }
        if ((i11 & 32) != 0) {
            f13 = tenVadModelConfig.maxSpeechDuration;
        }
        int i12 = i10;
        float f14 = f13;
        return tenVadModelConfig.copy(str, f10, f11, f12, i12, f14);
    }
    ...
    public boolean equals(Object other) {
        ...
        return s.c(this.model, tenVadModelConfig.model) && Float.compare(this.threshold, tenVadModelConfig.threshold) == 0 && Float.compare(this.minSilenceDuration, tenVadModelConfig.minSilenceDuration) == 0 && Float.compare(this.minSpeechDuration, tenVadModelConfig.minSpeechDuration) == 0 && this.windowSize == tenVadModelConfig.windowSize && Float.compare(this.maxSpeechDuration, tenVadModelConfig.maxSpeechDuration) == 0;
    }
    ...
    public TenVadModelConfig(String model, float f10, float f11, float f12, int i10, float f13) {
        s.h(model, "model");
        this.model = model;
        this.threshold = f10;
    ...
    public /* synthetic */ TenVadModelConfig(String str, float f10, float f11, float f12, int i10, float f13, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? "" : str, (i11 & 2) != 0 ? 0.5f : f10, (i11 & 4) != 0 ? 0.25f : f11, (i11 & 8) != 0 ? 0.25f : f12, (i11 & 16) != 0 ? 256 : i10, (i11 & 32) != 0 ? 5.0f : f13);
    }
}
