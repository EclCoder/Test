...
public class hnj extends uua {
    public hnj() {
        super(com.bytedance.adsdk.hnj.hn.gjv.qor.DIVISION);
    }
    ...
    public Object hnj(Map<String, JSONObject> map) {
        ...
        return com.bytedance.adsdk.hnj.hn.sk.hnj.hnj.hnj((Number) objHnj2, (Number) objHnj);
    }
}
