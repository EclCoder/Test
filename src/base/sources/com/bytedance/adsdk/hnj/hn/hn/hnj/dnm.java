...
public class dnm extends uua {
    public dnm() {
        super(com.bytedance.adsdk.hnj.hn.gjv.qor.MINUS);
    }
    ...
    public Object hnj(Map<String, JSONObject> map) {
        ...
        return com.bytedance.adsdk.hnj.hn.sk.hnj.sk.hnj((Number) objHnj2, (Number) objHnj);
    }
}
