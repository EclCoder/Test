...
public class orl extends uua {
    public orl() {
        super(com.bytedance.adsdk.hnj.hn.gjv.qor.MULTI);
    }
    ...
    public Object hnj(Map<String, JSONObject> map) {
        ...
        return com.bytedance.adsdk.hnj.hn.sk.hnj.dse.hnj((Number) objHnj2, (Number) objHnj);
    }
}
