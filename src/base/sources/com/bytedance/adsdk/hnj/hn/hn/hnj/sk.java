...
public class sk extends uua {
    public sk() {
        super(com.bytedance.adsdk.hnj.hn.gjv.qor.GT_EQ);
    }
    ...
    public Object hnj(Map<String, JSONObject> map) {
        ...
        return Boolean.valueOf(!((Boolean) com.bytedance.adsdk.hnj.hn.sk.hnj.gjv.hnj(objHnj2, (Number) objHnj)).booleanValue());
    }
}
