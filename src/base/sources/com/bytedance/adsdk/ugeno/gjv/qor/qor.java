...
public class qor extends com.bytedance.adsdk.ugeno.gjv.hn.hnj {
    public qor(com.bytedance.adsdk.ugeno.hn.qor qorVar, String str, dkl.hnj hnjVar) {
    ...
    public void hnj() {
        ...
        if (qorVarDkl instanceof com.bytedance.adsdk.ugeno.hn) {
            ((com.bytedance.adsdk.ugeno.hn) qorVarDkl).gjv();
        }
    }
}
