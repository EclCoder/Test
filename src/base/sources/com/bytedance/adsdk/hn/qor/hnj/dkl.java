...
public class dkl extends mjg<PointF, PointF> {
    public dkl(List<com.bytedance.adsdk.hn.dse.hnj<PointF>> list) {
        super(list);
    }
    ...
    public com.bytedance.adsdk.hn.hnj.hn.hnj<PointF, PointF> hnj() {
        return new com.bytedance.adsdk.hn.hnj.hn.dnm(this.hnj);
    }
