...
public class hnj extends mjg<Integer, Integer> {
    public hnj(List<com.bytedance.adsdk.hn.dse.hnj<Integer>> list) {
        super(list);
    }
    ...
    public com.bytedance.adsdk.hn.hnj.hn.hnj<Integer, Integer> hnj() {
        return new com.bytedance.adsdk.hn.hnj.hn.hn(this.hnj);
    }
