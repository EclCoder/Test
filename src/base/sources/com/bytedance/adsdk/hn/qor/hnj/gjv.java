...
public class gjv extends mjg<Integer, Integer> {
    public gjv(List<com.bytedance.adsdk.hn.dse.hnj<Integer>> list) {
        super(list);
    }
    ...
    public com.bytedance.adsdk.hn.hnj.hn.hnj<Integer, Integer> hnj() {
        return new com.bytedance.adsdk.hn.hnj.hn.dkl(this.hnj);
    }
