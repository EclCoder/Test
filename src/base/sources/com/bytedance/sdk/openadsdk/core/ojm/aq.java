...
public class aq extends com.bytedance.sdk.openadsdk.core.qor.hnj {
    public aq(Context context, com.bytedance.sdk.openadsdk.core.model.as asVar, String str, int i10) {
    ...
    protected com.bytedance.sdk.openadsdk.core.model.bug hnj(float f10, float f11, float f12, float f13, SparseArray<com.bytedance.sdk.openadsdk.core.qor.qor.hnj> sparseArray, long j10, long j11, View view, String str, float f14, int i10, float f15, int i11, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        this.f14165xn = 0;
        return new com.bytedance.sdk.openadsdk.core.model.bug.hnj().dkl(f10).sk(f11).gjv(fHn).qor(fHn2).hn(j12).hnj(j13).hnj(iArrHnj).hn(sq.qor(view)).gjv(this.tgn).sk(this.xyo).dkl(this.f14172vf).hn(com.bytedance.sdk.openadsdk.core.ta.hn().hnj() ? 1 : 2).hnj(sparseArray).hnj(str).hnj(f14).qor(i10).hn(f15).hnj(i11).hnj(jSONObject).hn(jSONObject2).hnj();
    }
