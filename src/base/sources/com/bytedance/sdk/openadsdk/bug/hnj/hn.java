...
public class hn extends com.bytedance.sdk.component.hnj.qor<JSONObject, JSONObject> {
    ...
    public static void hnj(com.bytedance.sdk.component.hnj.fc fcVar, final ua uaVar) {
        fcVar.hnj("interstitial_webview_close", new com.bytedance.sdk.component.hnj.qor.hn() { // from class: com.bytedance.sdk.openadsdk.bug.hnj.hn.1
    ...
    public void hnj(JSONObject jSONObject, com.bytedance.sdk.component.hnj.sk skVar) {
        com.bytedance.sdk.openadsdk.core.ta.hn().fc();
