...
final class g {
    ...
    private static long getChannelFieldOffset(Class<?> cls) {
        ...
        try {
            if (v1.hasUnsafeArrayOperations()) {
                return v1.objectFieldOffset(cls.getDeclaredField("channel"));
            }
            return -1L;
    ...
    private static boolean writeToChannel(ByteBuffer byteBuffer, OutputStream outputStream) throws IOException {
        ...
        try {
            writableByteChannel = (WritableByteChannel) v1.getObject(outputStream, j10);
