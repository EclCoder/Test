...
final class f extends c implements a0.a, RandomAccess, d1 {
    ...
    public int hashCode() {
        int iHashBoolean = 1;
        for (int i10 = 0; i10 < this.size; i10++) {
            iHashBoolean = (iHashBoolean * 31) + a0.hashBoolean(this.array[i10]);
        }
        return iHashBoolean;
    }
    ...
    private f(boolean[] zArr, int i10, boolean z10) {
        super(z10);
        this.array = zArr;
        this.size = i10;
    }
    ...
    public a0.a mutableCopyWithCapacity(int i10) {
        if (i10 >= this.size) {
            return new f(Arrays.copyOf(this.array, i10), this.size, true);
        }
