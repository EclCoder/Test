...
public class AppMeasurement {
    ...
    public static class ConditionalUserProperty {
        ...
        ConditionalUserProperty(Bundle bundle) {
            ...
            this.mAppId = (String) zzjh.zzb(bundle, MBridgeConstans.APP_ID, String.class, null);
            this.mOrigin = (String) zzjh.zzb(bundle, "origin", String.class, null);
            this.mName = (String) zzjh.zzb(bundle, dOIDCKnIR.fCECBRJMUnAP, String.class, null);
    ...
    public void logEventInternalNoInterceptor(String str, String str2, Bundle bundle, long j10) {
        this.zzb.zzb(str, str2, bundle, j10, 0L);
    }
