...
public final class zznt {
    ...
    public final int zzc(final Intent intent, int i10, final int i11) {
        ...
        zzicVarZzy.zzaV();
        zzguVarZzaW.zzk().zzc("Local AppMeasurementService called. startId, action", Integer.valueOf(i11), action);
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            zzk(zzpg.zza(context), new Runnable() { // from class: com.google.android.gms.measurement.internal.zzns
                @Override // java.lang.Runnable
                public final /* synthetic */ void run() {
                    this.zza.zzf(i11, zzguVarZzaW, intent);
                }
            });
        }
        return 2;
    ...
    final /* synthetic */ void zzf(int i10, zzgu zzguVar, Intent intent) {
        Context context = this.zza;
