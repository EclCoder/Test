...
final class zzmx implements Runnable {
    ...
    zzmx(zznl zznlVar, AtomicReference atomicReference, String str, String str2, String str3, zzr zzrVar, boolean z10) {
        ...
        synchronized (atomicReference2) {
            try {
                try {
                    ...
                    this.zzf.zzu.zzaW().zzb().zzd("(legacy) Failed to get user properties; remote exception", null, this.zzb, e10);
