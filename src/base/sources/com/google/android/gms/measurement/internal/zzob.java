...
final class zzob {
    ...
    final void zzb(long j10, long j11, boolean z10) {
        zzoc zzocVar = this.zza;
        zzocVar.zzg();
        zzocVar.zzj();
        zzic zzicVar = zzocVar.zzu;
        if (zzicVar.zzd().zzo(j10)) {
            zzicVar.zzd().zzg.zzb(true);
            zzocVar.zzu.zzv().zzi();
        }
    ...
    final void zzc(long j10, long j11, boolean z10) {
        zzoc zzocVar = this.zza;
        zzocVar.zzg();
        if (zzocVar.zzu.zzB()) {
            zzic zzicVar = zzocVar.zzu;
            ...
            zzicVar2.zzj().zzM("auto", "_sid", Long.valueOf(j12), j10);
            zzicVar.zzd().zzl.zzb(j12);
            zzicVar.zzd().zzg.zzb(false);
            Bundle bundle = new Bundle();
            bundle.putLong("_sid", j12);
            zzicVar2.zzj().zzF("auto", "_s", j10, j11, bundle);
            ...
            zzicVar2.zzj().zzF("auto", "_ssr", j10, j11, bundle2);
        }
    }
}
