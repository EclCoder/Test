...
public final class zbm {
    ...
    public static OptionalPendingResult zbd(GoogleApiClient googleApiClient, Context context, GoogleSignInOptions googleSignInOptions, boolean z10) {
    ...
    public static Intent zbc(Context context, GoogleSignInOptions googleSignInOptions) {
        ...
        Intent intentZba = zba(context, googleSignInOptions);
        intentZba.setAction(UoyZyZEcGYBpIg.ozeVqoY);
        return intentZba;
    }
}
