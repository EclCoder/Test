...
public class zzl {
    ...
    private static Object zzh(Context context, ComponentName componentName, zzk zzkVar, long j10, Executor executor) throws IOException {
    ...
    static /* synthetic */ TokenData zzb(Account account, String str, Bundle bundle, Context context, IBinder iBinder) throws IOException {
        Bundle bundleZze = com.google.android.gms.internal.auth.zze.zzb(iBinder).zze(account, str, bundle);
        if (bundleZze != null) {
            return zzg(context, NhHRaDJCHtCTJR.swSyjgzChXcpSBP, bundleZze);
        }
        throw new IOException("Service call returned null");
    }
