...
public abstract class GoogleApiClient {
    ...
    public abstract void stopAutoManage(s sVar);
    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                aVar2.put(api2.zab(), clientBuildClient);
            ...
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, clientSettingsZaa, this.zao, this.zap, aVar, this.zaq, this.zar, aVar2, this.zal, zabe.zad(aVar2.values(), true), arrayList);
        ...
        public Builder enableAutoManage(s sVar, int i10, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        public Builder enableAutoManage(s sVar, OnConnectionFailedListener onConnectionFailedListener) {
            enableAutoManage(sVar, 0, onConnectionFailedListener);
            return this;
        }
