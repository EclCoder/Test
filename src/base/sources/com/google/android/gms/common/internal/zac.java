...
public final class zac {
    private static final u zaa = new u();
    ...
    public static String zab(Context context, int i10) {
        ...
        if (i10 != 2) {
            return i10 != 3 ? resources.getString(android.R.string.ok) : resources.getString(R.string.common_google_play_services_enable_button);
        }
    ...
    private static String zah(Context context, String str) {
        ...
        synchronized (uVar) {
            try {
                Locale localeC = g.a(context.getResources().getConfiguration()).c(0);
                if (!localeC.equals(zab)) {
                    uVar.clear();
                    zab = localeC;
                }
                String str2 = (String) uVar.get(str);
                if (str2 != null) {
                    return str2;
                }
                ...
                Log.w(UHbHibBvYxKnPE.eZgvlUtgA, "Got empty resource: " + str);
                return null;
            } catch (Throwable th2) {
                throw th2;
            }
