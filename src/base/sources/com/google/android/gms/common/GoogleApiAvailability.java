...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    final Dialog zaa(Context context, int i10, zag zagVar, DialogInterface.OnCancelListener onCancelListener, DialogInterface.OnClickListener onClickListener) {
        ...
        builder2 = builder;
        builder2.setMessage(com.google.android.gms.common.internal.zac.zac(context, i10));
    ...
    final void zad(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        try {
            if (activity instanceof s) {
                SupportErrorDialogFragment.newInstance(dialog, onCancelListener).show(((s) activity).getSupportFragmentManager(), str);
                return;
            }
    ...
    final void zae(Context context, int i10, String str, PendingIntent pendingIntent) {
        int i11;
        String str2;
        Log.w("GoogleApiAvailability", String.format(WwUgngZLNA.YWyESTOSZuOs, Integer.valueOf(i10), null), new IllegalArgumentException());
        if (i10 == 18) {
            zaf(context);
            return;
        }
        ...
        NotificationCompat.l lVarS = new NotificationCompat.l(context).o(true).e(true).i(strZae).s(new NotificationCompat.j().h(strZad));
        if (DeviceProperties.isWearable(context)) {
            Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
            lVarS.r(context.getApplicationInfo().icon).q(2);
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                lVarS.a(com.google.android.gms.base.R.drawable.common_full_open_on_phone, resources.getString(com.google.android.gms.base.R.string.common_open_on_phone), pendingIntent);
            } else {
                lVarS.g(pendingIntent);
            }
        } else {
            lVarS.r(android.R.drawable.stat_sys_warning).t(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker)).u(System.currentTimeMillis()).g(pendingIntent).h(strZad);
        }
        if (PlatformVersion.isAtLeastO()) {
        ...
        Notification notificationB = lVarS.b();
    ...
    public boolean showErrorDialogFragment(Activity activity, int i10, f.c cVar, DialogInterface.OnCancelListener onCancelListener) {
        Dialog dialogZaa = zaa(activity, i10, null, onCancelListener, new zac(this, activity, i10, cVar));
        if (dialogZaa == null) {
            return false;
        }
        zad(activity, dialogZaa, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener);
