...
public final class zzfqg implements Runnable {
        ...
        try {
            if (((Boolean) zzbkj.zzc.zze()).booleanValue()) {
                if (arrayList.contains("banner") || arrayList.contains(AdFormat.BANNER.name())) {
                    this.zzi = 3;
                } else if (arrayList.contains(com.vungle.ads.internal.f.PLACEMENT_TYPE_INTERSTITIAL) || arrayList.contains(AdFormat.INTERSTITIAL.name())) {
                    this.zzi = 4;
                } else if (arrayList.contains("native") || arrayList.contains(AdFormat.NATIVE.name())) {
                    this.zzi = 8;
                } else if (arrayList.contains(com.vungle.ads.internal.f.PLACEMENT_TYPE_REWARDED) || arrayList.contains(AdFormat.REWARDED.name())) {
                    this.zzi = 5;
    ...
    public final synchronized zzfqg zzi(int i10) {
        if (((Boolean) zzbkj.zzc.zze()).booleanValue()) {
            this.zzi = i10;
        }
        return this;
