...
final class zzagl {
    ...
    static boolean zza(byte[] bArr, int i10, int i11) {
    ...
    static int zzc(String str, byte[] bArr, int i10, int i11) {
        int i12;
        int i13;
        int i14;
        char cCharAt;
            ...
            if (cCharAt2 < 128 && i16 < i12) {
                ...
                if ((cCharAt2 >= 55296 && cCharAt2 <= 57343) || i16 > i12 - 3) {
                    if (i16 > i12 - 4) {
                        ...
                        return zzagi.zza(str, bArr, i10, i11);
                    }
                    i15++;
                    if (i15 != str.length()) {
    ...
    static String zzd(byte[] bArr, int i10, int i11) throws zzaeh {
        int i12;
        if (i11 == 0) {
            return "";
        }
        ...
        while (i10 < i13) {
            ...
            if (zzagh.zza(b11)) {
                ...
                if (b11 < -32) {
                    ...
                    i12 = i15 + 1;
                    i10 += 2;
                    zzagh.zzb(b11, bArr[i16], cArr, i15);
                } else if (b11 < -16) {
                    if (i16 >= i13 - 1) {
                        throw new zzaeh("Protocol message had invalid UTF-8.");
                    }
                    ...
                    int i17 = i10 + 2;
                    i10 += 3;
                    zzagh.zzc(b11, bArr[i16], bArr[i17], cArr, i15);
                } else {
                    if (i16 >= i13 - 2) {
                        throw new zzaeh("Protocol message had invalid UTF-8.");
                    }
                    ...
                    byte b14 = bArr[i10 + 2];
                    i10 += 4;
                    zzagh.zzd(b11, b13, b14, bArr[i18], cArr, i15);
                    i15 += 2;
                }
                i15 = i12;
            }
