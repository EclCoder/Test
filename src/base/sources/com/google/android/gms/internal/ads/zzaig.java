...
public final class zzaig implements zzafy {
    ...
    private final long zzh(zzet zzetVar, boolean z10) {
        boolean zZza;
        this.zzh.getClass();
    ...
    private final void zzi() {
        ...
        zzagl zzaglVar = this.zzh;
        String str = zzfl.zza;
        this.zze.zze(j10 / ((long) zzaglVar.zze), 1, this.zzl, 0, null);
    }
    ...
    public final int zzd(zzafz zzafzVar, zzagy zzagyVar) throws zzat {
        ...
        int i12 = this.zzi;
        if (i11 < i12) {
            zzetVar3.zzk(Math.min(i12 - i11, zzetVar3.zzd()));
        }
        long jZzh = zzh(zzetVar3, z10);
