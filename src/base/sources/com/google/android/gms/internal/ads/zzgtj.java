...
public final class zzgtj {
    ...
    public static void zzc(boolean z10, String str, char c10) {
        if (!z10) {
            throw new IllegalArgumentException(zzgua.zzd(str, Character.valueOf(c10)));
        }
    }

    public static void zzd(boolean z10, String str, int i10) {
        if (!z10) {
            throw new IllegalArgumentException(zzgua.zzd(str, Integer.valueOf(i10)));
        }
    }

    public static void zze(boolean z10, String str, long j10) {
        if (!z10) {
            throw new IllegalArgumentException(zzgua.zzd(str, Long.valueOf(j10)));
        }
    }
    ...
    public static void zzg(boolean z10, String str, int i10, int i11) {
        if (!z10) {
            throw new IllegalArgumentException(zzgua.zzd(str, Integer.valueOf(i10), Integer.valueOf(i11)));
        }
    }
    ...
    public static int zzm(int i10, int i11, String str) {
        ...
        if (i10 < 0) {
            strZzd = zzgua.zzd("%s (%s) must not be negative", "index", Integer.valueOf(i10));
        } else {
            if (i11 < 0) {
            ...
            strZzd = zzgua.zzd("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i10), Integer.valueOf(i11));
        }
    ...
    public static void zzo(int i10, int i11, int i12) {
        ...
        if (i10 < 0 || i11 < i10 || i11 > i12) {
            if (i10 < 0 || i10 > i12) {
                ...
                strZzp = (i11 < 0 || i11 > i12) ? zzp(i11, i12, "end index") : zzgua.zzd("end index (%s) must not be less than start index (%s)", Integer.valueOf(i11), Integer.valueOf(i10));
            }
    ...
    private static String zzp(int i10, int i11, String str) {
        if (i10 < 0) {
            return zzgua.zzd("%s (%s) must not be negative", str, Integer.valueOf(i10));
        }
        if (i11 >= 0) {
            return zzgua.zzd("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i10), Integer.valueOf(i11));
        }
        StringBuilder sb2 = new StringBuilder(String.valueOf(i11).length() + 15);
        sb2.append("negative size: ");
        sb2.append(i11);
