...
public final class zzask {
    public static X509Certificate[][] zza(String str) {
        ...
        try {
            ...
            try {
                ...
                if (j14 != j11) {
                    StringBuilder sb7 = new StringBuilder(String.valueOf(j14).length() + 63 + String.valueOf(j11).length());
                    sb7.append("APK Signing Block sizes in header and footer do not match: ");
                    sb7.append(j14);
                    sb7.append(" vs ");
                    sb7.append(j11);
                    throw new zzash(sb7.toString());
                }
                ...
                try {
                    ...
                    while (byteBufferSlice.hasRemaining()) {
                        ...
                        if (j15 < 4 || j15 > 2147483647L) {
                            StringBuilder sb11 = new StringBuilder(String.valueOf(i12).length() + 45 + String.valueOf(j15).length());
                        ...
                        if (i13 > byteBufferSlice.remaining()) {
                            ...
                            throw new zzash(sb12.toString());
                        }
                        if (byteBufferSlice.getInt() == 1896449818) {
                            X509Certificate[][] x509CertificateArrZzb = zzb(randomAccessFile.getChannel(), new zzasg(zzi(byteBufferSlice, i13 - 4), jLongValue2, j13, jLongValue, byteBuffer, null));
    ...
    private static void zzd(Map map, FileChannel fileChannel, long j10, long j11, long j12, ByteBuffer byteBuffer) {
        if (map.isEmpty()) {
            throw new SecurityException("No digests provided");
        }
        zzasf zzasfVar = new zzasf(fileChannel, 0L, j10);
        zzasf zzasfVar2 = new zzasf(fileChannel, j11, j12 - j11);
        ByteBuffer byteBufferDuplicate = byteBuffer.duplicate();
        byteBufferDuplicate.order(ByteOrder.LITTLE_ENDIAN);
        zzasl.zzc(byteBufferDuplicate, j10);
    ...
    private static byte[][] zze(int[] iArr, zzase[] zzaseVarArr) throws DigestException {
        ...
        while (true) {
            ...
            jZza += (zzaseVarArr[i12].zza() + 1048575) / 1048576;
            i12++;
        }
        if (jZza >= 2097151) {
        ...
        int i18 = 0;
        while (i16 < i10) {
            zzase zzaseVar = zzaseVarArr[i16];
            int i19 = i16;
            ...
            while (jZza2 > 0) {
                ...
                try {
                    zzaseVar.zzb(messageDigestArr, j11, iMin);
                    int i22 = 0;
                    ...
                    StringBuilder sb4 = new StringBuilder(String.valueOf(i20).length() + 37 + String.valueOf(i18).length());
    ...
    private static ByteBuffer zzi(ByteBuffer byteBuffer, int i10) {
    ...
    private static X509Certificate[] zzc(ByteBuffer byteBuffer, Map map, CertificateFactory certificateFactory) throws IOException {
        ...
        while (byteBufferZzj2.hasRemaining()) {
            ...
            try {
                ...
                e = e11;
                StringBuilder sb3 = new StringBuilder(String.valueOf(i11).length() + 34);
                sb3.append("Failed to parse signature record #");
                sb3.append(i11);
                ...
                if (i10 != 769) {
                    switch (i10) {
                        case 257:
                            ...
                            break;
                        case 258:
                            pairCreate = Pair.create("SHA512withRSA/PSS", new PSSParameterSpec(Lykgign.rGVcLA, "MGF1", MGF1ParameterSpec.SHA512, 64, 1));
                            break;
                        case 259:
        ...
        try {
            ...
            if (signature.verify(bArrZzk3)) {
                ...
                while (byteBufferZzj4.hasRemaining()) {
                    ...
                    try {
                        ...
                        e = e12;
                        StringBuilder sb4 = new StringBuilder(String.valueOf(i13).length() + 31);
                        sb4.append("Failed to parse digest record #");
                        sb4.append(i13);
                        throw new IOException(sb4.toString(), e);
                    } catch (BufferUnderflowException e13) {
                        e = e13;
                        StringBuilder sb5 = new StringBuilder(String.valueOf(i13).length() + 31);
                        sb5.append("Failed to parse digest record #");
                        sb5.append(i13);
                ...
                if (arrayList.equals(arrayList2)) {
                    ...
                    while (byteBufferZzj6.hasRemaining()) {
                        ...
                        try {
                            ...
                            StringBuilder sb6 = new StringBuilder(String.valueOf(i15).length() + 30);
                            sb6.append("Failed to decode certificate #");
                            sb6.append(i15);
                            throw new SecurityException(sb6.toString(), e14);
                        }
                    }
            ...
            e = e15;
            StringBuilder sb7 = new StringBuilder(String.valueOf(str2).length() + 27);
            sb7.append("Failed to verify ");
            sb7.append(str2);
            sb7.append(" signature");
            throw new SecurityException(sb7.toString(), e);
        } catch (InvalidKeyException e16) {
            e = e16;
            StringBuilder sb8 = new StringBuilder(String.valueOf(str2).length() + 27);
            sb8.append("Failed to verify ");
            sb8.append(str2);
            sb8.append(" signature");
            throw new SecurityException(sb8.toString(), e);
        } catch (NoSuchAlgorithmException e17) {
            e = e17;
            StringBuilder sb9 = new StringBuilder(String.valueOf(str2).length() + 27);
            sb9.append("Failed to verify ");
            sb9.append(str2);
            sb9.append(" signature");
            throw new SecurityException(sb9.toString(), e);
        } catch (SignatureException e18) {
            e = e18;
            StringBuilder sb10 = new StringBuilder(String.valueOf(str2).length() + 27);
            sb10.append("Failed to verify ");
            sb10.append(str2);
            sb10.append(" signature");
            throw new SecurityException(sb10.toString(), e);
        } catch (InvalidKeySpecException e19) {
            e = e19;
            StringBuilder sb11 = new StringBuilder(String.valueOf(str2).length() + 27);
            sb11.append("Failed to verify ");
            sb11.append(str2);
            sb11.append(" signature");
            throw new SecurityException(sb11.toString(), e);
        }
    }
}
