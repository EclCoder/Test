...
final class zzgiu extends zzgix {
    ...
    zzgiu(zzaxm zzaxmVar, zzght zzghtVar, zzgec zzgecVar, Context context, Map map, zzgqh zzgqhVar) {
        super("l+kgGKMz/Iv8su4g8cwY9wke7SfZsr0faZH/ngMWgPU8rl0NeXLqH/yGmwd3VO0X", "i+H002K9niN4AH5EysFvLiWEIE/4786FSVH14vFL1Is=", zzaxmVar, zzghtVar, zzgqhVar.zza(Sdk$SDKError.b.TPAT_ERROR_VALUE));
        this.zzb = zzgecVar;
        this.zzc = context;
        this.zzd = map;
    }
        ...
        synchronized (zzaxmVar) {
            try {
                if (zzgecVar == zzgec.QUERY) {
                    Object obj = objArr[0];
                    Long l10 = zza;
                    zzaxmVar.zzq(((Long) zzgtg.zza(obj, l10)).longValue());
                    zzaxmVar.zzr(((Long) zzgtg.zza(objArr[1], l10)).longValue());
                }
