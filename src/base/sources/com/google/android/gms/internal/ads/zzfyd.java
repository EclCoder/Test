...
public final class zzfyd {
        ...
        if (file.exists()) {
            ...
            if (fileArrListFiles == null || fileArrListFiles.length == 0) {
                ...
                try {
                    ...
                    zzc(null, e10.toString(), context, zzfxgVar);
                }
            }
        } else {
            if (zzfxgVar != null) {
    ...
    private static final String zzd(Context context, zzfxg zzfxgVar) {
        ...
        try {
            ...
            if (zzfxgVar != null) {
                zzfxgVar.zzc(2024, 0L, e10);
            }
        } catch (NoSuchFieldException e11) {
            if (zzfxgVar != null) {
                zzfxgVar.zzc(2024, 0L, e11);
            }
        }
    ...
    private static final void zzc(byte[] bArr, String str, Context context, zzfxg zzfxgVar) {
        ...
        sb2.append("os.arch:");
        sb2.append(zzgtz.OS_ARCH.zza());
        sb2.append(";");
        try {
            String[] strArr = (String[]) Build.class.getField(giNWGaNAgVQoO.EjuSlFzcbeZbcX).get(null);
            if (strArr != null) {
        ...
        zzfxgVar.zze(4007, sb2.toString());
    }
}
