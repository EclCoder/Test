    ...
    protected final boolean zza(int i10, Parcel parcel, Parcel parcel2, int i11) {
        ...
        switch (i10) {
            case 1:
                ...
                zzbn.zzf(parcel);
                initialize(iObjectWrapperAsInterface, zzdbVar, j10);
                break;
            case 2:
            ...
            case 3:
                ...
                zzbn.zzf(parcel);
                logEventAndBundle(string3, string4, bundle2, zzcqVar, j12);
                break;
            case 4:
                ...
                zzbn.zzf(parcel);
                setUserProperty(string5, string6, iObjectWrapperAsInterface2, zZza3, j13);
                break;
            case 5:
            ...
            case 31:
                ...
                zzbn.zzf(parcel);
                onActivitySaveInstanceState(iObjectWrapperAsInterface10, zzcqVar7, j29);
                break;
            case 32:
                ...
                zzbn.zzf(parcel);
                performAction(bundle6, zzcqVar6, j30);
                break;
            case 33:
            ...
            case 50:
                ...
                zzbn.zzf(parcel);
                setCurrentScreenByScionActivityInfo(zzddVar, string20, string21, j34);
                break;
            case 51:
                zzdd zzddVar2 = (zzdd) zzbn.zzb(parcel, zzdd.CREATOR);
                long j35 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityStartedByScionActivityInfo(zzddVar2, j35);
                break;
            case 52:
                zzdd zzddVar3 = (zzdd) zzbn.zzb(parcel, zzdd.CREATOR);
                long j36 = parcel.readLong();
                zzbn.zzf(parcel);
                onActivityStoppedByScionActivityInfo(zzddVar3, j36);
                break;
            case 53:
            ...
            case INIT_TO_SUCCESS_CALLBACK_DURATION_MS_VALUE:
                ...
                zzbn.zzf(parcel);
                onActivitySaveInstanceStateByScionActivityInfo(zzddVar8, zzcqVar2, j41);
                break;
            ...
            case AD_START_TO_BACKGROUND_DURATION_MS_VALUE:
                ...
                zzbn.zzf(parcel);
                logEventWithElapsedTime(string22, string23, bundle11, zZza7, zZza8, j42, j43);
                break;
            case 60:
                ...
                zzbn.zzf(parcel);
                initializeWithElapsedTime(iObjectWrapperAsInterface14, zzdbVar2, j44, j45);
                break;
            case APP_BACKGROUND_DURING_AD_LOAD_VALUE:
                long j46 = parcel.readLong();
                long j47 = parcel.readLong();
                zzbn.zzf(parcel);
                resetAnalyticsDataWithElapsedTime(j46, j47);
                break;
        }
