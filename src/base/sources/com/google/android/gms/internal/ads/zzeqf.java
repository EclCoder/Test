...
public final class zzeqf implements zzels {
    ...
    final /* synthetic */ ListenableFuture zzc(final zzfkf zzfkfVar, zzfkq zzfkqVar, zzdwm zzdwmVar, Object obj) throws zzclj {
        ...
        final zzdvn zzdvnVarZzf = zzdvrVar.zzf(zzcyjVar, new zzdvo(new zzeqb(context, zzdwiVar, zzfkyVar, versionInfoParcel, zzfkfVar, zzcfwVar, zzckuVarZza, zzbptVar, z10, zzekrVar, zzdzgVar, this.zzk), zzckuVarZza));
        ...
        zzdvnVarZzf.zzl().zzi(zzckuVarZza, true, true != z10 ? null : zzbptVar, zzdzgVar);
        zzfkk zzfkkVar = zzfkfVar.zzs;
