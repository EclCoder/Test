...
public class zzadp<MessageType extends zzadu<MessageType, BuilderType>, BuilderType extends zzadp<MessageType, BuilderType>> extends zzaca<MessageType, BuilderType> {
    ...
    public final /* bridge */ /* synthetic */ zzaca zzaT(byte[] bArr, int i10, int i11) throws zzaeh {
        int i12 = zzadf.zzb;
        int i13 = zzacf.zza;
        zzbf(bArr, 0, i11, zzadf.zza);
        return this;
    }

    @Override // com.google.android.gms.internal.measurement.zzaca
    public final /* bridge */ /* synthetic */ zzaca zzaU(byte[] bArr, int i10, int i11, zzadf zzadfVar) throws zzaeh {
        zzbf(bArr, 0, i11, zzadfVar);
        return this;
    }
    ...
    public final zzadp zzbf(byte[] bArr, int i10, int i11, zzadf zzadfVar) throws zzaeh {
        if (!this.zza.zzch()) {
            zzaZ();
        }
        try {
            zzafl.zza().zzb(this.zza.getClass()).zzj(this.zza, bArr, 0, i11, new zzacg(zzadfVar));
            return this;
        } catch (zzaeh e10) {
            throw e10;
