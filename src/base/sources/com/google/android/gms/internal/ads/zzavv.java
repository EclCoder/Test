...
public final class zzavv {
    ...
    private final long zzg() throws zzavu, zzavs {
        ...
        while (i20 < (i10 ^ i11)) {
            try {
                ...
                int i23 = i11;
                this.zza = i22 + 1;
                byte bZza = zzaveVar.zza(zzavqVar, i22);
                int i24 = i14 ^ i15;
    ...
    private static final void zzh(long j10) throws zzavt {
    ...
    public final long zzb() {
        ...
        long j14 = jArr[4];
        long j15 = jArr[5];
        return ((long) this.zza) * ((jArr[6] + (((((~j10) & j11) | j12) + ((j10 & j13) | j14)) - j15)) ^ (jArr[7] % 1780695788));
    }
    ...
    public final long zzc() throws zzavu {
        try {
            ...
            int i10 = this.zza;
            this.zza = i10 + 1;
            return zzaveVar.zza(zzavqVar, i10);
        } catch (IndexOutOfBoundsException e10) {
            throw new zzavu(e10);
        }
    }
    ...
    public final int zzd() {
        ...
        try {
            ...
            this.zza = i18 + 1;
            int i19 = i10 ^ i11;
            int iZza = zzaveVar.zza(zzavqVar, i18) & i19;
            zzave zzaveVar2 = this.zzc;
            zzavq zzavqVar2 = this.zzb;
            int i20 = this.zza;
            this.zza = i20 + 1;
            int iZza2 = iZza | ((zzaveVar2.zza(zzavqVar2, i20) & i19) << (i12 ^ i13));
            zzave zzaveVar3 = this.zzc;
            zzavq zzavqVar3 = this.zzb;
            int i21 = this.zza;
            this.zza = i21 + 1;
            int iZza3 = iZza2 | ((i19 & zzaveVar3.zza(zzavqVar3, i21)) << (i14 ^ i15));
            zzave zzaveVar4 = this.zzc;
            zzavq zzavqVar4 = this.zzb;
            int i22 = this.zza;
            this.zza = i22 + 1;
            return iZza3 | (zzaveVar4.zza(zzavqVar4, i22) << (i16 ^ i17));
        } catch (IndexOutOfBoundsException e10) {
            throw new zzavu(e10);
        }
    }
    ...
    public final zzavq zzf(long j10) throws zzavu, zzavt {
        ...
        if (j12 > zzavqVar.zza.length || j12 < j11) {
            throw new zzavu();
        }
        try {
            int i20 = (int) j12;
            zzavq zzavqVarZzb = this.zzc.zzb(zzavqVar, i19, i20);
            this.zza = i20;
            return zzavqVarZzb;
        } catch (IndexOutOfBoundsException e10) {
    ...
    private zzavv(zzavq zzavqVar, int i10, zzave zzaveVar) {
        this.zzb = zzavqVar;
        this.zza = i10;
        this.zzc = zzaveVar;
    }

    public zzavv(zzavq zzavqVar, int i10, zzave zzaveVar, zzavh zzavhVar) {
        this(zzavqVar, i10, zzaveVar);
        this.zzd = zzavhVar;
    }
}
