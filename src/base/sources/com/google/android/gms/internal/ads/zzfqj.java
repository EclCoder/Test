            ...
            synchronized (obj) {
                try {
                    ...
                    try {
                        ...
                        if ((e10 instanceof zzeed) && ((zzeed) e10).zza() == 3) {
                            return;
                        }
                ...
                if (!this.zzm) {
                    ...
                    if (zza()) {
                        ...
                        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zznq)).booleanValue()) {
                            long j10 = iIntValue;
                            zzcfr.zzd.scheduleWithFixedDelay(this, j10, j10, TimeUnit.MILLISECONDS);
                        } else {
                            long j11 = iIntValue;
                            zzcfr.zzd.scheduleAtFixedRate(this, j11, j11, TimeUnit.MILLISECONDS);
                        }
