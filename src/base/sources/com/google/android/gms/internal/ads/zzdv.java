...
public final class zzdv implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public final void zza(int i10) throws zzdw {
        ...
        String str = zzfl.zza;
        zzdx.zze(z10, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", objArr));
        ...
        if (z11) {
            throw new zzdw(sb2.toString(), zzgwjVar.zzi());
        }
