...
public final class zzemd implements zzels {
    ...
    final /* synthetic */ ListenableFuture zzc(final zzfkf zzfkfVar, zzfkq zzfkqVar, zzdwm zzdwmVar, Object obj) throws zzclj {
        ...
        final zzcuw zzcuwVarZzf = zzcuzVar.zzf(zzcyjVar, new zzdmd(new zzemf(versionInfoParcel, zzcfwVar, zzfkfVar, zzckuVarZza, zzfkyVar, z10, zzbptVar, this.zzh, this.zzj), zzckuVarZza), new zzcux(zzfkfVar.zzaa));
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbihVar)).booleanValue()) {
        ...
        zzbpt zzbptVar2 = true == z10 ? zzbptVar : null;
