...
public final class zzedq {
    ...
    public static final void zzb(Context context, ViewGroup viewGroup, NativeAd nativeAd) {
        ...
        linearLayout.addView(zzc(context, resourcesZzf == null ? "Headline" : resourcesZzf.getString(com.google.android.gms.ads.impl.R.string.native_headline), "headline_header_tag"));
        ...
        linearLayout.addView(zzc(context, resourcesZzf == null ? "Body" : resourcesZzf.getString(com.google.android.gms.ads.impl.R.string.native_body), mTFeqtajA.FxZLOAgZ));
        ...
        linearLayout.addView(zzc(context, resourcesZzf == null ? "Media View" : resourcesZzf.getString(com.google.android.gms.ads.impl.R.string.native_media_view), "media_view_header_tag"));
