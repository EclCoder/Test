...
public final class zzxu {
    ...
    private zzxu(CopyOnWriteArrayList copyOnWriteArrayList, int i10, zzxk zzxkVar) {
        this.zzc = copyOnWriteArrayList;
        this.zza = 0;
        this.zzb = zzxkVar;
    }

    public final zzxu zza(int i10, zzxk zzxkVar) {
    ...
    public final void zzd(final zzxb zzxbVar, final zzxg zzxgVar, final int i10) {
        zzi(new zzdt() { // from class: com.google.android.gms.internal.ads.zzxt
            @Override // com.google.android.gms.internal.ads.zzdt
            public final /* synthetic */ void zza(Object obj) {
                ((zzxv) obj).zzai(0, this.zza.zzb, zzxbVar, zzxgVar, i10);
            }
        });
    }
    ...
    public final void zzg(final zzxb zzxbVar, final zzxg zzxgVar, final IOException iOException, final boolean z10) {
        zzi(new zzdt() { // from class: com.google.android.gms.internal.ads.zzxq
            @Override // com.google.android.gms.internal.ads.zzdt
            public final /* synthetic */ void zza(Object obj) {
                ((zzxv) obj).zzal(0, this.zza.zzb, zzxbVar, zzxgVar, iOException, z10);
            }
        });
    }
