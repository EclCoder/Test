...
final class zziau implements zzhek {
    ...
    /* synthetic */ zziau(RSAPublicKey rSAPublicKey, zziai zziaiVar, zziai zziaiVar2, int i10, byte[] bArr, byte[] bArr2, byte[] bArr3) throws GeneralSecurityException {
        if (zzhks.zza()) {
        ...
        while (true) {
            ...
            if (i13 < j10) {
                ...
                while (i14 <= (i11 - 2) / digestLength2) {
                    ...
                    int i16 = i10;
                    messageDigest2.update(zzhku.zzb(BigInteger.valueOf(i14), 4));
