...
public final class zzagu implements zzagt {
    ...
    public final long zzA() {
        return ((Long) zza.zzb(27, "measurement.alarm_manager.minimum_interval", ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS).get()).longValue();
    }
    ...
    public final long zzC() {
        return ((Long) zza.zzb(29, "measurement.monitoring.sample_period_millis", b.TWENTY_FOUR_HOURS_MILLIS).get()).longValue();
    }
    ...
    public final long zzS() {
        return ((Long) zza.zzb(48, "measurement.sgtm.upload.min_delay_after_background", TTAdConstant.AD_MAX_EVENT_TIME).get()).longValue();
    }
    ...
    public final long zzV() {
        return ((Long) zza.zzb(51, "measurement.sgtm.upload.retry_interval", TTAdConstant.AD_MAX_EVENT_TIME).get()).longValue();
    }
    ...
    public final long zzX() {
        return ((Long) zza.zzb(53, "measurement.upload.stale_data_deletion_interval", b.TWENTY_FOUR_HOURS_MILLIS).get()).longValue();
    }
    ...
    public final long zzai() {
        return ((Long) zza.zzb(64, "measurement.upload.initial_upload_delay_time", MBInterstitialActivity.WEB_LOAD_TIME).get()).longValue();
    }
    ...
    public final long zzf() {
        return ((Long) zza.zzb(5, "measurement.config.cache_time", b.TWENTY_FOUR_HOURS_MILLIS).get()).longValue();
    }
