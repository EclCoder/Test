...
public final class zzhyw implements zzhek {
    ...
    private zzhyw(RSAPublicKey rSAPublicKey, zzhww zzhwwVar, zzhww zzhwwVar2, int i10, byte[] bArr, byte[] bArr2, Provider provider) throws GeneralSecurityException {
        if (!zzhkr.zza(2)) {
        ...
        this.zze = zzd(zzhwwVar, zzhwwVar2, i10);
        this.zzf = bArr;
        this.zzg = bArr2;
        this.zzh = provider;
    }
    ...
    static String zzc(zzhww zzhwwVar) {
        ...
        throw new IllegalArgumentException("Unsupported hash: ".concat(String.valueOf(zzhwwVar)));
    }

    static PSSParameterSpec zzd(zzhww zzhwwVar, zzhww zzhwwVar2, int i10) {
        String str;
        ...
        if (zzhwwVar == zzhwwVar3) {
            ...
            if (zzhwwVar != zzhww.zzc) {
                throw new IllegalArgumentException("Unsupported MD hash: ".concat(String.valueOf(zzhwwVar)));
            }
            str = "SHA-512";
        }
        if (zzhwwVar2 == zzhwwVar3) {
            ...
            if (zzhwwVar2 != zzhww.zzc) {
                throw new IllegalArgumentException("Unsupported MGF1 hash: ".concat(String.valueOf(zzhwwVar2)));
            }
