...
final class zzfxo implements BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener {
    ...
    public zzfxo(Context context, int i10, zzbds zzbdsVar, String str, String str2, String str3, zzfxg zzfxgVar) {
        this.zzb = str;
        this.zzd = zzbdsVar;
        this.zzc = str2;
        this.zzg = zzfxgVar;
    ...
    private final void zzd(int i10, long j10, Exception exc) {
        ...
        if (zzfxgVar != null) {
            zzfxgVar.zzc(i10, System.currentTimeMillis() - j10, exc);
        }
    }
    ...
    public final zzfyu zza(int i10) {
        zzfyu zzfyuVar;
        try {
