...
public final class zztz extends zzcp {
    ...
    private final void zzu(int i10, int i11) {
        ...
        zzgtj.zzd(i10 % this.zzd == 0, "sizeToOutput is not aligned to frame size: %s", i10);
        zzgtj.zzi(this.zzj < this.zzi.length);
        byte[] bArr3 = this.zzl;
        zzgtj.zzd(i10 % this.zzd == 0, "byteOutput size is not aligned to frame size %s", i10);
        if (i11 != 3) {
