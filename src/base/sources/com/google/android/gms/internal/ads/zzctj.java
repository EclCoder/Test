...
public final class zzctj {
    ...
    final /* synthetic */ ListenableFuture zzd(String str, final Throwable th2) {
    ...
    final /* synthetic */ ListenableFuture zzf(Uri.Builder builder, final Throwable th2) {
    ...
    final /* synthetic */ void zzg(Throwable th2) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzlK)).booleanValue()) {
            ...
            zzcaaVarZzc.zzh(th2, "AttributionReporting");
        } else {
            zzcaa zzcaaVarZza = zzbzy.zza(this.zzc);
            this.zza = zzcaaVarZza;
            zzcaaVarZza.zzh(th2, "AttributionReportingSampled");
        }
    }
    ...
    final /* synthetic */ void zzh(Throwable th2) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzlK)).booleanValue()) {
            zzcaa zzcaaVarZzc = zzbzy.zzc(this.zzc);
            this.zzb = zzcaaVarZzc;
            zzcaaVarZzc.zzh(th2, "AttributionReporting.getUpdatedUrlAndRegisterSource");
        } else {
            zzcaa zzcaaVarZza = zzbzy.zza(this.zzc);
            this.zza = zzcaaVarZza;
            zzcaaVarZza.zzh(th2, "AttributionReportingSampled.getUpdatedUrlAndRegisterSource");
        }
    }
