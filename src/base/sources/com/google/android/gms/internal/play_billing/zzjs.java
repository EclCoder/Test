...
public enum zzjs implements zzgr {
    ...
    MISSING_RESPONSE_DATA_IN_DELEGATE_TO_BACKEND_RESPONSE(Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE),
    BILLING_OVERRIDE_SERVICE_CALL_TIMEOUT(Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE),
    BILLING_OVERRIDE_SERVICE_FALLBACK_ERROR(Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE),
    MULTI_ITEM_WITH_SEASON_PASS_NOT_SUPPORTED(Sdk$SDKError.b.INVALID_INDEX_URL_VALUE),
    BILLING_CLIENT_TRANSITIONED_OUT_OF_CONNECTING(Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE),
    SERVICE_CALL_EXCEPTION(Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE),
    SERVICE_RESET_TO_NULL(Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE),
    INVALID_BILLING_FLOW_PARAMS(Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE),
    SERVICE_DISCONNECTED(AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL),
    BINDING_DIED(Sdk$SDKError.b.TPAT_ERROR_VALUE),
    FIRST_PARTY_CLIENT_MISSING_1P_LISTENER(Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE),
    FIRST_PARTY_CLIENT_MISSING_3P_LISTENER(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE),
    NULL_DATA_WITH_OK_RESULT_CODE_IN_PROXY_BILLING_ACTIVITY_RESULT(Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE),
    NULL_DATA_WITH_CANCELLED_RESULT_CODE_IN_PROXY_BILLING_ACTIVITY_RESULT(Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE),
    NULL_DATA_WITH_PLAY_CANCELED_RESULT_CODE(145),
    NULL_DATA_WITH_PLAY_CANCELED_WITHOUT_COMPLETE_ACTION_RESULT_CODE(146),
    NULL_DATA_WITH_OTHER_RESULT_CODE_IN_PROXY_BILLING_ACTIVITY_RESULT(Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE),
    NULL_DATA_WITH_ON_CREATE_RUNTIME_EXCEPTION_RESULT_CODE(147),
    AUTO_PAY_NOT_SUPPORTED(Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE),
    BILLING_PROGRAM_NOT_SUPPORTED(128),
    LAUNCH_EXTERNAL_OFFER_FLOW_NOT_SUPPORTED(129),
    NULL_BUNDLE_RETURNED_BY_PHONESKY(130),
    LAUNCH_EXTERNAL_LINK_NOT_SUPPORTED(Sdk$SDKError.b.MRAID_JS_WRITE_FAILED_VALUE),
    RUNTIME_EXCEPTION_WHEN_LAUNCHING_INTENT(Sdk$SDKError.b.OMSDK_DOWNLOAD_JS_ERROR_VALUE),
    NULL_INTENT_RETURNED_BY_PHONESKY(Sdk$SDKError.b.OMSDK_JS_WRITE_FAILED_VALUE),
    ERROR_IN_ACTIVITY_RESULT(134),
    MISSING_RESPONSE_CODE_IN_PHONESKY_BUNDLE(135),
    BILLING_API_VERSION_NOT_SET_IN_BUNDLE(Sdk$SDKError.b.PRIVACY_URL_ERROR_VALUE),
    RESPONSE_CODE_NOT_SET_IN_BUNDLE(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE),
