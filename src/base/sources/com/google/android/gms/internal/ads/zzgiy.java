...
final class zzgiy extends zzgix {
    ...
    zzgiy(zzaxm zzaxmVar, zzght zzghtVar, zzgec zzgecVar, Map map, zzgqh zzgqhVar) {
        super("XWXJTGd1s4KBDryg9VrXAlY4jSAcYHe04/o6OdELnmUPXEyQBHBmyyV+Jg4HZM6P", "cfM2dBB5yNtLTWMY73EdilHQtVEOY0O+uF0cubJKH2M=", zzaxmVar, zzghtVar, zzgqhVar.zza(Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE));
        this.zza = map;
        this.zzb = zzgecVar;
    }
