...
public final class zzfma {
    public static com.google.android.gms.ads.internal.client.zze zza(Throwable th2) {
        if (th2 instanceof zzelw) {
            zzelw zzelwVar = (zzelw) th2;
            return zzc(zzelwVar.zza(), zzelwVar.zzb());
        }
        if (th2 instanceof zzeed) {
            return th2.getMessage() == null ? zzd(((zzeed) th2).zza(), null, null) : zzd(((zzeed) th2).zza(), th2.getMessage(), null);
        }
    ...
    public static com.google.android.gms.ads.internal.client.zze zzb(Throwable th2, zzelx zzelxVar) {
