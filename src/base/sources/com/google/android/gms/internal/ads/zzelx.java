...
public final class zzelx {
    ...
    private final synchronized void zzj(zzfkf zzfkfVar, int i10) {
        Map map = this.zzb;
    ...
    private final void zzk(zzfkf zzfkfVar, long j10, com.google.android.gms.ads.internal.client.zze zzeVar, boolean z10) {
        Map map = this.zzb;
        String strZzl = zzl(zzfkfVar);
        if (map.containsKey(strZzl)) {
            if (this.zze == null) {
            ...
            zzvVar.zzb = j10;
            zzvVar.zzc = zzeVar;
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzhJ)).booleanValue() && z10) {
                this.zzf = zzvVar;
            }
        }
    }
    ...
    public final void zzd(zzfkf zzfkfVar, long j10, com.google.android.gms.ads.internal.client.zze zzeVar) {
        zzk(zzfkfVar, j10, null, true);
    }

    public final void zze(zzfkf zzfkfVar, long j10, com.google.android.gms.ads.internal.client.zze zzeVar) {
        zzk(zzfkfVar, j10, zzeVar, false);
    }
