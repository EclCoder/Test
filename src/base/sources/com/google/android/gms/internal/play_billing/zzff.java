...
final class zzff extends zzfb implements RandomAccess, zzgu {
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i10 = 0; i10 < this.zzc; i10++) {
            iZza = (iZza * 31) + zzgv.zza(this.zzb[i10]);
        }
        return iZza;
    }
    ...
    public final /* bridge */ /* synthetic */ zzgu zzd(int i10) {
        if (i10 >= this.zzc) {
            return new zzff(i10 == 0 ? zza : Arrays.copyOf(this.zzb, i10), this.zzc, true);
        }
    ...
    private zzff(boolean[] zArr, int i10, boolean z10) {
        super(z10);
        this.zzb = zArr;
        this.zzc = i10;
    }
    ...
    private final String zzh(int i10) {
        return vHmGJpUTWNVV.DoPBtmcgJw + i10 + ", Size:" + this.zzc;
    }
