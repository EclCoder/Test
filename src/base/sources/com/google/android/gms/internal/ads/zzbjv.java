    ...
    */
    public final void zzh() {
        ...
        L3b:
            ...
            if (r1 == 0) goto L70
        L4d:
            androidx.browser.customtabs.i r1 = r5.zzg
    ...
    public final void zza(Context context, androidx.browser.customtabs.c cVar, String str, androidx.browser.customtabs.b bVar) {
        if (context == null) {
        ...
        zzbjs zzbjsVar = new zzbjs(this, bVar, zzdzqVar);
        this.zzf = zzbjsVar;
        androidx.browser.customtabs.i iVarF = cVar.f(zzbjsVar);
        this.zzg = iVarF;
        if (iVarF == null) {
            int i10 = com.google.android.gms.ads.internal.util.zze.zza;
    ...
    final /* synthetic */ androidx.browser.customtabs.i zzi() {
        return this.zzg;
    }
}
