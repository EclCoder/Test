    ...
    public zzcbg(Context context) {
        ...
        if (resolveInfoZze == null || (activityInfo = resolveInfoZze.activityInfo) == null) {
            ...
            try {
                ...
                if (packageInfo != null) {
                    ...
                    StringBuilder sb2 = new StringBuilder(String.valueOf(i10).length() + 1 + String.valueOf(str).length());
                    sb2.append(i10);
                    sb2.append(".");
                    sb2.append(str);
                    string = sb2.toString();
        ...
        try {
            ...
            if (packageInfo2 != null) {
                ...
                StringBuilder sb3 = new StringBuilder(String.valueOf(i11).length() + 1 + String.valueOf(str2).length());
                sb3.append(i11);
                sb3.append(".");
                sb3.append(str2);
