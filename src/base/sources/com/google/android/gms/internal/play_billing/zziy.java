...
final class zziy {
    ...
    static /* bridge */ /* synthetic */ void zzb(byte b10, byte b11, byte b12, char[] cArr, int i10) throws zzhb {
        if (!zze(b11)) {
            if (b10 != -32) {
                if (b10 != -19) {
                    if (!zze(b12)) {
    ...
    static /* bridge */ /* synthetic */ void zzc(byte b10, byte b11, char[] cArr, int i10) throws zzhb {
        if (b10 < -62 || zze(b11)) {
            throw new zzhb("Protocol message had invalid UTF-8.");
        }
    ...
    static /* bridge */ /* synthetic */ void zza(byte b10, byte b11, byte b12, byte b13, char[] cArr, int i10) throws zzhb {
        ...
        throw new zzhb(dOIDCKnIR.ChffQfpwQEZzD);
    }
}
