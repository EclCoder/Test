...
public final class zzbfz {
    public static void zza(String[] strArr, int i10, int i11, PriorityQueue priorityQueue) {
        ...
        while (true) {
            ...
            long jZza = zzbfw.zza(strArr[i12 - 1]);
            long jZza2 = zzbfw.zza(strArr[i12 + 5]);
    ...
    static void zzb(int i10, long j10, String str, int i11, PriorityQueue priorityQueue) {
        zzbfy zzbfyVar = new zzbfy(j10, str, i11);
        if ((priorityQueue.size() != i10 || (((zzbfy) priorityQueue.peek()).zzc <= zzbfyVar.zzc && ((zzbfy) priorityQueue.peek()).zza <= zzbfyVar.zza)) && !priorityQueue.contains(zzbfyVar)) {
    ...
    static String zzc(String[] strArr, int i10, int i11) {
        int i12 = i11 + i10;
    ...
    static long zzd(long j10, int i10) {
        if (i10 == 1) {
            return j10;
        }
        int i11 = i10 >> 1;
    ...
    private static long zze(String[] strArr, int i10, int i11) {
        ...
        for (int i12 = 1; i12 < i11; i12++) {
            jZza = (((jZza * 16785407) % 1073807359) + ((((long) zzbfw.zza(strArr[i12])) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return jZza;
    }
}
