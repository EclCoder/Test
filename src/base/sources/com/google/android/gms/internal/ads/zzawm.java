...
public final class zzawm {
    ...
    public static zzawm zza(Object obj) {
        ...
        zzawmVar.zzr();
        zzawmVar.zza = (i17 % 1937477084) ^ i18;
        zzawmVar.zzb = obj;
        return zzawmVar;
    }

    public static zzawm zzb(long j10) {
        zzawm zzawmVar = new zzawm();
        ...
        int i18 = i16 + ((((i11 & (~i10)) | i12) + ((i10 & i13) | i14)) - i15);
        zzawmVar.zzr();
        zzawmVar.zza = (i17 % 327254586) ^ i18;
        zzawmVar.zzc = j10;
        return zzawmVar;
    }

    public static zzawm zzc(double d10) {
        zzawm zzawmVar = new zzawm();
        ...
        int i18 = i16 + ((((i11 & (~i10)) | i12) + ((i10 & i13) | i14)) - i15);
        zzawmVar.zzr();
        zzawmVar.zza = (i17 % 1605908235) ^ i18;
        zzawmVar.zzd = d10;
        return zzawmVar;
    }
    ...
    public static zzawm zzd(zzavq zzavqVar) {
        ...
        int i18 = i16 + ((((i11 & (~i10)) | i12) + ((i10 & i13) | i14)) - i15);
        zzawmVar.zzr();
        zzawmVar.zza = (i17 % 1402586708) ^ i18;
    ...
    public static zzawm zze(List list) {
        ...
        int i18 = i16 + ((((i11 & (~i10)) | i12) + ((i10 & i13) | i14)) - i15);
        zzawmVar.zzr();
        zzawmVar.zza = (i17 % 324763920) ^ i18;
        zzawmVar.zzf = list;
        return zzawmVar;
    }
    ...
    public static zzawm zzf(zzawe zzaweVar) {
        ...
        int i18 = i16 + ((((i11 & (~i10)) | i12) + ((i10 & i13) | i14)) - i15);
        zzawmVar.zzr();
        zzawmVar.zza = (i17 % 474613996) ^ i18;
    ...
    private final void zzs(int i10) throws zzawj {
        if (i10 != this.zza) {
            throw new zzawj();
        }
    }
    ...
    */
    public final java.lang.Object zzi(java.lang.Class r19) throws com.google.android.gms.internal.ads.zzawj {
        /*
    ...
    public final void zzk(OutputStream outputStream) throws zzawj, IOException {
        ...
        switch (i15) {
            ...
            case 3:
                byte[] bArr = zzn().zza;
                zzavm.zzb(((long) bArr.length) * (j18 ^ j19), new zzawl(outputStream, 0), true);
                outputStream.write(bArr);
                return;
            case 4:
                List listZzo = zzo();
                zzavm.zzb(listZzo.size(), new zzawl(outputStream, i12 ^ i13), true);
            ...
            case 6:
                double dZzq = zzq();
                zzawl zzawlVar = new zzawl(outputStream, i10 ^ i11);
