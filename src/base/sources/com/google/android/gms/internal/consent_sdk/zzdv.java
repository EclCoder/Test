...
public abstract class zzdv extends zzds implements List, RandomAccess {
    ...
    static zzdv zzg(Object[] objArr, int i10) {
        return i10 == 0 ? zzdy.zza : new zzdy(objArr, i10);
    }
    ...
    public zzdv subList(int i10, int i11) {
        zzdj.zzc(i10, i11, size());
        int i12 = i11 - i10;
        if (i12 == size()) {
            return this;
        }
        return i12 == 0 ? zzdy.zza : new zzdu(this, i10, i12);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzh, reason: merged with bridge method [inline-methods] */
    public final zzec listIterator(int i10) {
        zzdj.zzb(i10, size(), "index");
        return isEmpty() ? zza : new zzdt(this, i10);
    }
}
