...
public final class zzdtc {
    ...
    public static final List zzl(JSONObject jSONObject) {
        ...
        for (int i10 = 0; i10 < jSONArrayOptJSONArray.length(); i10++) {
            com.google.android.gms.ads.internal.client.zzew zzewVarZzs = zzs(jSONArrayOptJSONArray.optJSONObject(i10));
            if (zzewVarZzs != null) {
    ...
    private final ListenableFuture zzm(JSONArray jSONArray, boolean z10, boolean z11, zzdyu zzdyuVar) {
    ...
    private final ListenableFuture zzn(JSONObject jSONObject, boolean z10, zzdyu zzdyuVar) {
        HashMap map;
        if (jSONObject == null) {
    ...
    private final ListenableFuture zzq(String str, boolean z10, final ListenableFuture listenableFuture, Object obj) {
    ...
    private final com.google.android.gms.ads.internal.client.zzr zzr(int i10, int i11) {
        if (i10 == 0) {
            if (i11 == 0) {
    ...
    public final ListenableFuture zzg(JSONObject jSONObject, zzfkf zzfkfVar, zzfki zzfkiVar, com.google.android.gms.ads.internal.zzb zzbVar, zzcdn zzcdnVar) {
        ...
        boolean z10 = ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzlu)).booleanValue() && jSONObjectOptJSONObject.has("html");
        if (TextUtils.isEmpty(strOptString) && !z10) {
        ...
        return zzq(true != z10 ? "NativeAssetsLoader.loadVideoView" : "NativeAssetsLoader.loadVideoHtml", false, zzhbw.zzi(listenableFutureZza, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzeH)).intValue(), TimeUnit.SECONDS, zzdtcVar.zzk), null);
    }
    ...
    final /* synthetic */ zzblm zzi(JSONObject jSONObject, List list) {
        ...
        int iOptInt2 = jSONObject.optInt(PAFNPq.DSa, 1000);
