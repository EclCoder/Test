    ...
    public static ECPoint zzd(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zzhlfVarZze = zzg(zzhlfVarZze, zzhlfVarZze2, a10, bigIntegerZzc);
                zzhlfVarZze2 = zzf(zzhlfVarZze2, a10, bigIntegerZzc);
            } else {
                zzhlfVarZze2 = zzg(zzhlfVarZze, zzhlfVarZze2, a10, bigIntegerZzc);
                zzhlfVarZze = zzf(zzhlfVarZze, a10, bigIntegerZzc);
            }
        }
        if (zzhlfVarZze.zza()) {
