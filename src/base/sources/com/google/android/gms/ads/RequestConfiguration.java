...
public class RequestConfiguration {
    ...
    public static final List zza = Arrays.asList(MAX_AD_CONTENT_RATING_MA, QGbBllacZSmHKn.vxPBXtSaTwmFjPC, MAX_AD_CONTENT_RATING_PG, MAX_AD_CONTENT_RATING_G);
    ...
    /* synthetic */ RequestConfiguration(int i10, int i11, String str, List list, PublisherPrivacyPersonalizationState publisherPrivacyPersonalizationState, byte[] bArr) {
        this.zzb = i10;
        this.zzc = i11;
        this.zzd = str;
        this.zze = list;
