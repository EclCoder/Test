...
public final class zza {
    ...
    public final void zza(WebView webView) {
        ...
        if (((Boolean) zzbkv.zzb.zze()).booleanValue() && g.a("DOCUMENT_START_SCRIPT") && webView != null) {
            f.a(webView, String.format(Locale.getDefault(), (String) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbiq.zzli), zzb()), zzgww.zzi("*"));
        }
    }
