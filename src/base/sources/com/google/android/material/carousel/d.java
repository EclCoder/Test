...
abstract class d {
    ...
    /*  JADX ERROR: Types fix failed
        ...
        Caused by: java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.InsnArg.getType()" because "arg" is null
        	...
        	... 5 more
        */
    static com.google.android.material.carousel.e c(android.content.Context r19, float r20, int r21, com.google.android.material.carousel.a r22) {
        /*
            Method dump skipped, instruction units count: 294
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.carousel.d.c(android.content.Context, float, int, com.google.android.material.carousel.a):com.google.android.material.carousel.e");
    }
    ...
    static e e(Context context, float f10, int i10, a aVar) {
        float fMin = Math.min(f(context) + f10, aVar.f19740f);
        float f11 = fMin / 2.0f;
        float f12 = 0.0f - f11;
        float fB = b(0.0f, aVar.f19740f, aVar.f19741g);
        float fJ = j(0.0f, a(fB, aVar.f19740f, aVar.f19741g), aVar.f19740f, aVar.f19741g);
        float fB2 = b(fJ, aVar.f19739e, aVar.f19738d);
        float fB3 = b(j(fJ, fB2, aVar.f19739e, aVar.f19738d), aVar.f19736b, aVar.f19737c);
        float f13 = i10 + f11;
        float fB4 = c.b(fMin, aVar.f19740f, f10);
        float fB5 = c.b(aVar.f19736b, aVar.f19740f, f10);
        float fB6 = c.b(aVar.f19739e, aVar.f19740f, f10);
        e.b bVarH = new e.b(aVar.f19740f, i10).a(f12, fB4, fMin).h(fB, 0.0f, aVar.f19740f, aVar.f19741g, true);
        if (aVar.f19738d > 0) {
            bVarH.b(fB2, fB6, aVar.f19739e);
        }
        int i11 = aVar.f19737c;
        if (i11 > 0) {
            bVarH.g(fB3, fB5, aVar.f19736b, i11);
        }
    ...
    static float f(Context context) {
        return context.getResources().getDimension(sb.e.F);
    }

    static float g(Context context) {
        return context.getResources().getDimension(sb.e.G);
    }

    static float h(Context context) {
        return context.getResources().getDimension(sb.e.H);
    }
