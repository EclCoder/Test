...
public class b extends j {
    ...
    private final int f19454b0;

    /* JADX INFO: renamed from: c0, reason: collision with root package name */
    private final int f19455c0;

    /* JADX INFO: renamed from: d0, reason: collision with root package name */
    private final int f19456d0;

    /* JADX INFO: renamed from: e0, reason: collision with root package name */
    private final int f19457e0;

    /* JADX INFO: renamed from: f0, reason: collision with root package name */
    private boolean f19458f0;

    /* JADX INFO: renamed from: g0, reason: collision with root package name */
    private final List f19459g0;

    public b(Context context) {
        super(context);
        this.f19459g0 = new ArrayList();
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-2, -2);
        layoutParams.gravity = 17;
        setLayoutParams(layoutParams);
        Resources resources = getResources();
        this.f19454b0 = resources.getDimensionPixelSize(e.f51679f);
        this.f19455c0 = resources.getDimensionPixelSize(e.f51682g);
        this.f19456d0 = resources.getDimensionPixelSize(e.f51673d);
        this.f19457e0 = resources.getDimensionPixelSize(e.f51676e);
    }
    ...
    protected void onMeasure(int i10, int i11) {
        ...
        if (getItemIconGravity() == 0) {
            if (j(getLabelVisibilityMode(), currentVisibleContentItemCount) && s()) {
                ...
                int iMax2 = this.f19457e0;
                if (childAt.getVisibility() != 8) {
                    childAt.measure(View.MeasureSpec.makeMeasureSpec(this.f19456d0, Integer.MIN_VALUE), iMakeMeasureSpec);
                    iMax2 = Math.max(iMax2, childAt.getMeasuredWidth());
                }
                int i15 = currentVisibleContentItemCount - (childAt.getVisibility() != 8 ? 1 : 0);
                int iMin = Math.min(size - (this.f19455c0 * i15), Math.min(iMax2, this.f19456d0));
                int i16 = size - iMin;
                int iMin2 = Math.min(i16 / (i15 != 0 ? i15 : 1), this.f19454b0);
                ...
                while (i18 < childCount) {
                    ...
                    this.f19459g0.add(Integer.valueOf(i13));
                    i18++;
                }
            } else {
                int iMin3 = Math.min(size / (currentVisibleContentItemCount != 0 ? currentVisibleContentItemCount : 1), this.f19456d0);
                ...
                for (int i20 = 0; i20 < childCount; i20++) {
                    ...
                    this.f19459g0.add(Integer.valueOf(i12));
                }
            }
            measuredWidth = 0;
            iMax = 0;
            while (i14 < childCount) {
                ...
                if (childAt2.getVisibility() != 8) {
                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(((Integer) this.f19459g0.get(i14)).intValue(), 1073741824), iMakeMeasureSpec);
