...
class a extends c {
    ...
    void d(TabLayout tabLayout, View view, View view2, float f10, Drawable drawable) {
        ...
        drawable.setBounds(tb.b.c((int) rectFA.left, (int) rectFA2.left, f11), drawable.getBounds().top, tb.b.c((int) rectFA.right, (int) rectFA2.right, fE), drawable.getBounds().bottom);
    }
}
