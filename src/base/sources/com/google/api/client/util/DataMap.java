...
final class DataMap extends AbstractMap<String, Object> {
        ...
        public boolean hasNext() {
            if (!this.isComputed) {
                ...
                while (this.nextFieldValue == null) {
                    ...
                    if (i10 >= DataMap.this.classInfo.names.size()) {
                        break;
                    }
    ...
    DataMap(Object obj, boolean z10) {
        this.object = obj;
        this.classInfo = ClassInfo.of(obj.getClass(), z10);
    }
    ...
    public Object put(String str, Object obj) {
        ...
        Preconditions.checkNotNull(fieldInfo, NpmRNZ.pNMax + str);
