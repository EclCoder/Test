...
public final class BatchRequest {
    ...
    public void execute() throws IOException {
        ...
        do {
            ...
            int i10 = 1;
            while (it.hasNext()) {
                multipartContent.addPart(new MultipartContent.Part(new HttpHeaders().setAcceptEncoding(null).set("Content-ID", (Object) Integer.valueOf(i10)), new HttpRequestContent(it.next().request)));
                i10++;
            }
            ...
            try {
                BatchUnparsedResponse batchUnparsedResponse = new BatchUnparsedResponse(httpResponseExecute.getContent(), "--" + httpResponseExecute.getMediaType().getParameter("boundary"), this.requestInfos, z10);
