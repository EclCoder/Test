...
public final class NetHttpTransport extends HttpTransport {
    ...
    NetHttpTransport(Proxy proxy, SSLSocketFactory sSLSocketFactory, HostnameVerifier hostnameVerifier, boolean z10) {
        this(new DefaultConnectionFactory(proxy), sSLSocketFactory, hostnameVerifier, z10);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static Proxy defaultProxy() {
        return new Proxy(Proxy.Type.HTTP, new InetSocketAddress(System.getProperty("https.proxyHost"), Integer.parseInt(System.getProperty(OGoz.TGWloQqHEQ))));
    }
