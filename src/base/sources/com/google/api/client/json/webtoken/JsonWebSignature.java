...
public class JsonWebSignature extends JsonWebToken {
    ...
    public static final class Parser {
        ...
        public JsonWebSignature parse(String str) {
            ...
            int i11 = iIndexOf2 + 1;
            Preconditions.checkArgument(str.indexOf(46, i11) == -1);
            byte[] bArrDecodeBase65 = Base64.decodeBase64(str.substring(i10, iIndexOf2));
            byte[] bArrDecodeBase66 = Base64.decodeBase64(str.substring(i11));
