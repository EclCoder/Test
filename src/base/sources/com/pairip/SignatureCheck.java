...
public class SignatureCheck {
    ...
    private static String expectedLegacyUpgradedSignature = "a1pk3d8zd4YSwjibn+EUHNHBsZRo0AIwcLuNyFCY7xs=";
    private static String expectedSignature = "a1pk3d8zd4YSwjibn+EUHNHBsZRo0AIwcLuNyFCY7xs=";
    private static String expectedTestSignature = "a1pk3d8zd4YSwjibn+EUHNHBsZRo0AIwcLuNyFCY7xs=";
