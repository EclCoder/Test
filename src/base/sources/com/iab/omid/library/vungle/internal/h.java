...
public class h {
    ...
    private static h f24268a = new h();

    class a implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ WebView f24269a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f24270b;

        a(WebView webView, String str) {
            this.f24269a = webView;
            this.f24270b = str;
        }

        @Override // java.lang.Runnable
        public void run() {
            h.this.c(this.f24269a, this.f24270b);
        }
    }
    ...
    public boolean c(WebView webView, String str) {
        if (webView != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                com.iab.omid.library.vungle.utils.d.d("Unable to inject javascript: " + e10.getMessage());
            }
        }
        return false;
    }
