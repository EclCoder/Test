...
public class c {
    ...
    private static WindowManager f23870a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f23871b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f23872c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f23874a);
            jSONObject.put("height", bVarA.f23875b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f23870a != null) {
            ...
            f23870a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f23872c = context.getResources().getDisplayMetrics().density;
            f23870a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.bytedance2.walking.a.C0347a c0347a) {
        com.iab.omid.library.bytedance2.internal.e eVarA = c0347a.a();
        JSONArray jSONArray = new JSONArray();
        ArrayList<String> arrayListB = c0347a.b();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f23873a[outputDeviceStatus.ordinal()] == 1;
    }
