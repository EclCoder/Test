...
public class c {
    ...
    private static WindowManager f24145a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f24146b = {qnwOeeQSSWa.gvVEEStUKmK, "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f24147c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f24149a);
            jSONObject.put("height", bVarA.f24150b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f24145a != null) {
            ...
            f24145a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f24147c = context.getResources().getDisplayMetrics().density;
            f24145a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.mmadbridge.walking.a.C0356a c0356a) {
        com.iab.omid.library.mmadbridge.internal.e eVarA = c0356a.a();
        JSONArray jSONArray = new JSONArray();
        ArrayList<String> arrayListB = c0356a.b();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f24148a[outputDeviceStatus.ordinal()] == 1;
    }
