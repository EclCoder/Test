...
public class JavaScriptSessionService {
    ...
    private void addWebViewListener() {
        ...
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList("*")), new x4.f.a() { // from class: com.iab.omid.library.mmadbridge.adsession.JavaScriptSessionService.2
            @Override // x4.f.a
            public void onPostMessage(WebView webView, d dVar, Uri uri, boolean z10, x4.a aVar) {
                try {
                    ...
                    com.iab.omid.library.mmadbridge.utils.d.b("Unexpected method in JavaScriptSessionService: " + string);
                } catch (JSONException e10) {
                    com.iab.omid.library.mmadbridge.utils.d.a("Error parsing JS message in JavaScriptSessionService.", e10);
                }
            }
        });
    }
