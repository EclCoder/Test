...
class c {
    ...
    private static final Pattern f23934a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Pattern f23935b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Pattern f23936c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final Pattern f23937d = Pattern.compile("<(body)( [^>]*?)?/>", 2);

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final Pattern f23938e = Pattern.compile("<(html)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final Pattern f23939f = Pattern.compile("<(html)( [^>]*?)?/>", 2);

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final Pattern f23940g = Pattern.compile("<!DOCTYPE [^>]*>", 2);

    static String a(String str, String str2) {
        g.a(str, "HTML is null or empty");
        int[][] iArrA = a(str);
        StringBuilder sb2 = new StringBuilder(str.length() + str2.length() + 16);
        if (!b(str, sb2, f23935b, str2, iArrA) && !a(str, sb2, f23934a, str2, iArrA) && !b(str, sb2, f23937d, str2, iArrA) && !a(str, sb2, f23936c, str2, iArrA) && !b(str, sb2, f23939f, str2, iArrA) && !a(str, sb2, f23938e, str2, iArrA) && !a(str, sb2, f23940g, str2, iArrA)) {
            return str2 + str;
        }
        return sb2.toString();
    }
    ...
    private static boolean b(String str, StringBuilder sb2, Pattern pattern, String str2, int[][] iArr) {
        ...
        while (matcher.find(i10)) {
            ...
            if (!a(iStart, iArr)) {
                ...
                String str3 = mDXVAtwcaFMHJ.pxxWVtysqkkk;
                sb2.append(str3);
                sb2.append(str2);
                sb2.append("</");
