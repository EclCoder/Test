...
public class JavaScriptSessionService {
    ...
    private void addWebViewListener() {
        ...
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList("*")), new x4.f.a() { // from class: com.iab.omid.library.inmobi.adsession.JavaScriptSessionService.2
            @Override // x4.f.a
