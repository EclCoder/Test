...
public class b extends a {
    ...
    private static volatile b f30217a;
    ...
    public int b(String str, String str2) {
        ...
        try {
            ...
            return getWritableDatabase().update("bid_replace_campaign", contentValues, "bid_unit_id" + obFGmWgqyy.jyr + "expect_bid_token = ?", new String[]{str2, str});
        } catch (Exception e10) {
            e10.printStackTrace();
            return 0;
        }
