...
public class a {
    ...
    private static String f30253a = "FrequencyDaoMiddle";

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static a f30254b = null;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static String f30255c = "FrequencyDaoMiddle";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static JSONArray f30256d = new JSONArray();
    ...
    private void c() {
        try {
            String str = (String) y0.a(c.n().d(), f30255c, f30256d.toString());
            if (TextUtils.isEmpty(str)) {
                return;
            }
            f30256d = new JSONArray(str);
        } catch (Exception e10) {
            q0.b(f30253a, e10.getMessage());
        }
    }
    ...
    private void d() {
        try {
            if (f30256d != null) {
                y0.b(c.n().d(), f30255c, f30256d.toString());
            }
        } catch (Exception e10) {
            q0.b(f30253a, e10.getMessage());
        }
    ...
    public void a(g gVar) {
        ...
        if (f30256d == null) {
            f30256d = new JSONArray();
        }
        f30256d.put(jSONObjectA);
        d();
    }
    ...
    public void a(String str) {
        if (f30256d != null) {
            ...
            for (int i10 = 0; i10 < f30256d.length(); i10++) {
                try {
                    JSONObject jSONObject = f30256d.getJSONObject(i10);
                    if (jSONObject != null) {
