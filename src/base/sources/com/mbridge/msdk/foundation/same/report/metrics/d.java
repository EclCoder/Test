...
public class d {
    ...
    private static d f30772e;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private volatile m f30773a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private Map<String, e> f30774b = new HashMap();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private LinkedHashMap<String, c> f30775c = new LinkedHashMap<>();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private Map<String, e> f30776d = new HashMap();

    private d() {
        if (this.f30773a == null) {
            this.f30773a = m.b("metrics_sdk", com.mbridge.msdk.foundation.controller.c.n().d(), a());
        }
        JSONObject jSONObjectB = com.mbridge.msdk.foundation.same.report.c.b();
        if (this.f30773a != null) {
            this.f30773a.a(jSONObjectB);
            this.f30773a.h();
        }
    }
    ...
    public e c(String str) {
        ...
        e eVar = new e();
        try {
            if (!TextUtils.isEmpty(str) && (map = this.f30774b) != null && map.containsKey(str)) {
                return this.f30774b.get(str);
            }
        } catch (Exception e10) {
            if (MBridgeConstans.DEBUG) {
                e10.printStackTrace();
    ...
    public String d() {
        return this.f30773a == null ? Saucuwx.Obgj : this.f30773a.d();
    }
    ...
    public void b(String str, String str2) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str3) && (linkedHashMap = this.f30775c) != null && linkedHashMap.containsKey(str3)) {
                this.f30775c.remove(str3);
            }
        } catch (Exception e10) {
            if (MBridgeConstans.DEBUG) {
                e10.printStackTrace();
    ...
    private p a(int i10) {
        if (i10 == 1) {
            return new p(new com.mbridge.msdk.foundation.same.report.m((byte) 2), com.mbridge.msdk.foundation.same.net.utils.d.h().f30627j, com.mbridge.msdk.foundation.same.net.utils.d.h().f30631n);
        }
        return new p(new h(), com.mbridge.msdk.foundation.same.net.utils.d.h().f30618d, 0);
    }
    ...
    public void a(String str, CampaignEx campaignEx, e eVar) {
        ...
        if (cVar != null) {
            if (Arrays.asList(b.f30738h).contains(str)) {
                cVar = a(cVar);
            }
        } else {
            cVar = new c();
    ...
    public void a(String str, c cVar) {
        try {
            ...
            if (map != null && map.containsKey(str) && cVar != null) {
                cVar.a(str, this.f30776d.get(str));
            }
    ...
    private void a(String str, c cVar, com.mbridge.msdk.foundation.same.report.metrics.callback.a aVar) {
        try {
            if (Arrays.asList(b.f30733c).contains(str)) {
                cVar.d(str);
            }
            Map<String, e> map = this.f30776d;
