...
public class j extends b {
    ...
    public static final String f30716b = "j";
    ...
    public static boolean a() {
        try {
            return System.currentTimeMillis() - com.vungle.ads.internal.signals.b.TWENTY_FOUR_HOURS_MILLIS > ((Long) y0.a(com.mbridge.msdk.foundation.controller.c.n().d(), "privateAuthorityTimesTamp", 0L)).longValue();
        } catch (Throwable th2) {
            th2.printStackTrace();
            return false;
        }
    ...
    public static com.mbridge.msdk.foundation.same.net.wrapper.e a(Context context) {
        ...
        try {
            ...
            eVar.a("orientation", URLEncoder.encode(m0.G(context) + ""));
            ...
            if (gVarF != null) {
                JSONObject jSONObjectA = a(context, gVarF);
    ...
    public static JSONObject a(Context context, com.mbridge.msdk.setting.g gVar) {
    ...
    public static void a(Context context, String str, String str2, boolean z10, CampaignEx campaignEx) {
        if (context != null) {
            try {
                ...
                if (!TextUtils.isEmpty(str2)) {
                    String str3 = com.mbridge.msdk.foundation.controller.a.f30138r.get(str2);
                    if (str3 == null) {
                        str3 = "";
                    }
    ...
    public static void a(Context context, String str, String str2, boolean z10, String str3, String str4, String str5, String str6) {
        if (context != null) {
            try {
                ...
                if (!TextUtils.isEmpty(str2)) {
                    String str7 = com.mbridge.msdk.foundation.controller.a.f30138r.get(str2);
                    if (str7 == null) {
                        str7 = "";
                    }
    ...
    public static void a(String str) {
        try {
            ...
            com.mbridge.msdk.setting.g gVarF = com.mbridge.msdk.setting.h.b().f(com.mbridge.msdk.foundation.controller.c.n().b());
            if (gVarF == null || b.a(gVarF, jSONObject.toString())) {
                com.mbridge.msdk.foundation.same.report.metrics.d.b().a(jSONObject);
            }
        } catch (Throwable th2) {
            q0.b(f30716b, th2.getMessage());
    ...
    public static void a(boolean z10, long j10, String str) {
        try {
            ...
            eVar.a(NotificationCompat.CATEGORY_STATUS, z10 ? "1" : MBridgeConstans.API_REUQEST_CATEGORY_APP);
            eVar.a("is_allow_crash", com.mbridge.msdk.foundation.controller.c.n().e().b() ? "1" : MBridgeConstans.API_REUQEST_CATEGORY_APP);
