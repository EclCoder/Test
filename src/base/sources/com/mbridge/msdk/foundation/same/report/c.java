...
public class c {
    ...
    private static final String f30671a = "c";
        ...
        public JSONObject a(com.mbridge.msdk.tracker.e eVar) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(strOptString)) {
                    String str = com.mbridge.msdk.foundation.controller.a.f30138r.get(strOptString);
                ...
                if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f30485g) && !jSONObjectI.has("c")) {
                    jSONObjectI.put("c", com.mbridge.msdk.foundation.same.a.f30485g);
                }
                return jSONObjectI;
            } catch (Exception e10) {
                q0.b(c.f30671a, e10.getMessage());
                return jSONObjectI;
            }
        }
    }
    ...
    public static void a(JSONObject jSONObject) {
        ...
        if (!com.mbridge.msdk.foundation.controller.authoritycontroller.c.m().c(MBridgeConstans.AUTHORITY_OTHER)) {
            jSONObject.remove(com.mbridge.msdk.foundation.same.net.wrapper.e.f30647d);
            jSONObject.remove(com.mbridge.msdk.foundation.same.net.wrapper.e.f30648e);
