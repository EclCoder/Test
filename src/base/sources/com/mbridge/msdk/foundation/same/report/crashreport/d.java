...
public class d {
    ...
    private static final class a implements com.mbridge.msdk.foundation.same.report.crashreport.a {
        ...
        class RunnableC0399a implements Runnable {
            ...
            final /* synthetic */ StackTraceElement[] f30685b;

            RunnableC0399a(String str, StackTraceElement[] stackTraceElementArr) {
                this.f30684a = str;
                this.f30685b = stackTraceElementArr;
            }

            @Override // java.lang.Runnable
            public void run() {
                a.c(this.f30684a, this.f30685b);
            }
        }
        ...
        public void a(String str, StackTraceElement[] stackTraceElementArr) {
            ...
            long unused = d.f30683a = System.currentTimeMillis();
            com.mbridge.msdk.foundation.same.threadpool.a.e().execute(new RunnableC0399a(str, stackTraceElementArr));
        }
    }
