...
public class DownloadTask implements IDownloadTask {
    ...
    public DownloadResponse run() {
        ...
        try {
            ...
            this._request.putExtraData("resumed_breakpoint", (this._downloadModel == null || this._downloadModel.getDownloadedBytes() <= 0) ? MBridgeConstans.API_REUQEST_CATEGORY_APP : "1");
