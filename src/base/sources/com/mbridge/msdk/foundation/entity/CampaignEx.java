...
public class CampaignEx extends DomainCampaignEx {
    ...
    private int vst = -2;
    private int wtick = 0;
    private int showIndex = com.mbridge.msdk.foundation.same.report.metrics.a.f30723a;
    private int showType = com.mbridge.msdk.foundation.same.report.metrics.a.f30725c;
    ...
    public static final class a implements Serializable {
        ...
        private int f30276f = 0;

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        private int f30277g = 0;
    ...
    public static final class b implements Serializable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public Map<Integer, String> f30282a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public boolean f30283b = false;
        ...
        /* JADX INFO: renamed from: f, reason: collision with root package name */
        public boolean f30287f = false;

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        public boolean f30288g = false;
    ...
    public static final class c implements Serializable {
        ...
        public static final class a implements Serializable {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            public List<String> f30300a = new ArrayList();
        ...
        public static c a(JSONObject jSONObject) {
            ...
            try {
                ...
                cVar.b(jSONObject.optInt(lkCBSIFlvmyGX.aqKhaQeuybj, 1));
    ...
    public static CampaignEx parseCampaignWithBackData(JSONObject jSONObject) {
        ...
        ArrayList arrayList;
        String str = giNWGaNAgVQoO.ifrxBZ;
        if (jSONObject == null) {
            return null;
        }
        try {
            ...
            try {
                ...
                campaignEx2.setNoticeUrl(jSONObject.optString(str));
                ...
                if (!TextUtils.isEmpty(jSONObject.optString(JSON_KEY_STAR))) {
                    campaignEx2.setRating(Double.parseDouble(jSONObject.optString(JSON_KEY_STAR, MBridgeConstans.ENDCARD_URL_TYPE_PL)));
                }
                ...
                try {
                    JSONObject jSONObjectOptJSONObject3 = jSONObject.optJSONObject(JSON_KEY_REWARD_TEMPLATE);
                    if (jSONObjectOptJSONObject3 != null) {
                        campaignEx2.setRewardTemplateMode(c.a(jSONObjectOptJSONObject3));
                    } else {
                        String strOptString3 = jSONObject.optString(JSON_KEY_REWARD_TEMPLATE);
                        if (!TextUtils.isEmpty(strOptString3)) {
                            campaignEx2.setRewardTemplateMode(c.a(new JSONObject(strOptString3)));
                        }
                    }
                } catch (Exception e10) {
                    if (MBridgeConstans.DEBUG) {
                ...
                try {
                    ...
                    String strOptString7 = jSONObject.optString(str);
    ...
    public String getImpressionURL() {
        try {
            if (s0.a().a("v_a_d_p", false)) {
                String strA = v0.a(this.impressionURL, "&tun=", m0.A() + "");
    ...
    public String getNoticeUrl() {
        try {
            if (s0.a().a("v_a_d_p", false)) {
                String strA = v0.a(this.noticeUrl, "&tun=", m0.A() + "");
                this.noticeUrl = strA;
                return strA;
            }
        } catch (Exception e10) {
    ...
    public String getOnlyImpressionURL() {
        try {
            if (s0.a().a("v_a_d_p", false)) {
                String strA = v0.a(this.onlyImpressionURL, "&tun=", m0.A() + "");
    ...
    public void setendcard_url(String str) {
        ...
        if (TextUtils.isEmpty(this.mof_template_url) && (((cVar = this.rewardTemplateMode) == null || TextUtils.isEmpty(cVar.f30298e)) && !TextUtils.isEmpty(str) && str.contains(KEY_IS_CMPT_ENTRY))) {
            setCMPTEntryUrl(str);
        }
    ...
    public static CampaignEx parseCampaign(JSONObject jSONObject, String str, String str2, String str3, boolean z10, CampaignUnit campaignUnit, String str4, String str5) {
        ...
        try {
            ...
            try {
                ...
                campaignEx2.setAppName(jSONObjectDealV5Temp.optString(JSON_KEY_TITLE));
                ...
                campaignEx2.setPackageName(jSONObjectDealV5Temp.optString(JSON_KEY_PACKAGE_NAME));
                ...
                if (!TextUtils.isEmpty(jSONObjectDealV5Temp.optString(JSON_KEY_STAR))) {
                    campaignEx2.setRating(Double.parseDouble(jSONObjectDealV5Temp.optString(JSON_KEY_STAR, MBridgeConstans.ENDCARD_URL_TYPE_PL)));
                }
                ...
                if (!TextUtils.isEmpty(strOptString2)) {
                    if (z10) {
                        ...
                        campaignEx2.setVideoUrlEncode(k0.a(strOptString2));
                    }
                }
                ...
                campaignEx2.setRewardTemplateMode(c.a(jSONObjectDealV5Temp.optJSONObject(JSON_KEY_REWARD_TEMPLATE)));
                ...
                campaignEx2.setKeyIaRst(jSONObjectDealV5Temp.optInt(Saucuwx.usKPPgkcoTj));
    ...
    public static JSONObject campaignToJsonObject(CampaignEx campaignEx) throws JSONException {
        ...
        jSONObject.put(mTFeqtajA.fHNnMejEBXiSpq, campaignEx.getClickInterval());
        jSONObject.put(JSON_KEY_CTA_TEXT, campaignEx.getAdCall());
        jSONObject.put(UHbHibBvYxKnPE.mGWBDnTgBjJSggz, campaignEx.getEndcard_click_result());
        ...
        try {
            jSONObject.put(mDXVAtwcaFMHJ.BMEBlxW, v0.a());
