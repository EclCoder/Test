...
public class v0 extends y {
    ...
    private static int f30974a = 1;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static volatile Boolean f30975b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Pattern f30976c = Pattern.compile("[一-龥]");

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static Map<String, String> f30977d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static Map<String, String> f30978e;
    ...
    class a implements View.OnClickListener {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ CampaignEx f30980b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ com.mbridge.msdk.foundation.feedback.a f30981c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        final /* synthetic */ int f30982d;

        a(ImageView imageView, CampaignEx campaignEx, com.mbridge.msdk.foundation.feedback.a aVar, int i10) {
            this.f30979a = imageView;
            this.f30980b = campaignEx;
            this.f30981c = aVar;
            this.f30982d = i10;
        }
        ...
        public void onClick(View view) {
            try {
                v0.a(this.f30980b, this.f30981c, this.f30982d, (String) this.f30979a.getTag());
            } catch (Exception e10) {
    ...
    public static synchronized String d(String str) {
        ...
        Map<String, String> map = f30978e;
        if (map == null || !map.containsKey(str2)) {
            return null;
        }
        return f30978e.get(str2);
    }
    ...
    public static final synchronized String e(String str) {
        ...
        try {
            try {
                ...
                if (zL0 && iMax != 0) {
                    if (zE0 && (map = f30977d) != null && map.containsKey(str2)) {
                        return f30977d.get(str2);
                    }
    ...
    public static synchronized void d(String str, String str2) {
        try {
            ...
            f30978e.put(com.mbridge.msdk.foundation.controller.c.n().b() + "_" + str, str2);
        } catch (Throwable th2) {
            throw th2;
        }
    }
    ...
    public static String b(int i10) {
        ...
        try {
            ...
            if (gVarF != null && gVarF.m() == 1 && (strArrA = com.mbridge.msdk.foundation.db.middle.a.b().a()) != null) {
    ...
    public static JSONArray b(Context context, String str) {
        ...
        try {
            ...
            if (gVarF != null && gVarF.m() == 1) {
                q0.c("SameTools", "fqci cfc:" + gVarF.m());
    ...
    public static String a(CampaignEx campaignEx) {
        ...
        String privacyUrl = WwUgngZLNA.pxlgWvM;
        if (campaignEx != null) {
            try {
        ...
        if (TextUtils.isEmpty(privacyUrl) && (gVarF = com.mbridge.msdk.setting.h.b().f(com.mbridge.msdk.foundation.controller.c.n().b())) != null) {
            privacyUrl = gVarF.c();
        }
        return TextUtils.isEmpty(privacyUrl) ? com.mbridge.msdk.foundation.same.net.utils.d.h().f30624g : privacyUrl;
    }
    ...
    private static boolean a(long j10, long j11) {
        ...
        return j11 + (gVarF.c0() * 1000) >= jCurrentTimeMillis;
    }

    public static final int a() {
        if (f30975b == null) {
            try {
                f30975b = MIMManager.b().e();
            } catch (Exception e10) {
                q0.b("SameTools", e10.getMessage());
            }
        }
        if (f30975b != null) {
            return f30975b.booleanValue() ? 1 : 0;
        }
        return -1;
    }
