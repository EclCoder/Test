...
public class b1 {
    ...
    class a implements View.OnTouchListener {
        ...
        JSONArray f30836a = new JSONArray();

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ View f30837b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ String f30838c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        final /* synthetic */ View.OnTouchListener f30839d;

        a(View view, String str, View.OnTouchListener onTouchListener) {
            this.f30837b = view;
            this.f30838c = str;
            this.f30839d = onTouchListener;
        }

        private void a() {
            this.f30836a = new JSONArray();
        }

        @Override // android.view.View.OnTouchListener
        public boolean onTouch(View view, MotionEvent motionEvent) {
            if (motionEvent.getAction() != 0) {
                b1.b(this.f30836a, motionEvent);
            }
            int actionMasked = motionEvent.getActionMasked();
            if (actionMasked == 0) {
                a();
                b1.b(this.f30836a, motionEvent);
                b1.b(this.f30837b, motionEvent, this.f30836a, this.f30838c);
            ...
            View.OnTouchListener onTouchListener = this.f30839d;
