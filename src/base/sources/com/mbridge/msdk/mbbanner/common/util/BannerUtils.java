...
public class BannerUtils {
    ...
    public static String getCloseIds(String str) {
        ...
        try {
            Map<String, List<com.mbridge.msdk.foundation.same.metadata.a>> map = b.f30511b;
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                if (jSONObjectOptJSONObject != null) {
                    strValueOf = String.valueOf(v0.a(c.n().d(), Integer.valueOf(jSONObjectOptJSONObject.getString(com.mbridge.msdk.foundation.same.a.f30486h)).intValue()));
                    strValueOf2 = String.valueOf(v0.a(c.n().d(), Integer.valueOf(jSONObjectOptJSONObject.getString(com.mbridge.msdk.foundation.same.a.f30487i)).intValue()));
                } else {
                    strValueOf = "-999";
                    strValueOf2 = "-999";
                }
