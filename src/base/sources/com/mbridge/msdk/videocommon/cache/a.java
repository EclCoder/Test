...
public class a {
    ...
    private static final String f35076b = "com.mbridge.msdk.videocommon.cache.a";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static a f35077c;
    ...
    class RunnableC0481a implements Runnable {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ CampaignEx f35080b;

        RunnableC0481a(String str, CampaignEx campaignEx) {
            this.f35079a = str;
            this.f35080b = campaignEx;
        }

        @Override // java.lang.Runnable
        public void run() {
            a.this.a(this.f35079a, this.f35080b);
        }
    }
    ...
    private a() {
        try {
            ...
            if (contextD != null) {
                this.f35078a = e.a(g.a(contextD));
            } else {
                q0.b(f35076b, "RewardCampaignCache get Context is null");
            }
        } catch (Exception e10) {
            e10.printStackTrace();
        }
    ...
    public void b(String str, String str2) {
        if (this.f35078a == null || TextUtils.isEmpty(str)) {
            return;
        }
        this.f35078a.a(str, str2);
    }
    ...
    public CopyOnWriteArrayList<CampaignEx> c(String str, int i10) {
        ...
        try {
            if (TextUtils.isEmpty(str) || (listA = this.f35078a.a(str, 0, 0, i10)) == null) {
                return null;
            }
    ...
    public CopyOnWriteArrayList<CampaignEx> b(String str, int i10, boolean z10, String str2) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                if (z10) {
                    listA = this.f35078a.a(str, 0, 0, i10, str2);
                } else {
                    listA = this.f35078a.a(str, 0, 0, i10, false);
                }
    ...
    public void a(String str, List<CampaignEx> list, String str2, int i10) {
        e eVar;
        if (TextUtils.isEmpty(str) || list == null || list.size() <= 0 || TextUtils.isEmpty(str2) || (eVar = this.f35078a) == null) {
            return;
        }
    ...
    public List<CampaignEx> c(String str, int i10, boolean z10, String str2) {
        ...
        try {
            com.mbridge.msdk.setting.g gVarF = h.b().f(c.n().b());
            if (gVarF != null) {
                jC0 = gVarF.c0();
            } else {
                jC0 = h.b().a().c0();
    ...
    public void a(String str, List<CampaignEx> list) {
        e eVar;
        if (TextUtils.isEmpty(str) || list == null || list.size() <= 0 || (eVar = this.f35078a) == null) {
            return;
        }
        eVar.b(str, list);
    }
    ...
    public void b(String str, CampaignEx campaignEx) {
        com.mbridge.msdk.foundation.same.threadpool.a.b().execute(new RunnableC0481a(str, campaignEx));
    }

    public void b(String str) {
        ConcurrentHashMap<String, com.mbridge.msdk.foundation.entity.c> concurrentHashMapF;
        try {
            if (TextUtils.isEmpty(str) || (concurrentHashMapF = this.f35078a.f(str)) == null || concurrentHashMapF.size() <= 0) {
                return;
            }
            com.mbridge.msdk.setting.g gVarF = h.b().f(c.n().b());
            if (gVarF == null) {
            ...
            long jC0 = gVarF != null ? gVarF.c0() : 0L;
            long jCurrentTimeMillis = System.currentTimeMillis();
    ...
    public synchronized void b(String str, int i10) {
        try {
            try {
                ...
                List<CampaignEx> listB = this.f35078a.b(str, i10, iF == 2);
    ...
    public List<CampaignEx> a(String str, int i10, boolean z10) {
        try {
            ...
            return this.f35078a.a(str, 0, 0, i10, z10);
        } catch (Exception e10) {
            q0.b(f35076b, e10.getLocalizedMessage());
            return null;
        }
    }
        ...
        if (campaignEx != null) {
            try {
                ...
                if (!TextUtils.isEmpty(localRequestId)) {
                    ...
                    if (z10) {
                        this.f35078a.a(str, localRequestId, localRequestId + "label_second");
                        return;
                    }
                    this.f35078a.a(campaignEx.getId(), str, campaignEx.isBidCampaign(), campaignEx.getRequestId());
                    return;
                }
                this.f35078a.a(campaignEx.getId(), str, campaignEx.isBidCampaign(), campaignEx.getRequestId());
            } catch (Exception e10) {
    ...
    public void a(CampaignEx campaignEx) {
        if (campaignEx != null) {
            try {
                ...
                this.f35078a.d(campaignEx.getId(), campaignEx.getRequestId());
            } catch (Exception e10) {
                e10.printStackTrace();
            }
        }
    ...
    public void a(String str, String str2) {
        try {
            ...
            List<com.mbridge.msdk.foundation.entity.c> listD = this.f35078a.d(str);
    ...
    public void a(String str, String str2, List<CampaignEx> list) {
        try {
            ...
            this.f35078a.a(list, str, str2, 0);
        } catch (Exception e10) {
            e10.printStackTrace();
        }
    }
