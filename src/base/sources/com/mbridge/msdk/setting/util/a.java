...
public class a {
    ...
    /* JADX INFO: compiled from: r8-map-id-1868b3f846f91b929d17a1f0de6da199bc8101b6e9bb94a36f131322636ef84b */
    class C0445a extends com.mbridge.msdk.foundation.same.net.handler.a {
    ...
    class b implements Runnable {
        ...
        public void run() throws Throwable {
            try {
                ...
                o0.a(this.f32528a.getBytes(), file);
                com.mbridge.msdk.foundation.buffer.sharedperference.a.b().a("MraidJSController", this.f32529b);
            } catch (Exception e10) {
    ...
    public String b() {
        try {
            ...
            if (gVarF != null && !TextUtils.isEmpty(gVarF.P())) {
                a(com.mbridge.msdk.foundation.controller.c.n().d(), gVarF.P());
            }
            return f32523b;
    ...
    public void a(Context context, String str) {
        ...
        if (TextUtils.isEmpty(strA) || !strA.equals(str)) {
            try {
                new com.mbridge.msdk.setting.net.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.wrapper.e) null, new C0445a(str), "mraid_js", ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
            } catch (Exception e10) {
