...
public final class DeferredMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public final MediaSource.MediaPeriodId f31956id;
    ...
    public void createPeriod() {
        MediaPeriod mediaPeriodCreatePeriod = this.mediaSource.createPeriod(this.f31956id, this.allocator);
    ...
    public void maybeThrowPrepareError() throws IOException {
        try {
            ...
            prepareErrorListener.onPrepareError(this.f31956id, e10);
        }
    }
