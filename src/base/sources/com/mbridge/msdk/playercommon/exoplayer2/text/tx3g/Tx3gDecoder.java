...
public final class Tx3gDecoder extends SimpleSubtitleDecoder {
    ...
    private static String readSubtitleText(ParsableByteArray parsableByteArray) throws SubtitleDecoderException {
        ...
        return (parsableByteArray.bytesLeft() < 2 || !((cPeekChar = parsableByteArray.peekChar()) == 65279 || cPeekChar == 65534)) ? parsableByteArray.readString(unsignedShort, Charset.forName(C.UTF8_NAME)) : parsableByteArray.readString(unsignedShort, Charset.forName(C.UTF16_NAME));
    }
