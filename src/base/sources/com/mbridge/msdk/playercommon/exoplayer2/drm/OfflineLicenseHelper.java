...
public final class OfflineLicenseHelper<T extends ExoMediaCrypto> {
    ...
    public static OfflineLicenseHelper<FrameworkMediaCrypto> newWidevineInstance(String str, boolean z10, HttpDataSource.Factory factory) {
        return newWidevineInstance(str, z10, factory, null);
    }

    public static OfflineLicenseHelper<FrameworkMediaCrypto> newWidevineInstance(String str, boolean z10, HttpDataSource.Factory factory, HashMap<String, String> map) {
