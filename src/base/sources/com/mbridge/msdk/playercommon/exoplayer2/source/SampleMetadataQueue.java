...
final class SampleMetadataQueue {
    ...
    public synchronized int advanceTo(long j10, boolean z10, boolean z11) throws Throwable {
        try {
            try {
    ...
    public synchronized long discardTo(long j10, boolean z10, boolean z11) throws Throwable {
        Throwable th2;
        try {
            try {
                int i10 = this.length;
