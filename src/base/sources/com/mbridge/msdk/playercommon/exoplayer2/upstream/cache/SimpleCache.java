...
public final class SimpleCache implements Cache {
    ...
    public synchronized File startFile(String str, long j10, long j11) throws Throwable {
        ...
        try {
            try {
                ...
                return SimpleCacheSpan.getCacheFile(this.cacheDir, cachedContent.f31963id, j10, System.currentTimeMillis());
            } catch (Throwable th4) {
                th = th4;
                th2 = th;
                throw th2;
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public synchronized SimpleCacheSpan startReadWrite(String str, long j10) {
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache
    public synchronized SimpleCacheSpan startReadWriteNonBlocking(String str, long j10) {
        Assertions.checkState(!this.released);
    ...
    private void removeSpan(CacheSpan cacheSpan, boolean z10) {
        CachedContent cachedContent = this.index.get(cacheSpan.key);
