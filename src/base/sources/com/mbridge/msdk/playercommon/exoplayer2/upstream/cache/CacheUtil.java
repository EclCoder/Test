...
public final class CacheUtil {
    ...
    public static void cache(DataSpec dataSpec, Cache cache, DataSource dataSource, CachingCounters cachingCounters, AtomicBoolean atomicBoolean) throws InterruptedException, EOFException {
    ...
    private static long readAndDiscard(DataSpec dataSpec, long j10, long j11, DataSource dataSource, byte[] bArr, PriorityTaskManager priorityTaskManager, int i10, CachingCounters cachingCounters) {
    ...
    public static void cache(DataSpec dataSpec, Cache cache, CacheDataSource cacheDataSource, byte[] bArr, PriorityTaskManager priorityTaskManager, int i10, CachingCounters cachingCounters, AtomicBoolean atomicBoolean, boolean z10) throws InterruptedException, EOFException {
        DataSpec dataSpec2 = dataSpec;
        Cache cache2 = cache;
