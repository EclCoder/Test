...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static class CueBuilder {
        ...
        public Cue build() {
            ...
            return new Cue(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, i10, 1, i11, f10, i15, Float.MIN_VALUE);
        }
    ...
    protected void decode(SubtitleInputBuffer subtitleInputBuffer) {
        ...
        while (true) {
            ...
            byte unsignedByte2 = (byte) (this.ccData.readUnsignedByte() & Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE);
            byte unsignedByte3 = (byte) (this.ccData.readUnsignedByte() & Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE);
