    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        for (int i13 = 0; i13 < size2; i13++) {
            ...
            if (containerAtom2.type == Atom.TYPE_trak) {
                ...
                if (trak != null) {
                    sparseArray2.put(trak.f31950id, trak);
                }
            }
        }
        ...
        if (this.trackBundles.size() != 0) {
            ...
            while (i10 < size3) {
                ...
                this.trackBundles.get(track.f31950id).init(track, getDefaultSampleValues(sparseArray, track.f31950id));
                i10++;
            }
            return;
        }
        while (i10 < size3) {
            ...
            trackBundle.init(track2, getDefaultSampleValues(sparseArray, track2.f31950id));
            this.trackBundles.put(track2.f31950id, trackBundle);
    ...
    private boolean readSample(ExtractorInput extractorInput) throws ParserException {
        ...
        if (i16 == 0) {
            ...
            while (true) {
                ...
                this.sampleBytesWritten += r11.sampleData(extractorInput, i18 - i17, false);
            }
        } else {
            ...
            while (this.sampleBytesWritten < this.sampleSize) {
                ...
                if (i21 == 0) {
                    ...
                    r11.sampleData(this.nalStartCode, i10);
                    r11.sampleData(this.nalPrefix, i11);
                    ...
                    if (this.processSeiNalUnitPayload) {
                        ...
                        r11.sampleData(this.nalBuffer, this.sampleCurrentNalBytesRemaining);
                        ...
                        iSampleData = r11.sampleData(extractorInput, i21, i12);
                    }
        ...
        r11.sampleMetadata(samplePresentationTime, r10 == true ? 1 : 0, this.sampleSize, 0, cryptoData);
