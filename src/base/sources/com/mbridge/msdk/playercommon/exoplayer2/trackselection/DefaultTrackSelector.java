...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    private static Point getMaxVideoSizeInViewport(boolean z10, int i10, int i11, int i12, int i13) {
        if (z10) {
            if ((i12 > i13) == (i10 > i11)) {
                i11 = i10;
                i10 = i11;
        ...
        int i14 = i12 * i10;
        int i15 = i13 * i11;
        return i14 >= i15 ? new Point(i11, Util.ceilDivide(i15, i12)) : new Point(Util.ceilDivide(i14, i13), i10);
    }
    ...
    private static TrackSelection selectAdaptiveVideoTrack(TrackGroupArray trackGroupArray, int[][] iArr, int i10, Parameters parameters, TrackSelection.Factory factory) {
    ...
    private static TrackSelection selectFixedVideoTrack(TrackGroupArray trackGroupArray, int[][] iArr, Parameters parameters) {
        ...
        while (i15 < trackGroupArray.length) {
            TrackGroup trackGroup2 = trackGroupArray.get(i15);
            ...
            int[] iArr2 = iArr[i15];
            int i18 = 0;
            while (i18 < trackGroup2.length) {
                if (isSupported(iArr2[i18], parameters.exceedRendererCapabilitiesIfNecessary)) {
                    Format format = trackGroup2.getFormat(i18);
                    boolean z10 = true;
                    boolean z11 = viewportFilteredTrackIndices.contains(Integer.valueOf(i18)) && ((i10 = format.width) == i13 || i10 <= parameters.maxVideoWidth) && (((i11 = format.height) == i13 || i11 <= parameters.maxVideoHeight) && ((i12 = format.bitrate) == i13 || i12 <= parameters.maxVideoBitrate));
                    if (z11 || parameters.exceedVideoConstraintsIfNecessary) {
                        int i19 = z11 ? 2 : 1;
                        boolean zIsSupported = isSupported(iArr2[i18], false);
                        if (zIsSupported) {
                            i19 += 1000;
                        }
                        boolean z12 = i19 > i17;
                        if (i19 != i17) {
                            ...
                            int iCompareFormatValues = pixelCount2 != pixelCount ? compareFormatValues(pixelCount2, pixelCount) : compareFormatValues(format.bitrate, i14);
                            if (!zIsSupported || !z11 ? iCompareFormatValues >= 0 : iCompareFormatValues <= 0) {
                                z10 = false;
                            }
                        } else if (compareFormatValues(format.bitrate, i14) >= 0) {
                            z10 = false;
                        }
                        if (z10) {
                            i14 = format.bitrate;
    ...
    protected TrackSelection selectAudioTrack(TrackGroupArray trackGroupArray, int[][] iArr, int i10, Parameters parameters, TrackSelection.Factory factory) {
        int i11 = -1;
        int i12 = -1;
    ...
    protected TrackSelection selectOtherTrack(int i10, TrackGroupArray trackGroupArray, int[][] iArr, Parameters parameters) {
        TrackGroup trackGroup = null;
        int i11 = 0;
        int i12 = 0;
        for (int i13 = 0; i13 < trackGroupArray.length; i13++) {
            ...
            for (int i13 = 0; i13 < trackGroup2.length; i13++) {
                if (isSupported(iArr2[i13], parameters.exceedRendererCapabilitiesIfNecessary)) {
                    ...
                    if (hasLanguage || (parameters.selectUndeterminedTextLanguage && formatHasNoLanguage(format))) {
                        i15 = (objArr == true ? 8 : objArr2 == false ? 6 : 4) + (hasLanguage ? 1 : 0);
                    } else if (objArr == true) {
                        i15 = 3;
    ...
    protected TrackSelection selectVideoTrack(TrackGroupArray trackGroupArray, int[][] iArr, int i10, Parameters parameters, TrackSelection.Factory factory) {
