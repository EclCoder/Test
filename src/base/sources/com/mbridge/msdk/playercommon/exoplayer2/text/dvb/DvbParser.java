    ...
    private static int[] generateDefault4BitClutEntries() {
        ...
        for (int i10 = 1; i10 < 16; i10++) {
            if (i10 < 8) {
                ...
                iArr[i10] = getColor(255, i13, i14, i12);
            }
        }
        return iArr;
    }
        ...
        for (int i10 = 0; i10 < 256; i10++) {
            if (i10 < 8) {
                ...
                if (i11 == 0) {
                    ...
                    iArr[i10] = getColor(Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE, ((i10 & 1) != 0 ? 85 : 0) + ((i10 & 16) != 0 ? 170 : 0), ((i10 & 2) != 0 ? 85 : 0) + ((i10 & 32) != 0 ? 170 : 0), ((i10 & 4) == 0 ? 0 : 85) + ((i10 & 64) == 0 ? 0 : 170));
                } else if (i11 == 128) {
                    iArr[i10] = getColor(255, ((i10 & 1) != 0 ? 43 : 0) + Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE + ((i10 & 16) != 0 ? 85 : 0), ((i10 & 2) != 0 ? 43 : 0) + Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE + ((i10 & 32) != 0 ? 85 : 0), ((i10 & 4) == 0 ? 0 : 43) + Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE + ((i10 & 64) == 0 ? 0 : 85));
                } else if (i11 == 136) {
            ...
            if (bits != 240) {
                switch (bits) {
                    case 16:
                        ...
                        canvas2 = canvas;
                        if (i10 == 3) {
                            if (bArrBuildClutMapTable2 == null) {
                    ...
                    case 17:
                        ...
                        Paint paint3 = paint;
                        canvas2 = canvas;
                        iPaint2BitPixelCodeString = paint4BitPixelCodeString(parsableBitArray, iArr3, i10 == 3 ? defaultMap4To8 : null, iPaint2BitPixelCodeString, i13, paint3, canvas2);
                        parsableBitArray.byteAlign();
                        paint = paint3;
                        iArr = iArr3;
                        break;
            ...
            case 17:
                ...
                if (bits2 == subtitleService.subtitlePageId && pageComposition3 != null) {
                    ...
                    if (pageComposition3.state == 0) {
                        regionComposition.mergeFrom(subtitleService.regions.get(regionComposition.f31960id));
                    }
                    subtitleService.regions.put(regionComposition.f31960id, regionComposition);
                }
                break;
            case 18:
                if (bits2 == subtitleService.subtitlePageId) {
                    ClutDefinition clutDefinition = parseClutDefinition(parsableBitArray, bits3);
                    subtitleService.cluts.put(clutDefinition.f31958id, clutDefinition);
                } else if (bits2 == subtitleService.ancillaryPageId) {
                    ClutDefinition clutDefinition2 = parseClutDefinition(parsableBitArray, bits3);
                    subtitleService.ancillaryCluts.put(clutDefinition2.f31958id, clutDefinition2);
                }
                break;
            case 19:
                if (bits2 == subtitleService.subtitlePageId) {
                    ObjectData objectData = parseObjectData(parsableBitArray);
                    subtitleService.objects.put(objectData.f31959id, objectData);
                } else if (bits2 == subtitleService.ancillaryPageId) {
                    ObjectData objectData2 = parseObjectData(parsableBitArray);
                    subtitleService.ancillaryObjects.put(objectData2.f31959id, objectData2);
                }
                break;
            case 20:
                if (bits2 == subtitleService.subtitlePageId) {
