...
public final class MimeTypes {
    ...
    public static String getMediaMimeType(String str) {
        ...
        if (strTrim.startsWith(VisualSampleEntry.TYPE3) || strTrim.startsWith(VisualSampleEntry.TYPE4)) {
            return VIDEO_H264;
        }
        if (strTrim.startsWith(VisualSampleEntry.TYPE7) || strTrim.startsWith(VisualSampleEntry.TYPE6)) {
            return VIDEO_H265;
        }
        ...
        if (strTrim.startsWith(AudioSampleEntry.TYPE3)) {
        ...
        if (strTrim.startsWith(AudioSampleEntry.TYPE8) || strTrim.startsWith(AC3SpecificBox.TYPE)) {
            return AUDIO_AC3;
        }
        if (strTrim.startsWith(AudioSampleEntry.TYPE9) || strTrim.startsWith(EC3SpecificBox.TYPE)) {
            return AUDIO_E_AC3;
        }
        if (strTrim.startsWith("ec+3")) {
            return AUDIO_E_AC3_JOC;
        }
        if (strTrim.startsWith("dtsc") || strTrim.startsWith(AudioSampleEntry.TYPE13)) {
            return AUDIO_DTS;
        }
        if (strTrim.startsWith(AudioSampleEntry.TYPE12) || strTrim.startsWith(AudioSampleEntry.TYPE11)) {
            return AUDIO_DTS_HD;
        }
        if (strTrim.startsWith("opus")) {
            return AUDIO_OPUS;
        }
        return strTrim.startsWith("vorbis") ? AUDIO_VORBIS : getCustomMimeTypeForCodec(strTrim);
    }
