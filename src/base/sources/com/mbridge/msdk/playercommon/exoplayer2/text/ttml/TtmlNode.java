    ...
    private void traverseForText(long j10, boolean z10, String str, Map<String, SpannableStringBuilder> map) {
        ...
        if (isActive(j10)) {
            ...
            while (i10 < getChildCount()) {
                getChild(i10).traverseForText(j10, z10 || zEquals, str2, map);
                i10++;
                j10 = j10;
                map = map;
            }
            ...
            if (zEquals) {
                TtmlRenderUtil.endParagraph(getRegionOutput(str2, map2));
            }
            for (Map.Entry<String, SpannableStringBuilder> entry2 : map2.entrySet()) {
