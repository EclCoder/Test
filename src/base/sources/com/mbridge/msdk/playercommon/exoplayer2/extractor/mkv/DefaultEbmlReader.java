...
final class DefaultEbmlReader implements EbmlReader {
    ...
    private double readFloat(ExtractorInput extractorInput, int i10) {
        long integer = readInteger(extractorInput, i10);
        return i10 == 4 ? Float.intBitsToFloat((int) integer) : Double.longBitsToDouble(integer);
    }
    ...
    private long readInteger(ExtractorInput extractorInput, int i10) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            j10 = (j10 << 8) | ((long) (this.scratch[i11] & AdConfig.NETWORK_LOAD_LIMIT_DISABLED));
        }
        return j10;
    }
