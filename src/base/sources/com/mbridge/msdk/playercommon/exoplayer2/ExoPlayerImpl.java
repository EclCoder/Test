...
final class ExoPlayerImpl implements ExoPlayer {
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.Player
    public void release() {
        Log.i(TAG, "Release " + Integer.toHexString(System.identityHashCode(this)) + " [" + giNWGaNAgVQoO.CXNrpLkv + "] [" + Util.DEVICE_DEBUG_INFO + "] [" + ExoPlayerLibraryInfo.registeredModules() + "]");
