...
public final class DownloadManager {
    ...
    private static final class Task implements Runnable {
        ...
        private String getStateString() {
            ...
            return i10 != 7 ? TaskState.getStateString(this.currentState) : "STOPPING";
        }
        ...
        public TaskState getDownloadState() {
            return new TaskState(this.f31954id, this.action, getExternalState(), getDownloadPercentage(), getDownloadedBytes(), this.error);
        }
    ...
    public int handleAction(DownloadAction downloadAction) {
        ...
        return taskAddTaskForAction.f31954id;
    }
}
