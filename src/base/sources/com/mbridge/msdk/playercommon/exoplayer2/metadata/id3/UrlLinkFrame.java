...
public final class UrlLinkFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && UrlLinkFrame.class == obj.getClass()) {
            ...
            if (this.f31953id.equals(urlLinkFrame.f31953id) && Util.areEqual(this.description, urlLinkFrame.description) && Util.areEqual(this.url, urlLinkFrame.url)) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        return this.f31953id + ": url=" + this.url;
    }
