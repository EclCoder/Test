...
public final class DefaultExtractorInput implements ExtractorInput {
    ...
    private int readFromDataSource(byte[] bArr, int i10, int i11, int i12, boolean z10) throws InterruptedException, EOFException {
    ...
    public boolean advancePeekPosition(int i10, boolean z10) throws InterruptedException, EOFException {
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.extractor.ExtractorInput
    public int read(byte[] bArr, int i10, int i11) throws InterruptedException, EOFException {
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.extractor.ExtractorInput
    public boolean readFully(byte[] bArr, int i10, int i11, boolean z10) throws InterruptedException, EOFException {
        int fromPeekBuffer = readFromPeekBuffer(bArr, i10, i11);
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.extractor.ExtractorInput
    public <E extends Throwable> void setRetryPosition(long j10, E e10) throws E {
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.extractor.ExtractorInput
    public int skip(int i10) throws InterruptedException, EOFException {
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.extractor.ExtractorInput
    public boolean skipFully(int i10, boolean z10) throws InterruptedException, EOFException {
        int iSkipFromPeekBuffer = skipFromPeekBuffer(i10);
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.extractor.ExtractorInput
    public void readFully(byte[] bArr, int i10, int i11) throws InterruptedException, EOFException {
        readFully(bArr, i10, i11, false);
    }

    @Override // com.mbridge.msdk.playercommon.exoplayer2.extractor.ExtractorInput
    public void advancePeekPosition(int i10) throws InterruptedException, EOFException {
        advancePeekPosition(i10, false);
    }

    @Override // com.mbridge.msdk.playercommon.exoplayer2.extractor.ExtractorInput
    public void skipFully(int i10) throws InterruptedException, EOFException {
        skipFully(i10, false);
    }
}
