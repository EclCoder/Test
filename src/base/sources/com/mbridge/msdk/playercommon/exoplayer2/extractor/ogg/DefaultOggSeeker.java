...
final class DefaultOggSeeker implements OggSeeker {
    ...
    public long getNextSeekPosition(long j10, ExtractorInput extractorInput) throws IOException {
    ...
    long skipToPageOfGranule(ExtractorInput extractorInput, long j10, long j11) throws ParserException, EOFException {
        this.pageHeader.populate(extractorInput, false);
        while (true) {
            OggPageHeader oggPageHeader = this.pageHeader;
    ...
    boolean skipToNextPage(ExtractorInput extractorInput, long j10) {
        int i10;
