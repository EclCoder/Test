...
public class VideoFeedsPlayer implements Player.EventListener {
    ...
    private Runnable playProgressRunnable = new Runnable() { // from class: com.mbridge.msdk.playercommon.VideoFeedsPlayer.2
        ...
        public void run() {
            ...
            try {
                ...
                float f10 = VideoFeedsPlayer.this.mCurrentPosition / 1000.0f;
                float f11 = VideoFeedsPlayer.this.mCurrentPosition % 1000;
    ...
    public void onPlayerError(ExoPlaybackException exoPlaybackException) {
        ...
        q0.b(TAG, "onPlayerError : " + message);
        onError(exoPlaybackException.type, message);
    }

    @Override // com.mbridge.msdk.playercommon.exoplayer2.Player.EventListener
    public void onPlayerStateChanged(boolean z10, int i10) {
        String str = FuoITeVPeXAj.xBzXRqo;
        q0.b(str, "onPlaybackStateChanged : " + i10);
        if (i10 == 1) {
            q0.b(str, "onPlaybackStateChanged : IDLE");
            return;
        }
        if (i10 == 2) {
            q0.b(str, "onPlaybackStateChanged : Buffering");
        ...
        if (i10 != 3) {
            ...
            q0.b(str, "onPlaybackStateChanged : Ended : PLAY ENDED");
            cancelPlayProgressTimer();
            onCompletion();
            return;
        }
        q0.b(str, "onPlaybackStateChanged : READY");
