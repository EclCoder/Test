...
public class MBBannerView extends RelativeLayout implements BaseExtraInterfaceForHandler {
    ...
    private void callbackAndReportFail(c cVar, b bVar) {
        ...
        if (bVar != null) {
            try {
                ...
                q0.b("BannerView", th2.getMessage());
            }
        }
        cVar.a(bVar);
        cVar.b(true);
    ...
    private void delayedNotify() {
        postDelayed(new Runnable() { // from class: com.mbridge.msdk.out.MBBannerView.1
            ...
            public void run() {
                if (MBBannerView.this.controller == null || com.mbridge.msdk.foundation.feedback.b.f30438f) {
                    return;
                }
    ...
    public void onResume() {
        if (this.controller == null || !TextUtils.isEmpty(this.bidToken) || com.mbridge.msdk.foundation.feedback.b.f30438f) {
            return;
        }
        this.controller.h();
    }
