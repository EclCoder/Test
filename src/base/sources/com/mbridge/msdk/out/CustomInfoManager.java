    ...
    public String getCustomInfoByUnitId(String str, String str2) {
        ...
        try {
            ...
            if (uri != null) {
                ...
                if (!TextUtils.isEmpty(host) && host.contains(CampaignEx.JSON_KEY_HB) && !TextUtils.isEmpty(path) && path.contains(TrackLoadSettingsAtom.TYPE)) {
