...
public class b extends WebViewClient {
    ...
    private CopyOnWriteArrayList<WebViewClient> f31649a = new CopyOnWriteArrayList<>();

    public void a(WebViewClient webViewClient) {
        this.f31649a.add(webViewClient);
    }

    public void b(WebViewClient webViewClient) {
        this.f31649a.remove(webViewClient);
    }

    @Override // android.webkit.WebViewClient
    public void doUpdateVisitedHistory(WebView webView, String str, boolean z10) {
        Iterator<WebViewClient> it = this.f31649a.iterator();
        while (it.hasNext()) {
    ...
    public void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        try {
            ...
            q0.b(UHbHibBvYxKnPE.VUACeKe, e10.getMessage());
        }
    }
