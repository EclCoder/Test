...
public class a extends WebChromeClient {
    ...
    private CopyOnWriteArrayList<WebChromeClient> f31648a = new CopyOnWriteArrayList<>();

    public void a(WebChromeClient webChromeClient) {
        this.f31648a.add(webChromeClient);
    }

    public void b(WebChromeClient webChromeClient) {
        this.f31648a.remove(webChromeClient);
    }
    ...
    public void onCloseWindow(WebView webView) {
        Iterator<WebChromeClient> it = this.f31648a.iterator();
        while (it.hasNext()) {
