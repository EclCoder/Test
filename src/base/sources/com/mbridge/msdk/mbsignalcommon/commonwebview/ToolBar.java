...
public class ToolBar extends LinearLayout {
    ...
    public static class b {
        ...
        public boolean f31646c = true;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        public View.OnClickListener f31647d;
    ...
    private void a(a aVar, List<b> list) {
        ...
        try {
            for (b bVar : list) {
                ...
                imageView.setTag(bVar.f31644a);
                imageView.setImageDrawable(getResources().getDrawable(getResources().getIdentifier(bVar.f31645b, "drawable", c.n().i())));
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(aVar.a(), -1);
                layoutParams.setMargins(32, 0, 32, 0);
                imageView.setLayoutParams(layoutParams);
                imageView.setOnClickListener(bVar.f31647d);
                if (!bVar.f31646c) {
