...
public abstract class BaseBannerSignalPlugin extends BannerSignalPluginDiff {
    ...
    private final String f31651g = "BannerSignalPlugin";
    ...
    public void click(Object obj, String str) {
        try {
            ...
            q0.b("BannerSignalPlugin", CampaignEx.JSON_NATIVE_VIDEO_CLICK, th2);
        }
    }
    ...
    public void initialize(Context context, WindVaneWebView windVaneWebView) {
        ...
        try {
            if (context instanceof e) {
                this.f31652h = (e) context;
            } else {
                if (windVaneWebView.getObject() == null || !(windVaneWebView.getObject() instanceof e)) {
                    return;
                }
                this.f31652h = (e) windVaneWebView.getObject();
            }
        } catch (Throwable th2) {
            q0.b("BannerSignalPlugin", "initialize", th2);
        }
    }
