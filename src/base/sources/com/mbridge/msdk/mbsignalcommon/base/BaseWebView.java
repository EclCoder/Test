...
public class BaseWebView extends WebView {
    ...
    protected Context f31584a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private View.OnTouchListener f31585b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private View.OnTouchListener f31586c;
    ...
    class a implements View.OnTouchListener {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            if (BaseWebView.this.f31585b != null) {
                return BaseWebView.this.f31585b.onTouch(view, motionEvent);
            }
            return false;
        }
    }
    ...
    protected void a() {
        ...
        settings.setDatabaseEnabled(true);
        String path = this.f31584a.getDir("database", 0).getPath();
        ...
        super.setOnTouchListener(this.f31586c);
    }
