...
public abstract class d extends com.mbridge.msdk.foundation.same.net.c<JSONObject> {
    ...
    private static final String f28267c = "d";
    ...
    private void b(List<g> list, JSONObject jSONObject) {
        ...
        CampaignUnit v5CampaignUnit = "v5".equals(strOptString) ? com.mbridge.msdk.foundation.entity.b.parseV5CampaignUnit(jSONObjectOptJSONObject, this.f28269b) : com.mbridge.msdk.foundation.entity.b.parseCampaignUnit(jSONObjectOptJSONObject, this.f28269b);
    ...
    public void onError(com.mbridge.msdk.foundation.same.net.exception.a aVar) {
        q0.b(f28267c, "errorCode = " + aVar.f30579a);
    ...
    private void a(List<g> list, JSONObject jSONObject) {
        ...
        calcRequestTime(System.currentTimeMillis());
        CampaignUnit v5CampaignUnit = "v5".equals(jSONObject.optString("version")) ? com.mbridge.msdk.foundation.entity.b.parseV5CampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), this.f28269b) : com.mbridge.msdk.foundation.entity.b.parseCampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), this.f28269b);
