...
public class b extends c {
    ...
    private WeakReference<Context> f28293c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private List<CampaignEx> f28294d;
    ...
    private com.mbridge.msdk.advanced.middle.a f28300j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    private NativeAdvancedExpandDialog f28301k;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private String f28292b = "NativeAdvancedJSBridgeImpl";

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private int f28299i = 5;

    /* JADX INFO: compiled from: r8-map-id-1868b3f846f91b929d17a1f0de6da199bc8101b6e9bb94a36f131322636ef84b */
    class a implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ ArrayList f28302a;
        ...
        public void run() {
            try {
                ...
                ArrayList arrayList = this.f28302a;
                ...
                q0.b(b.this.f28292b, "campain can't insert db");
            }
        }
    }
    ...
    public b(Context context, String str, String str2) {
        this.f28296f = str;
        this.f28295e = str2;
        this.f28293c = new WeakReference<>(context);
    }
    ...
    public void c(Object obj, String str) {
        try {
            ...
            q0.b(this.f28292b, "onSignalCommunicationConnect", th2);
        }
    }
    ...
    public void click(Object obj, String str) {
        try {
            List<CampaignEx> list = this.f28294d;
            CampaignEx campaignEx = (list == null || list.size() <= 0) ? null : this.f28294d.get(0);
            ...
            try {
                ...
                q0.b(this.f28292b, e10.getMessage());
            }
            com.mbridge.msdk.advanced.middle.a aVar = this.f28300j;
            if (aVar != null) {
                aVar.a(campaignEx);
            }
        } catch (Throwable th2) {
            q0.b(this.f28292b, CampaignEx.JSON_NATIVE_VIDEO_CLICK, th2);
        }
    }

    @Override // com.mbridge.msdk.mbsignalcommon.mraid.b
    public void close() {
        q0.b(this.f28292b, "close");
        try {
            com.mbridge.msdk.advanced.middle.a aVar = this.f28300j;
            if (aVar != null) {
                aVar.close();
            ...
            q0.b(this.f28292b, "close", th2);
        }
    }

    @Override // com.mbridge.msdk.mbsignalcommon.communication.b
    public void d(Object obj, String str) {
        q0.a(this.f28292b, "sendImpressions:" + str);
        try {
            if (TextUtils.isEmpty(str)) {
                return;
            }
            ...
            for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                ...
                for (CampaignEx campaignEx : this.f28294d) {
                    if (campaignEx.getId().equals(string)) {
                        com.mbridge.msdk.foundation.same.buffer.b.a(this.f28295e, campaignEx, "h5_native");
            ...
            q0.b(this.f28292b, "sendImpressions", th2);
        }
    }
    ...
    public void expand(String str, boolean z10) {
        try {
            ...
            WeakReference<Context> weakReference = this.f28293c;
            if (weakReference == null || weakReference.get() == null) {
                return;
            }
            NativeAdvancedExpandDialog nativeAdvancedExpandDialog = this.f28301k;
            if (nativeAdvancedExpandDialog == null || !nativeAdvancedExpandDialog.isShowing()) {
                NativeAdvancedExpandDialog nativeAdvancedExpandDialog2 = new NativeAdvancedExpandDialog(this.f28293c.get(), bundle, this.f28300j);
                this.f28301k = nativeAdvancedExpandDialog2;
                nativeAdvancedExpandDialog2.setCampaignList(this.f28295e, this.f28294d);
                this.f28301k.show();
                com.mbridge.msdk.advanced.middle.a aVar = this.f28300j;
                if (aVar != null) {
                    aVar.a(true);
                }
                com.mbridge.msdk.advanced.report.a.a(this.f28295e, getMraidCampaign(), str);
            }
        } catch (Throwable th2) {
            q0.b(this.f28292b, "expand", th2);
        }
    }
    ...
    public void getFileInfo(Object obj, String str) {
        ...
        try {
            ...
            q0.a(this.f28292b, th2.getMessage());
        }
    }
    ...
    public void init(Object obj, String str) {
        try {
            ...
            jSONObject2.put("dev_close_state", this.f28297g);
            jSONObject2.put("customURLScheme", 1);
            jSONObject.put("sdkSetting", jSONObject2);
            jSONObject.put("device", bVar.b());
            jSONObject.put("campaignList", CampaignEx.parseCamplistToJson(this.f28294d));
            l lVarA = h.b().a(com.mbridge.msdk.foundation.controller.c.n().b(), this.f28295e);
            if (lVarA == null) {
                lVarA = l.k(this.f28295e);
            }
            if (!TextUtils.isEmpty(this.f28296f)) {
                lVarA.d(this.f28296f);
            }
            lVarA.e(this.f28295e);
            lVarA.j(this.f28299i);
            lVarA.a(this.f28298h);
            ...
            q0.b(this.f28292b, "init" + jSONObject.toString());
            f.a().b(obj, Base64.encodeToString(jSONObject.toString().getBytes(), 2));
        } catch (Throwable th2) {
            q0.b(this.f28292b, "init", th2);
        }
    }

    @Override // com.mbridge.msdk.mbsignalcommon.communication.a, com.mbridge.msdk.mbsignalcommon.communication.b
    public void install(Object obj, String str) {
        q0.b(this.f28292b, "install");
        try {
            List<CampaignEx> list = this.f28294d;
            CampaignEx campaignEx = (list == null || list.size() <= 0) ? null : this.f28294d.get(0);
            if (TextUtils.isEmpty(str)) {
    ...
    public void reportUrls(Object obj, String str) {
        q0.a(this.f28292b, "reportUrls:" + str);
        if (TextUtils.isEmpty(str)) {
    ...
    public void toggleCloseBtn(Object obj, String str) {
        try {
            ...
            q0.b(this.f28292b, "toggleCloseBtn", th2);
        }
    }
    ...
    public void triggerCloseBtn(Object obj, String str) {
        if (this.f28300j != null) {
            ...
            this.f28300j.triggerCloseBtn(obj, str);
        }
    }
    ...
    public void useCustomClose(boolean z10) {
        try {
            ...
            q0.b(this.f28292b, "useCustomClose", th2);
        }
    }
    ...
    public void a(Object obj, String str) {
        try {
            ...
            q0.b(this.f28292b, "resetCountdown", e10);
        }
    }
}
