...
public class a implements View.OnClickListener {
    ...
    private com.mbridge.msdk.dycreator.viewdata.base.a f29875a;
    ...
    public void onClick(View view) {
        ...
        if (!(view instanceof MBCountDownView) || (aVar = this.f29875a) == null || aVar.getEffectData() == null || this.f29875a.getEffectData().isCanSkip()) {
            com.mbridge.msdk.dycreator.viewdata.base.a aVar2 = this.f29875a;
            if (aVar2 != null && (view instanceof MBRelativeLayout) && d.a(view, aVar2)) {
                com.mbridge.msdk.dycreator.viewdata.base.a aVar3 = this.f29875a;
                if (aVar3 instanceof MBSplashData) {
                    ...
                    ((MBSplashData) this.f29875a).setyInScreen(mBRelativeLayout.getyInScreen());
                    ((MBSplashData) this.f29875a).setClickType(1);
                }
            }
            com.mbridge.msdk.dycreator.viewdata.base.a aVar4 = this.f29875a;
            if (aVar4 != null && (view instanceof MBLinearLayout) && d.a(view, aVar4)) {
                com.mbridge.msdk.dycreator.viewdata.base.a aVar5 = this.f29875a;
                if (aVar5 instanceof MBSplashData) {
                    ...
                    ((MBSplashData) this.f29875a).setyInScreen(mBLinearLayout.getyInScreen());
                    ((MBSplashData) this.f29875a).setClickType(0);
                }
            }
            ...
            baseStrategyA.bindClickData(view, this.f29875a);
        }
    }
}
