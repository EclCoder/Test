...
public class MBSplashViewVModel implements BaseViewModel {
    ...
    private DynamicViewBackListener f30060e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private DyOption f30061f;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f30062a[EAction.CLOSE.ordinal()] = 2;
    ...
    public void setDynamicViewBackListener(DynamicViewBackListener dynamicViewBackListener) {
        if (dynamicViewBackListener != null) {
            this.f30060e = dynamicViewBackListener;
        }
    }
    ...
    public void setModelDataAndBind() {
        MBSplashData mBSplashData = new MBSplashData(this.f30061f);
        Context contextD = com.mbridge.msdk.foundation.controller.c.n().d();
        if (contextD != null) {
            DyOption dyOption = this.f30061f;
            if (dyOption != null) {
                CampaignEx campaignEx = dyOption.getCampaignEx();
                if (campaignEx != null) {
                    mBSplashData.setAdClickText(campaignEx.getAdCall());
                }
                mBSplashData.setCountDownText(contextD.getResources().getString(i0.a(contextD, this.f30061f.isCanSkip() ? "mbridge_splash_count_time_can_skip" : "mbridge_splash_count_time_can_skip_not", "string")));
            }
    ...
    private void a(SplashResData splashResData) {
        if (this.f30060e == null || splashResData == null) {
            return;
        }
        int i10 = AnonymousClass1.f30062a[splashResData.geteAction().ordinal()];
        if (i10 == 1 || i10 == 2) {
            b(splashResData);
        }
        this.f30060e.viewClicked(splashResData);
    }
