...
public class DynamicViewCreator {
    ...
    private static volatile DynamicViewCreator f30100a = null;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static int f30101b = -201;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f30102a[DyAdType.REWARD.ordinal()] = 2;
    ...
    public static DynamicViewCreator getInstance() {
        if (f30100a == null) {
            synchronized (DynamicViewCreator.class) {
                try {
                    if (f30100a == null) {
                        f30100a = new DynamicViewCreator();
                    }
                } catch (Throwable th2) {
                    throw th2;
                }
    ...
    public void createDynamicView(DyOption dyOption, DynamicViewBackListener dynamicViewBackListener) {
        ...
        if (a(dyOption, dynamicViewBackListener, new String[0])) {
            try {
                ...
                int i10 = AnonymousClass1.f30102a[dyOption.getDyAdType().ordinal()];
                if (i10 != 1) {
                    if (i10 != 2) {
                ...
                q0.b("DynamicViewCreator", e10.getMessage());
                dynamicViewBackListener.viewCreateFail(new a(f30101b, e10.getMessage()));
            }
        }
    }
