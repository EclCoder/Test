...
public class g {
    ...
    private static final g f33452a = c();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Logger f33453b = Logger.getLogger(v.class.getName());
    ...
    public void a(int i10, String str, Throwable th2) {
        f33453b.log(i10 == 5 ? Level.WARNING : Level.INFO, str, th2);
    }

    public Object a(String str) {
        if (f33453b.isLoggable(Level.FINE)) {
