...
class f<T> {
    ...
    private final Class<?> f33449a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final String f33450b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final Class[] f33451c;
    ...
    public Object b(T t10, Object... objArr) {
    ...
    public Object a(T t10, Object... objArr) {
        Method methodA = a(t10.getClass());
        if (methodA == null) {
            throw new AssertionError("Method " + this.f33450b + " not supported for object " + t10);
        }
        try {
            return methodA.invoke(t10, objArr);
    ...
    private Method a(Class<?> cls) {
        ...
        Method methodA = a(cls, str, this.f33451c);
        if (methodA == null || (cls2 = this.f33449a) == null || cls2.isAssignableFrom(methodA.getReturnType())) {
            return methodA;
        }
        return null;
    }
