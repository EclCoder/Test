    ...
    */
    ...
    public static class a {
        ...
        public a(long j10, y yVar, a0 a0Var) {
            ...
            this.f33132c = a0Var;
            if (a0Var != null) {
                this.f33138i = a0Var.t();
                this.f33139j = a0Var.r();
                r rVarM = a0Var.m();
                int iB = rVarM.b();
        ...
        private long a() {
            Date date = this.f33133d;
            long jMax = date != null ? Math.max(0L, this.f33139j - date.getTime()) : 0L;
            int i10 = this.f33141l;
            if (i10 != -1) {
                jMax = Math.max(jMax, TimeUnit.SECONDS.toMillis(i10));
            }
            long j10 = this.f33139j;
            return jMax + (j10 - this.f33138i) + (this.f33130a - j10);
        }

        private long b() {
            com.mbridge.msdk.thrid.okhttp.c cVarH = this.f33132c.h();
            if (cVarH.d() != -1) {
                return TimeUnit.SECONDS.toMillis(cVarH.d());
            }
            if (this.f33137h != null) {
                Date date = this.f33133d;
                long time = this.f33137h.getTime() - (date != null ? date.getTime() : this.f33139j);
                if (time > 0) {
                    return time;
                }
                return 0L;
            }
            if (this.f33135f != null && this.f33132c.s().g().k() == null) {
                Date date2 = this.f33133d;
                long time2 = (date2 != null ? date2.getTime() : this.f33138i) - this.f33135f.getTime();
                if (time2 > 0) {
                    return time2 / 10;
                }
            }
        ...
        private b d() {
            ...
            if (this.f33132c == null) {
                return new b(this.f33131b, null);
            }
            if (this.f33131b.d() && this.f33132c.l() == null) {
                return new b(this.f33131b, null);
            }
            if (!b.a(this.f33132c, this.f33131b)) {
                return new b(this.f33131b, null);
            }
            com.mbridge.msdk.thrid.okhttp.c cVarB = this.f33131b.b();
            if (cVarB.h() || a(this.f33131b)) {
                return new b(this.f33131b, null);
            }
            com.mbridge.msdk.thrid.okhttp.c cVarH = this.f33132c.h();
            long jA = a();
            ...
            r.a aVarA = this.f33131b.c().a();
            com.mbridge.msdk.thrid.okhttp.internal.a.f33105a.a(aVarA, str, str2);
            return new b(this.f33131b.f().a(aVarA.a()).a(), this.f33132c);
        }

        private boolean e() {
            return this.f33132c.h().d() == -1 && this.f33137h == null;
        }

        public b c() {
            b bVarD = d();
            return (bVarD.f33128a == null || !this.f33131b.b().j()) ? bVarD : new b(null, null);
        }

        private static boolean a(y yVar) {
            return (yVar.a("If-Modified-Since") == null && yVar.a(qnwOeeQSSWa.jNQMlBbWmRDsU) == null) ? false : true;
        }
    }
}
