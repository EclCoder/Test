...
final class h implements Closeable {
    ...
    static final Logger f33372e = Logger.getLogger(e.class.getName());

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final com.mbridge.msdk.thrid.okio.e f33373a;
    ...
    interface b {
        ...
        void a(boolean z10, int i10, com.mbridge.msdk.thrid.okio.e eVar, int i11);

        void a(boolean z10, m mVar);
    }

    h(com.mbridge.msdk.thrid.okio.e eVar, boolean z10) {
        this.f33373a = eVar;
        this.f33375c = z10;
        a aVar = new a(eVar);
        this.f33374b = aVar;
        this.f33376d = new d.a(4096, aVar);
    }
    ...
    private void b(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        int i12 = this.f33373a.readInt();
        int i13 = this.f33373a.readInt();
        int i14 = i10 - 8;
        ...
        com.mbridge.msdk.thrid.okio.f fVarB = com.mbridge.msdk.thrid.okio.f.f33642e;
        if (i14 > 0) {
            fVarB = this.f33373a.b(i14);
        }
    ...
    private void c(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        boolean z10 = (b10 & 1) != 0;
        short s10 = (b10 & 8) != 0 ? (short) (this.f33373a.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED) : (short) 0;
        if ((b10 & 32) != 0) {
            a(bVar, i11);
            i10 -= 5;
        }
    ...
    private void d(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        bVar.a((b10 & 1) != 0, this.f33373a.readInt(), this.f33373a.readInt());
    }
    ...
    private void f(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        short s10 = (b10 & 8) != 0 ? (short) (this.f33373a.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED) : (short) 0;
        bVar.a(i11, this.f33373a.readInt() & Integer.MAX_VALUE, a(a(i10 - 4, b10, s10), s10, b10, i11));
    }
    ...
    private void h(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        for (int i12 = 0; i12 < i10; i12 += 6) {
            int i13 = this.f33373a.readShort() & 65535;
            int i14 = this.f33373a.readInt();
            if (i13 == 2) {
                if (i14 != 0 && i14 != 1) {
    ...
    private void i(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        long j10 = ((long) this.f33373a.readInt()) & 2147483647L;
        if (j10 == 0) {
    ...
    public void a(b bVar) throws IOException {
        ...
        com.mbridge.msdk.thrid.okio.e eVar = this.f33373a;
        com.mbridge.msdk.thrid.okio.f fVar = e.f33288a;
        com.mbridge.msdk.thrid.okio.f fVarB = eVar.b(fVar.j());
        Logger logger = f33372e;
    ...
    static final class a implements s {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final com.mbridge.msdk.thrid.okio.e f33377a;
        ...
        private void d() throws IOException {
            ...
            int iA = h.a(this.f33377a);
            this.f33381e = iA;
            this.f33378b = iA;
            byte b10 = (byte) (this.f33377a.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED);
            this.f33379c = (byte) (this.f33377a.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED);
            Logger logger = h.f33372e;
            if (logger.isLoggable(Level.FINE)) {
                logger.fine(e.a(true, this.f33380d, this.f33378b, b10, this.f33379c));
            }
            int i11 = this.f33377a.readInt() & Integer.MAX_VALUE;
            this.f33380d = i11;
            if (b10 != 9) {
        ...
        public long b(com.mbridge.msdk.thrid.okio.c cVar, long j10) throws IOException {
            while (true) {
                ...
                if (i10 != 0) {
                    long jB = this.f33377a.b(cVar, Math.min(j10, i10));
                    if (jB == -1) {
                        return -1L;
                    }
                    this.f33381e = (int) (((long) this.f33381e) - jB);
                    return jB;
                }
                this.f33377a.skip(this.f33382f);
                this.f33382f = (short) 0;
                if ((this.f33379c & 4) != 0) {
                    return -1L;
                }
                d();
    ...
    public boolean a(boolean z10, b bVar) throws IOException {
        try {
            this.f33373a.e(9L);
            int iA = a(this.f33373a);
            if (iA >= 0 && iA <= 16384) {
                byte b10 = (byte) (this.f33373a.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED);
                if (z10 && b10 != 4) {
                    throw e.b("Expected a SETTINGS frame but was %s", Byte.valueOf(b10));
                }
                byte b11 = (byte) (this.f33373a.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED);
                int i10 = this.f33373a.readInt() & Integer.MAX_VALUE;
                Logger logger = f33372e;
                if (logger.isLoggable(Level.FINE)) {
    ...
    private void a(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        if ((b10 & 32) == 0) {
            short s10 = (b10 & 8) != 0 ? (short) (this.f33373a.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED) : (short) 0;
            bVar.a(z10, i11, this.f33373a, a(i10, b10, s10));
            this.f33373a.skip(s10);
            return;
        }
    ...
    private void a(b bVar, int i10) {
        int i11 = this.f33373a.readInt();
        bVar.a(i10, i11 & Integer.MAX_VALUE, (this.f33373a.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED) + 1, (Integer.MIN_VALUE & i11) != 0);
    }

    static int a(com.mbridge.msdk.thrid.okio.e eVar) {
