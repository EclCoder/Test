...
public class b {
    ...
    public static final String f31897a = DomainNameUtils.VERIFICATION_URL;
    ...
    class a extends com.mbridge.msdk.foundation.same.net.handler.a {
        ...
        final /* synthetic */ Context f31898b;
        ...
        public void a(String str) {
            ...
            new h(this.f31898b).a("", "", "", "", "fetch OM failed, request failed");
        }
    ...
    class RunnableC0426b implements Runnable {
        ...
        public void run() throws Throwable {
            try {
                ...
                o0.a(this.f31899a.getBytes(), file);
            } catch (Exception e10) {
    ...
    class c extends com.mbridge.msdk.foundation.same.net.handler.a {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ Context f31900b;
        ...
        public void a(String str) {
            ...
            new h(this.f31900b).a("", "", "", "", "fetch OM H5 failed, request failed");
        }
    ...
    class d implements Runnable {
        ...
        public void run() throws Throwable {
            try {
                ...
                o0.a(this.f31901a.getBytes(), file);
            } catch (Exception e10) {
                q0.a("OMSDK", e10.getMessage());
            }
        }
        ...
        try {
            try {
                ...
                try {
                    ...
                    AdSessionConfiguration adSessionConfigurationCreateAdSessionConfiguration = AdSessionConfiguration.createAdSessionConfiguration(creativeType, impressionType, owner, z10 ? Owner.NONE : owner, false);
                    context2 = context;
                    try {
                        try {
                            str7 = str2;
    ...
    public static void b(String str) {
        new Thread(new RunnableC0426b(str)).start();
    }
        ...
        try {
            try {
                try {
                    ...
                    new h(context).a(str2, str5, str3, str4, "failed, exception " + illegalArgumentException2.getMessage());
                    ...
                    new h(context).a(str2, str5, str3, str4, "failed, exception " + malformedURLException2.getMessage());
                }
    ...
    public static String a(String str) {
        ...
        return TextUtils.isEmpty(str) ? str : str.replace("/*OMSDK_INSERT_HERE*/", MBridgeConstans.OMID_JS_H5_CONTENT).replace("[INSERT RESOURCE URL]", f31897a);
    }
}
