...
public class ComponentFrameLayout extends FrameLayout implements com.mbridge.msdk.config.dynamic.baseview.inter.a {
    ...
    public void setViewClickListener() {
        setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.config.dynamic.baseview.b
