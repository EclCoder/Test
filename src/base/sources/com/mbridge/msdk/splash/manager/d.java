...
public class d {
    ...
    private static int f32645a = 1;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static com.mbridge.msdk.foundation.db.e f32646b = com.mbridge.msdk.foundation.db.e.a(com.mbridge.msdk.foundation.db.g.a(com.mbridge.msdk.foundation.controller.c.n().d()));

    /* JADX INFO: compiled from: r8-map-id-1868b3f846f91b929d17a1f0de6da199bc8101b6e9bb94a36f131322636ef84b */
    class a implements com.mbridge.msdk.videocommon.listener.a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ MBSplashView f32647a;

        a(MBSplashView mBSplashView) {
            this.f32647a = mBSplashView;
        }

        @Override // com.mbridge.msdk.videocommon.listener.a
        public void a(String str) {
            this.f32647a.setVideoReady(true);
        }

        @Override // com.mbridge.msdk.videocommon.listener.a
        public void a(String str, String str2) {
            this.f32647a.setVideoReady(false);
        }
    }
    ...
    class b implements com.mbridge.msdk.foundation.same.image.c {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.mbridge.msdk.splash.view.nativeview.a f32648a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ MBSplashView f32649b;

        b(com.mbridge.msdk.splash.view.nativeview.a aVar, MBSplashView mBSplashView) {
            this.f32648a = aVar;
            this.f32649b = mBSplashView;
        }

        @Override // com.mbridge.msdk.foundation.same.image.c
        public void onFailedLoad(String str, String str2) {
            com.mbridge.msdk.splash.view.nativeview.a aVar = this.f32648a;
            if (aVar != null) {
                aVar.b();
            }
            MBSplashView mBSplashView = this.f32649b;
    ...
    public static CampaignEx a(MBSplashView mBSplashView, String str, String str2, String str3, boolean z10, int i10, boolean z11, boolean z12) {
        if (f32646b == null) {
            f32646b = com.mbridge.msdk.foundation.db.e.a(com.mbridge.msdk.foundation.db.g.a(com.mbridge.msdk.foundation.controller.c.n().d()));
        }
        ...
        a(jC0, str2);
        List<CampaignEx> listA = f32646b.a(str2, 0, 0, f32645a, !TextUtils.isEmpty(str3));
