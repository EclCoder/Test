...
public class a {
    ...
    private static final String f32594a = "a";
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                if (jSONObjectOptJSONObject != null) {
                    String string = jSONObjectOptJSONObject.getString(com.mbridge.msdk.foundation.same.a.f30486h);
                    String string2 = jSONObjectOptJSONObject.getString(com.mbridge.msdk.foundation.same.a.f30487i);
                ...
                if (jSONObjectOptJSONObject != null) {
                    ...
                    while (itKeys2.hasNext()) {
                        ...
                        if (com.mbridge.msdk.foundation.same.a.f30486h.equals(next2) || com.mbridge.msdk.foundation.same.a.f30487i.equals(next2)) {
    ...
    public static String a(int i10, float f10, float f11) {
        ...
        try {
            ...
            if (i10 == 4) {
                jSONObject2.put(com.mbridge.msdk.foundation.same.a.f30486h, -999);
                jSONObject2.put(com.mbridge.msdk.foundation.same.a.f30487i, -999);
            } else {
                jSONObject2.put(com.mbridge.msdk.foundation.same.a.f30486h, v0.b(c.n().d(), f10));
                jSONObject2.put(com.mbridge.msdk.foundation.same.a.f30487i, v0.b(c.n().d(), f11));
            }
            jSONObject2.put(com.mbridge.msdk.foundation.same.a.f30491m, i10);
            jSONObject2.put(com.mbridge.msdk.foundation.same.a.f30489k, c.n().d().getResources().getConfiguration().orientation);
            jSONObject2.put(com.mbridge.msdk.foundation.same.a.f30490l, v0.d(c.n().d()));
