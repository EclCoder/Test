...
public class d {
    ...
    private MBSplashShowListener f32751a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private CampaignEx f32752b;
    ...
    public d(c cVar, MBSplashShowListener mBSplashShowListener, CampaignEx campaignEx) {
        this.f32753c = cVar;
        this.f32751a = mBSplashShowListener;
        this.f32752b = campaignEx;
    }
    ...
    public void a(MBridgeIds mBridgeIds, String str) {
        ...
        j.a(com.mbridge.msdk.foundation.controller.c.n().d(), this.f32752b, mBridgeIds.getUnitId(), str);
        MBSplashShowListener mBSplashShowListener = this.f32751a;
    ...
    public void b(MBridgeIds mBridgeIds) {
        ...
        try {
            jSONObject.put("load_to", this.f32753c.e());
            jSONObject.put("allow_skip", this.f32753c.f() ? 1 : 0);
            jSONObject.put("countdown", this.f32753c.d());
        } catch (JSONException e10) {
            q0.b("SplashShowListenerImpl", "e:" + e10.getMessage());
        }
        j.b(com.mbridge.msdk.foundation.controller.c.n().d(), this.f32752b, mBridgeIds.getUnitId(), jSONObject.toString());
        MBSplashShowListener mBSplashShowListener = this.f32751a;
        if (mBSplashShowListener != null) {
    ...
    public void a(MBridgeIds mBridgeIds, int i10) {
        ...
        if (i10 == 6 || i10 == 4 || i10 == 5) {
            com.mbridge.msdk.splash.report.a.a(this.f32752b, mBridgeIds.getUnitId(), i10);
        }
    }
    ...
    public void a(MBridgeIds mBridgeIds, int i10, int i11, int i12) {
        ...
        com.mbridge.msdk.splash.report.a.a(this.f32752b, mBridgeIds.getUnitId(), i10, i11, i12);
    }
}
