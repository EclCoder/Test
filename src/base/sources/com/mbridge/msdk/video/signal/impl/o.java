...
public class o extends p {
    ...
    public void a(String str) {
        super.a(str);
        try {
            if (this.f35061a == null || TextUtils.isEmpty(str)) {
                return;
            }
            if (str.equals("landscape")) {
                this.f35061a.setRequestedOrientation(0);
            } else if (str.equals("portrait")) {
                this.f35061a.setRequestedOrientation(1);
            }
        } catch (Throwable th2) {
            th2.printStackTrace();
        }
    ...
    public String b() {
        if (this.f35062b == null) {
            ...
            try {
                ...
                arrayList.add(this.f35062b.getCampaign());
                String unitID = this.f35062b.getUnitID();
                com.mbridge.msdk.videocommon.setting.c cVarB = b(unitID);
                JSONObject jSONObject = new JSONObject();
                if (cVarB != null) {
                    jSONObject = cVarB.H();
                }
                q0.a("JSRewardVideoV1", "getEndScreenInfo success campaign = " + this.f35062b.getCampaign());
                return a(arrayList, unitID, "MAL_17.1.31,3.0.1", jSONObject);
            } catch (Throwable th2) {
                th2.printStackTrace();
            }
        }
    ...
    public void handlerPlayableException(String str) {
        ...
        try {
            if (this.f35061a == null || TextUtils.isEmpty(str) || (mBridgeContainerView = this.f35062b) == null) {
                return;
            }
    ...
    public void notifyCloseBtn(int i10) {
        ...
        MBridgeContainerView mBridgeContainerView = this.f35062b;
    ...
    public void triggerCloseBtn(String str) {
        ...
        try {
            if (this.f35061a == null || TextUtils.isEmpty(str) || !str.equals(CampaignEx.JSON_NATIVE_VIDEO_CLICK) || (mBridgeContainerView = this.f35062b) == null) {
                return;
            }
        ...
        try {
            ...
            if (com.mbridge.msdk.setting.h.b() != null) {
                ...
                if (!TextUtils.isEmpty(strG)) {
                    ...
                    a(jSONObject3, str);
                    String strE = com.mbridge.msdk.setting.h.b().e(str);
