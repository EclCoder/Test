...
public class BaseRewardSignalH5 extends a {
    ...
    public void getEndScreenInfo(Object obj, String str) {
        ...
        try {
            IJSFactory iJSFactory = this.f34707a;
            if (iJSFactory != null) {
    ...
    public void handlerPlayableException(Object obj, String str) {
        try {
            if (this.f34707a == null || TextUtils.isEmpty(str)) {
                return;
            }
            ...
            this.f34707a.getIJSRewardVideoV1().handlerPlayableException(strOptString);
        } catch (Throwable th2) {
    ...
    public void initialize(Context context, WindVaneWebView windVaneWebView) {
        if (context instanceof IJSFactory) {
            this.f34707a = (IJSFactory) context;
        }
    }
    ...
    public void install(Object obj, String str) {
        try {
            if (this.f34707a != null) {
                ...
                if (this.f34707a.getJSContainerModule().endCardShowing()) {
                    this.f34707a.getJSCommon().click(3, str);
                } else {
                    this.f34707a.getJSCommon().click(1, str);
                }
            }
        } catch (Throwable th2) {
    ...
    public void notifyCloseBtn(Object obj, String str) {
        try {
            ...
            this.f34707a.getIJSRewardVideoV1().notifyCloseBtn(iOptInt);
        } catch (Throwable th2) {
    ...
    public void setOrientation(Object obj, String str) {
        try {
            ...
            this.f34707a.getIJSRewardVideoV1().a(strOptString);
        } catch (Throwable th2) {
            q0.b("JS-Reward-Communication", "setOrientation", th2);
        }
    }
    ...
    public void toggleCloseBtn(Object obj, String str) {
        try {
            ...
            this.f34707a.getIJSRewardVideoV1().toggleCloseBtn(iOptInt);
        } catch (Throwable th2) {
    ...
    public void triggerCloseBtn(Object obj, String str) {
        try {
            ...
            f.a().b(obj, a(0));
            this.f34707a.getIJSRewardVideoV1().triggerCloseBtn(new JSONObject(str).optString("state"));
