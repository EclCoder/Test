...
public class BaseVideoCommunication extends AbsFeedBackForH5 implements IVideoCommunication {
    ...
    protected IJSFactory f34708g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private FastKV f34709h = null;
    ...
    public void clearAllCache(Object obj, String str) {
        if (com.mbridge.msdk.foundation.controller.d.a().e() && this.f34709h == null) {
            try {
                this.f34709h = new FastKV.Builder(e.b(com.mbridge.msdk.foundation.same.directory.c.MBRIDGE_700_CONFIG), "MBridgeH5CacheSP").build();
            } catch (Exception unused) {
                this.f34709h = null;
            }
        }
        FastKV fastKV = this.f34709h;
        if (fastKV != null) {
            try {
                try {
                    fastKV.clear();
    ...
    public void click(Object obj, String str) {
        ...
        try {
            ...
            IJSFactory iJSFactory = this.f34708g;
            if (iJSFactory != null) {
            ...
            if (obj != null) {
                ...
                if (!(aVar.f31700b.getObject() instanceof k) || (kVar = (k) aVar.f31700b.getObject()) == null) {
                    return;
                }
    ...
    public void closeVideoOperte(Object obj, String str) {
        try {
            if (this.f34708g == null || TextUtils.isEmpty(str)) {
                return;
            }
            JSONObject jSONObject = new JSONObject(str);
            ...
            this.f34708g.getJSVideoModule().closeVideoOperate(iOptInt, iOptInt2);
            f.a().b(obj, a(0));
        } catch (Throwable th2) {
    ...
    public void closeWeb(Object obj, String str) {
        ...
        try {
            if (TextUtils.isEmpty(str) || this.f34708g == null || TextUtils.isEmpty(str)) {
                return;
            }
            int iOptInt = new JSONObject(str).optInt(NotificationCompat.CATEGORY_STATUS);
            this.f34708g.getJSContainerModule().hideAlertWebview();
            this.f34708g.getJSVideoModule().hideAlertView(iOptInt);
        } catch (Throwable th2) {
    ...
    public void getAllCache(Object obj, String str) {
        ...
        try {
            ...
            jSONObject4.put(PglCryptUtils.KEY_MESSAGE, str2);
            if (jSONObject2 != null) {
                jSONObject4.put(DataSchemeDataSource.SCHEME_DATA, jSONObject2);
            } else {
                jSONObject4.put(DataSchemeDataSource.SCHEME_DATA, "{}");
            }
            if (obj != null) {
    ...
    public void getAppSetting(Object obj, String str) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(strOptString)) {
                ...
                String strG = h.b().g(strOptString);
    ...
    public void getCutout(Object obj, String str) {
        try {
            String strE = this.f34708g.getJSCommon().e();
        ...
        try {
            ...
            if (this.f34708g != null) {
                while (i10 < jSONArray.length()) {
                    ...
                    jSONObject.put(b(i11), this.f34708g.getJSCommon().f(i11));
                    i10++;
                }
            } else if (obj != null) {
                while (i10 < jSONArray.length()) {
                    ...
                    if (aVar.f31700b.getObject() instanceof k) {
                        jSONObject.put(b(i12), ((k) aVar.f31700b.getObject()).f(i12));
                    }
                    i10++;
                }
            }
    ...
    public void handlerH5Exception(Object obj, String str) {
        try {
            ...
            this.f34708g.getJSCommon().handlerH5Exception(jSONObject.optInt("code", -999), jSONObject.optString(PglCryptUtils.KEY_MESSAGE, "h5 error"));
        } catch (Throwable th2) {
    ...
    public void init(Object obj, String str) {
        ...
        try {
            ...
            if (iJSFactory != null) {
                ...
                f.a().b(obj, strC);
                this.f34708g.getJSCommon().b(true);
                if (TextUtils.isEmpty(str)) {
                    return;
                }
                JSONObject jSONObject = new JSONObject(str);
                ...
                this.f34708g.getJSCommon().a(iOptInt == 1);
                this.f34708g.getJSCommon().e(iOptInt2);
                this.f34708g.getJSCommon().b(iOptInt3);
                this.f34708g.getJSCommon().c(iOptInt4);
                this.f34708g.getJSCommon().setWebViewFront(iOptInt5);
                com.mbridge.msdk.video.signal.d jSCommon = this.f34708g.getJSCommon();
                if (iOptInt6 != 0) {
                    i10 = iOptInt6;
                }
                jSCommon.d(i10);
            ...
            if (obj != null) {
                com.mbridge.msdk.mbsignalcommon.windvane.a aVar = (com.mbridge.msdk.mbsignalcommon.windvane.a) obj;
                if (aVar.f31700b.getObject() instanceof k) {
                    k kVar = (k) aVar.f31700b.getObject();
                    String strC2 = kVar.c();
                    if (!TextUtils.isEmpty(str)) {
    ...
    public void isSystemResume(Object obj, String str) {
        try {
            if (this.f34708g != null) {
                ...
                f.a().b(obj, a(this.f34708g.getActivityProxy().a()));
            }
        } catch (Throwable th2) {
    ...
    public void ivRewardAdsWithoutVideo(Object obj, String str) {
        ...
        try {
            ...
            this.f34708g.getJSContainerModule().ivRewardAdsWithoutVideo(str);
        } catch (Throwable th2) {
    ...
    public void notifyCloseBtn(Object obj, String str) {
        try {
            ...
            this.f34708g.getJSVideoModule().notifyCloseBtn(iOptInt);
        } catch (Throwable th2) {
    ...
    public void playVideoFinishOperate(Object obj, String str) {
        try {
            ...
            this.f34708g.getJSCommon().a(iOptInt);
        } catch (Throwable th2) {
    ...
    public void progressBarOperate(Object obj, String str) {
        try {
            ...
            this.f34708g.getJSVideoModule().progressBarOperate(new JSONObject(str).optInt("view_visible"));
            f.a().b(obj, a(0));
        } catch (Throwable th2) {
    ...
    public void progressOperate(Object obj, String str) {
        try {
            ...
            this.f34708g.getJSVideoModule().progressOperate(iOptInt, iOptInt2);
            f.a().b(obj, a(0));
        } catch (Throwable th2) {
            q0.b("JS-Video-Brigde", "progressOperate error", th2);
        }
    ...
    public void reactDeveloper(Object obj, String str) {
        ...
        try {
            if (this.f34708g == null || TextUtils.isEmpty(str)) {
                ...
                this.f34708g.getJSBTModule().reactDeveloper(obj, str);
            }
        } catch (Throwable th2) {
    ...
    public void readyStatus(Object obj, String str) {
        if (obj != null) {
            try {
                ...
                int iOptInt = new JSONObject(str).optInt("isReady", 1);
                if (aVar.f31700b.getObject() instanceof k) {
                    ((k) aVar.f31700b.getObject()).h(iOptInt);
                }
    ...
    public void reportUrls(Object obj, String str) {
        ...
        try {
            ...
            if (iJSFactory == null || iJSFactory.getJSBTModule() == null) {
                d.c().c(obj, str);
            } else if (this.f34708g.getJSBTModule() instanceof j) {
                this.f34708g.getJSBTModule().reportUrls(obj, str);
            } else {
                d.c().c(obj, str);
            }
        } catch (Throwable th2) {
            ...
            try {
                if (TextUtils.isEmpty(str)) {
                    ...
                    if (!TextUtils.isEmpty(string) && !TextUtils.isEmpty(string2)) {
                        try {
                            this.f34709h.putString(string, string2);
                        } catch (Exception unused2) {
                        }
                    }
                    i10 = 1;
    ...
    public void showAlertView(Object obj, String str) {
        ...
        try {
            ...
            this.f34708g.getJSVideoModule().showIVRewardAlertView(str);
    ...
    public void showVideoClickView(Object obj, String str) {
        try {
            ...
            this.f34708g.getJSContainerModule().showVideoClickView(iOptInt);
        } catch (Throwable th2) {
    ...
    public void showVideoLocation(Object obj, String str) {
        try {
            ...
            this.f34708g.getJSVideoModule().showVideoLocation(iOptInt, iOptInt2, iOptInt3, iOptInt4, iOptInt5, iOptInt6, iOptInt7, iOptInt8, iOptInt9);
            this.f34708g.getJSCommon().h();
        } catch (Throwable th2) {
    ...
    public void soundOperate(Object obj, String str) {
        try {
            ...
            if (TextUtils.isEmpty(strOptString)) {
                this.f34708g.getJSVideoModule().soundOperate(iOptInt, iOptInt2);
            } else {
                this.f34708g.getJSVideoModule().soundOperate(iOptInt, iOptInt2, strOptString);
            }
            f.a().b(obj, a(0));
        } catch (Throwable th2) {
    ...
    public void statistics(Object obj, String str) {
        ...
        try {
            ...
            JSONObject jSONObject = new JSONObject(str);
            this.f34708g.getJSCommon().a(jSONObject.optInt("type"), jSONObject.optString(DataSchemeDataSource.SCHEME_DATA));
        } catch (Throwable th2) {
    ...
    public void toggleCloseBtn(Object obj, String str) {
        try {
            ...
            this.f34708g.getJSVideoModule().closeVideoOperate(0, i10);
        } catch (Throwable th2) {
    ...
    public void triggerCloseBtn(Object obj, String str) {
        ...
        try {
            if (this.f34708g == null || TextUtils.isEmpty(str) || !new JSONObject(str).optString("state").equals(CampaignEx.JSON_NATIVE_VIDEO_CLICK)) {
                return;
            }
            this.f34708g.getJSVideoModule().closeVideoOperate(1, -1);
            f.a().b(obj, a(0));
        } catch (Throwable th2) {
    ...
    public void videoOperate(Object obj, String str) {
        try {
            ...
            this.f34708g.getJSVideoModule().videoOperate(iOptInt);
            f.a().b(obj, a(0));
        } catch (Throwable th2) {
    ...
    public void getRewardUnitSetting(Object obj, String str) {
        try {
            ...
            String str2 = obFGmWgqyy.CnRdGAEDpcKwT;
            if (zIsEmpty || TextUtils.isEmpty(strOptString2)) {
                ...
                if (obj == null || jSONObjectH == null) {
                    ...
                    jSONObject2.put(PglCryptUtils.KEY_MESSAGE, InitializationStatus.SUCCESS);
                    jSONObject2.put(DataSchemeDataSource.SCHEME_DATA, jSONObjectH);
                }
            }
            f.a().b(obj, Base64.encodeToString(jSONObject2.toString().getBytes(), 2));
        } catch (Throwable th2) {
    ...
    public void loadads(Object obj, String str) {
        ...
        try {
            if (TextUtils.isEmpty(str)) {
                ...
                String strOptString2 = jSONObject.optString("unitId");
                int iOptInt2 = jSONObject.optInt(lkCBSIFlvmyGX.tWvUoPZTYoJXl, 1);
                if (iOptInt2 > 2) {
                    iOptInt2 = 1;
                }
                str2 = strOptString;
                iOptInt = jSONObject.optInt(mDXVAtwcaFMHJ.uSNP, 1);
                str3 = strOptString2;
                i10 = iOptInt2;
            }
    ...
    public void setScaleFitXY(Object obj, String str) {
        String str2 = IAoPeRfJn.tAETiEVfBQVn;
        try {
            if (this.f34708g == null || TextUtils.isEmpty(str)) {
                return;
            }
            int iOptInt = new JSONObject(str).optInt("fitxy");
            q0.c(str2, "setScaleFitXY,type:" + iOptInt);
            this.f34708g.getJSVideoModule().setScaleFitXY(iOptInt);
        } catch (Throwable th2) {
            q0.b(str2, "showVideoClickView error", th2);
        }
    }
    ...
    public void insertViewAbove(Object obj, String str) {
        ...
        try {
            ...
            q0.b("JS-Video-Brigde", UHbHibBvYxKnPE.ECgYzEdHdOSFitn + th2);
        }
    }
