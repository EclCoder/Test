...
public class MBridgeBTContainer extends AbstractJSContainer implements com.mbridge.msdk.video.signal.c {
    ...
    private FrameLayout f34077t;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    private MBridgeBTLayout f34078u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    private WindVaneWebView f34079v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    private LayoutInflater f34080w;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    private Context f34081x;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    private TextView f34082y;

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    private ImageView f34083z;
    ...
    class c implements com.mbridge.msdk.video.bt.module.listener.b {
        ...
        public void a(String str) {
            if (MBridgeBTContainer.this.f34079v != null) {
                JSONObject jSONObject = new JSONObject();
                try {
                    jSONObject.put("id", str);
                    JSONObject jSONObject2 = new JSONObject();
                    jSONObject2.put(MBridgeConstans.PLACEMENT_ID, ((AbstractJSContainer) MBridgeBTContainer.this).f34991e);
                    jSONObject2.put("unitId", ((AbstractJSContainer) MBridgeBTContainer.this).f34990d);
                    jSONObject.put(DataSchemeDataSource.SCHEME_DATA, jSONObject2);
                    q0.a(MBridgeBTContainer.V, " BT Call H5 onAdShow " + jSONObject.toString());
                } catch (JSONException e10) {
                    q0.a(MBridgeBTContainer.V, e10.getMessage());
                }
                com.mbridge.msdk.mbsignalcommon.windvane.f.a().a((WebView) MBridgeBTContainer.this.f34079v, "onSubPlayTemplateViewPlayStart", Base64.encodeToString(jSONObject.toString().getBytes(), 2));
            }
        }
        ...
        public void c(String str, String str2, String str3) {
            if (MBridgeBTContainer.this.f34079v != null) {
                ...
                com.mbridge.msdk.mbsignalcommon.windvane.f.a().a((WebView) MBridgeBTContainer.this.f34079v, "onSubPlayTemplateViewEndcardShowSuccess", Base64.encodeToString(jSONObject.toString().getBytes(), 2));
            }
        }
        ...
        public void b(String str, String str2, String str3) {
            if (MBridgeBTContainer.this.f34079v != null) {
                JSONObject jSONObject = new JSONObject();
                try {
                    jSONObject.put(UHbHibBvYxKnPE.hrDzApeqx, str);
                    JSONObject jSONObject2 = new JSONObject();
                    jSONObject2.put(MBridgeConstans.PLACEMENT_ID, str2);
                    jSONObject2.put("unitId", str3);
                    jSONObject.put(DataSchemeDataSource.SCHEME_DATA, jSONObject2);
                ...
                com.mbridge.msdk.mbsignalcommon.windvane.f.a().a((WebView) MBridgeBTContainer.this.f34079v, "onSubPlayTemplateViewClicked", Base64.encodeToString(jSONObject.toString().getBytes(), 2));
            }
        }
        ...
        public void a(String str, boolean z10, com.mbridge.msdk.videocommon.entity.c cVar) {
            if (MBridgeBTContainer.this.f34079v != null) {
                ...
                com.mbridge.msdk.mbsignalcommon.windvane.f.a().a((WebView) MBridgeBTContainer.this.f34079v, "onSubPlayTemplateViewCloseBtnClicked", Base64.encodeToString(jSONObject.toString().getBytes(), 2));
                com.mbridge.msdk.mbsignalcommon.windvane.f.a().a((WebView) MBridgeBTContainer.this.f34079v, "onSubPlayTemplateViewDismissed", Base64.encodeToString(jSONObject.toString().getBytes(), 2));
            }
        }
        ...
        public void a(String str, String str2) {
            if (MBridgeBTContainer.this.f34079v != null) {
                ...
                com.mbridge.msdk.mbsignalcommon.windvane.f.a().a((WebView) MBridgeBTContainer.this.f34079v, "onSubPlayTemplateViewPlayFailed", Base64.encodeToString(jSONObject.toString().getBytes(), 2));
            }
        }
        ...
        public void a(String str, String str2, String str3) {
            if (MBridgeBTContainer.this.f34079v != null) {
                ...
                com.mbridge.msdk.mbsignalcommon.windvane.f.a().a((WebView) MBridgeBTContainer.this.f34079v, "onSubPlayTemplateViewPlayCompleted", Base64.encodeToString(jSONObject.toString().getBytes(), 2));
            }
        }
    ...
    private static final class e implements Runnable {
        ...
        private List<CampaignEx> f34088a;
        ...
        public void run() {
            List<CampaignEx> list = this.f34088a;
            if (list == null || list.size() <= 0) {
                return;
            }
            try {
                com.mbridge.msdk.foundation.db.e.a(g.a(this.f34089b)).a(this.f34090c, this.f34088a);
                com.mbridge.msdk.videocommon.cache.a.a().b(this.f34091d, this.f34088a.get(0).getAdType());
    ...
    /* JADX INFO: compiled from: r8-map-id-1868b3f846f91b929d17a1f0de6da199bc8101b6e9bb94a36f131322636ef84b */
    private class f extends com.mbridge.msdk.video.signal.impl.a.C0479a {
        private f() {
        }
        ...
        public void a(boolean z10) {
            ...
            MBridgeBTContainer.this.I.a(z10, ((AbstractJSContainer) MBridgeBTContainer.this).f34991e, ((AbstractJSContainer) MBridgeBTContainer.this).f34990d);
        }

        @Override // com.mbridge.msdk.video.signal.impl.a.C0479a, com.mbridge.msdk.out.BaseTrackingListener
        public void onFinishRedirection(Campaign campaign, String str) {
            super.onFinishRedirection(campaign, str);
            u0.a(campaign, MBridgeBTContainer.this.f34077t);
            ...
            try {
                ...
                if (campaignEx.getLinkType() == 3 && campaignEx.getEndcard_click_result() == 2 && strOptString.equals("1.0") && ((AbstractJSContainer) MBridgeBTContainer.this).f34989c != null) {
                    if (MBridgeBTContainer.this.B) {
                        MBridgeBTContainer.this.onAdClose();
                    } else {
                        ((AbstractJSContainer) MBridgeBTContainer.this).f34989c.finish();
                    }
                }
            } catch (JSONException e10) {
                e10.printStackTrace();
        ...
        public void onStartRedirection(Campaign campaign, String str) {
            ...
            u0.b(campaign, MBridgeBTContainer.this.f34077t);
        }
    ...
    public void appendSubView(MBridgeBTContainer mBridgeBTContainer, MBTempContainer mBTempContainer, JSONObject jSONObject) {
        try {
            ...
            mBTempContainer.setActivity(this.f34989c);
            mBTempContainer.setMute(this.f34996j);
            mBTempContainer.setBidCampaign(this.A);
            mBTempContainer.setIV(this.f34997k);
            mBTempContainer.setBigOffer(this.B);
            mBTempContainer.setIVRewardEnable(this.f34999m, this.f35000n, this.f35001o);
            ...
            mBTempContainer.init(this.f34081x);
    ...
    public void broadcast(String str, JSONObject jSONObject) {
        if (this.f34079v != null) {
            try {
                JSONObject jSONObject2 = new JSONObject();
                jSONObject2.put("code", this.f34075r);
                jSONObject2.put("id", this.C);
                jSONObject2.put("eventName", str);
                jSONObject2.put(DataSchemeDataSource.SCHEME_DATA, jSONObject);
                com.mbridge.msdk.mbsignalcommon.windvane.f.a().a((WebView) this.f34079v, "broadcast", Base64.encodeToString(jSONObject2.toString().getBytes(), 2));
            } catch (Exception unused) {
                com.mbridge.msdk.video.bt.component.d.c().a((WebView) this.f34079v, "broadcast", this.C);
            }
        }
    }
    ...
    public void init(Context context) {
        this.f34081x = context;
        this.f34080w = LayoutInflater.from(context);
    }
    ...
    public void onBackPressed() {
        try {
            LinkedHashMap<String, View> linkedHashMapB = com.mbridge.msdk.video.bt.component.d.c().b(this.f34990d, this.L);
    ...
    public void onCreate(boolean z10) {
        ...
        try {
            ...
            FrameLayout frameLayout = (FrameLayout) this.f34080w.inflate(iFindLayout, this);
            this.f34077t = frameLayout;
            if (frameLayout == null) {
                b("ViewIds null");
                return;
            }
            ...
            this.f34079v = c(this.f34990d + "_" + this.L + "_" + cMPTEntryUrl);
            com.mbridge.msdk.videocommon.a.e(this.f34990d + "_" + this.L + "_" + cMPTEntryUrl);
            l();
            WindVaneWebView windVaneWebView = this.f34079v;
            ...
            com.mbridge.msdk.video.signal.factory.b bVar = new com.mbridge.msdk.video.signal.factory.b(this.f34989c, this, windVaneWebView);
            registerJsFactory(bVar);
            this.f34079v.setApiManagerJSFactory(bVar);
            if (this.f34079v.getParent() != null) {
                b("preload template webview is null or load error");
                return;
            }
            RelativeLayout.LayoutParams layoutParams = null;
            if (this.f34079v.getObject() instanceof k) {
                bVar.a((k) this.f34079v.getObject());
                if (this.f34079v != null) {
                    JSONObject jSONObject = new JSONObject();
                ...
                ((com.mbridge.msdk.video.signal.impl.d) getJSCommon()).f35032m.onInitSuccess();
            }
            this.f34079v.setBackgroundColor(0);
            LinkedHashMap<String, View> linkedHashMapB = com.mbridge.msdk.video.bt.component.d.c().b(this.f34990d, this.L);
            ...
            if (view instanceof MBridgeBTLayout) {
                ...
                com.mbridge.msdk.foundation.feedback.b.b().a(this.f34990d + "_1", new a());
                this.f34078u.addView(this.f34079v, 0, new FrameLayout.LayoutParams(-1, -1));
                com.mbridge.msdk.foundation.feedback.b.b().d(this.f34990d + "_2");
                FeedBackButton feedBackButtonA = com.mbridge.msdk.foundation.feedback.b.b().a(this.f34990d + "_1");
                if (com.mbridge.msdk.foundation.feedback.b.b().a() && feedBackButtonA != null) {
                    ...
                    this.f34078u.addView(feedBackButtonA);
                }
                this.f34078u.setTag(this.C);
                linkedHashMapB.put(this.C, this.f34078u);
                for (View view2 : linkedHashMapB.values()) {
                    if (view2 instanceof MBridgeBTRootLayout) {
                        ...
                        this.f34077t.addView(mBridgeBTRootLayout, new FrameLayout.LayoutParams(-1, -1));
                        break;
                    }
                }
            ...
            com.mbridge.msdk.video.bt.component.d.c().a(this.f34990d, this.f34996j);
            com.mbridge.msdk.video.bt.component.d.c().d(this.C, this.L);
            com.mbridge.msdk.video.bt.component.d.c().d(this.K, this.L);
            com.mbridge.msdk.video.bt.component.d.c().a(this.f34990d + "_" + this.L, this.f34989c);
            try {
                com.mbridge.msdk.foundation.same.threadpool.a.b().execute(new e(this.E, getContext().getApplicationContext(), this.f34990d, this.f34991e));
    ...
    public void onDestroy() {
        ...
        super.onDestroy();
        com.mbridge.msdk.video.bt.component.d.c().h(this.f34990d + "_" + this.L);
        try {
            WindVaneWebView windVaneWebView = this.f34079v;
            if (windVaneWebView != null) {
                ...
                this.f34079v.clearWebView();
                this.f34079v.release();
            }
            if (this.J != null) {
                this.J = null;
            }
            ...
            if (list != null && list.size() > 0) {
                for (CampaignEx campaignEx : this.E) {
                    if (campaignEx != null && campaignEx.getRewardTemplateMode() != null) {
                        com.mbridge.msdk.videocommon.a.e(this.f34990d + "_" + campaignEx.getRequestId() + "_" + campaignEx.getRewardTemplateMode().j());
                    }
                }
                com.mbridge.msdk.video.dynview.energize.a.a().d();
            }
            com.mbridge.msdk.video.bt.component.d.c().a(this.C);
            com.mbridge.msdk.video.bt.component.d.c().b(this.f34990d);
            com.mbridge.msdk.video.bt.component.d.c().b(this.f34990d, this.L).remove(this.C);
            com.mbridge.msdk.video.bt.component.d.c().b(this.f34990d, this.L).remove(this.K);
            com.mbridge.msdk.video.bt.component.d.c().b(this.f34990d, this.L).clear();
        } catch (Throwable th2) {
            q0.a(V, th2.getMessage());
        }
    }
                ...
                case 6:
                    ...
                    if (!this.f34997k && z10) {
                        if (campaignWithBackData != null) {
                            com.mbridge.msdk.video.module.report.b.a(campaignWithBackData, cVarA, strOptString, this.f34993g, this.P);
                        } else {
                            com.mbridge.msdk.video.module.report.b.a(campaignEx, cVarA, strOptString, this.f34993g, this.P);
                        }
                    }
    ...
    public void setNotchPadding(int i10, int i11, int i12, int i13, int i14) {
        ...
        try {
            ...
            if (windVaneWebView != null && (windVaneWebView.getObject() instanceof k) && !TextUtils.isEmpty(strA)) {
                ((k) this.f34079v.getObject()).a(strA);
                com.mbridge.msdk.mbsignalcommon.windvane.f.a().a((WebView) this.f34079v, "oncutoutfetched", Base64.encodeToString(strA.getBytes(), 0));
            }
            a(i11, i13, i12, i15);
        ...
        if (campaignEx != null) {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    com.mbridge.msdk.click.a.a(com.mbridge.msdk.foundation.controller.c.n().d(), campaignEx2, this.f34990d, it.next(), false, true);
    ...
    class a implements com.mbridge.msdk.foundation.feedback.a {
        ...
        public void a() {
            ...
            com.mbridge.msdk.mbsignalcommon.windvane.f.a().a((WebView) MBridgeBTContainer.this.f34079v, "onFeedbackAlertStatusNotify", Base64.encodeToString(string.getBytes(), 2));
        }
    ...
    private void a(int i10, int i11, int i12, int i13) {
        ...
        try {
            if (this.E.get(0).isDynamicView() && (textView = this.f34082y) != null && (layoutParams = (FrameLayout.LayoutParams) textView.getLayoutParams()) != null) {
                if (i10 > 0) {
                ...
                this.f34082y.setLayoutParams(layoutParams);
                if (this.f34083z != null) {
                    try {
                        FrameLayout.LayoutParams layoutParams2 = new FrameLayout.LayoutParams(this.f34083z.getLayoutParams());
                        layoutParams2.leftMargin = layoutParams.rightMargin;
                        layoutParams2.topMargin = layoutParams.topMargin;
                        this.f34083z.setLayoutParams(layoutParams2);
                    } catch (Exception e10) {
                        e10.printStackTrace();
                    }
                }
    ...
    class b implements com.mbridge.msdk.video.dynview.listener.h {
        ...
        public void a(com.mbridge.msdk.video.dynview.a aVar) {
            ...
            String str;
            if (aVar != null) {
                if (MBridgeBTContainer.this.f34077t == null || aVar.b() == null) {
                    MBridgeBTContainer.this.b("nativeview is null");
                    return;
                }
                MBridgeBTContainer.this.f34077t.removeAllViews();
                MBridgeBTContainer.this.f34077t.addView(aVar.b());
                MBridgeBTContainer mBridgeBTContainer = MBridgeBTContainer.this;
                mBridgeBTContainer.f34082y = (TextView) mBridgeBTContainer.findViewById(mBridgeBTContainer.findID("mbridge_choice_one_countdown_tv"));
                MBridgeBTContainer mBridgeBTContainer2 = MBridgeBTContainer.this;
                mBridgeBTContainer2.f34083z = (ImageView) mBridgeBTContainer2.findViewById(mBridgeBTContainer2.findID("mbridge_iv_link"));
                if (MBridgeBTContainer.this.G != null) {
                    MBridgeBTContainer.this.G.a();
                    MBridgeBTContainer.this.G.a(2, ((AbstractJSContainer) MBridgeBTContainer.this).f34991e, ((AbstractJSContainer) MBridgeBTContainer.this).f34990d);
                }
                ...
                com.mbridge.msdk.videocommon.setting.c cVarC = com.mbridge.msdk.videocommon.setting.b.b().c(com.mbridge.msdk.foundation.controller.c.n().b(), ((AbstractJSContainer) MBridgeBTContainer.this).f34990d);
                ...
                com.mbridge.msdk.click.a.a(com.mbridge.msdk.foundation.controller.c.n().d(), campaignEx, ((AbstractJSContainer) MBridgeBTContainer.this).f34990d, str, false, true, com.mbridge.msdk.click.retry.a.f28481n);
                com.mbridge.msdk.foundation.same.buffer.b.f30521l.put(campaignEx.getOnlyImpressionURL(), Long.valueOf(System.currentTimeMillis()));
