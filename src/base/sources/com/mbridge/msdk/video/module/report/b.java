...
public class b {
    ...
    public static HashMap<String, ArrayList<String>> f34705a = new HashMap<>();
    ...
    public static void a(Context context, CampaignEx campaignEx) {
        ...
        ArrayList<String> arrayList = f34705a.get(campaignUnitId);
        if (arrayList == null) {
            arrayList = new ArrayList<>();
            f34705a.put(campaignUnitId, arrayList);
        }
