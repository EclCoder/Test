...
public final class Ad {
    ...
    public final Pg getPubContent() {
        Pg pg2 = this._pubContent;
        if (pg2 != null) {
            return pg2;
        }
        Pg pgA = Qg.a(this.pubContent, this.markupType);
        this._pubContent = pgA;
        return pgA;
    }
