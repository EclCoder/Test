...
public final /* data */ class WatermarkData {
    ...
    public WatermarkData(String watermarkBase64EncodedString, float f10) {
        s.h(watermarkBase64EncodedString, "watermarkBase64EncodedString");
    ...
    public boolean equals(Object other) {
        ...
        return s.c(this.watermarkBase64EncodedString, watermarkData.watermarkBase64EncodedString) && Float.compare(this.alpha, watermarkData.alpha) == 0;
    }
