...
public abstract class u {
    ...
    public static boolean d(Type type, Type type2) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            return d(parameterizedType.getOwnerType(), parameterizedType2.getOwnerType()) && parameterizedType.getRawType().equals(parameterizedType2.getRawType()) && Arrays.equals(parameterizedType instanceof vj.c.b ? ((vj.c.b) parameterizedType).f55659c : parameterizedType.getActualTypeArguments(), parameterizedType2 instanceof vj.c.b ? ((vj.c.b) parameterizedType2).f55659c : parameterizedType2.getActualTypeArguments());
        }
        if (type instanceof GenericArrayType) {
    ...
    static Type f(Type type) {
        Class clsG = g(type);
        return vj.c.p(type, clsG, clsG.getGenericSuperclass());
    }
    ...
    static Type h(Type type, Class cls, Class cls2) {
        if (cls2.isAssignableFrom(cls)) {
            return vj.c.p(type, cls, vj.c.e(type, cls, cls2));
        }
    ...
    public static ParameterizedType j(Type type, Type... typeArr) {
        if (typeArr.length != 0) {
            return new vj.c.b(null, type, typeArr);
        }
        throw new IllegalArgumentException("Missing type arguments for " + type);
    }

    public static WildcardType k(Type type) {
        return new vj.c.C0842c(type instanceof WildcardType ? ((WildcardType) type).getUpperBounds() : new Type[]{type}, vj.c.f55652b);
    }

    public static WildcardType l(Type type) {
        return new vj.c.C0842c(new Type[]{Object.class}, type instanceof WildcardType ? ((WildcardType) type).getLowerBounds() : new Type[]{type});
    }
}
