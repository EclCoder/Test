...
class ImageViewAction extends Action<ImageView> {
    ...
    ImageViewAction(Picasso picasso, ImageView imageView, Request request, int i10, int i11, int i12, Drawable drawable, String str, Object obj, Callback callback, boolean z10) {
