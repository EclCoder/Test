...
final class MarkableInputStream extends InputStream {
    ...
    private final InputStream f35590in;
    private long limit;
    ...
    private void setLimit(long j10) {
        try {
            ...
            if (j11 >= j12 || j12 > this.limit) {
                this.reset = j12;
                this.f35590in.mark((int) (j10 - j12));
            } else {
                this.f35590in.reset();
                this.f35590in.mark((int) (j10 - this.reset));
    ...
    private void skip(long j10, long j11) throws IOException {
        while (j10 < j11) {
            long jSkip = this.f35590in.skip(j11 - j10);
            if (jSkip == 0) {
                if (read() == -1) {
                    return;
                } else {
    ...
    public int available() {
        return this.f35590in.available();
    }
    ...
    public boolean markSupported() {
        return this.f35590in.markSupported();
    }
    ...
    private MarkableInputStream(InputStream inputStream, int i10, int i11) {
        ...
        this.f35590in = inputStream.markSupported() ? inputStream : new BufferedInputStream(inputStream, i10);
    ...
    public long skip(long j10) throws IOException {
        ...
        long jSkip = this.f35590in.skip(j10);
        this.offset += jSkip;
        return jSkip;
    }
    ...
    public int read(byte[] bArr) throws IOException {
        ...
        int i10 = this.f35590in.read(bArr);
        if (i10 != -1) {
    ...
    public int read(byte[] bArr, int i10, int i11) throws IOException {
        ...
        int i12 = this.f35590in.read(bArr, i10, i11);
        if (i12 != -1) {
