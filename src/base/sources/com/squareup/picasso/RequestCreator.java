...
public class RequestCreator {
    ...
    RequestCreator(Picasso picasso, Uri uri, int i10) {
    ...
    private Request createRequest(long j10) {
        ...
        requestBuild.f35591id = andIncrement;
        ...
        if (requestTransformRequest != requestBuild) {
            requestTransformRequest.f35591id = andIncrement;
    ...
    public void into(ImageView imageView, Callback callback) {
        ...
        if (imageView != null) {
            ...
            if (MemoryPolicy.shouldReadFromMemoryCache(this.memoryPolicy) && (bitmapQuickMemoryCacheCheck = this.picasso.quickMemoryCacheCheck(strCreateKey)) != null) {
                ...
                if (this.picasso.loggingEnabled) {
                    Utils.log(jyeoXJ.UYQNHWKX, "completed", requestCreateRequest.plainId(), "from " + loadedFrom);
                }
                if (callback != null) {
                    callback.onSuccess();
                    return;
