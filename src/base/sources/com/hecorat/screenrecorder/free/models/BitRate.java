...
public final /* data */ class BitRate {
    ...
    public boolean equals(Object other) {
        ...
        return s.c(this.name, bitRate.name) && this.value == bitRate.value;
    }
    ...
    public String toString() {
        return "BitRate(name=" + this.name + ", value=" + this.value + ')';
    }
}
