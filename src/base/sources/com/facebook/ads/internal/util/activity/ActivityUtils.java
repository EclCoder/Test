...
import com.facebook.ads.redexgen.core.AbstractC1610Td;
import com.facebook.ads.redexgen.core.AbstractC1701Wt;
import com.facebook.ads.redexgen.core.C1611Te;
import com.facebook.ads.redexgen.core.C1648Up;
import com.facebook.ads.redexgen.core.C2194ge;
import com.facebook.ads.redexgen.core.C2198gi;
import com.facebook.ads.redexgen.core.InterfaceC1704Ww;
import com.facebook.ads.redexgen.core.RunnableC1703Wv;
...
public final class ActivityUtils implements Application.ActivityLifecycleCallbacks {
    ...
    public static final List<InterfaceC1704Ww> A06;
     ...
     */
    public static synchronized void A04(C2194ge c2194ge, Class<? extends Activity> cls) {
        A02 = c2194ge;
        A01 = c2194ge.getApplicationContext();
            ...
            if (aNActivityLifecycleCallbacksListener != null) {
                ...
                synchronized (activityStateMap) {
                    try {
                        ...
                        c2194ge.A08().ABC(A01(Sdk$SDKError.b.INVALID_BID_PAYLOAD_VALUE, 8, 61), AbstractC1610Td.A02, new C1611Te(A01(72, 80, 65)));
                    }
                }
                ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c2194ge);
            }
            ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
        } else {
            c2194ge.A08().ABC(A01(Sdk$SDKError.b.AD_RESPONSE_INVALID_TEMPLATE_TYPE_VALUE, 3, 3), AbstractC1610Td.A0d, new C1611Te(A01(42, 30, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE)));
        }
    }
    ...
    public static synchronized Activity A00() {
        ...
        if (z10) {
            activityA00 = AbstractC1701Wt.A00();
        }
        if (A02 != null && z10 && key != activityA00) {
            C1611Te c1611Te = new C1611Te(A01(19, 23, 76), A01(Sdk$SDKError.b.AD_IS_LOADING_VALUE, 5, 97) + key + A01(12, 7, 1) + activityA00);
            c1611Te.A05(1);
            A02.A08().ABC(A01(Sdk$SDKError.b.INVALID_BID_PAYLOAD_VALUE, 8, 61), AbstractC1610Td.A03, c1611Te);
        }
        return key != null ? key : activityA00;
    }

    public static void A03(C2198gi c2198gi) {
        if (!C1648Up.A1p(c2198gi) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        RunnableC1703Wv runnableC1703Wv = new RunnableC1703Wv(c2198gi);
        synchronized (A07) {
            A07.add(runnableC1703Wv);
        }
        Y4.A01.A01().postDelayed(runnableC1703Wv, 2000L);
    }

    @Override // android.app.Application.ActivityLifecycleCallbacks
    public final void onActivityCreated(Activity activity, Bundle bundle) {
        A08.put(activity, 1);
        Iterator<InterfaceC1704Ww> it = A06.iterator();
        ...
        if (zHasNext) {
            it.next();
            throw new NullPointerException(A01(Sdk$SDKError.b.MRAID_JS_COPY_FAILED_VALUE, 17, 82));
        }
    }
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        if (num == null || num.intValue() != 3) {
            C1611Te c1611Te = new C1611Te(A01(172, 31, 79), A01(152, 20, 101) + num + A01(0, 12, 105) + activity);
            c1611Te.A05(0);
            A02.A08().ABC(A01(Sdk$SDKError.b.INVALID_BID_PAYLOAD_VALUE, 8, 61), AbstractC1610Td.A03, c1611Te);
        }
        A08.put(activity, 4);
