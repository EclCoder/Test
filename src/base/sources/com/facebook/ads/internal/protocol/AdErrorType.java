...
public enum AdErrorType {
    UNKNOWN_ERROR(-1, A00(2564, 13, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE), false),
    NETWORK_ERROR(1000, A00(2090, 13, 38), true),
    NO_FILL(1001, A00(2103, 7, 67), true),
    LOAD_TOO_FREQUENTLY(1002, A00(261, 31, 33), true),
    DISABLED_APP(GeofenceStatusCodes.GEOFENCE_REQUEST_TOO_FREQUENT, A00(368, 39, 73), true),
    SERVER_ERROR(2000, A00(2209, 12, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE), true),
    INTERNAL_ERROR(2001, A00(1620, 14, 59), true),
    CACHE_FAILURE_ERROR(2002, A00(2124, 19, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE), true),
    START_BEFORE_INIT(2005, A00(2528, 36, 87), true),
    REMOTE_ADS_SERVICE_ERROR(2008, A00(343, 25, 103), true),
    INTERSTITIAL_AD_TIMEOUT(2009, A00(2221, 31, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE), true),
    RV_AD_TIMEOUT(2010, A00(2252, 33, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE), true),
    ...
    BID_IMPRESSION_MISMATCH(4001, A00(465, 36, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE), true),
    BID_PAYLOAD_ERROR(4002, A00(1673, 19, 99), false),
    NO_ADAPTER_ON_LOAD(5001, A00(292, 25, 62), false),
    NO_ADAPTER_ON_START(5002, A00(Sdk$SDKError.b.AD_CLOSED_TEMPLATE_ERROR_VALUE, 26, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE), false),
