...
import com.facebook.ads.redexgen.core.AbstractC1556Ra;
import com.facebook.ads.redexgen.core.C1558Rc;
import com.facebook.ads.redexgen.core.C1559Rd;
import com.facebook.ads.redexgen.core.C1560Re;
import com.facebook.ads.redexgen.core.C1561Rf;
import com.facebook.ads.redexgen.core.C1563Rh;
import com.facebook.ads.redexgen.core.C1569Rn;
import com.facebook.ads.redexgen.core.C1571Rp;
import com.facebook.ads.redexgen.core.C1573Rr;
import com.facebook.ads.redexgen.core.C1574Rs;
import com.facebook.ads.redexgen.core.C1581Rz;
import com.facebook.ads.redexgen.core.C1632Tz;
import com.facebook.ads.redexgen.core.C1660Vb;
import com.facebook.ads.redexgen.core.C1661Vc;
import com.facebook.ads.redexgen.core.C1662Vd;
import com.facebook.ads.redexgen.core.C1671Vn;
import com.facebook.ads.redexgen.core.C1682Vz;
import com.facebook.ads.redexgen.core.C2227hB;
import com.facebook.ads.redexgen.core.C2228hC;
import com.facebook.ads.redexgen.core.C2245hT;
import com.facebook.ads.redexgen.core.InterfaceC1659Va;
...
public class DynamicLoaderImpl implements DynamicLoader, RemoteRenderingApi {
    ...
    public static final InitApi A06 = new C1573Rr();
    ...
    public AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i10, AdOptionsView adOptionsView) {
        return new C2245hT(context, nativeAdBase, nativeAdLayout, orientation, i10, adOptionsView);
    }
    ...
    public AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
        return new C2245hT(context, nativeAdBase, nativeAdLayout, adOptionsView);
    }
    ...
    public AdSizeApi createAdSizeApi(int i10) {
        return new C1632Tz(this, XG.A02(i10));
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public AdViewApi createAdViewApi(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        return (AdViewApi) AbstractC1556Ra.A00(new C1559Rd(context, str, adSize, adViewParentApi, adView), AdViewApi.class);
    }
    ...
    public AdViewApi createAdViewApi(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws Exception {
        try {
            return (AdViewApi) AbstractC1556Ra.A00(new C1559Rd(context, str, str2, adViewParentApi, adView), AdViewApi.class);
        } catch (C1671Vn e10) {
    ...
    public AudienceNetworkActivityApi createAudienceNetworkActivity(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        return new C1561Rf(audienceNetworkActivity, audienceNetworkActivityApi, new C1560Re(audienceNetworkActivity, audienceNetworkActivityApi));
    }
    ...
    public InterstitialAdApi createInterstitialAd(Context context, String str, InterstitialAd interstitialAd) {
        return (InterstitialAdApi) AbstractC1556Ra.A00(new C1574Rs(context, str, interstitialAd), InterstitialAdApi.class);
    }
    ...
    public NativeAdBaseApi createNativeAdBaseApi(Context context, String str) {
        return new UK(context, str, (InterfaceC1659Va) UK.A0K(), false);
    }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C1661Vc createNativeAdRatingApi(JSONObject jSONObject) {
        return C1661Vc.A00(jSONObject);
    }
    ...
    public NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i10, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i11) {
        return new S3(nativeAdScrollView, context, nativeAdsManager, adViewProvider, i10, type, nativeAdViewAttributes, i11);
    }
    ...
    public NativeAdsManagerApi createNativeAdsManagerApi(Context context, String str, int i10) {
        return (NativeAdsManagerApi) AbstractC1556Ra.A00(new S6(context, str, i10), NativeAdsManagerApi.class);
    }
    ...
    public RewardedInterstitialAdApi createRewardedInterstitialAd(Context context, String str, RewardedInterstitialAd rewardedInterstitialAd) {
        return (RewardedInterstitialAdApi) AbstractC1556Ra.A00(new SD(context, str, rewardedInterstitialAd), RewardedInterstitialAdApi.class);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public RewardedVideoAdApi createRewardedVideoAd(Context context, String str, RewardedVideoAd rewardedVideoAd) {
        return (RewardedVideoAdApi) AbstractC1556Ra.A00(new SH(context, str, rewardedVideoAd), RewardedVideoAdApi.class);
    }

    public static C1569Rn getBidderTokenProviderApi() {
        if (A04 == null) {
            A04 = new C1569Rn();
        }
        return A04;
