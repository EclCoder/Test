...
public class C09793v extends AbstractC1218Dt {
    ...
    public C09793v(C1211Dm c1211Dm) {
        this.A00 = c1211Dm;
    }
    ...
    public final void A03(C1219Du c1219Du) {
        if (this.A00.A01 != null && !this.A00.A05 && c1219Du.A00().getAction() == 0) {
            C1211Dm c1211Dm = this.A00;
            String[] strArr = A01;
            if (strArr[5].length() == strArr[2].length()) {
                throw new RuntimeException();
            }
            A01[4] = "8qKCS4QoQxaUoDKBRazWJt0HJmuP0GoR";
            c1211Dm.A07.removeCallbacksAndMessages(null);
            if (this.A00.A0G(EnumC2111fJ.A04)) {
                this.A00.A03();
                C1211Dm c1211Dm2 = this.A00;
                if (A01[3].charAt(1) != 'x') {
                    A01[3] = "krfS0sgwBFPIM38aK2Y5K2a50FO4BQxK";
                    c1211Dm2.A06(true, false);
                } else {
                    c1211Dm2.A06(true, false);
                }
            }
            if (this.A00.A04) {
                this.A00.A07.postDelayed(new C1212Dn(this), this.A00.A00);
            }
        }
    }
}
