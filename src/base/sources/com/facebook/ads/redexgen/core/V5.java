...
public final class V5 extends Handler {
    ...
    private C2312id A01(C2308iY c2308iY, String str) {
        C2312id c2312id = new C2312id(c2308iY, this.A03, str);
        c2312id.A0G(c2308iY.A0B(), c2308iY.A07());
        return c2312id;
    }

    private C2309iZ A02(C2293iI c2293iI, String str) {
        C2309iZ c2309iZ = new C2309iZ(c2293iI, this.A03, str);
        c2309iZ.A0J(c2293iI.A05, c2293iI.A02, c2293iI.A08);
        return c2309iZ;
    }
    ...
    public final void handleMessage(Message msg) throws Throwable {
        ...
        try {
            ...
            C2198gi c2198giA05 = C1571Rp.A05(this.A00, callingAppPackage);
            c2198giA05.A0F().AJS(msg.getData().getBoolean(A03(6, 21, 22), false));
            if (this.A02 != null) {
            ...
            switch (msg.what) {
                case TTAdConstant.IMAGE_MODE_1010 /* 1010 */:
                    ...
                    C2308iY intAdModel = OX.A04(c2198giA05, msg.getData(), strVerifyPackage);
                    if (v2A04.A00 == null) {
                        v2A04.A00 = A01(intAdModel, callingAppPackage);
                    } else if (v2A04.A00 instanceof C2312id) {
                        ((C2312id) v2A04.A00).A0G(intAdModel.A0B(), intAdModel.A07());
                    }
                ...
                case 2000:
                    ...
                    V2 v2A05 = X9.A00().A04(callingAppPackage);
                    if (v2A05 == null) {
                        v2A05 = X9.A00().A05(callingAppPackage, messenger, strVerifyPackage);
                    }
                    C2293iI c2293iIA05 = OX.A05(c2198giA05, msg.getData(), strVerifyPackage);
                    if (v2A05.A00 == null) {
                        v2A05.A00 = A02(c2293iIA05, callingAppPackage);
                    } else if (v2A05.A00 instanceof C2309iZ) {
                        C2309iZ c2309iZ = (C2309iZ) v2A05.A00;
                        String adId = c2293iIA05.A05;
                        c2309iZ.A0J(adId, c2293iIA05.A02, c2293iIA05.A08);
                    }
                    X9.A00().A07(2001, callingAppPackage, A00(), messenger);
                    return;
                case 2003:
                    OG ogA03 = X9.A00().A03(callingAppPackage);
                    if (ogA03 instanceof C2309iZ) {
                        RewardData rewardDataA01 = OY.A01(msg.getData());
                        C2309iZ c2309iZ2 = (C2309iZ) ogA03;
                        if (rewardDataA01 != null) {
                            c2309iZ2.A0I(rewardDataA01);
                            return;
                        }
                        return;
                    }
