...
public final class Y2 {
    ...
    private EnumC1708Xc A00() {
        if (this.A0G == null || this.A0F == null) {
            return EnumC1708Xc.A0J;
        }
        View view = this.A0G;
        String[] strArr = A0J;
        if (strArr[6].length() == strArr[4].length()) {
            ...
            strArr2[4] = "";
            if (view != this.A0F) {
                EnumC1708Xc enumC1708Xc = EnumC1708Xc.A0H;
                String[] strArr3 = A0J;
            ...
            Object tag = this.A0G.getTag(EnumC1708Xc.A02);
            if (tag == null) {
                return EnumC1708Xc.A0I;
            }
            if (!(tag instanceof EnumC1708Xc)) {
                EnumC1708Xc enumC1708Xc2 = EnumC1708Xc.A0K;
                if (A0J[2].charAt(2) == 'm') {
                    A0J[0] = "fnwPYOgaVMSkQLAdq2SZMccx8Jl2b0fK";
                    return enumC1708Xc2;
                }
            } else {
                return (EnumC1708Xc) tag;
            }
        }
        throw new RuntimeException();
    }
    ...
    public final Map<String, String> A04() {
        ...
        String radius6 = A01(165, 9, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE);
        ...
        String radius10 = A01(56, 6, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE);
        ...
        String radius12 = A01(89, 4, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE);
        ...
        String radius16 = A01(Sdk$SDKError.b.PRIVACY_URL_ERROR_VALUE, 7, 98);
    ...
    public final void A06(C2198gi c2198gi, MotionEvent motionEvent, View view, View view2) {
        if (view == null) {
            c2198gi.A0F().AKl();
            return;
        }
