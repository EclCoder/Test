...
public class S7 extends AsyncTask<S9, Void, Drawable> {
        ...
        if (!WU.A02(this) && s9Arr != null) {
            try {
                if (s9Arr.length >= 1) {
                    ...
                    try {
                        bitmapA0O = new C1604Sx(this.A01).A0O(str, -1, -1);
                    } catch (Throwable th2) {
                        this.A01.A08().ABC(A01(0, 7, 4), AbstractC1610Td.A1V, new C1611Te(th2));
                    }
                    if (bitmapA0O != null) {
    ...
    public S7(C2198gi c2198gi, S8 s10, boolean z10) {
        this.A01 = c2198gi;
        this.A00 = s10;
        this.A02 = z10;
    }

    public /* synthetic */ S7(C2198gi c2198gi, S8 s10, boolean z10, C2220h4 c2220h4) {
        this(c2198gi, s10, z10);
    }
