...
public abstract class C2L<K, V> extends AbstractC1166Bq<K, V> implements Serializable {
    ...
    public C2L(Map<K, Collection<V>> map) {
        AbstractC2428ki.A0C(map.isEmpty());
        this.A01 = map;
    }
    ...
    public static /* synthetic */ int A02(C2L c2l, int i10) {
        int i11 = c2l.A00 + i10;
        c2l.A00 = i11;
        return i11;
    }

    public static /* synthetic */ int A03(C2L c2l, int i10) {
        int i11 = c2l.A00 - i10;
        c2l.A00 = i11;
        return i11;
    }
    ...
    public void A0A(@CheckForNull Object key) {
        Collection<V> collection = (Collection) AbstractC2728po.A06(this.A01, key);
        if (collection != null) {
    ...
    public final Collection<V> A0B() {
        return new C2499ls(this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2L != com.google.common.collect.AbstractMapBasedMultimap<K, V> */
    @Override // com.facebook.ads.redexgen.core.AbstractC1166Bq
    public Iterator<V> A0C() {
        return new C1170Bu(this);
    }
    ...
    public final List A0H(@ParametricNullness Object key, @CheckForNull List list, C2496lp ancestor) {
        if (list instanceof RandomAccess) {
            return new C2N(this, key, list, ancestor);
        }
        return new C1167Br(this, key, list, ancestor);
    }
    ...
    public final Map<K, Collection<V>> A0J() {
        ...
        return new C1169Bt(this, this.A01);
    }
    ...
    public final void A0L(Map<K, Collection<V>> map) {
        ...
        for (Collection<V> collection : map.values()) {
            AbstractC2428ki.A0C(!collection.isEmpty());
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2L != com.google.common.collect.AbstractMapBasedMultimap<K, V> */
    @Override // com.facebook.ads.redexgen.core.AbstractC1166Bq, com.facebook.ads.redexgen.core.InterfaceC2743q3
