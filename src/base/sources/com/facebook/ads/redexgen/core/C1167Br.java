...
public class C1167Br<V> extends C2L<K, V>.WrappedCollection implements List<V> {
    ...
    public C1167Br(@ParametricNullness final C2L this$0, @CheckForNull Object key, List delegate, C2496lp ancestor) {
