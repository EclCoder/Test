...
public abstract class UJ {
    ...
    public static String A01(T8 t10) {
        return WebSettings.getDefaultUserAgent(t10);
    }

    public static String A02(T8 t10) {
        FutureTask futureTask = new FutureTask(new UI(t10));
    ...
    public static String A03(T8 t10, C1621To c1621To) {
        String strA07 = c1621To.A07();
        if (TextUtils.isEmpty(strA07) && !A04.getAndSet(true)) {
            InterfaceC1609Tc interfaceC1609TcA08 = t10.A08();
            int i10 = AbstractC1610Td.A1Z;
            String bundle = A00(73, 7, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE);
            C1611Te c1611Te = new C1611Te(bundle);
            String bundle2 = A00(Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE, 7, 87);
            interfaceC1609TcA08.ABC(bundle2, i10, c1611Te);
        }
        return strA07;
    }

    public static String A04(T8 t10, boolean z10) {
        if (t10 == null) {
            return A00;
        }
        if (z10) {
            return System.getProperty(A00(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 10, 59));
        }
        String str = A03.get();
        if (str != null) {
            return str;
        }
        long spUserAgentRefresh = AbstractC1647Uo.A01(t10);
        String strA00 = A00(143, 23, 1);
        String strA01 = A00(Sdk$SDKError.b.OMSDK_JS_WRITE_FAILED_VALUE, 10, 52);
        String strA02 = A00(88, 28, 96);
        if (spUserAgentRefresh > 0) {
            SharedPreferences sharedPreferences = t10.getSharedPreferences(ProcessUtils.getProcessSpecificName(strA02, t10), 0);
        ...
        if (spUserAgentRefresh > 0) {
            SharedPreferences sharedPreferences2 = t10.getSharedPreferences(ProcessUtils.getProcessSpecificName(strA02, t10), 0);
    ...
    public static String A05(C1621To c1621To, T8 t10) {
        if (AbstractC1647Uo.A04(t10)) {
            return A00(63, 5, 5) + A03(t10, c1621To) + A00(39, 6, 61) + c1621To.A06() + A00(45, 6, 61) + c1621To.A04() + A00(38, 1, 85);
        }
        return A00(0, 0, 76);
    }

    public static String A06(C1621To c1621To, T8 t10, boolean z10) {
        return A04(t10, z10) + A00(0, 38, 50) + t10.A05().A9S() + A00(57, 6, 26) + C1621To.A04 + A00(38, 1, 85) + A05(c1621To, t10) + A00(68, 5, 13) + t10.A05().A9T() + A00(51, 6, 8) + Locale.getDefault().toString() + A00(87, 1, 36);
    }

    public static void A08(T8 t10, Throwable th2) {
        t10.A08().ABC(A00(166, 8, 78), AbstractC1610Td.A2i, new C1611Te(th2));
    }
}
