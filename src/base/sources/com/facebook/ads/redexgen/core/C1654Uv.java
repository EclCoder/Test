...
public class C1654Uv extends AbstractC2142fo {
    ...
    public final /* synthetic */ C2380ju A01;
    public final /* synthetic */ UK A02;
    public final /* synthetic */ boolean A03;

    public C1654Uv(UK uk2, View view, boolean z10, C2380ju c2380ju) {
        this.A02 = uk2;
        this.A00 = view;
        this.A03 = z10;
        this.A01 = c2380ju;
    ...
    public final void A03() {
        this.A02.A0i.A0B();
        if (C1648Up.A2I(this.A02.A16()) && (this.A00 instanceof AdNativeComponentView)) {
            View adContentsView = ((AdNativeComponentView) this.A00).getAdContentsView();
            if ((adContentsView instanceof C2082eq) && !((C2082eq) adContentsView).A05()) {
                this.A02.A0U.A0T();
                this.A02.A0i.A08();
                return;
            }
        ...
        if (this.A02.A0Y != null && this.A02.A0Y.get() != null) {
            ((AbstractC2142fo) this.A02.A0Y.get()).A03();
        }
        if (this.A02.A0j.A07()) {
            this.A02.A0i.A04();
            return;
        ...
        if (this.A02.A0A != null && this.A02.A04 != null) {
            ...
            if (view != null) {
                ...
                this.A02.A0A.A0D(AbstractC1762Ze.A00(this.A02.A08));
