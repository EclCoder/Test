...
public enum EnumC2686p7 implements Iterator<Object> {
    A03;
    ...
    public static String A00(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            int i14 = (bArrCopyOfRange[i13] ^ i12) ^ Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE;
            if (A01[4].charAt(4) != 'R') {
