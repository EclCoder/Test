...
public final class C1776Zs extends LinearLayout {
    ...
    public C1776Zs(C2198gi c2198gi) {
        super(c2198gi);
    ...
    public void setInfo(YM ym2, String str, String str2) {
        this.A00.setImageBitmap(YN.A01(ym2));
