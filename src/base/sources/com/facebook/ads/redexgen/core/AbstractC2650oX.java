...
public abstract class AbstractC2650oX<K, V> implements Map<K, V>, Serializable {
    ...
    @CheckForNull
    @LazyInit
    public transient AbstractC2641oO<V> A00;
     ...
     */
    public static <K, V> AbstractC2650oX<K, V> A05(Iterable<? extends Map.Entry<? extends K, ? extends V>> entries) {
        C2648oV c2648oV = new C2648oV(entries instanceof Collection ? ((Collection) entries).size() : 4);
        c2648oV.A04(entries);
        return c2648oV.A07();
    }
    ...
    public abstract AbstractC2641oO<V> A0A();
    ...
    public static <K, V> C2648oV<K, V> A03() {
        return new C2648oV<>();
    }

    public static <K, V> AbstractC2650oX<K, V> A04() {
        AbstractC2650oX<K, V> abstractC2650oX = (AbstractC2650oX<K, V>) B9.A04;
        if (A04[4].charAt(3) != 'V') {
    ...
    public static <K, V> AbstractC2650oX<K, V> A06(Map<? extends K, ? extends V> map) {
        if ((map instanceof AbstractC2650oX) && !(map instanceof SortedMap)) {
            AbstractC2650oX<K, V> abstractC2650oX = (AbstractC2650oX) map;
            if (!abstractC2650oX.A0F()) {
                return abstractC2650oX;
            }
        }
    ...
    public AbstractC2641oO<V> values() {
        AbstractC2641oO<V> abstractC2641oOA0A = this.A00;
        if (abstractC2641oOA0A == null) {
            abstractC2641oOA0A = A0A();
            if (A04[3].length() == 23) {
                throw new RuntimeException();
            }
            A04[6] = "23ujWmcydF5ICCpn56C";
            this.A00 = abstractC2641oOA0A;
        }
        return abstractC2641oOA0A;
    }
    ...
    public boolean equals(@CheckForNull Object object) {
        return AbstractC2728po.A0B(this, object);
    }
    ...
    @Override // java.util.Map
    public int hashCode() {
        return AbstractC2781qj.A00(entrySet());
    }
    ...
    public final String toString() {
        return AbstractC2728po.A08(this);
    }
}
