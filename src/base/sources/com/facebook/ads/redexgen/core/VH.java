...
public final class VH {
    ...
    static {
        A01();
        A0D = new VH(A00(167, 20, 63), 0, A00(1176, 20, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE));
        A08 = new VH(A00(58, 18, 14), 1, A00(1067, 18, 81));
        A04 = new VH(A00(0, 15, 98), 2, A00(1196, 15, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE));
        ...
        A0i = new VH(A00(754, 25, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE), 7, A00(1786, 25, 105));
        A0j = new VH(A00(779, 20, 98), 8, A00(1811, 20, 41));
        A0V = new VH(A00(463, 37, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE), 9, A00(1495, 37, 91));
        A06 = new VH(A00(33, 9, 25), 10, A00(1058, 9, 54));
        A07 = new VH(A00(42, 16, 33), 11, A00(1042, 16, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE));
        ...
        A0q = new VH(A00(875, 21, 104), 18, A00(1904, 21, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE));
        A0a = new VH(A00(551, 16, 54), 19, A00(1583, 16, 85));
        A0J = new VH(A00(278, 11, 49), 20, A00(1302, 11, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE));
        A0d = new VH(A00(639, 20, 22), 21, A00(1671, 20, 27));
        A0Y = new VH(A00(520, 16, 94), 22, A00(1552, 16, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE));
        ...
        A0n = new VH(A00(842, 8, 33), 33, A00(1871, 8, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE));
        A0m = new VH(A00(833, 9, 4), 34, A00(1862, 9, 104));
        A0l = new VH(A00(813, 20, 110), 35, A00(1845, 17, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE));
        ...
        A0F = new VH(A00(Sdk$SDKError.b.AD_NOT_LOADED_VALUE, 26, 11), 43, A00(1234, 26, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL));
        ...
        A0R = new VH(A00(404, 19, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE), 47, A00(1436, 19, 27));
        A0M = new VH(A00(Sdk$SDKError.b.AD_CLOSED_MISSING_HEARTBEAT_VALUE, 25, 87), 48, A00(1350, 25, 52));
        A0L = new VH(A00(HttpStatusCodes.STATUS_CODE_SEE_OTHER, 15, 67), 49, A00(1327, 23, 48));
        A0Q = new VH(A00(386, 18, 19), 50, A00(1418, 18, 72));
        A0N = new VH(A00(343, 12, 21), 51, A00(1375, 12, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE));
        A0e = new VH(A00(659, 22, 97), 52, A00(1691, 22, 79));
        A0g = new VH(A00(697, 32, 28), 53, A00(1729, 32, 9));
        A0c = new VH(A00(607, 32, 91), 54, A00(1639, 32, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE));
        A0b = new VH(A00(567, 40, 108), 55, A00(1599, 40, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE));
        A0f = new VH(A00(681, 16, 73), 56, A00(1713, 16, 55));
        A0h = new VH(A00(729, 25, 20), 57, A00(1761, 25, 76));
        A03 = A02();
    }

    public VH(String str, int i10, String str2) {
        super(str, i10);
        this.A00 = str2;
    }
