...
public final class S6 implements NativeAdsManagerApi {
    ...
    public S6(Context context, String str, int i10) {
        this.A08 = C1571Rp.A03(context);
        this.A09 = str;
        this.A07 = Math.max(i10, 0);
        this.A0A = new ArrayList(i10);
    }
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        EnumC1673Vq enumC1673Vq = EnumC1673Vq.A06;
        int i10 = this.A07;
        C2327iu c2327iu = this.A03;
        this.A03 = new C2327iu(this.A08, this.A09, enumC1673Vq, null, i10);
        if (this.A06) {
            this.A03.A06();
        }
        this.A03.A09(this.A04);
        this.A03.A08(new C2221h5(this, this.A08, mediaCacheFlag, this.A01));
        this.A03.A07();
    }
