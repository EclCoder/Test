...
public enum EnumC2184gU {
    A03(A01(37, 3, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE)),
    A04(A01(40, 7, 55));
    ...
    public static String A01(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            bArrCopyOfRange[i13] = (byte) ((bArrCopyOfRange[i13] ^ i12) ^ Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE);
        }
    ...
    EnumC2184gU(String str) {
        this.A00 = str;
    }

    public static EnumC2184gU A00(String str) {
        for (EnumC2184gU enumC2184gU : values()) {
            if (enumC2184gU.A00.equals(str)) {
                return enumC2184gU;
            }
        }
