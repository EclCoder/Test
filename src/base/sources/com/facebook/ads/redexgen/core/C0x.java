...
public final class C0x extends C1F implements InterfaceC2033e2 {
    ...
    public int A02;
    public int A03;
    public InterfaceC1750Ys A04;
    public boolean A05;
    public final C10576v A06;
    ...
    public C0x(C2198gi c2198gi) {
        ...
        this.A00 = 0;
        this.A05 = false;
        this.A06 = new C10576v(c2198gi, new C2031e0(), new C2030dz());
        A02();
    }

    public C0x(C2198gi c2198gi, AttributeSet attributeSet) {
    ...
    public C0x(C2198gi c2198gi, AttributeSet attributeSet, int i10) {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2033e2
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.A05) {
            int i12 = (int) XX.A02;
            int verticalPadding = C1648Up.A0F(getContext());
        ...
        if (this.A05) {
            int verticalPadding5 = C1745Yn.A09;
    ...
    public void setAdapter(AbstractC1546Qq abstractC1546Qq) {
        this.A06.A2J(abstractC1546Qq == null ? -1 : abstractC1546Qq.hashCode());
        super.setAdapter(abstractC1546Qq);
    }
    ...
    public void setChildWidth(int i10) {
        ...
        C10576v c10576v = this.A06;
        int pageWidth3 = this.A01;
        c10576v.A2K((i12 - pageWidth3) / 2);
        C10576v c10576v2 = this.A06;
        int pageWidth4 = this.A01;
        c10576v2.A2I(((double) pageWidth4) / ((double) measuredWidth));
    }
    ...
    public void setOnPageChangedListener(InterfaceC1750Ys interfaceC1750Ys) {
        this.A04 = interfaceC1750Ys;
    }
