...
public abstract class AbstractC1379Ka extends AbstractC1911c3 implements XQ {
    ...
    public final AbstractC2363jd A04;
    public final NR A05;
    public final InterfaceC1739Yh A06;
    public final AbstractC1861bF A07;
    public final XS A08;
    ...
    public abstract AbstractC1861bF A1R(C1915c7 c1915c7, NR nr, String str);
    ...
    public final void A1U() {
        ...
        C1892bk c1892bk = new C1892bk(super.A07.A06());
        c1892bk.setRadius(15);
        YB.A0N(c1892bk, 0);
        LinearLayout.LayoutParams layoutParams3 = new LinearLayout.LayoutParams(A0E, A0E);
        layoutParams3.gravity = 17;
        c1892bk.setLayoutParams(layoutParams3);
        new LM(c1892bk, super.A07.A06()).A05(A0E, A0E).A07(super.A07.A05().A2C().A01());
        ...
        linearLayout.addView(c1892bk);
        linearLayout.addView(textView2);
        addView(linearLayout);
        addView(A0J());
        if (this.A04.A2M() && this.A04.A2R()) {
            addView(A00(super.A07.A06(), super.A07.A05(), super.A07.A08(), EnumC1806aM.A07, super.A07.A0C()));
        }
        if (this.A04.A2W()) {
            addView(A01(super.A07.A06(), EnumC1806aM.A07));
        }
    }
    ...
    public AbstractC1379Ka(C1915c7 c1915c7, boolean z10) {
        super(c1915c7, z10);
        this.A03 = new Handler(Looper.getMainLooper());
        this.A09 = new AtomicBoolean(false);
        this.A04 = c1915c7.A05();
        this.A08 = XS.A00(c1915c7.A06(), this.A04, this);
        this.A05 = this.A04.A29();
        this.A07 = A0K(c1915c7);
        if (this.A04.A1w()) {
            this.A07.setVisibility(8);
        }
        AbstractC1733Yb abstractC1733YbA0B = c1915c7.A0B();
        this.A06 = c1915c7.A0C();
        if (abstractC1733YbA0B != null) {
            abstractC1733YbA0B.setLayoutParams(new RelativeLayout.LayoutParams(-1, abstractC1733YbA0B.getToolbarHeight()));
            abstractC1733YbA0B.setPageDetailsVisible(false);
        }
    }
    ...
    private AbstractC1861bF A0K(C1915c7 c1915c7) {
        String clickEvent;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        if (this.A04.A1w()) {
        ...
        if (c1915c7.A05().A10().equals(A0L(91, 14, 67))) {
            clickEvent = EnumC2091ez.A04.A03();
        } else {
            clickEvent = A0L(9, 37, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE);
        }
        AbstractC1861bF abstractC1861bFA1R = A1R(c1915c7, this.A05, clickEvent);
        abstractC1861bFA1R.getCTAButton().getCtaActionHelper().A08(this.A04);
        abstractC1861bFA1R.getCTAButton().setCreativeAsCtaLoggingHelper(this.A08);
        this.A02 = new DA(abstractC1861bFA1R, 400, 100, 0);
        YB.A0K(abstractC1861bFA1R);
        abstractC1861bFA1R.A0l(c1915c7.A00());
        if (C1648Up.A17(c1915c7.A06())) {
            abstractC1861bFA1R.A0k();
            if (c1915c7.A0B() != null) {
                c1915c7.A0B().setCTAClickListener(getCtaButton());
            }
        }
        addView(abstractC1861bFA1R, layoutParams);
        abstractC1861bFA1R.getCTAButton().A0F(this.A04, c1915c7.A0B());
        return abstractC1861bFA1R;
    }
    ...
    public final int A1Q(AbstractC1733Yb abstractC1733Yb) {
        return abstractC1733Yb == null ? AbstractC1733Yb.A00 : abstractC1733Yb.getToolbarHeight();
    }

    public void A1S() {
        View expandableLayout = getAdDetailsView().getExpandableLayout();
        if (expandableLayout != null) {
            this.A00 = new C1211Dm(true, false);
            if (this.A01 != null) {
                this.A00.A0L(this.A01);
            }
            C1456Na c1456NaA01 = this.A04.A28().A01();
            this.A00.A0L(new DB(getAdDetailsView().getCTAButton(), HttpStatusCodes.STATUS_CODE_MULTIPLE_CHOICES, -1, c1456NaA01.A0A(true)));
            Drawable startDrawable = YB.A08(A0C, A0D, A0B);
            this.A00.A0L(new DS(getAdDetailsView().getCTAButton(), HttpStatusCodes.STATUS_CODE_MULTIPLE_CHOICES, startDrawable, YB.A05(c1456NaA01.A09(true), A0B)));
    ...
    public final void A1T() {
        ...
        textView.setGravity(1);
        textView.setLayoutParams(layoutParams2);
        C1886be c1886be = new C1886be(super.A07.A06(), 0, -13524404, YM.REWARD_GRANTED_ICON);
        LinearLayout.LayoutParams layoutParams3 = new LinearLayout.LayoutParams(A0H, A0H);
        layoutParams3.gravity = 17;
        c1886be.setLayoutParams(layoutParams3);
        linearLayout.addView(c1886be);
        linearLayout.addView(textView);
        addView(linearLayout);
    }
    ...
    public final /* synthetic */ void A1W(View view) {
        this.A06.A4j(A0L(46, 45, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE));
    }
    ...
    public AbstractC1861bF getAdDetailsView() {
        return this.A07;
    }
    ...
    public C1211Dm getAnimationPlugin() {
        return this.A00;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (!this.A04.A29().A0K().A03() && !this.A04.A1j() && !this.A04.A1w() && (expandableLayout = getAdDetailsView().getExpandableLayout()) != null && z10 && this.A01 == null) {
            this.A01 = new DR(expandableLayout, HttpStatusCodes.STATUS_CODE_MULTIPLE_CHOICES, expandableLayout.getHeight(), 0);
            this.A00.A0L(this.A01);
            this.A00.A0J();
        }
    }
