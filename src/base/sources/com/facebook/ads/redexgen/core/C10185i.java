...
public final class C10185i {
    ...
    public static final C10185i A0C;
    ...
    public C10185i(Uri uri, long j10, int i10, byte[] bArr, Map<String, String> map, long j11, long j12, String str, int i11, ML ml2) {
        boolean z10 = true;
        AbstractC09823y.A07(j10 + j11 >= 0);
    ...
    static {
        ...
        A0C = new C10185i(Uri.parse(A02(43, 16, 34)));
    }

    public C10185i(Uri uri) {
        this(uri, 0, -1);
    }

    @MetaExoPlayerCustomization
    @Deprecated
    public C10185i(Uri uri, int i10, int i11) {
        this(uri, 0L, 1, null, Collections.emptyMap(), 0L, -1L, null, i10, new ML(A02(0, 0, 9), -1L, false, -1, -1, -1, -1, false, false, i11, -1L, new MK(), false, -1, -1, -1L, -1L, -1, null, -1, null, null, MJ.A02, -1, false, null, A02(0, 0, 9), A02(0, 0, 9), null, -1L, -1L));
    }

    @MetaExoPlayerCustomization("creation and passage of FbDataSpecExtension")
    @Deprecated
    public C10185i(Uri uri, long j10, long j11, String str) {
        this(uri, 0L, 1, null, Collections.emptyMap(), j10, j11, str, 0, new ML());
    }
    ...
    public final C10155f A04() {
        return new C10155f(this);
    }

    @MetaExoPlayerCustomization("Replacement of customData Object with fbDataSpecExtension + new copy creation")
    public final C10185i A05(long j10, long j11) {
        if (j10 == 0 && this.A03 == j11) {
            return this;
        }
        return new C10185i(this.A06, this.A05, this.A01, this.A0A, this.A09, this.A04 + j10, j11, this.A08, this.A00, new ML(this.A07));
    }
