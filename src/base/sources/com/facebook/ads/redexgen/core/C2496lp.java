...
public class C2496lp<V> extends AbstractCollection<V> {
    ...
    public boolean removeAll(Collection<?> c10) {
        ...
        int size = size();
        boolean zRemoveAll = this.A00.removeAll(c10);
        if (zRemoveAll) {
            C2L.A02(this.A04, this.A00.size() - size);
            A05();
        }
    ...
    public C2496lp(@ParametricNullness final C2L this$0, @CheckForNull Object key, Collection delegate, C2496lp ancestor) {
        this.A04 = this$0;
        this.A02 = key;
        this.A00 = delegate;
        this.A01 = ancestor;
    ...
    public final boolean remove(@CheckForNull Object o10) {
        A04();
        boolean zRemove = this.A00.remove(o10);
        if (zRemove) {
            C2L.A01(this.A04);
            A05();
        }
    ...
    public final boolean retainAll(Collection<?> c10) {
        AbstractC2428ki.A04(c10);
        int size = size();
        boolean zRetainAll = this.A00.retainAll(c10);
        if (zRetainAll) {
