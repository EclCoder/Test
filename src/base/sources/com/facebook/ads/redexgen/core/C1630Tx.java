...
public final class C1630Tx {
     ...
     */
    public C1630Tx(Map<String, String> map) {
        byte b10;
        this.A01 = -1;
        this.A00 = -1;
        this.A0B = A0G;
        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            switch (key.hashCode()) {
                ...
                case -856794442:
                    ...
                    break;
                case -726276175:
                    if (key.equals(A01(Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE, 15, 32))) {
                        b10 = 11;
                    } else {
                        b10 = -1;
                    }
                ...
                case -553208868:
                    ...
                    break;
                case 3575610:
                    if (key.equals(A01(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 4, 34))) {
                        b10 = 0;
                    } else {
                        b10 = -1;
                    }
                ...
                case 700812481:
                    ...
                    break;
                case 858630459:
                    if (key.equals(A01(Sdk$SDKError.b.AD_LOAD_FAIL_PLACEMENT_ID_MISMATCH_VALUE, 24, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE))) {
                        b10 = 2;
                    } else {
                        b10 = -1;
                    }
    ...
    static {
        A02();
        A0H = C1630Tx.class.getSimpleName();
        A0G = AdPlacementType.UNKNOWN;
    }

    @Nullable
    public static C1630Tx A00(@Nullable JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
