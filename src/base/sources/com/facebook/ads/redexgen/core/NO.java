...
public final class NO extends RelativeLayout implements InterfaceC1740Yi {
    ...
    public final AbstractC2363jd A0O;
    public final C1470No A0P;
    public final InterfaceC1566Rk A0Q;
    public final C2198gi A0R;
    public final VA A0S;
    public final VI A0T;
    public final XO A0U;
    public final ViewOnSystemUiVisibilityChangeListenerC1729Xx A0V;
    public final InterfaceC1739Yh A0W;
    public final ZU A0X;
    public final InterfaceC1889bh A0Y;
    public final C1890bi A0Z;
    public final C2053eM A0a;
    public final AtomicBoolean A0b;
    public final AtomicBoolean A0c;
    public final boolean A0d;
    public final boolean A0e;
    public final boolean A0f;
    public final AbstractC1733Yb A0g;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public NO(C2198gi c2198gi, VA va2, InterfaceC1739Yh interfaceC1739Yh, AbstractC2363jd abstractC2363jd, String str, ZU zu, boolean z10) {
        super(c2198gi);
        String strA0D = A0D(0, 0, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE);
        this.A0E = strA0D;
        this.A0D = strA0D;
        ...
        this.A0f = z10;
        this.A0R = c2198gi;
        this.A0W = interfaceC1739Yh;
        this.A0S = va2;
        this.A0O = abstractC2363jd;
        this.A0P = abstractC2363jd.A29().A0H().A07();
        this.A0T = new VI(this.A0O.A2E(), this.A0S);
        this.A0X = zu;
        this.A0C = new C2066ea(c2198gi, this.A0X, str, this.A0W);
        if (abstractC2363jd.A29().A0H().A07() != null) {
            this.A0I = abstractC2363jd.A29().A0H().A07().A0X();
            this.A0E = abstractC2363jd.A29().A0H().A07().A0O();
            this.A0D = abstractC2363jd.A29().A0H().A07().A0N();
        }
        ...
        OV ov = null;
        this.A0U = new XO(iA03, new C1477Nv(this, ov));
        this.A0d = C1648Up.A0o(this.A0R);
        this.A0g = A07();
        if (this.A0P.A0c()) {
            this.A0g.A09();
        }
        this.A0a = new C2053eM(this.A0R, this.A0S, this.A0O);
        AbstractC1899br.A00(c2198gi, this, abstractC2363jd.A29().A0H().A08());
        this.A0V = new ViewOnSystemUiVisibilityChangeListenerC1729Xx(this);
        this.A0V.A05(EnumC1728Xw.A02);
        if (C1648Up.A2K(this.A0R)) {
            this.A0g.setProgressSpinnerInvisible(true);
        }
        NP np2 = new NP(this, ov);
        HashMap map = new HashMap();
        map.put(A0D(56, 9, 90), this.A0X.A8l());
        this.A0B = new C2049eI(this.A0R, this.A0O, this.A0P, this.A0S, np2, map);
        A0K();
        this.A0W.A45(this, new RelativeLayout.LayoutParams(-1, -1));
        A0H();
        this.A0Y = new C1481Nz(this);
        this.A0Z = new C1890bi(this.A0R, this.A0g, this.A0O, (C1235Ek) null, this.A0W, this.A0Y, this.A0A, this.A02, this.A0B);
    ...
    public NO(C2198gi c2198gi, VA va2, InterfaceC1739Yh interfaceC1739Yh, AbstractC2363jd abstractC2363jd, String str, ZU zu) {
        this(c2198gi, va2, interfaceC1739Yh, abstractC2363jd, str, zu, false);
    }
    ...
    private FullScreenAdToolbar A07() {
        ...
        fullScreenAdToolbar.A0D(this.A0O.A28().A01(), ViewOnClickListenerC1396Kr.A05(this.A0O));
        ...
        fullScreenAdToolbar.setToolbarListener(new C1478Nw(this));
        return fullScreenAdToolbar;
    }

    private ViewOnClickListenerC1396Kr A09() {
        if (this.A0B == null || this.A0B.getViewabilityChecker() == null || this.A0B.getTouchDataRecorder() == null) {
            return null;
        }
        ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr = new ViewOnClickListenerC1396Kr(this.A0R, this.A0X.A7M(), this.A0O.A28().A01(), this.A0S, this.A0W, this.A0B.getViewabilityChecker(), this.A0B.getTouchDataRecorder(), this.A0O.A2A());
        YB.A0K(viewOnClickListenerC1396Kr);
        viewOnClickListenerC1396Kr.setText(this.A0O.A29().A0J().A04());
        viewOnClickListenerC1396Kr.setTextSize(14.0f);
        viewOnClickListenerC1396Kr.setPadding(XV.A02, XV.A02, XV.A02, XV.A02);
        viewOnClickListenerC1396Kr.setOnClickListener(new Z6(this));
        return viewOnClickListenerC1396Kr;
    }

    private C1898bq A0B() {
        C2198gi c2198gi = this.A0R;
        C1456Na c1456NaA01 = this.A0O.A28().A01();
        int i10 = !this.A0J ? 16 : 17;
        ...
        C1898bq c1898bq = new C1898bq(c2198gi, c1456NaA01, true, i10, !z10 ? 14 : 13, 0);
        c1898bq.A04(this.A0O.A29().A0I().A0G(), this.A0O.A29().A0I().A0F(), null, false, true);
        TextView descriptionTv = c1898bq.getDescriptionTextView();
        descriptionTv.setAlpha(0.8f);
        descriptionTv.setMaxLines(1);
        descriptionTv.setEllipsize(TextUtils.TruncateAt.END);
        TextView descriptionTv2 = c1898bq.getTitleTextView();
    ...
    private void A0G() {
        ...
        C1892bk c1892bk = new C1892bk(this.A0R);
        YB.A0N(c1892bk, 0);
        YB.A0K(c1892bk);
        new LM(c1892bk, this.A0R).A05(A0k, A0k).A07(this.A0O.A2C().A01());
        ...
        C1894bm c1894bm = new C1894bm(this.A0R, !this.A0I ? A0o : A0m, 5, A0n, -1);
        ...
        linearLayout.addView(c1894bm, layoutParams2);
        ...
        ratingInfoContainerParams.addRule(1, c1892bk.getId());
        ...
        if (this.A04 != null) {
            ...
            this.A04.addView(c1892bk, layoutParams);
        }
        ...
        c1894bm.setRating(Float.parseFloat(this.A0O.A29().A0I().A0C()));
        ...
        if (!this.A0I) {
            ...
            strA01 = AbstractC1712Xg.A01(Integer.parseInt(this.A0O.A29().A0I().A09()));
        }
        sb2.append(strA01);
    ...
    private void A0J() {
        C2021dq c2021dqA0F = new Cdo(this.A0R, this.A0O.A29().A0I(), this.A0O.A2C()).A0A(this.A0O.A28().A01()).A0D(this.A0P.A0Q()).A0C(this.A0P.A0K()).A09(2000).A0E(this.A0I).A0B(this.A0E).A0F();
        VK.A04(c2021dqA0F, this.A0T, VH.A0U);
        addView(c2021dqA0F, A0p);
        c2021dqA0F.A04(new C1480Ny(this));
    }
    ...
    private void A0K() {
        ...
        if (this.A0d) {
            ...
            C1898bq c1898bqA0B = A0B();
            RelativeLayout.LayoutParams iconAndMetaDataContainerParams = new RelativeLayout.LayoutParams(-2, -2);
            relativeLayout.addView(c1898bqA0B, iconAndMetaDataContainerParams);
        }
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams2.setMargins(0, 0, XV.A09, 0);
        this.A02.addView(this.A04, layoutParams2);
        if (this.A0A != null) {
            ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr = this.A0A;
            String[] strArr = A0i;
            if (strArr[6].charAt(22) == strArr[1].charAt(22)) {
                throw new RuntimeException();
            }
            A0i[3] = "f";
            layoutParams2.addRule(0, viewOnClickListenerC1396Kr.getId());
            if (!this.A0I) {
    ...
    private void A0L() {
        this.A09 = AbstractC1808aO.A02(this.A0R, EnumC1806aM.A03, this.A0O);
        YB.A0K(this.A09);
    ...
    private void A0M() {
        this.A08 = AbstractC1808aO.A01(this.A0R, true, this.A0O, this.A0T, this.A0W, EnumC1806aM.A03, AbstractC1805aL.A00(this.A0O));
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(11);
        layoutParams.topMargin = XV.A09;
    ...
    public void A0N() {
        if (this.A0O.A2M() && this.A08 != null) {
            this.A08.A0P();
            if (this.A0O.A2U()) {
                AbstractC1805aL.A04(this.A0R, EnumC1806aM.A02);
            } else {
                AbstractC1805aL.A05(this.A0R, EnumC1806aM.A02);
            }
        }
        if (this.A0O.A2W() && this.A09 != null) {
            AbstractC1805aL.A06(this.A0R, EnumC1806aM.A02);
        }
        ...
        YB.A0L(this.A0A);
        Pair<EnumC2052eL, View> pairA03 = this.A0a.A03(this.A0A);
        this.A00 = (View) pairA03.second;
        switch (Z7.A00[((EnumC2052eL) pairA03.first).ordinal()]) {
            case 1:
                ...
                if (!this.A0I) {
                    ...
                    View c2015dj = new C2015dj(this.A0R, this.A0O.A2C(), this.A0O.A29().A0I(), A09(), this.A0D, new Z5(this));
                    ...
                    addView(c2015dj, screenshotParams2);
                    View view = this.A0g;
                    String[] strArr3 = A0i;
    ...
    public void A0O() {
        ...
        if (this.A0A != null && this.A0O.A25() > 0 && this.A07 == null) {
            this.A07 = new XO(this.A0O.A25(), new C1479Nx(this));
            this.A07.A07();
        }
        this.A0U.A07();
        if (this.A08 != null && this.A0O.A2Q()) {
            C1803aJ c1803aJ = this.A08;
            String[] strArr2 = A0i;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0W(boolean z10, String str) {
        this.A0H = true;
        HashMap map = new HashMap();
        map.put(A0D(8, 12, 57), z10 ? A0D(79, 13, 2) : A0D(44, 12, 82));
        map.put(A0D(20, 12, 7), str);
        new C1877bV(this.A0R, this.A0X.A7M(), this.A0B.getViewabilityChecker(), this.A0B.getTouchDataRecorder(), this.A0S, this.A0O.A2A(), this.A0W).A05(this.A0O.A2E(), this.A0O.A29().A0J().A05(), map);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0X() {
        return this.A0O.A10().equals(A0D(65, 14, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE)) || (this.A0O.A10().equals(A0D(32, 12, 60)) && this.A0O.A29().A0V());
    }
    ...
    public final void onDestroy() {
        ...
        if (this.A0B != null) {
            if (!TextUtils.isEmpty(this.A0O.A2E())) {
                this.A0S.AB7(this.A0O.A2E(), new C1855b9().A03(this.A0B.getViewabilityChecker()).A02(this.A0B.getTouchDataRecorder()).A05());
            }
            C2049eI c2049eI = this.A0B;
            String[] strArr = A0i;
