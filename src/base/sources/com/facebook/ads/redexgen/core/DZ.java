...
public final class DZ extends RelativeLayout implements InterfaceC2086eu {
    ...
    public DZ(C2198gi c2198gi, int i10) {
        this(c2198gi, A0E, -12549889, 0, i10);
    }

    public DZ(C2198gi c2198gi, int i10, int i11) {
        this(c2198gi, i11, -12549889, 0, i10);
    }

    public DZ(C2198gi c2198gi, int i10, int i11, int i12, int i13) {
        super(c2198gi);
        this.A04 = false;
        this.A01 = -1;
        this.A05 = true;
        this.A0A = new AbstractC1224Dz() { // from class: com.facebook.ads.redexgen.X.33
        ...
        this.A00 = i13;
        this.A06 = new ProgressBar(c2198gi, null, R.attr.progressBarStyleHorizontal);
        A08(i11, i12, false);
    ...
    public final void AAv(C1235Ek c1235Ek) {
        this.A03 = c1235Ek;
        c1235Ek.getEventBus().A03(this.A08, this.A09, this.A0A, this.A07);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2086eu
    public final void AKV(C1235Ek c1235Ek) {
        c1235Ek.getEventBus().A04(this.A0A, this.A09, this.A08, this.A07);
        this.A03 = null;
    }
