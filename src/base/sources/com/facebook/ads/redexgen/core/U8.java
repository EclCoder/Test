...
public final class U8 {
    ...
    public static synchronized void A03(T8 t10, Map<String, String> map, String str) {
        ...
        map.put(A00(35, 6, 107), C1621To.A04);
        C1621To c1621To = new C1621To(t10, str);
        map.put(A00(15, 7, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE), c1621To.A06());
        map.put(A00(8, 7, 61), c1621To.A05());
        map.put(A00(0, 8, 52), String.valueOf(c1621To.A04()));
        map.put(A00(28, 5, 71), c1621To.A0A());
