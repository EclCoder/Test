...
public final class Z3 extends RelativeLayout {
    ...
    public Z3(C2198gi c2198gi, int i10, int i11, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c2198gi);
        this.A05 = new TextView(c2198gi);
        this.A02 = new Button(c2198gi);
        this.A01 = new Button(c2198gi);
        ...
        int iA02 = P3.A02(i11, 20);
        YB.A0Q(this.A02, i10, A07);
