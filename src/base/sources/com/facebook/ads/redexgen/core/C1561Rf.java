...
public final class C1561Rf implements AudienceNetworkActivityApi {
    ...
    public C1561Rf(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi, C1560Re c1560Re) {
    ...
    private void A02(Throwable th2) {
        ...
        if (logContext != null) {
            logContext.A08().ABC(A00(38, 11, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), AbstractC1610Td.A0C, new C1611Te(th2));
            return;
        }
