...
public class C1521Pp implements YT {
    public static byte[] A04;
    public C2194ge A00;
    public C1629Tw A01;
    public InterfaceC2149fv A02;
    ...
    public C1521Pp(Executor executor, C1629Tw c1629Tw, C2198gi c2198gi) {
        this.A00 = c2198gi.A02();
        this.A02 = C2167gD.A01(this.A00);
        this.A03 = executor;
        this.A01 = c1629Tw;
    }
    ...
    public Map<String, String> A02(String str) {
        ...
        C2163g9 c2163g10 = new C2163g9();
        C2163g9 c2163g11 = new C2163g9();
        c2163g9.put(A03(257, 15, 52), SZ.A00().A03());
        c2163g9.put(A03(Sdk$SDKError.b.AD_RESPONSE_RETRY_AFTER_VALUE, 9, 15), A03(15, 15, 91));
        c2163g9.put(A03(186, 11, 79), A03(0, 15, 101));
        c2163g9.put(A03(174, 12, 79), A03(30, 48, 92));
        c2163g9.put(A03(197, 11, Sdk$SDKError.b.TPAT_ERROR_VALUE), (System.currentTimeMillis() / 1000) + A03(0, 0, 108));
        String strA09 = this.A01.A09();
        if (strA09 != null) {
            c2163g11.put(A03(Sdk$SDKError.b.INVALID_BID_PAYLOAD_VALUE, 12, 53), strA09);
        }
        c2163g10.put(A03(229, 11, 80), str);
        c2163g10.put(A03(248, 9, 97), AbstractC1709Xd.A01(c2163g11));
        c2163g9.A04(A03(PsExtractor.VIDEO_STREAM_MASK, 8, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE), AbstractC1709Xd.A01(c2163g10));
        return c2163g9;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A07(C1629Tw c1629Tw) {
        this.A01 = c1629Tw;
    }
