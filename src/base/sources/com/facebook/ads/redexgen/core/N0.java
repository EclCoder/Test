...
public final class N0 {
    ...
    public InterfaceC1449Ms A04;
    public UserReturnTracker$UserReturnListener A05;
    public final VA A08;
    public long A01 = 0;
    public long A00 = 0;
    public String A06 = null;
    public EnumC1447Mq A03 = null;
    ...
    public N0(VA va2, final Activity activity, int i10) {
        this.A08 = va2;
    ...
    public static N0 A01(VA va2, Activity activity, int i10) {
        if (activity != null && i10 >= 14) {
            return new N0(va2, activity, i10);
        }
        return null;
    }

    private void A04(String str, long j10, long j11, EnumC1447Mq enumC1447Mq) {
        HashMap map = new HashMap();
        map.put(A02(54, 10, 111), Long.toString(j10));
        map.put(A02(45, 9, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE), Long.toString(j11));
        if (enumC1447Mq != null) {
            map.put(A02(64, 7, 66), enumC1447Mq.name());
        }
    ...
    public final void A05() {
        ...
        if (this.A00 - this.A01 < 2000 && this.A04 != null) {
            InterfaceC1449Ms interfaceC1449Ms = this.A04;
            if (A0A[2].length() != 10) {
                throw new RuntimeException();
            }
            A0A[1] = "";
            interfaceC1449Ms.AFa();
        }
        if (this.A06 != null) {
            ...
            if (application != null && (this.A02.getBaseContext() instanceof C2198gi)) {
                ((C2198gi) this.A02.getBaseContext()).A08().ABC(A02(71, 9, 21), AbstractC1610Td.A22, new C1611Te(strA02));
            }
            Log.w(A0B, strA02);
        }
    ...
    public final void A06(EnumC1447Mq enumC1447Mq) {
        this.A03 = enumC1447Mq;
    }

    public final void A07(InterfaceC1449Ms interfaceC1449Ms) {
        this.A04 = interfaceC1449Ms;
    }
