...
public abstract class AbstractC09271r<E> extends AbstractC1134Ai<E> implements List<E> {
    ...
    public static final C2782qk A02;
    ...
    public int lastIndexOf(E element) {
        AbstractC09271r<E> abstractC09271r = this;
        ListIterator<E> listIterator = abstractC09271r.listIterator(abstractC09271r.size());
        while (listIterator.hasPrevious()) {
            if (C2772qY.A0C(listIterator.previous(), element)) {
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC1134Ai, java.util.Collection, java.lang.Iterable, java.util.List
    public Iterator<E> iterator() {
        return new C1133Ah(this);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator() {
        return new C09281s(this, 0);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator(int index) {
        return new C09281s(this, index);
    }
