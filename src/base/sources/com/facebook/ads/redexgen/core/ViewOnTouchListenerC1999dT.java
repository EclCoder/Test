...
public class ViewOnTouchListenerC1999dT implements View.OnTouchListener {
    ...
    public ViewOnTouchListenerC1999dT(C5F c5f) {
        this.A00 = c5f;
    }
            ...
            case 1:
                ...
                if (A02[2].charAt(15) != 'o') {
                    ...
                    if (!z10 && this.A00.A07 >= 5) {
                        this.A00.A0N = true;
                        this.A00.A0i(A00(0, 14, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE));
                        return false;
                    }
                    return false;
                }
