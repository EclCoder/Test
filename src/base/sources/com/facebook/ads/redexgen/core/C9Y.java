                ...
                while (true) {
                    ...
                    if (newSampleRate2 < oldSampleRate3 - 1) {
                        while (true) {
                            ...
                            int position2 = (position + 1) * i11;
                            int oldSampleRate4 = this.A03;
                            if (position2 <= oldSampleRate4 * i12) {
                                break;
                            }
                            short[] sArr = this.A0B;
                            int oldSampleRate5 = this.A05;
                            this.A0B = A0G(sArr, oldSampleRate5, 1);
                            for (int i13 = 0; i13 < oldSampleRate; i13++) {
                                short[] sArr2 = this.A0B;
                                int i14 = this.A05;
                                int oldSampleRate6 = this.A0G;
                                int i15 = (i14 * oldSampleRate6) + i13;
                                short[] sArr3 = this.A0C;
                                int oldSampleRate7 = this.A0G;
                                sArr2[i15] = A05(sArr3, (oldSampleRate7 * newSampleRate2) + i13, i12, i11);
                            }
                        ...
                        if (oldSampleRate11 == i12) {
                            this.A04 = 0;
                            int oldSampleRate12 = this.A03;
                            AbstractC09823y.A08(oldSampleRate12 == i11);
                            this.A03 = 0;
                        }
                        newSampleRate2++;
                    } else {
