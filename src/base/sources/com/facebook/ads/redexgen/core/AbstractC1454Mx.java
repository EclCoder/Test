...
public abstract class AbstractC1454Mx {
    ...
    public static EnumC1452Mv A00(JSONObject jSONObject) {
        return EnumC1452Mv.A00(jSONObject.optString(A02(52, 21, 9)));
    }

    public static C2404kJ A01(C2198gi c2198gi, JSONObject jSONObject, String str) {
        return new C2404kJ(jSONObject, c2198gi, str);
    }

    public static Collection<String> A03(C2198gi c2198gi, JSONObject jSONObject) {
        ...
        try {
            ...
            c2198gi.A08().ABC(A02(73, 7, 26), AbstractC1610Td.A2C, new C1611Te(e10));
        }
    ...
    public static boolean A06(C2198gi c2198gi, InterfaceC1453Mw interfaceC1453Mw, VA va2) {
        EnumC1452Mv enumC1452MvA8K = interfaceC1453Mw.A8K();
        if (enumC1452MvA8K != null) {
            EnumC1452Mv invalidationBehavior = EnumC1452Mv.A03;
            if (enumC1452MvA8K != invalidationBehavior) {
                boolean packageInstalled = false;
                Collection<String> collectionA7p = interfaceC1453Mw.A7p();
                if (collectionA7p == null || collectionA7p.isEmpty()) {
                    return false;
                }
                Iterator<String> it = collectionA7p.iterator();
                while (it.hasNext()) {
                    if (AbstractC1714Xi.A04(c2198gi, it.next())) {
                        packageInstalled = true;
                        break;
                    }
                }
                EnumC1452Mv invalidationBehavior2 = EnumC1452Mv.A02;
                if (packageInstalled != (enumC1452MvA8K == invalidationBehavior2)) {
                    return false;
                }
                String clientToken = interfaceC1453Mw.A7O();
                if (!TextUtils.isEmpty(clientToken)) {
                    va2.ABK(clientToken, null);
                    return true;
                }
                c2198gi.A08().ABC(A02(32, 3, 61), AbstractC1610Td.A0Z, new C1611Te(A02(0, 32, 80)));
                return true;
            }
        }
        return false;
