...
import com.facebook.ads.redexgen.core.AbstractC2678oz;
import com.facebook.ads.redexgen.core.AnonymousClass61;
import com.facebook.ads.redexgen.core.C2679p0;
import java.util.ArrayDeque;
import java.util.Arrays;

/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.oy, reason: case insensitive filesystem */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public abstract class AbstractC2677oy<I extends C2679p0, O extends AbstractC2678oz, E extends AnonymousClass61> implements AnonymousClass60<I, O, E> {
    ...
    public AbstractC2677oy(I[] iArr, O[] oArr) {
        this.A0B = iArr;
    ...
    public final I A5r() throws AnonymousClass61 {
        ...
        synchronized (this.A07) {
            A0Q();
            AbstractC09823y.A08(this.A04 == null);
            if (this.A00 == 0) {
                i10 = null;
            } else {
                I[] iArr = this.A0B;
    ...
    public final void A0d(int i10) {
        AbstractC09823y.A08(this.A00 == this.A0B.length);
        for (I i11 : this.A0B) {
            i11.A0C(i10);
        }
    }
    ...
    public final void AHJ(I inputBuffer) throws AnonymousClass61 {
        synchronized (this.A07) {
            A0Q();
            AbstractC09823y.A07(inputBuffer == this.A04);
