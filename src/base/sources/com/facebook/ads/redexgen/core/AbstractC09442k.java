...
public abstract class AbstractC09442k {
    ...
    public static int A00(Uri uri) {
        ...
        if (!lastPathSegment.endsWith(filename)) {
            ...
            if (!lastPathSegment.endsWith(filename2)) {
                ...
                String filename4 = A03(12, 5, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE);
                ...
                String filename8 = A03(38, 4, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE);
                ...
                if (!lastPathSegment.endsWith(filename9)) {
                    ...
                    if (!lastPathSegment.endsWith(filename10)) {
                        ...
                        if (!lastPathSegment.startsWith(strA03, length - (strA03.length() + 1))) {
                            String filename12 = A03(Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE, 5, 33);
                                        ...
                                        if (!lastPathSegment.endsWith(filename15)) {
                                            ...
                                            if (!lastPathSegment.endsWith(filename16)) {
                                                ...
                                                if (!lastPathSegment.endsWith(filename17)) {
                                                    String filename18 = A03(51, 4, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL);
                                                    if (!lastPathSegment.endsWith(filename18)) {
                                                        ...
                                                        String filename20 = A03(Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE, 5, 95);
                                                        ...
                                                        String filename22 = A03(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 7, 55);
                                                        if (lastPathSegment.endsWith(filename22)) {
                                                            return 13;
                                                        }
                                                        String filename23 = A03(47, 4, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE);
                                                        if (lastPathSegment.endsWith(filename23)) {
                                                            return 14;
                                                        }
                                                        String filename24 = A03(42, 5, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE);
    ...
    public static int A01(String str) {
        ...
        String strA08 = C3J.A08(str);
        switch (strA08.hashCode()) {
            case -2123537834:
                if (strA08.equals(A03(232, 14, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL))) {
                    b10 = 2;
                } else {
                    b10 = -1;
                }
            ...
            case -1662384011:
                if (strA08.equals(A03(347, 10, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE))) {
                    b10 = 20;
                } else {
                    b10 = -1;
                }
            ...
            case -1662384007:
                if (strA08.equals(A03(357, 10, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE))) {
                    b10 = 21;
                } else {
                    b10 = -1;
                }
            ...
            case -1606874997:
                if (strA08.equals(A03(Sdk$SDKError.b.AD_NOT_LOADED_VALUE, 12, 33))) {
                    b10 = 6;
                } else {
                    b10 = -1;
                }
            ...
            case -387023398:
                if (strA08.equals(A03(Sdk$SDKError.b.EVALUATE_JAVASCRIPT_FAILED_VALUE, 16, Sdk$SDKError.b.TPAT_ERROR_VALUE))) {
                    b10 = 11;
                } else {
                    b10 = -1;
                }
            ...
            case 187078296:
                ...
                throw new RuntimeException();
            case 187078297:
                if (strA08.equals(A03(PsExtractor.AUDIO_STREAM, 9, 8))) {
                    b10 = 3;
                } else {
                    b10 = -1;
                }
            ...
            case 187090232:
                if (strA08.equals(A03(266, 9, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE))) {
                    b10 = 17;
                } else {
                    b10 = -1;
                }
            ...
            case 1503095341:
                if (strA08.equals(A03(TTAdConstant.IMAGE_MODE_VERTICAL_IMG_173, 10, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE))) {
                    b10 = 5;
                } else {
                    b10 = -1;
                }
            ...
            case 1504578661:
                if (strA08.equals(A03(Sdk$SDKError.b.INVALID_WATERFALL_PLACEMENT_ID_VALUE, 10, 35))) {
                    b10 = 1;
                } else {
                    b10 = -1;
                }
            ...
            case 1505118770:
                if (strA08.equals(A03(HttpStatusCodes.STATUS_CODE_SEE_OTHER, 10, 52))) {
                    b10 = 13;
                } else {
                    b10 = -1;
                }
