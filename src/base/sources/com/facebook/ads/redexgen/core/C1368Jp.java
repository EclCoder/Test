...
public final class C1368Jp {
    ...
    public final C1367Jo A05() {
        ...
        for (int i12 = 0; i12 < this.A0L.size(); i12++) {
            spannableStringBuilder.append((CharSequence) this.A0L.get(i12));
            ...
            case 3:
                ...
                if (this.A00 % 3 == 0) {
                    ...
                    if (strArr2[6].length() == strArr2[2].length()) {
                        String[] strArr3 = A0N;
                        strArr3[0] = "Fa7UQvLnbqmxFbTcY1UUAPqIv3qiyseY";
                        strArr3[5] = "Rn7fSkhECSao3Se51ChHFeFA96BWKZhu";
                    }
                } else {
                    if (this.A00 % 3 == 1) {
                        i11 = 1;
                ...
                return new C1367Jo(spannableStringBuilder, alignment, f13, 0, i10, f12, i11, -3.4028235E38f, z10, this.A0E, this.A09);
            case 1:
                ...
                if (strArr5[1].length() != strArr5[3].length()) {
                    ...
                    float f14 = (f10 * 0.9f) + 0.05f;
                    float f15 = (0.9f * f11) + 0.05f;
                    if (this.A00 / 3 == 0) {
                        i10 = 0;
                    } else if (this.A00 / 3 == 1) {
                        i10 = 1;
                    ...
                    if (this.A00 % 3 == 0) {
                        ...
                        if (strArr2[6].length() == strArr2[2].length()) {
                            String[] strArr7 = A0N;
                            strArr7[0] = "Fa7UQvLnbqmxFbTcY1UUAPqIv3qiyseY";
                            strArr7[5] = "Rn7fSkhECSao3Se51ChHFeFA96BWKZhu";
                        }
                    } else if (this.A00 % 3 == 1) {
                        i11 = 1;
                        strArr = A0N;
                        if (strArr[6].length() == strArr[2].length()) {
                            String[] strArr8 = A0N;
                            strArr8[6] = "EFcN8K0y7Hbu8UhXppleE";
                            strArr8[2] = "H3lBazkydsESAKcSyiLhJ";
                        }
                    } else {
                        i11 = 2;
                    }
                    ...
                    return new C1367Jo(spannableStringBuilder, alignment, f15, 0, i10, f14, i11, -3.4028235E38f, z10, this.A0E, this.A09);
                }
                throw new RuntimeException();
            case 2:
                ...
                float f16 = (f10 * 0.9f) + 0.05f;
                float f17 = (0.9f * f11) + 0.05f;
                if (this.A00 / 3 == 0) {
                    i10 = 0;
                } else if (this.A00 / 3 == 1) {
                    i10 = 1;
                ...
                if (this.A00 % 3 == 0) {
                    ...
                    if (strArr2[6].length() == strArr2[2].length()) {
                        String[] strArr9 = A0N;
                        strArr9[0] = "Fa7UQvLnbqmxFbTcY1UUAPqIv3qiyseY";
                        strArr9[5] = "Rn7fSkhECSao3Se51ChHFeFA96BWKZhu";
                    }
                } else {
                    if (this.A00 % 3 == 1) {
                        i11 = 1;
                        ...
                        if (strArr[6].length() == strArr[2].length()) {
                            String[] strArr10 = A0N;
                            strArr10[6] = "EFcN8K0y7Hbu8UhXppleE";
                            strArr10[2] = "H3lBazkydsESAKcSyiLhJ";
                        }
                        throw new RuntimeException();
                    }
                    i11 = 2;
                ...
                return new C1367Jo(spannableStringBuilder, alignment, f17, 0, i10, f16, i11, -3.4028235E38f, z10, this.A0E, this.A09);
            default:
    ...
    public static int A01(int i10, int i11, int i12, int i13) {
        int i14;
        AbstractC09823y.A00(i10, 0, 4);
        AbstractC09823y.A00(i11, 0, 4);
        AbstractC09823y.A00(i12, 0, 4);
        AbstractC09823y.A00(i13, 0, 4);
        switch (i13) {
            case 0:
            case 1:
                i14 = 255;
