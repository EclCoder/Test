...
public class HandlerThreadC1259Fi extends HandlerThread implements Handler.Callback {
    ...
    public HandlerThreadC1259Fi() {
        super(A00(77, 12, 62));
    }

    private void A01() {
        AbstractC09823y.A01(this.A01);
        this.A01.A08();
    }
    ...
    public final DummySurface A04(int i10) {
        ...
        if (this.A04 == null) {
            if (this.A03 == null) {
                return (DummySurface) AbstractC09823y.A01(this.A02);
            }
            throw this.A03;
        }
        throw this.A04;
            ...
            switch (message.what) {
                case 1:
                    try {
                        ...
                        AbstractC09904g.A08(A00(0, 12, 34), A00(12, 34, 23), e10);
                        this.A03 = e10;
                        synchronized (this) {
                            notify();
                        }
                    } catch (RuntimeException e11) {
                        AbstractC09904g.A08(A00(0, 12, 34), A00(12, 34, 23), e11);
                        this.A04 = e11;
                        synchronized (this) {
                            notify();
                            break;
                ...
                case 2:
                    try {
                        ...
                        try {
                            AbstractC09904g.A08(A00(0, 12, 34), A00(46, 31, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE), th2);
                        } finally {
                            quit();
                        }
                        break;
