...
public final class C2675ow implements AnonymousClass78 {
    ...
    public InterfaceC2667oo A01;
    public boolean A04;
    public final C6P A05;
    public final C2663ok A06;
    ...
    public boolean A02 = MetaExoPlayerUpgradeConfig.A03(EnumC2358jX.A1h);
    ...
    public C2675ow(C6P c6p, AnonymousClass45 anonymousClass45) {
        this.A05 = c6p;
        this.A06 = new C2663ok(anonymousClass45);
    }
    ...
    private void A02(boolean z10) {
        ...
        AnonymousClass78 anonymousClass78 = (AnonymousClass78) AbstractC09823y.A01(this.A00);
        ...
        this.A06.A02(jA8p);
        C2737px c2737pxA8m = anonymousClass78.A8m();
        AnonymousClass78 rendererClock2 = this.A06;
        if (!c2737pxA8m.equals(rendererClock2.A8m())) {
            AnonymousClass78 rendererClock3 = this.A06;
            rendererClock3.AJd(c2737pxA8m);
            this.A05.AFI(c2737pxA8m);
        }
    }

    private boolean A03(boolean z10) {
        if (this.A01 != null) {
            InterfaceC2667oo interfaceC2667oo = this.A01;
            String[] strArr = A08;
            if (strArr[0].charAt(6) != strArr[7].charAt(6)) {
                throw new RuntimeException();
            }
    ...
    public final void A08(InterfaceC2667oo interfaceC2667oo) {
        if (interfaceC2667oo == this.A01) {
            this.A00 = null;
            this.A01 = null;
            this.A03 = true;
        }
    ...
    public final void A09(InterfaceC2667oo interfaceC2667oo) throws AD {
        AnonymousClass78 anonymousClass78A8T = interfaceC2667oo.A8T();
        if (anonymousClass78A8T != null) {
            ...
            if (anonymousClass78A8T != rendererMediaClock) {
                ...
                if (anonymousClass78 == null) {
                    ...
                    this.A01 = interfaceC2667oo;
                    AnonymousClass78 anonymousClass79 = this.A00;
                    AnonymousClass78 rendererMediaClock2 = this.A06;
                    anonymousClass79.AJd(rendererMediaClock2.A8m());
                    return;
                }
    ...
    public final long A8p() {
        ...
        return ((AnonymousClass78) AbstractC09823y.A01(this.A00)).A8p();
    }
    ...
    public final void AJd(C2737px c2737px) {
        if (this.A00 != null) {
            this.A00.AJd(c2737px);
            c2737px = this.A00.A8m();
        }
        this.A06.AJd(c2737px);
        if (this.A02) {
            this.A05.AFI(c2737px);
        }
    }
}
