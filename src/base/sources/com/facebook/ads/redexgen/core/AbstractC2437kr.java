...
public abstract class AbstractC2437kr implements InterfaceC1407Lc {
    ...
    static {
        A04();
        A03 = AbstractC2437kr.class.getSimpleName();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A06(File file) throws IOException {
        C1410Lf.A03(file);
        List<File> files = C1410Lf.A01(file.getParentFile());
        A07(files);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC1407Lc
    public void AKR(File file) throws IOException {
        this.A00.submit(new CallableC1411Lg(this, file));
    }
}
