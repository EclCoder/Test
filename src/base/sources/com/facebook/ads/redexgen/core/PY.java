...
public class PY extends R7 {
    ...
    public final void A0L(C7M c7m, int i10) {
        int iA25;
        InterfaceC1746Yo interfaceC1746Yo;
        super.A0L(c7m, i10);
        C2268hr linearLayoutManager = this.A00.getLayoutManager();
        if (linearLayoutManager != null && (iA25 = linearLayoutManager.A25()) >= 0) {
            ...
            if (c1j.getAdapter() == null || iA25 >= this.A00.getAdapter().A0B() || (interfaceC1746Yo = (InterfaceC1746Yo) c7m.A1F(iA25)) == null) {
                return;
            }
            interfaceC1746Yo.AJF();
        }
    }
}
