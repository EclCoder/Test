...
public final class EnumC2351jL {
    ...
    public static final /* synthetic */ InterfaceC1128Ac A02;
    public static final /* synthetic */ EnumC2351jL[] A03;
    public static final EnumC2351jL A04;
    public static final EnumC2351jL A05;
    ...
    public static final /* synthetic */ EnumC2351jL[] A02() {
        EnumC2351jL[] enumC2351jLArr = new EnumC2351jL[2];
        EnumC2351jL enumC2351jL = A04;
        String[] strArr = A01;
        if (strArr[5].charAt(11) == strArr[7].charAt(11)) {
            throw new RuntimeException();
        }
        A01[4] = "Fkm6UCeGNRQRi4wWDBIOpvvd9TujRbQP";
        enumC2351jLArr[0] = enumC2351jL;
        enumC2351jLArr[1] = A05;
        return enumC2351jLArr;
    }

    static {
        A01();
        A04 = new EnumC2351jL(A00(0, 11, 97), 0);
        A05 = new EnumC2351jL(A00(11, 8, 38), 1);
        A03 = A02();
        A02 = AbstractC2775qd.A01(A03);
    }

    public EnumC2351jL(String str, int i10) {
        super(str, i10);
    }

    public static EnumC2351jL valueOf(String str) {
        return (EnumC2351jL) Enum.valueOf(EnumC2351jL.class, str);
    }

    public static EnumC2351jL[] values() {
        return (EnumC2351jL[]) A03.clone();
    }
}
