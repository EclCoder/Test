...
public abstract class H7 {
    ...
    static {
        ...
        A04 = new int[]{64, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE, 128, PsExtractor.AUDIO_STREAM, 224, 256, 384, 448, 512, 640, 768, 896, UserVerificationMethods.USER_VERIFY_ALL, 1152, 1280, 1536, 1920, 2048, 2304, 2560, 2688, 2816, 2823, 2944, 3072, 3840, 4096, 6144, 7680};
    }
    ...
    public static C2758qI A03(byte[] bArr, String str, String str2, DrmInitData drmInitData) {
        int i10;
        C10044u c10044uA04 = A04(bArr);
        c10044uA04.A09(60);
        int amode = c10044uA04.A04(6);
        int bitrate = A02[amode];
        int amode2 = c10044uA04.A04(4);
        int rate = A03[amode2];
        int amode3 = c10044uA04.A04(5);
        ...
        c10044uA04.A09(10);
        int amode4 = c10044uA04.A04(2);
        int amode5 = amode4 > 0 ? 1 : 0;
        return new C09492p().A0y(str).A11(A05(0, 13, 27)).A0a(i10).A0b(bitrate + amode5).A0m(rate).A0u(drmInitData).A10(str2).A14();
    }

    public static C10044u A04(byte[] bArr) {
        if (bArr[0] == 127) {
            return new C10044u(bArr);
        }
        ...
        if (bArrCopyOf[0] == 31) {
            C10044u c10044u2 = new C10044u(bArrCopyOf);
            while (c10044u2.A01() >= 16) {
                c10044u2.A09(2);
                int iA04 = c10044u2.A04(14);
                if (A01[4].length() == 13) {
                    throw new RuntimeException();
                }
                String[] strArr = A01;
