...
public abstract class AbstractC10255p {
    ...
    static {
        A04();
        A03 = Pattern.compile(A02(Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE, 28, 72));
    ...
    public static long A00(String str) {
        ...
        if (matcher.matches()) {
            return Long.parseLong((String) AbstractC09823y.A01(matcher.group(1)));
        }
        return -1L;
    }
    ...
    public static long A01(String str, String str2) {
        ...
        if (!zIsEmpty) {
            try {
                ...
                AbstractC09904g.A05(strA03, A02(31, 27, 88) + str + strA02);
            }
        }
        if (!TextUtils.isEmpty(str2)) {
            ...
            if (matcher.matches()) {
                try {
                    long j10 = (Long.parseLong((String) AbstractC09823y.A01(matcher.group(2))) - Long.parseLong((String) AbstractC09823y.A01(matcher.group(1)))) + 1;
                    if (jMax < 0) {
                        return j10;
                    }
                    if (jMax != j10) {
                        AbstractC09904g.A07(strA03, A02(9, 22, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE) + str + A02(85, 3, 111) + str2 + strA02);
                        jMax = Math.max(jMax, j10);
                        return jMax;
                    }
                    return jMax;
                } catch (NumberFormatException unused2) {
                    AbstractC09904g.A05(strA03, A02(58, 26, Sdk$SDKError.b.TPAT_ERROR_VALUE) + str2 + strA02);
                    return jMax;
                }
            }
            return jMax;
