...
public abstract class WI {
    ...
    public static String A02(T8 t10) {
        String loggingEndpointPrefix = C1648Up.A0X(t10);
    ...
    public static String A04(T8 t10) {
        String syncEndpointPrefix = C1648Up.A0Y(t10);
    ...
    public static String A05(T8 t10) {
        ...
        String urlOverride = A00(66, 28, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE);
    ...
    public static String A08(String str, String str2) {
        ...
        return str.replace(A00(AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL, 3, 79), str2);
    }
}
