...
public final class C1470No implements Serializable {
    ...
    public static final EnumC1471Np A0S;
    public static final EnumC1859bD A0T;
    ...
    public final EnumC1471Np A0D;
    public final EnumC1859bD A0E;
    ...
    public C1470No(String str, String str2, int i10, String str3, String str4, EnumC1859bD enumC1859bD, int i11, boolean z10, boolean z11, EnumC1471Np enumC1471Np, boolean z12, String str5, boolean z13, boolean z14, int i12, String str6, String str7, int i13, String str8, boolean z15, boolean z16, int i14, boolean z17, int i15, String str9) {
        if (z12) {
        ...
        this.A0J = str3;
        this.A0F = str4;
        this.A0E = enumC1859bD;
        this.A0C = i11;
        this.A0L = z10;
        this.A06 = z11;
        this.A0D = enumC1471Np;
        this.A0M = z12;
        this.A08 = z13;
        this.A07 = z14;
        this.A01 = i12;
    ...
    public static C1470No A02(JSONObject jSONObject) {
        boolean z10;
        JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A04(340, 13, 62));
        if (jSONObjectOptJSONObject == null) {
            return null;
        }
        EnumC1471Np enumC1471NpA00 = EnumC1471Np.A00(jSONObjectOptJSONObject.optString(A04(499, 17, 24), A0S.name()));
        ...
        EnumC1859bD enumC1859bDA03 = A03(jSONObjectOptJSONObject);
        int iOptInt = jSONObjectOptJSONObject.optInt(A04(717, 32, 38), 5000);
        if (!zOptBoolean) {
            String precachingMethodStr4 = A04(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 17, 90);
        ...
        String precachingMethodStr5 = A04(Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE, 15, 104);
        ...
        String precachingMethodStr8 = A04(TTAdConstant.PACKAGE_NAME_CODE, 25, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE);
        ...
        String strOptString4 = jSONObject.optString(A04(375, 24, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), A04(68, 11, 101));
        String strOptString5 = jSONObject.optString(A04(353, 22, 80), A04(Sdk$SDKError.b.AD_WIN_NOTIFICATION_ERROR_VALUE, 15, 27));
        ...
        String precachingMethodStr12 = A04(Sdk$SDKError.b.AD_LOAD_FAIL_RETRY_AFTER_VALUE, 39, 73);
        ...
        int iOptInt4 = jSONObjectOptJSONObject.optInt(precachingMethodStr13, AuthApiStatusCodes.AUTH_API_INVALID_CREDENTIALS);
    ...
    public final EnumC1471Np A0G() {
        return this.A0D;
    }

    public final EnumC1859bD A0H() {
        return this.A0E;
    }
