...
public final class C2059eS {
    ...
    public final AbstractC2363jd A0d;
    public final NN A0e;
    public final NY A0f;
    public final C1459Nd A0g;
    public final C1468Nm A0h;
    public final C2198gi A0i;
    public final VI A0j;
    public final InterfaceC1739Yh A0k;
    public final ViewOnClickListenerC1396Kr A0l;
    public int A06 = 160;
    public int A07 = 130;
    public int A03 = 56;
    public int A04 = 430;
    public int A0K = 110;
    public int A0L = 70;
    public int A0A = AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL;
    public int A0G = 48;
    public int A0F = 44;
    public int A0D = 24;
    public int A0C = 20;
    ...
    public int A0E = 4;
    public int A0J = 530;
    public int A0I = HttpStatusCodes.STATUS_CODE_MULTIPLE_CHOICES;
    public int A05 = Sdk$SDKError.b.AD_RESPONSE_RETRY_AFTER_VALUE;
    ...
    public C2059eS(final C2198gi c2198gi, AbstractC2363jd abstractC2363jd, InterfaceC1739Yh interfaceC1739Yh, ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr, Handler handler, VI vi2) {
        this.A0i = c2198gi;
        this.A0d = abstractC2363jd;
        this.A0j = vi2;
        this.A0h = abstractC2363jd.A2C();
        this.A0g = abstractC2363jd.A29().A0K();
        this.A0k = interfaceC1739Yh;
        this.A0b = handler;
        this.A0f = abstractC2363jd.A29().A0I();
        this.A0e = abstractC2363jd.A28();
        this.A0l = viewOnClickListenerC1396Kr;
        this.A0S = new C7M(c2198gi) { // from class: com.facebook.ads.redexgen.X.1E
        ...
        this.A0P = new RelativeLayout(c2198gi);
        this.A0W = new C1892bk(c2198gi);
        this.A0R = new TextView(c2198gi);
        this.A0M = new ImageView(c2198gi);
    ...
    private ImageView A03() {
        ...
        if (this.A0l != null && this.A0l.getCtaActionHelper().A06() == null) {
            this.A0l.getCtaActionHelper().A07(new InterfaceC1448Mr() { // from class: com.facebook.ads.redexgen.X.FQ
    ...
    private LinearLayout A06() {
        ...
        arrayList.add(new C2062eV(this.A0i).A02(new C1881bZ(this.A0i, -1, -1, YM.RATINGS)).A04(this.A0f.A0C()).A03(this.A0f.A0B()));
        if (!this.A0f.A09().isEmpty()) {
            try {
                strA09 = AbstractC1712Xg.A01(Integer.parseInt(this.A0f.A09()));
            } catch (NumberFormatException unused) {
                strA09 = this.A0f.A09();
            }
            arrayList.add(new C2062eV(this.A0i).A02(new C1881bZ(this.A0i, -1, -1, YM.NUCLEUS_GROUP)).A04(strA09).A03(this.A0f.A0A()));
        }
        if (!this.A0f.A05().isEmpty()) {
            arrayList.add(new C2062eV(this.A0i).A02(new C1881bZ(this.A0i, -1, -1, YM.DOWNLOAD)).A04(this.A0f.A05()).A03(this.A0f.A06()));
        }
        NY ny = this.A0f;
        if (A0o[2].length() == 29) {
            throw new RuntimeException();
        ...
        A0o[2] = "3vpsIj";
        if (!ny.A01().isEmpty()) {
            arrayList.add(new C2062eV(this.A0i).A02(new C1881bZ(this.A0i, -1, -1, YM.NUCLEUS_DURATION)).A04(this.A0f.A01()).A03(this.A0f.A0D()));
        }
        if (!this.A0f.A02().isEmpty()) {
            arrayList.add(new C2062eV(this.A0i).A02(new C1881bZ(this.A0i, -1, -1, YM.GRID_4)).A04(this.A0f.A02()).A03(this.A0f.A03()));
        }
    ...
    private LinearLayout A07(RelativeLayout relativeLayout, ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr) {
        LinearLayout linearLayout = new LinearLayout(this.A0i);
        linearLayout.setOrientation(0);
        linearLayout.setGravity(17);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(3, viewOnClickListenerC1396Kr.getId());
        ...
        linearLayout.setId(View.generateViewId());
        C1881bZ iconView = new C1881bZ(this.A0i, -1, -1, YM.GOOGLE_PLAY_STORE);
    ...
    private RelativeLayout.LayoutParams A08(LinearLayout linearLayout) {
        int i10;
        int i11 = this.A0i.getResources().getConfiguration().orientation;
        if (linearLayout == null || this.A0Y || i11 == 2) {
    ...
    private RelativeLayout.LayoutParams A0B(C1892bk c1892bk) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(14);
        layoutParams.addRule(3, c1892bk.getId());
    ...
    private TextView A0E(RelativeLayout relativeLayout, C1892bk c1892bk) {
        TextView textView = new TextView(this.A0i);
        ...
        textView.setLayoutParams(A0B(c1892bk));
        relativeLayout.addView(textView);
        textView.setId(View.generateViewId());
        return textView;
    }

    private C1892bk A0G(LinearLayout linearLayout) {
        C1892bk c1892bk = new C1892bk(this.A0i);
        c1892bk.setRadius(30);
        YB.A0N(c1892bk, 0);
        LM downloadImageTask = new LM(c1892bk, this.A0i).A04();
        downloadImageTask.A07(this.A0h.A01());
        c1892bk.setLayoutParams(A08(linearLayout));
        c1892bk.setId(View.generateViewId());
        return c1892bk;
    }
    ...
    private void A0I() {
        ...
        if (shouldShowThirdEndCard2 && this.A0g.A00() > 0) {
            ...
            AbstractC2061eU.A01(this.A0i, this.A0M, this.A0g.A00(), this.A0N);
        }
    }
    ...
    private void A0L() {
        ...
        if (parent2 instanceof ViewGroup) {
            this.A0m.set(true);
            this.A0X = new C1927cJ(this.A0i, this.A0d, this.A0j, this.A0b, this.A0k);
    ...
    private void A0Q(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr) {
        this.A0T = AbstractC1808aO.A01(this.A0i, false, this.A0d, this.A0j, this.A0k, EnumC1806aM.A02, AbstractC1805aL.A00(this.A0d));
        YB.A0K(this.A0T);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0B, 0, this.A0B);
        layoutParams.addRule(7, viewOnClickListenerC1396Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
        this.A0T.setLayoutParams(layoutParams);
        relativeLayout.addView(this.A0T);
    }

    private void A0R(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr) {
        this.A0U = AbstractC1808aO.A01(this.A0i, false, this.A0d, this.A0j, this.A0k, EnumC1806aM.A02, EnumC1809aP.A04);
        YB.A0K(this.A0U);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0H, 0, this.A0B);
        layoutParams.addRule(5, viewOnClickListenerC1396Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
        this.A0U.setLayoutParams(layoutParams);
        relativeLayout.addView(this.A0U);
    }

    private void A0S(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr) {
        this.A0V = AbstractC1808aO.A02(this.A0i, EnumC1806aM.A02, this.A0d);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0B, 0, this.A0B);
        layoutParams.addRule(5, viewOnClickListenerC1396Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
    ...
    private void A0T(RelativeLayout relativeLayout, ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr, LinearLayout linearLayout, TextView textView) {
        RelativeLayout.LayoutParams layoutParamsA09 = A09(linearLayout, textView);
        viewOnClickListenerC1396Kr.setIncludeFontPadding(false);
        viewOnClickListenerC1396Kr.setLayoutParams(layoutParamsA09);
        viewOnClickListenerC1396Kr.A0D();
        viewOnClickListenerC1396Kr.setHeight(this.A03);
        viewOnClickListenerC1396Kr.setTextSize(18.0f);
        viewOnClickListenerC1396Kr.setCornerRadiusPx(40);
        viewOnClickListenerC1396Kr.setTextColor(A00(this.A0e.A01().A04()));
        YB.A0V(viewOnClickListenerC1396Kr, YB.A06(this.A0e.A01().A04(), 40));
        ...
        relativeLayout.addView(viewOnClickListenerC1396Kr);
        String[] strArr = A0o;
        if (strArr[7].length() == strArr[5].length()) {
            throw new RuntimeException();
        }
    ...
    private void A0U(ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr) {
        this.A0S.setLayoutManager(new C2268hr(this.A0i, 0, false));
        ...
        this.A0S.setAdapter(new FO(this.A0i, this.A0g.A02(), this.A0H, this.A0S, viewOnClickListenerC1396Kr, i10));
    }

    private void A0V(final InterfaceC2058eR interfaceC2058eR) {
        final ImageView imageView = new ImageView(this.A0i);
        imageView.setAdjustViewBounds(true);
        LM lm2 = new LM(imageView, this.A0i);
        if (!this.A0g.A02().isEmpty()) {
            lm2.A06(new InterfaceC1854b8() { // from class: com.facebook.ads.redexgen.X.FR
                @Override // com.facebook.ads.redexgen.core.InterfaceC1854b8
                public final void AE7(C1853b7 c1853b7) {
                    this.A02.A0c(imageView, interfaceC2058eR, c1853b7);
                }
            });
            lm2.A07(this.A0g.A02().get(0));
        } else {
            interfaceC2058eR.AE9();
        }
    }
    ...
    public final FrameLayout A0W() {
        ...
        this.A0P = A0C();
        if (C1648Up.A1D(this.A0i)) {
            this.A0P.setOnClickListener(new ViewOnClickListenerC2056eP(this));
        }
        A0P(this.A0P);
        this.A0O = A06();
        ...
        if (this.A0d.A2T()) {
            ...
            blackBackgroundView.setOnClickListener(new ViewOnClickListenerC2057eQ(this));
        ...
        A0V(new InterfaceC2058eR() { // from class: com.facebook.ads.redexgen.X.FX
            @Override // com.facebook.ads.redexgen.core.InterfaceC2058eR
    ...
    public final void A0a(int i10) {
        if (!this.A0m.get()) {
            FO fo2 = (FO) this.A0S.getAdapter();
            if (fo2 == null) {
                this.A0i.A08().ABC(A0H(16, 11, 8), AbstractC1610Td.A0A, new C1611Te(A0H(72, 42, 15)));
            }
            if (this.A0l != null) {
    ...
    public final /* synthetic */ void A0b(View view) {
        if (this.A0l != null) {
            EnumC1447Mq enumC1447MqA0E = this.A0l.A0E(A0H(Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE, 4, 84));
            if (this.A0d.A2N()) {
                return;
            }
            EnumC1447Mq actionOutcome = EnumC1447Mq.A09;
            if (enumC1447MqA0E != actionOutcome) {
                EnumC1447Mq actionOutcome2 = EnumC1447Mq.A06;
                if (enumC1447MqA0E != actionOutcome2) {
                    A0Z();
                }
            }
        }
    ...
    public final /* synthetic */ void A0c(ImageView imageView, InterfaceC2058eR interfaceC2058eR, C1853b7 c1853b7) {
    ...
    public final void A0e(boolean z10) {
        if (!z10 && this.A0T != null) {
            this.A0T.A0P();
        }
        if (this.A0U != null) {
            C1803aJ c1803aJ = this.A0U;
            String[] strArr = A0o;
            if (strArr[6].charAt(0) == strArr[0].charAt(0)) {
                throw new RuntimeException();
            }
    ...
    public final /* synthetic */ void A0g(boolean z10, View view) {
        if (z10) {
            A0L();
        } else {
            this.A0i.A0F().AB0();
