...
public abstract class AbstractC1991dL {
     ...
     */
    public static C1990dK A00(C2198gi c2198gi, JSONObject jSONObject, C1604Sx c1604Sx, VI vi2, C1969cz c1969cz, boolean z10) {
        boolean z11;
        String strA0S;
        boolean z12 = z10;
        ...
        if (z12) {
            strA0S = c1604Sx.A0S(strOptString);
        ...
        try {
            ...
            if (jSONObjectOptJSONObject != null && jSONObjectOptJSONObject.optString(strA01) != null) {
                ...
                if (z11) {
                    jSONObjectOptJSONObject.put(strA01, c1604Sx.A0R(jSONObjectOptJSONObject.optString(strA01)));
                }
            }
            JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(A01(77, 15, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE));
            if (jSONArrayOptJSONArray != null) {
                for (int i10 = 0; i10 < jSONArrayOptJSONArray.length(); i10++) {
                    String strOptString2 = jSONArrayOptJSONArray.optString(i10);
                    arrayList.add(strOptString2);
                    if (z11) {
                        jSONArrayOptJSONArray.put(i10, c1604Sx.A0R(strOptString2));
                    }
                }
            }
            ...
            if (jSONArrayOptJSONArray2 != null) {
                for (int i11 = 0; i11 < jSONArrayOptJSONArray2.length(); i11++) {
                    A03(arrayList, arrayList2, jSONArrayOptJSONArray2.optJSONObject(i11), c1604Sx, z11);
                }
            } else {
                A03(arrayList, arrayList2, jSONObject, c1604Sx, z11);
            }
        } catch (JSONException unused) {
            c1969cz.A04(AbstractC1610Td.A15, A01(0, 43, 35));
        }
        return new C1990dK(jSONObject, strA0S, arrayList, arrayList2, arrayList3, z12);
    }
    ...
    public static void A03(ArrayList<String> imageUrls, ArrayList<String> videoUrls, JSONObject jSONObject, C1604Sx c1604Sx, boolean z10) throws JSONException {
        ...
        if (jSONObjectOptJSONObject != null) {
            ...
            if (jSONObjectOptJSONObject.optString(strA01) != null) {
                ...
                if (z10) {
                    jSONObjectOptJSONObject.put(strA01, c1604Sx.A0R(strOptString));
                }
            }
        }
        ...
        if (!TextUtils.isEmpty(jSONObject.optString(strA02))) {
            ...
            if (z10) {
                jSONObject.put(strA02, c1604Sx.A0S(strOptString2));
            }
        }
    }
}
