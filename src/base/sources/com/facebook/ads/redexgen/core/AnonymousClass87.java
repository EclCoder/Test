...
public final class AnonymousClass87 extends AbstractC2402kH {
    ...
    private final List<Intent> A06() {
        List<C1455My> listA05 = A05();
        ArrayList arrayList = new ArrayList();
        if (listA05 != null) {
            Iterator<C1455My> it = listA05.iterator();
            while (it.hasNext()) {
    ...
    public AnonymousClass87(C2198gi c2198gi, VA va2, String str, Uri uri, Map<String, String> extraData, N0 n10, boolean z10, C1462Ng c1462Ng) {
        super(c2198gi, va2, str, n10, z10);
        this.A01 = uri;
        this.A03 = extraData;
        this.A02 = c1462Ng;
    }
    ...
    */
    private android.content.Intent A00(com.facebook.ads.redexgen.core.C1455My r12) {
        /*
    ...
    private Intent A01(C1455My c1455My) {
        Intent intent = new Intent(A04(88, 26, 77));
        intent.addFlags(268435456);
        if (!TextUtils.isEmpty(c1455My.A05()) && !TextUtils.isEmpty(c1455My.A04())) {
            intent.setComponent(new ComponentName(c1455My.A05(), c1455My.A04()));
        }
        if (!TextUtils.isEmpty(c1455My.A03())) {
            intent.setData(XB.A00(c1455My.A03()));
        }
        return intent;
    }

    private final Uri A02() {
        String queryParameter = this.A01.getQueryParameter(A04(Sdk$SDKError.b.MRAID_JS_COPY_FAILED_VALUE, 9, 98));
        ...
        String storeUrl2 = A04(Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE, 22, 5);
        return XB.A00(String.format(locale, storeUrl2, objArr));
    }

    private EnumC1447Mq A03() throws C1700Ws {
        X6 x10 = new X6();
        try {
            return X6.A06(x10, ((AbstractC1450Mt) this).A01, A02(), ((AbstractC1450Mt) this).A03, this.A03);
            ...
            if (queryParameter != null && queryParameter.length() > 0) {
                X6.A0E(x10, ((AbstractC1450Mt) this).A01, XB.A00(queryParameter), ((AbstractC1450Mt) this).A03);
            }
            return EnumC1447Mq.A09;
        }
    }

    private List<C1455My> A05() {
        String queryParameter = this.A01.getQueryParameter(A04(Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE, 12, 106));
        if (TextUtils.isEmpty(queryParameter)) {
            return null;
        }
        ...
        try {
            ...
            if (jSONArrayOptJSONArray != null) {
                for (int i10 = 0; i10 < jSONArrayOptJSONArray.length(); i10++) {
                    C1455My c1455MyA00 = C1455My.A00(jSONArrayOptJSONArray.optJSONObject(i10));
                    if (c1455MyA00 != null) {
                        arrayList.add(c1455MyA00);
                    }
                }
            }
        } catch (JSONException e10) {
            InterfaceC1609Tc interfaceC1609TcA08 = ((AbstractC1450Mt) this).A01.A08();
            int i11 = AbstractC1610Td.A24;
            C1611Te c1611Te = new C1611Te(e10);
            String appsiteDataString3 = A04(204, 7, 61);
            interfaceC1609TcA08.ABC(appsiteDataString3, i11, c1611Te);
            String str = A06;
    ...
    private boolean A08() {
        ...
        while (it.hasNext()) {
            try {
                if (C1702Wu.A0D(((AbstractC1450Mt) this).A01, it.next())) {
                    return true;
                }
    ...
    public static boolean A09(C2198gi c2198gi, String str) {
        return Build.VERSION.SDK_INT >= 30 && str != null && C1648Up.A29(c2198gi);
    }
    ...
    public final EnumC1447Mq A0H() {
        ...
        A0J(map, enumC1447MqA0M);
        C1462Ng.A06(this.A02, ((AbstractC1450Mt) this).A01);
        return enumC1447MqA0M;
    }

    public final EnumC1447Mq A0M() {
        EnumC1447Mq enumC1447MqA03 = EnumC1447Mq.A09;
