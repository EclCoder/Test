...
public final class C2163g9 implements Map<String, String> {
    ...
    public C2163g9(Map<String, String> map) {
        this.A00 = map;
    }
    ...
    public final C2163g9 A04(String str, String str2) {
        this.A00.put(str, str2);
        return this;
    }

    public final C2163g9 A05(Map<? extends String, ? extends String> arg) {
        putAll(arg);
        return this;
    }
    ...
    public final String A06() {
        if (this.A00 == null) {
            return A00(0, 0, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE);
        }
        ...
        for (String str : this.A00.keySet()) {
            ...
            if (str3 != null) {
                ...
                try {
                    sb2.append(URLEncoder.encode(str3, A00(2, 5, Sdk$SDKError.b.TPAT_ERROR_VALUE)));
    ...
    public final byte[] A08() {
        byte[] bytes = null;
        try {
            bytes = A06().getBytes(A00(2, 5, Sdk$SDKError.b.TPAT_ERROR_VALUE));
            return bytes;
        } catch (UnsupportedEncodingException e10) {
            e10.printStackTrace();
            return bytes;
