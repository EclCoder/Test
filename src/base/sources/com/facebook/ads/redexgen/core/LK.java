...
public abstract class LK extends AbstractC1861bF {
    ...
    public final C1468Nm A09;
    public final C1488Og A0A;
    public final VI A0B;
    ...
    public final AbstractC2363jd A0R;
    public final NY A0S;
    public final C1456Na A0T;
    public final C2198gi A0U;
    public final C1803aJ A0V;
    public final DZ A0W;
    ...
    public LK(C2198gi c2198gi, ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr, int i10, boolean z10, C1456Na c1456Na, boolean z11, String str, VA va2, InterfaceC1739Yh interfaceC1739Yh, C2143fp c2143fp, Y2 y10, AbstractC2363jd abstractC2363jd, DZ dz, VI vi2, boolean z12) {
        super(c2198gi, viewOnClickListenerC1396Kr, i10, c1456Na, z11, str, va2, interfaceC1739Yh, c2143fp, y10, abstractC2363jd.A2A(), abstractC2363jd.A1k(), abstractC2363jd.A13());
        this.A0Y = new AtomicBoolean(true);
        this.A0Z = new AtomicBoolean(false);
        this.A0X = new RunnableC1862bG(this);
        this.A0E = new RunnableC1863bH(this);
        this.A0D = new RunnableC1864bI(this);
        this.A0B = vi2;
        this.A0R = abstractC2363jd;
        this.A0A = AbstractC1489Oh.A00(c2198gi.A02());
        this.A0C = interfaceC1739Yh;
        this.A0F = abstractC2363jd.A2E();
        this.A09 = abstractC2363jd.A2C();
        this.A0T = c1456Na;
        this.A0S = abstractC2363jd.A29().A0I();
        this.A0U = c2198gi;
        this.A0a = z10;
        this.A0b = z12;
        ...
        this.A0V = AbstractC1808aO.A01(this.A0U, true, this.A0R, this.A0B, this.A0C, EnumC1806aM.A03, AbstractC1805aL.A00(this.A0R));
        YB.A0K(this.A0V);
        this.A01 = -1;
        this.A03 = -16777216;
        this.A0O = A0O();
        ...
        if (this.A0b) {
            ...
            this.A0J.setOnClickListener(AbstractC1902bu.A03(super.A08, A0T(6, 10, 11)));
        } else {
        ...
        this.A0K.setOnClickListener(new ViewOnClickListenerC1865bJ(this));
        A0t(8);
        setUpAdReportingInitiateView(abstractC2363jd);
        setUpCreditLineV2(abstractC2363jd);
        this.A08 = this.A0R.A29().A0H().A03();
        if (this.A0R.A10().equals(A0T(60, 14, 21)) && !abstractC2363jd.A1h() && this.A08 > 0) {
            this.A04 = A0Q();
            YB.A0K(this.A04);
        }
    ...
    public final void A0k() {
        super.A09.setOnClickListener(AbstractC1902bu.A03(super.A08, A0T(27, 4, 19)));
        this.A0Q.setOnClickListener(AbstractC1902bu.A03(super.A08, A0T(74, 5, 18)));
        this.A0P.setOnClickListener(AbstractC1902bu.A03(super.A08, A0T(16, 11, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE)));
        this.A0W.setOnClickListener(AbstractC1902bu.A03(super.A08, A0T(48, 12, 20)));
        if (this.A04 != null) {
            this.A04.setOnClickListener(AbstractC1902bu.A03(super.A08, A0T(31, 17, 106)));
        }
    }
    ...
    public void setPlaceHolderTextForRewardsConversion(String str) {
        if (this.A04 != null) {
            ...
            textView.setOnClickListener(AbstractC1902bu.A03(super.A08, A0T(31, 17, 106)));
        }
    }

    private void setUpAdReportingInitiateView(AbstractC2363jd abstractC2363jd) {
        if (abstractC2363jd.A2Q() || abstractC2363jd.A2U()) {
    ...
    private void setUpCreditLineV2(AbstractC2363jd abstractC2363jd) {
        if (abstractC2363jd.A2W()) {
            this.A06 = AbstractC1808aO.A02(this.A0U, EnumC1806aM.A03, abstractC2363jd);
            YB.A0K(this.A06);
        } else {
            if (!abstractC2363jd.A2V()) {
                return;
            }
            this.A05 = AbstractC1808aO.A01(this.A0U, true, this.A0R, this.A0B, this.A0C, EnumC1806aM.A03, EnumC1809aP.A04);
            YB.A0K(this.A05);
        }
    }
}
