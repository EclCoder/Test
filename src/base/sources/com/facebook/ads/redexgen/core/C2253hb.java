...
public final class C2253hb extends PL {
    public final PL A00 = new C2256he(this);
    public final C7M A01;

    public C2253hb(C7M c7m) {
        this.A01 = c7m;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.PL
    public final void A08(View view, Q6 q10) {
        super.A08(view, q10);
        q10.A0O(C7M.class.getName());
        if (!A0B() && this.A01.getLayoutManager() != null) {
            this.A01.getLayoutManager().A1H(q10);
        }
    }
