...
public abstract class RK {
    ...
    public final void A0b(RA ra2, boolean z10) {
        this.A0F = ra2;
        this.A0G = z10;
    }
    ...
    public final void A0d(boolean z10) {
        ...
        if (i12 < 0) {
            this.A0D = 0;
            Log.e(A08(143, 4, 66), A08(186, 78, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE) + this);
    ...
    public final String toString() {
        String strA08;
        StringBuilder sb2 = new StringBuilder(A08(147, 11, 70) + Integer.toHexString(hashCode()) + A08(46, 10, 14) + this.A03 + A08(0, 4, 21) + this.A05 + A08(Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE, 9, 58) + this.A01 + A08(135, 8, 1) + this.A04);
        if (A0h()) {
        ...
        if (A0k()) {
            sb2.append(A08(Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE, 7, 20));
        }
        if (A0g()) {
        ...
        if (!A0n()) {
            StringBuilder sb3 = new StringBuilder().append(A08(30, 16, 42)).append(this.A0D).append(A08(Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE, 1, 45));
