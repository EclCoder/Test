...
public final class C1458Nc implements Serializable {
    ...
    public C1458Nc(String str, String str2, JSONObject jSONObject, String str3) {
        this.A03 = A01(str);
        this.A02 = A01(str2);
        this.A00 = A01(str3);
    ...
    private String A02(JSONObject jSONObject) {
        String strA00 = A00(0, 0, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE);
        if (jSONObject == null) {
            return strA00;
        }
