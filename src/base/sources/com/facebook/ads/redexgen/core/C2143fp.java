...
public final class C2143fp {
    ...
    @Nullable
    public AbstractRunnableC1685Wc A04;
    public C2144fq A05;
    ...
    public final WeakReference<AbstractC2142fo> A0E;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:27:0x00a3, code lost:
        ...
        return new com.facebook.ads.redexgen.core.C2144fq(com.facebook.ads.redexgen.core.EnumC1422Lr.A0G);
     */
    ...
    */
    public static com.facebook.ads.redexgen.core.C2144fq A0E(android.view.View r7, int r8, com.facebook.ads.redexgen.core.C2198gi r9) {
        /*
            Method dump skipped, instruction units count: 659
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2143fp.A0E(android.view.View, int, com.facebook.ads.redexgen.X.gi):com.facebook.ads.redexgen.X.fq");
    }
    ...
    public final synchronized String A0R() {
        return EnumC1422Lr.values()[this.A05.A01()].toString() + String.format(Locale.US, A0H(0, 9, 46), Float.valueOf(this.A05.A00() * 100.0f));
    }

    static {
        A0M();
        A0I = C2143fp.class.getSimpleName();
    }

    public C2143fp(View view, int i10, int i11, boolean z10, WeakReference<AbstractC2142fo> weakReference, C2198gi c2198gi) {
        this.A0B = new Handler();
        this.A01 = 0;
        this.A02 = 1000;
        this.A08 = true;
        this.A05 = new C2144fq(EnumC1422Lr.A0L);
    ...
    public C2143fp(View view, int i10, WeakReference<AbstractC2142fo> weakReference, C2198gi c2198gi) {
        this(view, i10, 0, false, weakReference, c2198gi);
    }

    public C2143fp(View view, int i10, boolean z10, WeakReference<AbstractC2142fo> weakReference, C2198gi c2198gi) {
        this(view, i10, 0, z10, weakReference, c2198gi);
    }
    ...
    public static /* synthetic */ int A05(C2143fp c2143fp) {
        int i10 = c2143fp.A00;
        c2143fp.A00 = i10 + 1;
        return i10;
    }
    ...
    public static Vector<Rect> A0K(View view) {
        ...
        for (int iIndexOfChild = viewGroup.indexOfChild(view) + 1; iIndexOfChild < viewGroup.getChildCount(); iIndexOfChild++) {
            ...
            int childIndex = 1;
            boolean z10 = !(childAt instanceof C2046eF);
            if ((childAt instanceof C1346It) && AbstractC2145fr.A00(childAt)) {
                childIndex = 0;
            }
            if (z10 && childIndex != 0) {
    ...
    public static Vector<Rect> A0L(View view) {
        ...
        if ((view instanceof ViewGroup) && (AbstractC2145fr.A00(view) || isTransparentToolbar)) {
    ...
    public static void A0N(View view, boolean z10, String str) {
        if (BuildConfigApi.isDebug()) {
            String str2 = A0H(PsExtractor.VIDEO_STREAM_MASK, 5, 35) + view + A0H(9, 4, 46) + (z10 ? A0H(579, 8, 10) : A0H(565, 12, 4)) + A0H(13, 14, 71) + str;
        }
    }
    ...
    public final synchronized Map<String, String> A0S() {
        HashMap map;
        map = new HashMap();
        map.put(A0H(589, 3, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE), String.valueOf(this.A05.A01()));
    ...
    public final synchronized void A0U() {
        ...
        this.A04 = new C09432j(this, this.A0D);
