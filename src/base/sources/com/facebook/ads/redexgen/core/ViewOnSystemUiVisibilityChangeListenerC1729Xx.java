...
public final class ViewOnSystemUiVisibilityChangeListenerC1729Xx implements View.OnSystemUiVisibilityChangeListener {
    ...
    public EnumC1728Xw A02 = EnumC1728Xw.A02;
    public final Runnable A04 = new QB(this);

    public ViewOnSystemUiVisibilityChangeListenerC1729Xx(View view) {
        this.A03 = view;
    ...
    public void A02(boolean z10) {
        if (EnumC1728Xw.A02.equals(this.A02)) {
            return;
        }
        int i10 = 3840;
        if (!z10) {
    ...
    public final void A05(EnumC1728Xw enumC1728Xw) {
        this.A02 = enumC1728Xw;
