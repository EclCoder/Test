...
public final class MT implements InterfaceC1740Yi {
    ...
    public MT(C2198gi c2198gi, C1560Re c1560Re) {
        this.A01 = c2198gi;
        this.A00 = c1560Re;
    }
    ...
    public final void AAu(Intent intent, Bundle bundle, C1560Re c1560Re) {
        ComponentName component = new ComponentName(AbstractC1651Us.A05(AbstractC1651Us.A02.get()), A00(39, 61, 63));
        Intent intent2 = new Intent();
        intent2.setComponent(component);
        String strA00 = A00(26, 13, 4);
        intent2.putExtra(strA00, intent.getStringExtra(strA00));
        String strA01 = A00(0, 26, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE);
        intent2.putExtra(strA01, intent.getIntExtra(strA01, -1));
        try {
            this.A01.A0F().AID();
            C1702Wu.A09(c1560Re.A05(), intent2);
    ...
    public final boolean onActivityResult(int i10, int i11, Intent intent) {
        this.A01.A0F().AHp();
        if (i11 != -1) {
            this.A01.A0F().AHo(i11);
            A02();
            return false;
        }
        C1560Re c1560Re = this.A00;
        String[] strArr = A03;
