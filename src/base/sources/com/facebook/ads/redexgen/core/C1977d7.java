...
public class C1977d7 extends WebChromeClient {
    ...
    public C1977d7(C1982dC c1982dC) {
        this.A00 = c1982dC;
    }
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        if (consoleMessage.messageLevel() == ConsoleMessage.MessageLevel.ERROR) {
            ...
            try {
                jSONObject.put(A00(10, 7, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE), consoleMessage.message());
            ...
            this.A00.A0E.A04(AbstractC1610Td.A14, string);
