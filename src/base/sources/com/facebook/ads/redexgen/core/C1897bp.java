...
public final class C1897bp implements TO {
    ...
    public final void ACV(TN tn2) {
        ...
        synchronized (AdInternalSettings.sSettingsBundle) {
            stringArray = AdInternalSettings.sSettingsBundle.getStringArray(A00(35, 27, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE));
