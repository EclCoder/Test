...
public final class C2638oL implements C9F {
    ...
    private final int A01(int i10) {
        ...
        return AbstractC1142As.A02((((long) maxByteRate) * ((long) iA00)) / 1000000);
    }
    ...
    private final int A02(int i10, int i11) {
        ...
        if (i11 != -1) {
            bufferSizeUs = AbstractC1523Pr.A00(i11, 8, RoundingMode.CEILING);
        } else {
            bufferSizeUs = A00(i10);
        }
        return AbstractC1142As.A02((((long) i12) * ((long) bufferSizeUs)) / 1000000);
    }

    public static int A03(int i10, int i11, int i12) {
        return AbstractC1142As.A02(((((long) i10) * ((long) i11)) * ((long) i12)) / 1000000);
    }
