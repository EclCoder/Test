...
public final class C1581Rz implements MediaViewVideoRendererApi {
    ...
    public final AbstractC1222Dx A0E = new AbstractC1222Dx() { // from class: com.facebook.ads.redexgen.X.7H
        /* JADX INFO: Access modifiers changed from: private */
        @Override // com.facebook.ads.redexgen.core.UN
        /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
        public final void A03(C1223Dy c1223Dy) {
            this.A00.A00.onSeek();
        }
    };
    public final EA A09 = new EA() { // from class: com.facebook.ads.redexgen.X.7G
        ...
        public final void A03(C4K c4k) {
            ...
            if (!C1648Up.A1j(this.A00.A00.getContext())) {
                return;
            }
            this.A00.A00.play(VideoStartReason.AUTO_STARTED);
        }
    };
    public final AbstractC1216Dr A0F = new AbstractC1216Dr() { // from class: com.facebook.ads.redexgen.X.7F
        /* JADX INFO: Access modifiers changed from: private */
        @Override // com.facebook.ads.redexgen.core.UN
        /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
    ...
    public C1568Rm A02 = new C1568Rm();
    ...
    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        C2198gi c2198giA16 = ((UK) nativeAd.getInternalNativeAd()).A16();
        C2198gi adObjectContext = this.A03;
        adObjectContext.A0L(c2198giA16);
        S2 s10 = (S2) nativeAd.getNativeAdApi();
        this.A05.setClientToken(UK.A0L(nativeAd.getInternalNativeAd()).A1H());
        this.A05.setVideoMPD(s10.A02());
        this.A05.setVideoURI(s10.A03());
        C2380ju c2380juA12 = UK.A0L(nativeAd.getInternalNativeAd()).A12();
        if (c2380juA12 != null) {
            this.A05.setVideoProgressReportIntervalMs(c2380juA12.A0B());
        }
        this.A05.setVideoCTA(nativeAd.getAdCallToAction());
        this.A05.setNativeAd(nativeAd);
        this.A01 = s10.getVideoAutoplayBehavior();
        if (this.A04 != null) {
            this.A04.AJZ(nativeAd);
        }
    }

    public final void A05(VA va2) {
        this.A05.setAdEventManager(va2);
    }
    ...
    public final void A07(InterfaceC1753Yv interfaceC1753Yv) {
        this.A05.setListener(interfaceC1753Yv);
    }
    ...
    public final void disengageSeek(VideoStartReason videoStartReason) {
        if (!this.A06) {
            if (AdInternalSettings.isDebugBuild()) {
                String str = A0I;
                String strA01 = A01(Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE, 40, 65);
                if (A0H[6].length() != 3) {
                    throw new RuntimeException();
                }
                String[] strArr = A0H;
    ...
    public final void engageSeek() {
        if (this.A06) {
            ...
            this.A06 = true;
            this.A07 = EnumC2140fm.A0A.equals(this.A05.getState());
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        if (context instanceof C2198gi) {
            c2198giA03 = (C2198gi) context;
        } else {
            c2198giA03 = C1571Rp.A03(context);
        }
        this.A03 = c2198giA03;
        switch (adViewConstructorParams.getInitializationType()) {
            case 0:
                this.A05 = new C10536r(c2198giA03);
                break;
            case 1:
                this.A05 = new C10536r(c2198giA03, adViewConstructorParams.getAttributeSet());
                break;
            case 2:
                this.A05 = new C10536r(c2198giA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
                break;
            case 3:
                this.A05 = new C10536r(c2198giA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
                break;
            default:
        ...
        EnumC1708Xc.A04(this.A05, EnumC1708Xc.A0B);
    ...
    public final boolean shouldAutoplay() {
        if (this.A05 == null || this.A05.getState() == EnumC2140fm.A06) {
            return false;
        }
