...
public final class N7 {
     ...
     */
    public final synchronized void A0A(@Nullable String str) throws JSONException, C1611Te {
        if (str != null) {
            if (!str.trim().isEmpty()) {
    ...
    private final synchronized C1461Nf A00(String str, JSONObject jSONObject) throws JSONException, C1611Te {
        C1461Nf frequencyCappingData;
        if (str.equals(jSONObject.optString(A01(29, 12, 70), null))) {
            frequencyCappingData = new C1461Nf(str);
            A03(frequencyCappingData, jSONObject);
        } else {
            C1611Te c1611Te = new C1611Te(new IllegalArgumentException());
    ...
    private void A03(C1461Nf c1461Nf, JSONObject jSONObject) throws JSONException {
        ...
        String strA01 = A01(64, 11, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE);
        if (jSONObject.has(strA01)) {
            c1461Nf.A06((JSONArray) jSONObject.get(strA01));
        }
        String strA02 = A01(81, 20, 107);
        if (jSONObject.has(strA02)) {
            int cappingTimeSecs = jSONObject.optInt(strA02);
            c1461Nf.A04(cappingTimeSecs);
        }
        c1461Nf.A05(iOptInt, iOptInt2, jOptLong, maxCappedArrayLength);
    }
    ...
    public final synchronized void A08(@Nullable String str) throws JSONException {
        if (str != null) {
            if (!str.trim().isEmpty()) {
                ...
                for (int i10 = 0; i10 < jSONArray.length() && i10 < C1461Nf.A00(); i10++) {
    ...
    public final synchronized void A0B(JSONObject jSONObject) throws JSONException {
        ...
        if (this.A00.has(strOptString) && (this.A00.get(strOptString) instanceof C1461Nf)) {
            frequencyCappingData = (C1461Nf) this.A00.get(strOptString);
        } else {
            frequencyCappingData = new C1461Nf(strOptString);
        }
        A03(frequencyCappingData, jSONObject);
