...
public class C1849b3 extends WebViewClient {
    ...
    public final WeakReference<C2143fp> A07;
    ...
    public C1849b3(C2198gi c2198gi, WeakReference<InterfaceC1847b1> weakReference, WeakReference<C2143fp> weakReference2, WeakReference<Y2> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<LV> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z10) {
        this.A02 = c2198gi;
    ...
    private WebResourceResponse A00() {
        return new WebResourceResponse(A01(Sdk$SDKError.b.AD_RESPONSE_INVALID_TEMPLATE_TYPE_VALUE, 10, 100), StandardCharsets.UTF_8.name(), 403, A01(13, 6, 1), Collections.singletonMap(A01(0, 13, 79), A01(198, 8, 55)), new ByteArrayInputStream(A01(13, 6, 1).getBytes()));
    }
    ...
    private final void A04(WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        ...
        this.A02.A0F().AL2(webResourceResponse.getStatusCode(), AbstractC1707Xb.A01(webResourceResponse.getStatusCode(), A01(67, 10, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE), A01(0, 0, 53) + webResourceRequest.getUrl()));
    }
    ...
    private void A06(String str, String str2) {
        ...
        try {
            ...
            jSONObject.put(A01(Sdk$SDKError.b.PRIVACY_ICON_FALLBACK_ERROR_VALUE, 10, 25), str2);
            jSONObject.put(A01(Sdk$SDKError.b.AD_ALREADY_FAILED_VALUE, 10, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE), this.A09.get());
        } catch (JSONException unused) {
        }
        if (this.A02 != null) {
            this.A02.A08().ABC(A01(236, 8, 74), AbstractC1610Td.A2c, new C1611Te(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
        }
    }
    ...
    private boolean A07(Uri uri) {
        ...
        if (scheme.equals(path3)) {
            ...
            List<String> listA09 = C1604Sx.A09(this.A02);
            boolean zA09 = A09(path, listA09);
            if (!zA09) {
                if (BuildConfigApi.isDebug()) {
                    StringBuilder sb4 = new StringBuilder();
                    String path7 = A01(77, 31, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE);
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        boolean zA12 = C1648Up.A12(this.A02);
        ...
        if (zA12 || webResourceRequest.isForMainFrame()) {
            ...
            this.A02.A0F().AL1(AbstractC1707Xb.A01(webResourceError.getErrorCode(), strA01 + ((Object) webResourceError.getDescription()), strA01 + webResourceRequest.getUrl()));
        }
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        AbstractC1844ay.A0D(AbstractC1610Td.A2b);
        InterfaceC1847b1 adWebViewListener = this.A04.get();
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().ADN(str, new C1855b9().A03(this.A07.get()).A02(this.A06.get()).A05());
        }
