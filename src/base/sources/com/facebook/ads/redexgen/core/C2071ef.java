...
public final class C2071ef extends LinearLayout {
    public static final int A00 = (int) (XX.A02 * 32.0f);
    public static final int A01 = (int) (XX.A02 * 8.0f);

    public C2071ef(C2198gi c2198gi, NativeAd nativeAd, C1662Vd c1662Vd, C1892bk c1892bk, AdOptionsView adOptionsView) {
        super(c2198gi);
        setOrientation(0);
        ...
        addView(c1892bk, iconViewParams);
        TextView textView = new TextView(c2198gi);
        c1662Vd.A08(textView);
        textView.setMaxLines(1);
        textView.setText(nativeAd.getAdvertiserName());
        TextView sponsoredTextView = new TextView(c2198gi);
        c1662Vd.A06(sponsoredTextView);
