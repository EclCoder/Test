...
public class C1532Qb implements Comparator<C1533Qc> {
    ...
    public final int compare(C1533Qc c1533Qc, C1533Qc c1533Qc2) {
        if ((c1533Qc.A03 == null) != (c1533Qc2.A03 == null)) {
            C7M c7m = c1533Qc.A03;
            if (A00[1].length() == 18) {
        ...
        if (c1533Qc.A04 != c1533Qc2.A04) {
            return c1533Qc.A04 ? -1 : 1;
        }
        int i10 = c1533Qc2.A02 - c1533Qc.A02;
        if (i10 != 0) {
            return i10;
        }
        int i11 = c1533Qc.A00;
        int deltaViewVelocity = c1533Qc2.A00;
