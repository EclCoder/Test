...
public final class C2408kN implements InterfaceC1441Mk {
    ...
    public static final C2408kN A03 = new C2408kN(Collections.emptyMap());
    public int A00;
    ...
    public C2408kN(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static Map<String, byte[]> A00(Map<String, byte[]> otherMetadata, C1442Ml c1442Ml) {
    ...
    public static byte[] A04(Object obj) {
        ...
        if (obj instanceof String) {
            return ((String) obj).getBytes(AbstractC2395k9.A05);
        }
    ...
    public final C2408kN A05(C1442Ml c1442Ml) {
        Map<String, byte[]> mapA00 = A00(this.A01, c1442Ml);
        Map<String, byte[]> mutatedMetadata = this.A01;
        if (A03(mutatedMetadata, mapA00)) {
            return this;
        }
        return new C2408kN(mapA00);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1441Mk
    public final long A6h(String str, long j10) {
    ...
    public final boolean equals(Object obj) {
        ...
        return A03(this.A01, ((C2408kN) obj).A01);
    }
