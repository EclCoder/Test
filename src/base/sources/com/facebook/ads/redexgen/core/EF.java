...
public class EF {
    ...
    public boolean A0A;
    public boolean A0B;
    public final C2289iE A0C;
    public final C2198gi A0D;
    public final VA A0E;
    public final InterfaceC2074ei A0F;
    public final InterfaceC2083er A0G;
    public final C2084es A0H;
     ...
     */
    public EF(C2198gi c2198gi, VA va2, InterfaceC2074ei interfaceC2074ei, String str, boolean z10, int i10, int i11, boolean z11, Bundle bundle, Map<String, String> map, InterfaceC2083er interfaceC2083er) {
        this.A02 = 0;
        this.A01 = 0;
        this.A05 = false;
        this.A0B = false;
        ...
        this.A0D = c2198gi;
        this.A0E = va2;
        this.A0F = interfaceC2074ei;
        this.A0J = str;
        this.A0K = map;
        this.A08 = z10;
        this.A07 = z11;
        this.A0G = interfaceC2083er;
        ArrayList arrayList = new ArrayList();
        arrayList.add(new EH(this, 0.5d, -1.0d, 2.0d, true));
        arrayList.add(new EG(this, 1.0E-7d, -1.0d, 0.001d, false));
        if (bundle != null) {
            this.A0C = new C2289iE(arrayList, bundle.getBundle(A0H(6, 16, 57)), this.A0G);
            ...
            this.A02 = i10;
            this.A01 = i11;
            this.A0C = new C2289iE(arrayList, this.A0G);
        }
        this.A05 = C1648Up.A2W(this.A0D);
        this.A0B = C1648Up.A2a(this.A0D);
        this.A0H = new C2084es(new Handler(), this);
    }
    ...
    public Map<String, String> A0J(EnumC2076ek enumC2076ek) {
        int currentPositionInMillis = this.A0F.getCurrentPositionInMillis();
        int i10 = this.A00 + 1;
        this.A00 = i10;
        return A0K(enumC2076ek, currentPositionInMillis, i10);
    }

    private Map<String, String> A0K(EnumC2076ek enumC2076ek, int i10, int i11) {
        HashMap map = new HashMap();
        Y7.A03(map, this.A0F.getVideoStartReason() == EnumC2085et.A02, !this.A0F.AAV());
        A0U(map);
        A0S(map);
        A0W(map, i10);
        A0V(map);
        A0T(map);
        A0n(enumC2076ek, map);
        map.put(A0H(0, 6, 24), String.valueOf(enumC2076ek.A00));
    ...
    private void A0M() {
        ...
        A0R(this.A0J, A0J(EnumC2076ek.A04));
    }
    ...
    private final void A0P(int i10, boolean z10, boolean z11) {
        ...
        if (i10 > this.A02) {
            ...
            if (dA9V < 0.5d && C1648Up.A1i(this.A0D)) {
                this.A0D.A0F().AKk(String.valueOf(dA9V));
            }
            this.A02 = i10;
            if (z11 || i10 - this.A01 >= 5000) {
                String str = this.A0J;
                EnumC2076ek enumC2076ek = EnumC2076ek.A09;
                int i11 = this.A00 + 1;
                this.A00 = i11;
                A0R(str, A0K(enumC2076ek, i10, i11));
                this.A01 = this.A02;
                this.A0C.A05();
                return;
            }
        ...
        if (z10) {
            ...
            EnumC2076ek enumC2076ek2 = EnumC2076ek.A09;
            int i12 = this.A00 + 1;
            this.A00 = i12;
            A0R(str2, A0K(enumC2076ek2, i10, i12));
        }
    }
    ...
    private void A0S(Map<String, String> params) {
        C1487Of c1487OfA03 = this.A0C.A03();
        C1486Oe c1486OeA00 = c1487OfA03.A00();
        params.put(A0H(Sdk$SDKError.b.PRIVACY_ICON_FALLBACK_ERROR_VALUE, 3, 25), String.valueOf(c1486OeA00.A00()));
        params.put(A0H(229, 3, 8), String.valueOf(c1486OeA00.A06()));
        params.put(A0H(232, 5, 59), String.valueOf(c1486OeA00.A03()));
        params.put(A0H(Sdk$SDKError.b.PLACEMENT_SLEEP_VALUE, 8, 108), String.valueOf(c1486OeA00.A02() * 1000.0d));
        params.put(A0H(47, 12, 65), String.valueOf(c1486OeA00.A01() * 1000.0d));
        params.put(A0H(Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE, 7, 81), String.valueOf(c1486OeA00.A04() * 1000.0d));
        if (this.A04 != null) {
            params.put(A0H(Sdk$SDKError.b.AD_RESPONSE_RETRY_AFTER_VALUE, 6, 19), this.A04);
        }
        C1486Oe c1486OeA01 = c1487OfA03.A01();
        params.put(A0H(195, 3, 83), String.valueOf(c1486OeA01.A00()));
        params.put(A0H(198, 3, 76), String.valueOf(c1486OeA01.A06()));
        params.put(A0H(201, 5, 61), String.valueOf(c1486OeA01.A03()));
        params.put(A0H(22, 8, 35), String.valueOf(c1486OeA01.A02() * 1000.0d));
        params.put(A0H(35, 12, 36), String.valueOf(c1486OeA01.A01() * 1000.0d));
        params.put(A0H(Sdk$SDKError.b.INVALID_INDEX_URL_VALUE, 7, 52), String.valueOf(c1486OeA01.A04() * 1000.0d));
    }
    ...
    private void A0U(Map<String, String> map) {
        ...
        map.put(A0H(Sdk$SDKError.b.OMSDK_JS_WRITE_FAILED_VALUE, 4, 90), Long.toString(this.A0F.getInitialBufferTime()));
    }

    private void A0V(Map<String, String> params) {
        Rect rect = new Rect();
        this.A0F.getGlobalVisibleRect(rect);
        params.put(A0H(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 2, 90), String.valueOf(rect.top));
        params.put(A0H(Sdk$SDKError.b.MRAID_JS_WRITE_FAILED_VALUE, 2, 60), String.valueOf(rect.left));
        ...
        WindowManager windowManager = (WindowManager) this.A0D.getSystemService(A0H(237, 6, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE));
        DisplayMetrics displayMetrics = new DisplayMetrics();
        windowManager.getDefaultDisplay().getMetrics(displayMetrics);
        params.put(A0H(Sdk$SDKError.b.AD_ALREADY_FAILED_VALUE, 3, 4), String.valueOf(displayMetrics.heightPixels));
        params.put(A0H(Sdk$SDKError.b.INVALID_JSON_BID_PAYLOAD_VALUE, 3, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL), String.valueOf(displayMetrics.widthPixels));
    }
    ...
    public final void A0d() {
        ...
        A0R(this.A0J, A0J(EnumC2076ek.A07));
    }
    ...
    public final void A0e() {
        ...
        A0R(this.A0J, A0J(EnumC2076ek.A08));
    }
    ...
    public final void A0i(int i10) {
        ...
        this.A0C.A04();
        A0R(this.A0J, A0J(EnumC2076ek.A05));
        if (this.A05) {
            A0P(i10, false, true);
        } else {
    ...
    public final void A0m(InterfaceC2075ej interfaceC2075ej) {
        this.A03 = interfaceC2075ej;
    }

    public void A0n(EnumC2076ek enumC2076ek, Map<String, String> params) {
    }
