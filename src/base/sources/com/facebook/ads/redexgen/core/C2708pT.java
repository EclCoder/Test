...
public class C2708pT implements AnonymousClass24 {
    ...
    public static final C2708pT A0J = new C09723o().A0G("").A0H();
    ...
    public static final AnonymousClass23<C2708pT> A0I = new AnonymousClass23() { // from class: com.facebook.ads.redexgen.X.pV
        @Override // com.facebook.ads.redexgen.core.AnonymousClass23
        public final AnonymousClass24 A6f(Bundle bundle) {
            return C2708pT.A00(bundle);
        }
    };

    public C2708pT(CharSequence charSequence, Layout.Alignment alignment, Layout.Alignment alignment2, Bitmap bitmap, float f10, int i10, int i11, float f11, int i12, int i13, float f12, float f13, float f14, boolean z10, int i14, int i15, float f15) {
        if (charSequence == null) {
            AbstractC09823y.A01(bitmap);
        } else {
            AbstractC09823y.A07(bitmap == null);
        }
    ...
    public static final C2708pT A00(Bundle bundle) {
        ...
        if (bundle.containsKey(A0M)) {
            ...
            if (zContainsKey) {
                c09723o.A07(bundle.getFloat(A0M), bundle.getInt(A0O));
            }
        }
        if (bundle.containsKey(A0N)) {
            int i10 = bundle.getInt(A0N);
        ...
        if (bundle.containsKey(A0Q)) {
            c09723o.A04(bundle.getFloat(A0Q));
        }
        if (bundle.containsKey(A0R)) {
            c09723o.A0A(bundle.getInt(A0R));
        }
        if (bundle.containsKey(A0W) && bundle.containsKey(A0X)) {
            c09723o.A08(bundle.getFloat(A0W), bundle.getInt(A0X));
        }
        if (bundle.containsKey(A0T)) {
            c09723o.A06(bundle.getFloat(A0T));
        }
        if (bundle.containsKey(A0L)) {
            c09723o.A03(bundle.getFloat(A0L));
        }
        String str = A0Z;
        if (A0H[6].length() != 9) {
            A0H[6] = "";
            if (bundle.containsKey(str)) {
                c09723o.A0C(bundle.getInt(A0Z));
            }
        ...
        if (bundle.containsKey(A0Y)) {
            c09723o.A0B(bundle.getInt(A0Y));
        }
        if (bundle.containsKey(A0S)) {
            c09723o.A05(bundle.getFloat(A0S));
        }
        return c09723o.A0H();
    }

    public final C09723o A02() {
        return new C09723o(this);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        C2708pT c2708pT = (C2708pT) obj;
        if (TextUtils.equals(this.A0F, c2708pT.A0F) && this.A0E == c2708pT.A0E && this.A0D == c2708pT.A0D && (this.A0C != null ? !(c2708pT.A0C == null || !this.A0C.sameAs(c2708pT.A0C)) : c2708pT.A0C == null) && this.A01 == c2708pT.A01 && this.A07 == c2708pT.A07 && this.A06 == c2708pT.A06) {
            float f10 = this.A02;
            if (A0H[4].charAt(16) == 'F') {
                throw new RuntimeException();
            }
            A0H[6] = "OaHYrPsvOOcaJ1wPKUjhJjBsa";
            if (f10 == c2708pT.A02 && this.A08 == c2708pT.A08 && this.A04 == c2708pT.A04 && this.A00 == c2708pT.A00 && this.A0G == c2708pT.A0G && this.A0B == c2708pT.A0B && this.A09 == c2708pT.A09 && this.A05 == c2708pT.A05 && this.A0A == c2708pT.A0A && this.A03 == c2708pT.A03) {
                return true;
            }
        }
        return false;
