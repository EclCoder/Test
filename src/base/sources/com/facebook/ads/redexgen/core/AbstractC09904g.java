...
public abstract class AbstractC09904g {
    public static int A00;
    public static InterfaceC09894f A01;
    ...
    public static String A02(Throwable th2) {
        synchronized (A05) {
            try {
                ...
                return Log.getStackTraceString(th2).trim().replace(A00(0, 1, 74), A00(5, 4, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE));
            } catch (Throwable th3) {
                throw th3;
            }
        }
