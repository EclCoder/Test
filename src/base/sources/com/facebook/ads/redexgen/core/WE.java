...
public final class WE {
    ...
    private RG A01(C2198gi c2198gi, JSONObject data, long j10) throws JSONException {
        JSONArray placements = data.getJSONArray(A04(190, 10, 45));
        JSONObject jSONObject = placements.getJSONObject(0);
        C1630Tx c1630TxA00 = C1630Tx.A00(jSONObject.getJSONObject(A04(Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE, 10, 90)));
        ...
        C1629Tw c1629Tw = new C1629Tw(c1630TxA00, strOptString, adReportingConfig, cache, flashConfig, strOptString2, A06(jSONObject));
        ...
        if (jSONObject.has(strA07)) {
            ...
            while (i10 < jSONArray.length()) {
                ...
                VK.A06(c2198gi, jSONObject2, j10, str);
                ...
                JSONArray jSONArrayOptJSONArray = jSONObject2.optJSONArray(A04(Sdk$SDKError.b.INVALID_JSON_BID_PAYLOAD_VALUE, 8, Sdk$SDKError.b.TPAT_ERROR_VALUE));
                if (ad2 != null) {
                    c1629Tw.A0F(new C1627Tu(strOptString3, strOptString4, ad2, jSONArrayOptJSONArray));
                } else {
                    ...
                    interfaceC1424LtA0F.A5g(errorCode, A04(72, 18, 80));
                }
                i10++;
                str = null;
            }
        ...
        if (jSONObject.has(strA08)) {
            c1629Tw.A0G(jSONObject.getJSONObject(strA08));
        }
        String anValidationUuid = data.optString(A04(29, 18, 33));
        return new RG(c1629Tw, anValidationUuid);
    }
    ...
    private R4 A03(JSONObject jSONObject) {
        ...
        try {
            ...
            C1630Tx c1630TxA00 = C1630Tx.A00(jSONObject2.getJSONObject(A04(Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE, 10, 90)));
            ...
            return new R4(jSONObject.optString(A04(183, 7, 16), A04(0, 0, 92)), jSONObject.optInt(A04(64, 4, 96), 0), new C1629Tw(c1630TxA00, strOptString, featureConfig, null, strOptString2, cache, A06(jSONObject2)));
    ...
    public final WG A07(C2198gi c2198gi, String str, long j10) throws JSONException {
        byte b10;
        if (!TextUtils.isEmpty(str)) {
            JSONObject jSONObject = new JSONObject(str);
            String strOptString = jSONObject.optString(A04(Sdk$SDKError.b.AD_RESPONSE_TIMED_OUT_VALUE, 4, 7));
            ...
            switch (b10) {
                case 0:
                    return A01(c2198gi, jSONObject, j10);
                case 1:
