...
public final class TI extends SQLiteOpenHelper {
    ...
    public TI(C2194ge c2194ge, TH th2) {
        super(c2194ge, A01(c2194ge), (SQLiteDatabase.CursorFactory) null, 4);
        if (th2 != null) {
            this.A00 = th2;
            return;
        }
    ...
    public static String A01(C2194ge c2194ge) {
        ...
        String strA00 = A00(Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE, 8, 41);
        String str = String.format(locale, strA00, objArr);
        if (!C1648Up.A2k(c2194ge)) {
            return str;
        }
        String defaultDbName = c2194ge.getPackageName();
        String processName = ProcessUtils.getProcessName(c2194ge);
    ...
    public final void onUpgrade(SQLiteDatabase sQLiteDatabase, int i10, int i11) {
        ...
        if (i10 <= 3 && i11 >= 4) {
            TF tf2 = C2146fs.A02;
            sQLiteDatabase.execSQL(A00(11, 30, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE) + tf2.A01 + A00(0, 1, 52) + tf2.A02 + A00(1, 10, 2));
        }
    }
}
