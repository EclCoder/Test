...
public final class C1574Rs implements InterstitialAdApi, Repairable {
    public static byte[] A04;
    public final InterstitialAd A00;
    public final C2308iY A01;
    ...
    public C1574Rs(Context context, String str, InterstitialAd interstitialAd) {
        String string;
        this.A00 = interstitialAd;
        if (context instanceof C2198gi) {
            this.A03 = (C2198gi) context;
            string = this.A03.A0F().getId();
        } else {
            string = UUID.randomUUID().toString();
            this.A03 = C1571Rp.A06(context, string);
        }
        InterfaceC1424Lt interfaceC1424LtA0F = this.A03.A0F();
        String adId = AdPlacementType.INTERSTITIAL.toString();
        interfaceC1424LtA0F.A3T(adId, str);
        this.A01 = new C2308iY(this.A03, interstitialAd, str);
        this.A03.A0O(this);
    ...
    public final void A05(EnumSet<CacheFlag> enumSet, String str) {
        AbstractC1681Vy.A05(A00(129, 8, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE), A00(65, 30, 111), A00(16, 8, 42));
        if (str == null) {
            this.A03.A0F().A3Q();
        } else {
            this.A03.A0F().A3P();
    ...
    public final void destroy() {
        AbstractC1681Vy.A05(A00(Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE, 7, 21), A00(40, 25, 105), A00(0, 8, 21));
        if (C1648Up.A2M(this.A03)) {
            return;
        }
        this.A02.A08();
        this.A03.A0F().A3U();
    ...
    public final void loadAd(InterstitialAd.InterstitialLoadAdConfig interstitialLoadAdConfig) {
        ((C1575Rt) interstitialLoadAdConfig).A00();
    }

    @Override // com.facebook.ads.internal.context.Repairable
    public final void repair(Throwable th2) {
        if (this.A01.A6o() != null) {
            this.A01.A6o().onError(this.A00, new AdError(2001, A00(24, 16, 63) + AbstractC1725Xt.A03(this.A03, th2)));
        }
    }
    ...
    public final boolean show() {
        AbstractC1681Vy.A05(A00(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 4, 11), A00(95, 27, 100), A00(8, 8, 56));
        this.A03.A0F().A3Z();
        boolean zA0I = this.A02.A0I(this.A00, new C1576Ru());
