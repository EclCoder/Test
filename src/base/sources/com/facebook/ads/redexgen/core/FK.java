...
public final class FK<T extends FL> extends Handler implements Runnable {
    ...
    public final /* synthetic */ C2563n7 A0A;
    ...
    private void A02() {
        ...
        this.A03 = null;
        this.A0A.A02.execute((Runnable) AbstractC09823y.A01(this.A0A.A00));
    }
    ...
    public final void handleMessage(Message message) throws Throwable {
        ...
        try {
            ...
            FI fi2 = (FI) AbstractC09823y.A01(this.A02);
            if (this.A05) {
                fi2.AEc(this.A08, jElapsedRealtime, j10, false);
                return;
            }
            switch (message.what) {
                case 1:
                    try {
                        fi2.AEe(this.A08, jElapsedRealtime, j10);
                        return;
                    } catch (RuntimeException e10) {
                        AbstractC09904g.A08(A01(0, 8, 0), A01(71, 44, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE), e10);
                ...
                case 2:
                    ...
                    this.A01++;
                    FJ fjAEf = fi2.AEf(this.A08, jElapsedRealtime, j10, this.A03, this.A01);
                    if (fjAEf.A00 == 3) {
    ...
    public FK(C2563n7 c2563n7, Looper looper, T loadable, FI<T> fi2, int i10, long j10) {
        super(looper);
        this.A0A = c2563n7;
        this.A08 = loadable;
        this.A02 = fi2;
    ...
    private long A00() {
        return AbstractC2325is.A00(this.A01, 0);
    }
    ...
    public final void A06(long j10) {
        AbstractC09823y.A08(this.A0A.A00 == null);
        this.A0A.A00 = this;
        if (j10 > 0) {
    ...
    public final void A07(boolean z10) {
        ...
        if (z10) {
            A03();
            long jElapsedRealtime = SystemClock.elapsedRealtime();
            ((FI) AbstractC09823y.A01(this.A02)).AEc(this.A08, jElapsedRealtime, jElapsedRealtime - this.A07, true);
            this.A02 = null;
        }
    }
    ...
    public final void run() throws Throwable {
        ...
        try {
            try {
                try {
                    try {
                        ...
                        if (z10) {
                            AnonymousClass54.A02(A01(150, 5, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE) + this.A08.getClass().getSimpleName());
                            try {
                                this.A08.AAr();
                    ...
                    if (!this.A09) {
                        AbstractC09904g.A08(A01(0, 8, 0), A01(40, 31, 85), e10);
                ...
                if (!this.A09) {
                    AbstractC09904g.A08(A01(0, 8, 0), A01(Sdk$SDKError.b.INVALID_INDEX_URL_VALUE, 35, 50), e11);
            ...
            if (!this.A09) {
                AbstractC09904g.A08(A01(0, 8, 0), A01(8, 32, 20), e13);
                obtainMessage(2, new FP(e13)).sendToTarget();
            }
        }
    }
}
