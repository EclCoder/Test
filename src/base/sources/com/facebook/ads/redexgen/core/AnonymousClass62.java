...
public final class AnonymousClass62 extends FrameLayout implements InterfaceC1345Is {
    ...
    public final VA A04;
    public final Y2 A05;
    public final InterfaceC1971d1 A06;
    public final C1982dC A07;
    ...
    public AnonymousClass62(C2198gi c2198gi, VA va2, InterfaceC1971d1 interfaceC1971d1, AbstractC2363jd abstractC2363jd, String str, int i10, Y2 y10) {
        super(c2198gi);
        this.A03 = c2198gi;
        this.A04 = va2;
        this.A02 = abstractC2363jd;
        this.A08 = str;
        this.A06 = interfaceC1971d1;
        this.A01 = i10;
        C1982dC preloadedDynamicWebViewController = AbstractC1983dD.A02(abstractC2363jd.A1D());
        if (preloadedDynamicWebViewController != null) {
            this.A07 = preloadedDynamicWebViewController;
            this.A09 = true;
        } else {
            this.A07 = new C1982dC(this.A03, abstractC2363jd, va2, i10);
            AbstractC1983dD.A03(abstractC2363jd, this.A07);
            this.A09 = false;
        }
        if (y10 != null) {
            this.A05 = y10;
        ...
        this.A07.A0a(interfaceC1971d1);
        EnumC1708Xc.A04(this, EnumC1708Xc.A0B);
        if (C1648Up.A1z(c2198gi)) {
            c2198gi.A0B().AKp(this.A07.A0O(), abstractC2363jd.A2E(), false, false, true);
        }
        A04();
    }
    ...
    private void A05(Intent intent, AbstractC2363jd abstractC2363jd) {
        intent.putExtra(A01(157, 8, 110), WK.A07);
        intent.putExtra(A01(130, 18, 58), abstractC2363jd);
        intent.addFlags(268435456);
    }

    private final void A06(AbstractC2363jd abstractC2363jd) {
        AdActivityIntent adActivityIntentA05 = C1702Wu.A05(this.A03);
        A05(adActivityIntentA05, abstractC2363jd);
        try {
            C1702Wu.A0B(this.A03, adActivityIntentA05);
        } catch (Exception e10) {
            this.A03.A08().ABC(A01(107, 11, 42), AbstractC1610Td.A0D, new C1611Te(e10));
    ...
    private void A07(String str) {
        ...
        C1877bV c1877bV = new C1877bV(this.A03, this.A08, this.A00, this.A05, this.A04, this.A02.A2A());
        HashMap map = new HashMap();
        map.put(A01(Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE, 12, 105), A01(148, 9, 96));
        c1877bV.A05(this.A02.A2E(), str, map);
    }
    ...
    public C1982dC getDynamicWebViewController() {
        return this.A07;
    }
    ...
    public void setAdViewabilityChecker(C2143fp c2143fp) {
        this.A00 = c2143fp;
        this.A07.A0e(c2143fp);
    }
}
