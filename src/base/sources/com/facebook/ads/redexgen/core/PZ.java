...
public class PZ extends RelativeLayout implements InterfaceC1740Yi {
    ...
    public String A04;
    public boolean A05;
    public final InterfaceC1566Rk A06;
    public final LinearLayout A07;
    public final C1560Re A08;
    public final C2198gi A09;
    public final VA A0A;
    public final InterfaceC1739Yh A0B;
    public final C1827ah A0C;
    public final InterfaceC1836aq A0D;
    public final M3 A0E;
    public final InterfaceC1841av A0F;
    ...
    public PZ(C1560Re c1560Re, C2198gi c2198gi, VA va2, InterfaceC1739Yh interfaceC1739Yh, boolean z10) {
        M3 m10;
        super(c2198gi);
        this.A06 = new C1510Pc(this);
        this.A05 = true;
        this.A01 = -1L;
        this.A03 = true;
        this.A08 = c1560Re;
        ...
        this.A0D = A0F();
        if (AbstractC1649Uq.A02(c2198gi) || c2198gi.A0E() == null) {
            m10 = new M3(c2198gi, this.A0D);
        } else {
            m10 = new M3(c2198gi, c2198gi.A0E(), this.A0D);
        }
        this.A0E = m10;
        this.A0F = A0C(z10);
        this.A07 = (LinearLayout) this.A0F;
        this.A07.setId(View.generateViewId());
        this.A0F.setListener(new C1509Pb(this));
        this.A0E.setBrowserNavigationListener(this.A0F.getBrowserNavigationListener());
        this.A0C = new C1827ah(c2198gi, null, R.attr.progressBarStyleHorizontal);
        A0G();
        c1560Re.A0A(this.A06);
    }

    private InterfaceC1841av A0C(boolean z10) {
        if (z10) {
    ...
    public InterfaceC1836aq A0F() {
        return new C1508Pa(this);
    }
    ...
    public void AAu(Intent intent, Bundle bundle, C1560Re c1560Re) {
        if (this.A01 < 0) {
            this.A01 = System.currentTimeMillis();
        }
        String strA0D = A0D(231, 11, 97);
        String strA0D2 = A0D(Sdk$SDKError.b.AD_RESPONSE_RETRY_AFTER_VALUE, 11, 26);
        String url = A0D(Sdk$SDKError.b.AD_NOT_LOADED_VALUE, 10, 13);
        if (bundle == null) {
    ...
    public final void AFA(boolean z10) {
        ...
        if (this.A03) {
            this.A03 = false;
            C1830ak c1830akA07 = new C1829aj(this.A0E.getFirstUrl()).A01(this.A00).A03(this.A01).A04(this.A0E.getResponseEndMs()).A00(this.A0E.getDomContentLoadedMs()).A05(this.A0E.getScrollReadyMs()).A02(this.A0E.getLoadFinishMs()).A06(System.currentTimeMillis()).A07();
            this.A0A.AB5(this.A04, c1830akA07.A02());
            if (BuildConfigApi.isDebug()) {
                String str = A0D(169, 30, 15) + System.currentTimeMillis() + A0D(149, 20, 60) + c1830akA07.A01 + A0D(53, 22, Sdk$SDKError.b.TPAT_ERROR_VALUE) + c1830akA07.A03 + A0D(75, 24, 83) + c1830akA07.A04 + A0D(0, 30, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE) + c1830akA07.A00 + A0D(99, 24, 75) + c1830akA07.A05 + A0D(30, 23, 22) + c1830akA07.A02 + A0D(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 26, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE) + c1830akA07.A06;
            }
        }
    }
    ...
    public final void AIv(Bundle bundle) {
        bundle.putString(A0D(Sdk$SDKError.b.AD_NOT_LOADED_VALUE, 10, 13), this.A02);
    }
