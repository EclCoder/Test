...
public final class YV {
    ...
    public static boolean A02(C2198gi c2198gi) {
        return A03(c2198gi) && YW.A03(c2198gi);
    }
    ...
    public static boolean A03(C2198gi c2198gi) {
        ...
        try {
            return ((PowerManager) c2198gi.getSystemService(A00(60, 5, 91))).isInteractive();
        } catch (Exception e10) {
            Log.e(A02, A00(0, 60, 20), e10);
            c2198gi.A08().ABC(A00(65, 5, 53), AbstractC1610Td.A2S, new C1611Te(e10));
            return true;
        }
    }
}
