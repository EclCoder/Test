...
public final class C2301iR {
    ...
    public /* synthetic */ C2301iR(AbstractC2773qZ abstractC2773qZ) {
        this();
    }
    ...
    private final long A01(List<C2303iT> list, int i10, int i11) {
    ...
    private final String A03(String str) {
        ...
        while (true) {
            ...
            if (n10 < length2) {
                int iCharAt = (sb2.charAt(n10) << 16) + (sb2.charAt(n10 + 1) << '\b') + sb2.charAt(n10 + 2);
                int n11 = (iCharAt >> 12) & 63;
                int n12 = (iCharAt >> 6) & 63;
                StringBuilder sb4 = sb3.append(strA02.charAt((iCharAt >> 18) & 63));
                sb4.append(strA02.charAt(n11)).append(strA02.charAt(n12)).append(strA02.charAt(iCharAt & 63));
                n10 += 3;
            } else {
    ...
    private final String A04(List<Long> list) {
        ...
        C2772qY.A08(string, A02(Sdk$SDKError.b.INVALID_INDEX_URL_VALUE, 13, 74));
        return A03(string);
    }

    private final String A05(List<C2303iT> list, int i10, int i11, boolean z10) {
        if (list == null || list.isEmpty() || i10 < 0 || i10 >= list.size() || i11 <= 0 || i10 + i11 > list.size()) {
            return null;
        }
        Map frameDataMap = new HashMap();
        frameDataMap.put(A02(73, 2, Sdk$SDKError.b.TPAT_ERROR_VALUE), list.get(i10).A05());
    ...
    private final void A08(StringBuilder sb2, long j10) {
        while (j10 >= 128) {
            long j11 = ((long) (128 - 1)) & j10;
            long v10 = 128;
            j10 >>= 7;
            sb2.append((char) (AbstractC2786qr.A00((short) (j11 | v10)) & 65535));
        }
        int iA00 = AbstractC2786qr.A00((short) j10) & 65535;
        String[] strArr = A01;
    ...
    private final void A09(List<C2303iT> list, int i10, int i11) {
        long a00;
        int i12 = (i10 + i11) - 1;
        int i13 = i10 + 1;
        if (i13 > i12) {
    ...
    @JvmStatic
    public final String A0A(List<C2303iT> list) {
        if (list != null) {
