...
public final class C8R {
    ...
    public static final AbstractC2650oX<Integer, Integer> A06;
    ...
    static {
        ...
        A06 = new C2648oV().A05(5, 6).A05(17, 6).A05(7, 6).A05(18, 6).A05(6, 8).A05(8, 8).A05(14, 8).A07();
    }
    ...
    public static int A01(int i10, int i11) {
        ...
        return ((Integer) AbstractC09823y.A01(orDefault)).intValue();
    }

    public static C8R A02(Context context) {
        Intent intent = context.registerReceiver(null, new IntentFilter(A05(68, 36, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE)));
        return A03(context, intent);
    }

    public static C8R A03(Context context, Intent intent) {
        if (A07() && Settings.Global.getInt(context.getContentResolver(), A05(Sdk$SDKError.b.AD_ALREADY_FAILED_VALUE, 31, 58), 0) == 1) {
            return A05;
        }
    ...
    public final Pair<Integer, Integer> A09(C2758qI c2758qI) {
        int encoding;
        int channelCount;
        int iA03 = C3J.A03((String) AbstractC09823y.A01(c2758qI.A0W), c2758qI.A0R);
    ...
    public final boolean A0B(C2758qI c2758qI) {
        return A09(c2758qI) != null;
    }
