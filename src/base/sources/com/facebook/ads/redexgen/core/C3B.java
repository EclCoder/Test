...
public final class C3B extends ED {
    ...
    public C3B(C2198gi c2198gi) {
        this(c2198gi, null);
    }

    public C3B(C2198gi c2198gi, AttributeSet attributeSet) {
        this(c2198gi, attributeSet, 0);
    }

    public C3B(C2198gi c2198gi, AttributeSet attributeSet, int i10) {
        super(c2198gi, attributeSet, i10);
        this.A00 = new C1199Da(this);
