...
public final class C2676ox implements AnonymousClass74 {
    ...
    public C2676ox() {
        this(new C2568nC(true, C.DEFAULT_BUFFER_SEGMENT_SIZE), DefaultLoadControl.DEFAULT_MAX_BUFFER_MS, DefaultLoadControl.DEFAULT_MAX_BUFFER_MS, DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_MS, 5000, -1, false, 0, false);
    }

    public C2676ox(C2568nC c2568nC, int i10, int i11, int i12, int i13, int i14, boolean z10, int i15, boolean z11) {
        int i16;
        String strA02 = A02(163, 19, 110);
        String strA03 = A02(21, 1, 6);
        A04(i12, 0, strA02, strA03);
        String strA04 = A02(Sdk$SDKError.b.MRAID_JS_WRITE_FAILED_VALUE, 32, 12);
        A04(i13, 0, strA04, strA03);
        String strA05 = A02(193, 11, Sdk$SDKError.b.TPAT_ERROR_VALUE);
        A04(i10, i12, strA05, strA02);
        A04(i10, i13, strA05, strA04);
        A04(i11, i10, A02(182, 11, 66), strA05);
        A04(i15, 0, A02(111, 20, 53), strA03);
        this.A08 = c2568nC;
    ...
    private final int A01(InterfaceC2570nE[] interfaceC2570nEArr) {
        int iA00 = 0;
        for (InterfaceC2570nE interfaceC2570nE : interfaceC2570nEArr) {
            if (interfaceC2570nE != null) {
                int targetBufferSize = interfaceC2570nE.A9L().A02;
    ...
    public static void A04(int i10, int i11, String str, String str2) {
        AbstractC09823y.A09(i10 >= i11, str + A02(0, 21, 28) + str2);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass74
    public final void AGF(AnonymousClass73 anonymousClass73, C2588nW c2588nW, InterfaceC2570nE[] interfaceC2570nEArr) {
        int iA01;
        if (this.A02 == -1) {
            iA01 = A01(interfaceC2570nEArr);
        } else {
            iA01 = this.A02;
        }
        this.A00 = iA01;
    ...
    public final boolean AJv(AnonymousClass73 anonymousClass73) {
        ...
        if (anonymousClass73.A01 < Math.max(jMin, 500000L)) {
            ...
            if (!targetBufferSizeReached2 && anonymousClass73.A01 < 500000) {
                AbstractC09904g.A07(A02(22, 18, 28), A02(40, 71, 106));
            }
