...
public final class C1342Io {
     ...
     */
    public static Pair<String, List<byte[]>> A02(C10054v c10054v) throws C3K {
        try {
            c10054v.A0g(16);
            ...
            A0q[2] = "JoNevXQ";
            if (jA0O != 826496599) {
                AbstractC09904g.A07(A03(Sdk$SDKError.b.DEEPLINK_OPEN_FAILED_VALUE, 17, 46), A03(492, 51, 65));
                return new Pair<>(A03(1189, 15, 45), null);
            }
            byte[] bArrA0l = c10054v.A0l();
            for (int iA09 = c10054v.A09() + 20; iA09 < bArrA0l.length - 4; iA09++) {
    ...
    public void A06() {
        AbstractC09823y.A01(this.A0b);
    }

    public static boolean A09(C10054v c10054v) throws C3K {
        try {
            ...
            c10054v.A0f(24);
            return c10054v.A0P() == MatroskaExtractor.A0x.getMostSignificantBits() && c10054v.A0P() == MatroskaExtractor.A0x.getLeastSignificantBits();
        } catch (ArrayIndexOutOfBoundsException unused) {
    ...
    public final void A0E() {
        if (this.A0c != null) {
            C1306He c1306He = this.A0c;
            InterfaceC1305Hd interfaceC1305Hd = this.A0b;
            String[] strArr = A0q;
            ...
            c1306He.A05(interfaceC1305Hd, this.A0a);
        }
    }
    ...
    public final void A0G(com.facebook.ads.redexgen.core.HA r20, int r21) throws com.facebook.ads.redexgen.core.C3K {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1342Io.A0G(com.facebook.ads.redexgen.X.HA, int):void");
    }
}
