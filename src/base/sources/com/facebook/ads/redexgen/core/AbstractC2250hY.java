...
public abstract class AbstractC2250hY {
    ...
    public static int A0F(@Nullable StringBuilder sb2, @Nullable String str, Object... objArr) {
        ...
        for (Object obj : objArr) {
            int length = A0E(sb2, str, iA01, obj, !z10);
            if (length == -1) {
                return -1;
            }
            if (argsWasEmpty) {
        ...
        int segIdx2 = A0B(sb2, str, iA01, i10, argsWasEmpty);
        return segIdx2;
    }
    ...
    public static String A0K(@Nullable String str, Object... objArr) {
        try {
            return String.format(null, str, (Object[]) AbstractC2259hi.A00(objArr, A0G(2, 45, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE)));
