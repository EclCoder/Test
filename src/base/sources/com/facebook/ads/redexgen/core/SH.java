...
public final class SH implements RewardedVideoAdApi, Repairable {
    ...
    public SH(Context context, String str, Ad ad2) {
        String string;
        this.A00 = ad2;
        if (context instanceof C2198gi) {
            ...
            this.A03 = C1571Rp.A07(context, string);
        }
        ...
        this.A01 = new C2293iI(this.A03, str, this.A00, new C2317ij());
        this.A03.A0O(this);
    ...
    public final void destroy() {
        AbstractC1681Vy.A05(A00(Sdk$SDKError.b.PRIVACY_URL_ERROR_VALUE, 7, 47), A00(48, 27, 50), A00(0, 8, 64));
        A04();
    }
    ...
    public final void loadAd() {
        AbstractC1681Vy.A05(A00(143, 6, 44), A00(75, 32, 96), A00(24, 8, 30));
        A07(null, null, true);
    }
    ...
    public final void repair(Throwable th2) {
        if (this.A01.A04 != null) {
            this.A01.A04.onError(this.A00, new AdError(2001, A00(32, 16, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE) + AbstractC1725Xt.A03(this.A01.A0B, th2)));
        }
    }
    ...
    public final boolean show() {
        AbstractC1681Vy.A05(A00(149, 4, 108), A00(107, 29, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE), A00(8, 8, 38));
    ...
    public final boolean show(RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        AbstractC1681Vy.A05(A00(149, 4, 108), A00(107, 29, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE), A00(16, 8, 88));
