...
public abstract class BR<E> extends AbstractC2640oN<E> {
    ...
    public BR(int initialCapacity) {
        AbstractC2575nJ.A00(initialCapacity, A00(0, 15, 58));
    ...
    private void A02(int newElements) {
        ...
        int newCapacity = AbstractC2640oN.A03(objArr.length, this.A00 + newElements);
