...
public final class LA {
    ...
    private int A01(InterfaceC2549ms interfaceC2549ms, HV hv, int i10) throws IOException {
        int iMin = (int) Math.min(this.A06, interfaceC2549ms.A8O());
        ...
        this.A07.A0d(iMin);
        interfaceC2549ms.AIl();
        interfaceC2549ms.AGt(this.A07.A0l(), 0, iMin);
        this.A01 = A03(this.A07, i10);
        this.A04 = true;
        return 0;
    }

    private int A02(InterfaceC2549ms interfaceC2549ms, HV hv, int i10) throws IOException {
        long inputLength = interfaceC2549ms.A8O();
        int iMin = (int) Math.min(this.A06, inputLength);
        long inputLength2 = inputLength - ((long) iMin);
        if (interfaceC2549ms.A8n() != inputLength2) {
            hv.A00 = inputLength2;
            return 1;
        }
        this.A07.A0d(iMin);
    ...
    private long A03(C10054v c10054v, int i10) {
        int iA0A = c10054v.A0A();
        for (int iA09 = c10054v.A09(); iA09 < iA0A; iA09++) {
            int searchEndPosition = c10054v.A0l()[iA09];
            if (searchEndPosition == 71) {
                long jA01 = LI.A01(c10054v, iA09, i10);
    ...
    private long A04(C10054v c10054v, int i10) {
        int iA09 = c10054v.A09();
        int iA0A = c10054v.A0A();
        for (int i11 = iA0A - 188; i11 >= iA09; i11--) {
            if (LI.A03(c10054v.A0l(), iA09, iA0A, i11)) {
                long jA01 = LI.A01(c10054v, i11, i10);
                if (jA01 != C.TIME_UNSET) {
                    return jA01;
                }
            }
    ...
    public final int A07(InterfaceC2549ms interfaceC2549ms, HV hv, int i10) throws IOException {
        if (i10 <= 0) {
            return A00(interfaceC2549ms);
        }
        if (!this.A05) {
            return A02(interfaceC2549ms, hv, i10);
        }
        if (this.A02 == C.TIME_UNSET) {
            return A00(interfaceC2549ms);
        }
        if (!this.A04) {
            int iA01 = A01(interfaceC2549ms, hv, i10);
            if (A0A[0].charAt(2) == 'O') {
        ...
        if (this.A00 < 0) {
            AbstractC09904g.A07(A05(45, 16, 60), A05(27, 18, 47) + this.A00 + A05(0, 27, 104));
