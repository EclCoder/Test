...
public final class KC {
    ...
    public static float A00(String str) {
        try {
            ...
            AbstractC09904g.A0A(A06(261, 8, 80), A06(71, 28, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE) + str + A06(2, 1, 8), e10);
    ...
    public static int A01(String str) {
        ...
        AbstractC09904g.A07(A06(261, 8, 80), A06(129, 28, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE) + str);
        return -1;
    }
    ...
    public static int A02(String str) {
        ...
        AbstractC09904g.A07(A06(261, 8, 80), A06(99, 30, 93) + str);
        return -1;
    }
    ...
    public static KC A04(String str, K8 k10) {
        ...
        AbstractC09823y.A07(str.startsWith(strA06));
        String[] strArrSplit = TextUtils.split(str.substring(strA06.length()), A06(3, 1, 66));
        int length = strArrSplit.length;
        int i10 = k10.A05;
        String strA07 = A06(261, 8, 80);
        if (length != i10) {
            AbstractC09904g.A07(strA07, C5C.A0n(A06(157, 69, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE), Integer.valueOf(k10.A05), Integer.valueOf(strArrSplit.length), str));
            return null;
        }
        try {
            ...
            AbstractC09904g.A0A(strA07, A06(Sdk$SDKError.b.PRIVACY_ICON_FALLBACK_ERROR_VALUE, 35, 80) + str + A06(2, 1, 8), e10);
            return null;
        }
    }
    ...
    public static Integer A05(String str) {
        ...
        try {
            ...
            AbstractC09823y.A07(j10 <= 4294967295L);
            int iA02 = AbstractC1142As.A02(((j10 >> 24) & 255) ^ 255);
            int iA03 = AbstractC1142As.A02((j10 >> 16) & 255);
            int b10 = AbstractC1142As.A02((j10 >> 8) & 255);
            int a10 = AbstractC1142As.A02(j10 & 255);
            return Integer.valueOf(Color.argb(iA02, a10, b10, iA03));
        } catch (IllegalArgumentException e10) {
            AbstractC09904g.A0A(A06(261, 8, 80), A06(36, 35, 57) + str + A06(2, 1, 8), e10);
            return null;
        }
    }
    ...
    public static boolean A0A(String str) {
        try {
            ...
            AbstractC09904g.A0A(A06(261, 8, 80), A06(4, 32, 13) + str + A06(2, 1, 8), e10);
            return false;
        }
    }
}
