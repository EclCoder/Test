...
public final class RU extends Thread {
    ...
    public RU(C2198gi c2198gi, RW rw) {
        this(c2198gi, rw, C1648Up.A08(c2198gi));
    }

    public RU(C2198gi c2198gi, RW rw, int i10) {
            ...
            while (!isInterrupted()) {
                ...
                try {
                    ...
                    if (interval2 != 0 && !this.A06 && !Debug.isDebuggerConnected()) {
                        ...
                        if (strA03 != null) {
                            this.A03.A08().ABC(A01(15, 7, 8), AbstractC1610Td.A1D, new C1611Te(this.A02.A04(strA03)));
                        }
                        this.A06 = true;
                    }
