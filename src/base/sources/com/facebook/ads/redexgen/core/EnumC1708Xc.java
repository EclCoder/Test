...
public enum EnumC1708Xc {
    ...
    EnumC1708Xc(int i10, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i10;
        this.A01 = nativeComponentTag;
    }

    @Nullable
    public static EnumC1708Xc A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC1708Xc enumC1708Xc : values()) {
            if (enumC1708Xc.A01 == nativeComponentTag) {
                return enumC1708Xc;
            }
        }
        return null;
    ...
    public static void A03(@Nullable View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC1708Xc internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(@Nullable View view, @Nullable EnumC1708Xc enumC1708Xc) {
        if (view != null && enumC1708Xc != null) {
            view.setTag(A02, enumC1708Xc);
        }
    }
