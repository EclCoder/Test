...
public final class C1694Wl {
    public static C1694Wl A03;
    ...
    public final C1693Wk A01 = new C1693Wk();
    ...
    public C1694Wl(T8 t10) {
        this.A00 = t10;
    }

    public static C1694Wl A00(T8 t10) {
        if (A03 == null) {
            A03 = new C1694Wl(t10);
        }
        return A03;
    ...
    private void A06(String str, int i10) {
        ...
        if (str.equals(AdPlacementType.INTERSTITIAL.toString())) {
            this.A01.A05(this.A00, A01(65, 23, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE), i10);
            return;
        }
        ...
        if (str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString())) {
            this.A01.A05(this.A00, A01(88, 26, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE), i10);
        } else if (str.equals(AdPlacementType.NATIVE.toString())) {
            this.A01.A05(this.A00, A01(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 17, 5), i10);
        } else {
            if (!str.equals(AdPlacementType.NATIVE_BANNER.toString())) {
                return;
            }
            this.A01.A05(this.A00, A01(Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE, 23, 66), i10);
        }
    }
    ...
    public final int A0A(String str) {
        ...
        if (str.equals(AdPlacementType.INTERSTITIAL.toString())) {
            return this.A01.A03(this.A00, A01(65, 23, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE), 0);
        }
        if (str.equals(AdPlacementType.BANNER.toString())) {
            return this.A01.A03(this.A00, A01(48, 17, 18), 0);
        }
        if (str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString())) {
            return this.A01.A03(this.A00, A01(88, 26, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE), 0);
        }
        if (str.equals(AdPlacementType.NATIVE.toString())) {
            return this.A01.A03(this.A00, A01(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 17, 5), 0);
        }
        if (!str.equals(AdPlacementType.NATIVE_BANNER.toString())) {
            return 0;
        }
        C1693Wk c1693Wk = this.A01;
        T8 t10 = this.A00;
        String strA01 = A01(Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE, 23, 66);
        if (A05[5].charAt(25) != '7') {
            throw new RuntimeException();
        }
        A05[3] = "fotbcTaHfC";
        return c1693Wk.A03(t10, strA01, 0);
    }
                ...
                try {
                    ...
                    if (!A08(str, clientToken)) {
                        ...
                        if (!jSONObject.has(strA01)) {
                            ...
                            if (System.currentTimeMillis() - jSONObject.getLong(strA01) < C1648Up.A02(this.A00)) {
    ...
    public final void A0C(String str) {
        try {
            ...
            JSONArray placementJSON = jSONArray.getJSONObject(0).getJSONArray(A01(11, 3, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE));
            if (placementJSON.length() == 0) {
                return;
            }
            JSONObject jSONObject = placementJSON.getJSONObject(0).getJSONObject(A01(16, 4, 109));
            String string = jSONObject.getString(A01(14, 2, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE));
            String clientToken = jSONArray.getJSONObject(0).getJSONObject(A01(20, 10, 63)).getString(A01(177, 4, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE));
    ...
    public final boolean A0F(String str) {
        return !C1648Up.A1A(this.A00) && (str.equals(AdPlacementType.BANNER.toString()) || str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString()));
    }
}
