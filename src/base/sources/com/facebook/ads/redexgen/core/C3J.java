...
public abstract class C3J {
    ...
    public static C3I A04(String str) {
        ...
        String str2 = (String) AbstractC09823y.A01(matcher.group(1));
    ...
    public static int A00(String str) {
        ...
        switch (str.hashCode()) {
            ...
            case 187078297:
                ...
                break;
            case 1504578661:
                if (!str.equals(A06(400, 10, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE))) {
                    b10 = -1;
                } else {
                    b10 = 1;
                }
    ...
    public static int A01(String str) {
        ...
        if (!A06(108, 15, 43).equals(str)) {
            ...
            if (strArr[3].charAt(11) != strArr[1].charAt(11)) {
                A01[6] = "P";
                if (A06(Sdk$SDKError.b.AD_IS_LOADING_VALUE, 18, 4).equals(str)) {
                    return 5;
                }
            } else {
                String[] strArr2 = A01;
                ...
                if (A06(Sdk$SDKError.b.AD_IS_LOADING_VALUE, 18, 52).equals(str)) {
                    return 5;
                }
            }
    ...
    public static int A03(String str, String str2) {
        ...
        switch (str.hashCode()) {
            ...
            case 1504831518:
                if (str.equals(A06(508, 10, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE))) {
                    b10 = 0;
                }
                switch (b10) {
                    case 0:
    ...
    public static String A05(int i10) {
        switch (i10) {
            ...
            case 105:
            case 107:
                String strA06 = A06(508, 10, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE);
                String[] strArr2 = A01;
            ...
            case 165:
                return A06(382, 9, 27);
            case 166:
                return A06(400, 10, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE);
            case 169:
            case 172:
                String strA08 = A06(576, 13, 35);
                if (A01[5].length() != 2) {
                    String[] strArr8 = A01;
            ...
            case 174:
                ...
                break;
            case 177:
                return A06(989, 19, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE);
            default:
                return null;
        }
        throw new RuntimeException();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:121:0x0353, code lost:
        ...
        if (r3.startsWith(A06(764, 4, com.inmobi.media.core.config.models.AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL)) == false) goto L124;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:131:0x03a2, code lost:
        ...
        if (r3.startsWith(A06(854, 4, com.vungle.ads.internal.protos.Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE)) == false) goto L137;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:146:0x0409, code lost:
        ...
        if (r3.startsWith(A06(858, 4, com.vungle.ads.internal.protos.Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE)) == false) goto L149;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:49:0x015c, code lost:
        ...
        return A06(989, 19, com.vungle.ads.internal.protos.Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE);
     */
    /* JADX WARN: Code restructure failed: missing block: B:51:0x016a, code lost:
    
        if (r3.startsWith(A06(1022, 3, com.vungle.ads.internal.protos.Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE)) != false) goto L54;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:72:0x01e7, code lost:
        ...
        r3 = A06(474, 10, com.vungle.ads.internal.protos.Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:89:0x025e, code lost:
        ...
        return A06(400, 10, com.vungle.ads.internal.protos.Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE);
     */
    ...
    */
    ...
    public static String A08(String str) {
        ...
        switch (b10) {
            case 0:
                return A06(424, 10, 2);
            case 1:
                return A06(508, 10, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE);
            case 2:
                return A06(673, 9, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE);
            default:
                return str;
        }
    }
    ...
    public static boolean A0D(String str) {
        return A06(814, 5, 109).equals(A0A(str)) || A06(Sdk$SDKError.b.AD_LOAD_FAIL_RETRY_AFTER_VALUE, 23, Sdk$SDKError.b.TPAT_ERROR_VALUE).equals(str);
    }

    public static boolean A0E(String str) {
        if (!A06(862, 4, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE).equals(A0A(str)) && !A06(51, 19, 85).equals(str) && !A06(70, 19, 31).equals(str) && !A06(244, 25, 111).equals(str) && !A06(357, 20, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE).equals(str)) {
            String[] strArr = A01;
            if (strArr[7].charAt(24) == strArr[2].charAt(24)) {
                throw new RuntimeException();
            }
            A01[5] = "uN";
            if (!A06(138, 20, 34).equals(str) && !A06(290, 28, Sdk$SDKError.b.TPAT_ERROR_VALUE).equals(str) && !A06(269, 21, 1).equals(str) && !A06(Sdk$SDKError.b.AD_CLOSED_MISSING_HEARTBEAT_VALUE, 19, 34).equals(str) && !A06(158, 18, 9).equals(str) && !A06(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 15, 63).equals(str) && !A06(89, 19, 98).equals(str)) {
                return false;
            }
        }
        return true;
    ...
    /* JADX WARN: Code duplicated, block: B:46:0x00fe A[ADDED_TO_REGION, RETURN] */
    /* JADX WARN: Code duplicated, block: B:47:0x00ff  */
    /* JADX WARN: Code duplicated, block: B:56:0x0112 A[RETURN] */
            ...
            case -2123537834:
                ...
                switch (b10) {
                    ...
                    case 9:
                        return true;
                    case 10:
                        return (str2 != null || (c3iA04 = A04(str2)) == null || (iA00 = c3iA04.A00()) == 0 || iA00 == 16) ? false : true;
                    default:
                        return false;
                }
            case -432837260:
