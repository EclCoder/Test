...
public final class C1852b6 extends Drawable {
    ...
    public String A05;
    public String A06;
    public WeakReference<C2143fp> A07;
    public boolean A08;
    ...
    public C1852b6() {
        this.A09.setColor(Color.argb(Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE, 36, 36, 36));
        ...
        this.A0B.setColor(Color.argb(Sdk$SDKError.b.PLACEMENT_SLEEP_VALUE, 0, 0, 0));
    ...
    public void A03() {
        ...
        if (i10 <= 0) {
            ...
            sb2.append(A02(47, 4, 50));
            sb2.append(A02(21, 6, 57));
            sb2.append(A02(12, 9, 31));
            if (this.A03 > 0) {
                long jMax = Math.max(0L, System.currentTimeMillis() - this.A03);
                int i11 = (int) (jMax / 3600000);
                long j10 = jMax % 3600000;
                int minutes = (int) (j10 / ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
                int i12 = (int) ((j10 % ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS) / 1000);
                if (i11 > 0) {
                    sb2.append(i11);
                    sb2.append(A02(85, 2, 91));
                }
                if (i11 > 0 || minutes > 0) {
                    sb2.append(minutes);
                    sb2.append(A02(87, 2, 24));
                }
                sb2.append(i12);
                sb2.append(A02(89, 5, 37));
            } else {
                sb2.append(A02(51, 7, 9));
            }
        } else {
            sb2.append(A02(27, 5, 81));
            sb2.append(this.A01 + 1);
            sb2.append(A02(8, 4, 74));
            sb2.append(this.A00);
        }
        sb2.append(A02(1, 7, 31));
        if (this.A07 != null) {
            C2143fp c2143fp = this.A07.get();
            String[] strArr = A0H;
    ...
    public final void A0A(C2143fp c2143fp) {
        this.A07 = new WeakReference<>(c2143fp);
        A03();
    }
