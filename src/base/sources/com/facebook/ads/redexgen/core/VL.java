...
public final class VL {
     ...
     */
    public static void A06(T8 t10, InterfaceC2149fv interfaceC2149fv, Map<String, ?> map) throws JSONException {
        HashMap map2 = new HashMap();
        map2.put(A01(93, 7, 67), A01(13, 1, 40));
        A0A(t10, map2);
        HashMap map3 = new HashMap();
        map3.put(A01(188, 7, 36), A01(157, 14, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE));
        map3.put(A01(195, 12, 37), String.valueOf(3501));
        map3.put(A01(100, 16, 16), A01(14, 1, 62));
        map3.put(A01(178, 10, 74), A01(65, 13, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE));
        ...
        A0A(t10, map3);
        U7 u7A09 = t10.A09();
        JSONObject jSONObjectA05 = C1612Tf.A05(new C1614Th(u7A09.A01(), u7A09.A02(), map3));
        ...
        c2163g9.put(A01(171, 7, 40), jSONObject2.toString());
        interfaceC2149fv.AGy(t10.A05().A86(), c2163g9.A08(), new WJ(t10));
    }
    ...
    public static void A08(T8 t10, String str) {
        ...
        synchronized (VL.class) {
            if (A03.get() != 2) {
                ...
                SharedPreferences sharedPreferences = t10.getApplicationContext().getSharedPreferences(ProcessUtils.getProcessSpecificName(A01(Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE, 31, 83), t10), 0);
                value = sharedPreferences.getInt(str, 0) + 1;
                sharedPreferences.edit().putInt(str, value).apply();
            }
            if (t10.A05().AAO()) {
                String str2 = A01(43, 22, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE) + str + A01(0, 13, 71) + value;
            }
        }
    }
    ...
    public static boolean A0C(T8 t10) {
        ...
        if (!AbstractC1650Ur.A0U(t10)) {
            return true;
        }
        return A0B(t10.A09().A00(), AbstractC1650Ur.A0C(t10));
    }
}
