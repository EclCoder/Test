...
public final class TH {
    ...
    public final C2139fl A03 = new C2139fl(this);
    public final C2146fs A02 = new C2146fs(this);
    ...
    static {
        A07();
        StringBuilder sbAppend = new StringBuilder().append(A05(107, 14, 44)).append(C2139fl.A03.A01);
        String strA05 = A05(58, 2, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE);
        ...
        StringBuilder sbAppend4 = sbAppend3.append(strA07).append(C2139fl.A02.A01).append(strA05);
        String strA08 = A05(Sdk$SDKError.b.PRIVACY_URL_ERROR_VALUE, 6, 26);
        A05 = sbAppend4.append(strA08).append(strA07).append(C2146fs.A04.A01).append(strA05).append(strA08).append(strA07).append(C2146fs.A05.A01).append(strA05).append(strA08).append(strA07).append(C2146fs.A0A.A01).append(strA05).append(strA08).append(strA07).append(C2146fs.A08.A01).append(strA05).append(strA08).append(strA07).append(C2146fs.A07.A01).append(strA05).append(strA08).append(strA07).append(C2146fs.A06.A01).append(strA05).append(strA08).append(strA07).append(C2146fs.A03.A01).append(strA05).append(strA08).append(strA07).append(C2146fs.A02.A01).append(A05(11, 6, 105)).append(strA08).append(A05(17, 6, 78)).append(strA06).append(A05(30, 4, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE)).append(strA08).append(strA07).append(C2146fs.A09.A01).append(A05(0, 3, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE)).append(strA06).append(strA07).append(C2139fl.A03.A01).append(A05(34, 10, 38)).append(strA08).append(strA07).append(C2146fs.A08.A01).append(A05(7, 4, 36)).toString();
        A08 = new ReentrantReadWriteLock();
        A06 = A08.readLock();
        A07 = A08.writeLock();
    }

    public TH(C2194ge c2194ge) {
        this.A01 = c2194ge;
    }
    ...
    private synchronized SQLiteDatabase A01() {
        ...
        this.A01.A08().ABC(A05(128, 8, 110), AbstractC1610Td.A0v, new C1611Te(e10));
        throw e10;
        return A00();
    }
    ...
    public final int A08(int i10) {
        A07.lock();
        try {
            return A0E().delete(A05(Sdk$SDKError.b.PRIVACY_URL_ERROR_VALUE, 6, 26), C2146fs.A02.A01 + A05(3, 4, 60), new String[]{String.valueOf(i10 - 1)});
        } finally {
            A07.unlock();
        }
    }
    ...
    public final SQLiteDatabase A0E() {
        ...
        throw new IllegalStateException(A05(64, 43, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE));
    }
    ...
    public final AsyncTask A0G(final String str, final int i10, final String str2, final double d10, final double d11, final String str3, final Map<String, String> data, UO<String> uo2) {
        return A0F(new AbstractC2106fE<String>() { // from class: com.facebook.ads.redexgen.X.75
                    ...
                    try {
                        ...
                        if (sQLiteDatabaseA0E != null && sQLiteDatabaseA0E.isOpen()) {
                            try {
                                ...
                                this.A03.A01.A08().ABC(eventId, AbstractC1610Td.A0z, new C1611Te(e10));
                            }
                        }
                        TH.A07.unlock();
                        return strA0E;
                        ...
                        A01(TJ.A05);
                        this.A03.A01.A08().ABC(eventId, AbstractC1610Td.A0y, new C1611Te(e11));
                        if (sQLiteDatabaseA0E != null && sQLiteDatabaseA0E.isOpen()) {
                            try {
                                if (sQLiteDatabaseA0E.inTransaction()) {
                                    sQLiteDatabaseA0E.endTransaction();
                                ...
                                this.A03.A01.A08().ABC(eventId, AbstractC1610Td.A0z, new C1611Te(e12));
                            }
                        }
                        TH.A07.unlock();
                        return null;
                    ...
                    if (sQLiteDatabaseA0E != null) {
                        ...
                        if (zIsOpen) {
                            try {
                                ...
                                this.A03.A01.A08().ABC(eventId, AbstractC1610Td.A0z, new C1611Te(e13));
                            }
                        }
                    }
                    TH.A07.unlock();
    ...
    public final boolean A0L(String str) {
        ...
        try {
            ...
            sb2.append(A05(Sdk$SDKError.b.TPAT_ERROR_VALUE, 7, 90)).append(A05(Sdk$SDKError.b.PRIVACY_URL_ERROR_VALUE, 6, 26)).append(A05(44, 5, 36)).append(C2146fs.A02.A01).append(A05(61, 1, 32)).append(C2146fs.A02.A01).append(A05(56, 2, 50)).append(A05(49, 7, 92)).append(C2146fs.A04.A01).append(A05(62, 2, 77));
