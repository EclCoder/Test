...
public final class C2015dj extends RelativeLayout {
    ...
    public C2015dj(C2198gi c2198gi, C1468Nm c1468Nm, NY ny, ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr, String str, View.OnClickListener onClickListener) {
        super(c2198gi);
        this.A04 = c2198gi;
        this.A03 = c1468Nm;
        this.A02 = ny;
        ...
        this.A06 = new C1898bq(this.A04, C1456Na.A01(null), true, false, true);
        A00();
    }

    private void A00() {
        AbstractC1899br.A00(this.A04, this, this.A03.A01());
