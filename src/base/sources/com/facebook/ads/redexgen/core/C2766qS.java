...
public final class C2766qS implements AnonymousClass24 {
    ...
    public static final C2766qS A08;
    public static final AnonymousClass23<C2766qS> A09;
    public static final C2767qT A0A;
    ...
    public final C2767qT[] A05;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static C2766qS A00(Bundle bundle) {
        C2767qT[] c2767qTArr;
        ArrayList parcelableArrayList = bundle.getParcelableArrayList(A0B);
        if (parcelableArrayList == null) {
            c2767qTArr = new C2767qT[0];
        } else {
            c2767qTArr = new C2767qT[parcelableArrayList.size()];
            for (int i10 = 0; i10 < parcelableArrayList.size(); i10++) {
                c2767qTArr[i10] = (C2767qT) C2767qT.A09.A6f((Bundle) parcelableArrayList.get(i10));
            }
        }
        return new C2766qS(null, c2767qTArr, bundle.getLong(A0C, A08.A02), bundle.getLong(A0D, A08.A03), bundle.getInt(A0E, A08.A01));
    }
    ...
    static {
        A03();
        A08 = new C2766qS(null, new C2767qT[0], 0L, C.TIME_UNSET, 0);
        A0A = new C2767qT(0L).A06(0);
        A0B = C5C.A0h(1);
        A0C = C5C.A0h(2);
        A0D = C5C.A0h(3);
        A0E = C5C.A0h(4);
        A09 = new AnonymousClass23() { // from class: com.facebook.ads.redexgen.X.qV
            ...
            public final AnonymousClass24 A6f(Bundle bundle) {
                return C2766qS.A00(bundle);
            }
        };
    }

    public C2766qS(Object obj, C2767qT[] c2767qTArr, long j10, long j11, int i10) {
        this.A04 = obj;
        this.A02 = j10;
        this.A03 = j11;
        this.A00 = c2767qTArr.length + i10;
        this.A05 = c2767qTArr;
        this.A01 = i10;
    }
    ...
    public final C2767qT A07(int i10) {
        if (i10 < this.A01) {
            return A0A;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        C2766qS c2766qS = (C2766qS) obj;
        if (C5C.A1E(this.A04, c2766qS.A04) && this.A00 == c2766qS.A00 && this.A02 == c2766qS.A02 && this.A03 == c2766qS.A03 && this.A01 == c2766qS.A01) {
            C2767qT[] c2767qTArr = this.A05;
            String[] strArr = A07;
            if (strArr[5].length() == strArr[1].length()) {
                throw new RuntimeException();
            }
            ...
            if (Arrays.equals(c2767qTArr, c2766qS.A05)) {
                return true;
            }
        }
        return false;
        ...
        while (true) {
            ...
            if (i10 < length) {
                ...
                while (true) {
                    ...
                    String strA03 = A02(0, 2, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE);
                    if (i12 < length2) {
