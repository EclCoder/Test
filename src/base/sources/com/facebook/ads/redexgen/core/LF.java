...
public final class LF extends C1500Os {
    ...
    private void A02() {
        ...
        new LM(c1892bk, this.A03).A05(A0D, A0D).A07(this.A02.A2C().A01());
        c1892bk.setFullCircleCorners(true);
        YB.A0N(c1892bk, 0);
        YB.A0K(c1892bk);
        ...
        layoutParams2.addRule(3, c1892bk.getId());
        ...
        C1894bm c1894bm = new C1894bm(this.A03, A0B, 5, A0A, -1);
        c1894bm.setGravity(16);
        linearLayout.addView(c1894bm, new LinearLayout.LayoutParams(-2, -1));
        ...
        if (TextUtils.isEmpty(this.A02.A29().A0I().A0C())) {
            ...
            c1894bm.setRating(Float.parseFloat(this.A02.A29().A0I().A0C()));
            if (this.A02.A29().A0I().A09() != null) {
                textView2.setText(A00(0, 1, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE) + NumberFormat.getNumberInstance().format(Integer.parseInt(this.A02.A29().A0I().A09())) + A00(1, 1, 1));
            }
        }
    ...
    static {
        A03();
        A0C = (int) (C1500Os.A08 * 12.0f);
        A0D = (int) (C1500Os.A08 * 84.0f);
        A0B = (int) (C1500Os.A08 * 14.0f);
        A09 = XV.A0v;
        A0A = P3.A02(-1, 77);
    }

    public LF(C2198gi c2198gi, AbstractC2363jd abstractC2363jd, VA va2, InterfaceC1739Yh interfaceC1739Yh) {
        super(c2198gi);
        this.A05 = new Y2();
        this.A03 = c2198gi;
        this.A02 = abstractC2363jd;
        this.A04 = va2;
        this.A06 = interfaceC1739Yh;
        this.A05.A05();
        setRadius(20.0f);
        setMaxCardElevation(75.0f);
        this.A01 = new RelativeLayout(c2198gi);
        AbstractC1899br.A00(c2198gi, this.A01, abstractC2363jd.A29().A0H().A08());
    ...
    private void A01() {
        ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr = new ViewOnClickListenerC1396Kr(this.A03, EnumC2091ez.A04.A03(), this.A02.A28().A01(), this.A02.A29().A0J().A06(), this.A04, this.A06, null, this.A05, this.A02.A2A());
        viewOnClickListenerC1396Kr.setViewShowsOverMedia(true);
        YB.A0G(1001, viewOnClickListenerC1396Kr);
        viewOnClickListenerC1396Kr.setCta(this.A02.A29().A0J(), this.A02.A2E(), new HashMap(), null);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
        viewOnClickListenerC1396Kr.setPadding(A0C, A0C, A0C, A0C);
        layoutParams.setMargins(A0C, A0C, A0C, A0C * 2);
        this.A00.addView(viewOnClickListenerC1396Kr, layoutParams);
    }
}
