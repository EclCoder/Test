...
public class C1477Nv implements XN {
    ...
    public C1477Nv(NO no2) {
        this.A00 = no2;
    }

    public /* synthetic */ C1477Nv(NO no2, OV ov) {
        this(no2);
    }
    ...
    public final void AFV(float f10) {
        ...
        if (this.A00.A0e) {
            if (this.A00.A0J) {
                AbstractC2363jd abstractC2363jd = this.A00.A0O;
                if (A02[6].charAt(27) != 'a') {
                    throw new RuntimeException();
                }
                A02[4] = "3MuDy2E798EtOoHK0e0a3SiH1QgAy5";
                fA04 = 1.0f - (f10 / abstractC2363jd.A29().A0H().A03());
                if (this.A00.A0M || fA04 < 1.0f) {
                    this.A00.A0M = false;
                    this.A00.A0g.setToolbarActionMessage(this.A00.A0O.A2D().A06().replace(A00(0, 6, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE), String.valueOf((int) f10)));
                } else {
                    this.A00.A0M = true;
                    AbstractC1733Yb abstractC1733Yb = this.A00.A0g;
                    String strA00 = A00(0, 0, 19);
                    if (A02[3].length() != 16) {
                        abstractC1733Yb.setToolbarActionMessage(strA00);
                    } else {
                        String[] strArr = A02;
