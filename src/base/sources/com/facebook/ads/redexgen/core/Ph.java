...
public abstract class Ph {
    public static final C1514Pg A00;
    ...
    public static C1529Py A05(View view, C1529Py c1529Py) {
        return A00.A07(view, c1529Py);
    }

    public static C1529Py A06(View view, C1529Py c1529Py) {
        return A00.A08(view, c1529Py);
    }
