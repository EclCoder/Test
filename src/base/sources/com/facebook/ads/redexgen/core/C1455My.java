...
public final class C1455My {
     ...
     */
    @Nullable
    public static C1455My A00(@Nullable JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        String strOptString = jSONObject.optString(A01(50, 7, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE));
        ...
        return new C1455My(strOptString, strOptString2, strOptString3, arrayList, jSONObject.optString(A01(40, 10, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE)), jSONObject.optString(A01(18, 12, 5)));
    }
    ...
    public C1455My(String str, String str2, String str3, List<String> mKeyHashes, String str4, String str5) {
        this.A04 = str;
        this.A01 = str2;
        this.A00 = str3;
        this.A05 = mKeyHashes;
