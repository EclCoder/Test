...
public final class C09994p {
    public static C09994p A04;
    ...
    public final CopyOnWriteArrayList<WeakReference<InterfaceC09974n>> A03 = new CopyOnWriteArrayList<>();
    ...
    public C09994p(Context context) {
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction(A04(0, 36, 40));
        context.registerReceiver(new C09984o(this), intentFilter);
    }
    ...
    public static synchronized C09994p A03(Context context) {
        if (A04 == null) {
            A04 = new C09994p(context);
        }
        return A04;
    }

    private void A05() {
        for (WeakReference<InterfaceC09974n> weakReference : this.A03) {
    ...
    public void A07(int i10) {
        synchronized (this.A02) {
            ...
            this.A00 = i10;
            for (WeakReference<InterfaceC09974n> weakReference : this.A03) {
                InterfaceC09974n interfaceC09974n = weakReference.get();
                if (interfaceC09974n != null) {
                    interfaceC09974n.AF1(i10);
                } else {
                    this.A03.remove(weakReference);
                }
            }
    ...
    public final void A0A(final InterfaceC09974n interfaceC09974n) {
        A05();
        this.A03.add(new WeakReference<>(interfaceC09974n));
        this.A01.post(new Runnable() { // from class: com.facebook.ads.redexgen.X.4j
            @Override // java.lang.Runnable
            public final void run() {
                this.A01.A0B(interfaceC09974n);
            }
        });
    }

    public final /* synthetic */ void A0B(InterfaceC09974n interfaceC09974n) {
        interfaceC09974n.AF1(A09());
    }
}
