...
public abstract class VK {
    ...
    public static List<String> A02(C2198gi c2198gi, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int eventIndex = 0; eventIndex < jSONArray.length(); eventIndex++) {
            try {
                arrayList.add(jSONArray.getString(eventIndex));
            } catch (JSONException e10) {
                c2198gi.A08().ABC(A00(39, 17, 76), AbstractC1610Td.A1C, new C1611Te(e10));
            }
        }
        return arrayList;
    }

    public static void A04(View view, VI vi2, VH vh2) {
        view.addOnAttachStateChangeListener(new VJ(vi2, vh2));
    }

    public static void A05(C2198gi c2198gi, String str, long j10) {
        VA adEventManager = c2198gi.A0A();
        VI vi2 = new VI(str, adEventManager);
        HashMap map = new HashMap();
        map.put(A00(24, 15, 67), Y1.A07(j10));
        map.put(A00(12, 12, 71), Y1.A05(j10));
        vi2.A04(VH.A0D, map);
    }

    public static void A06(C2198gi c2198gi, JSONObject jSONObject, long j10, String str) {
        ...
        if (TextUtils.isEmpty(str) && jSONArrayOptJSONArray != null) {
            A07(c2198gi, jSONObjectOptJSONObject, A02(c2198gi, jSONArrayOptJSONArray), j10, null);
            return;
        }
        ...
        A07(c2198gi, jSONObjectOptJSONObject, A03.get(str), j10, str);
    }

    public static void A07(C2198gi c2198gi, JSONObject jSONObject, List<String> list, long j10, String str) {
        String strA00 = A00(0, 2, 106);
        if (jSONObject.has(strA00)) {
            String clientToken = jSONObject.optString(strA00);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c2198gi, clientToken, j10);
        }
    }
    ...
    public static boolean A0A(String str, VH vh2) {
        return A0B(str, vh2.A03());
    }
