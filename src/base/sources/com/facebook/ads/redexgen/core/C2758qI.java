...
public final class C2758qI implements AnonymousClass24 {
    ...
    public static final AnonymousClass23<C2758qI> A0b;
    ...
    static {
        ...
        A0b = new AnonymousClass23() { // from class: com.facebook.ads.redexgen.X.qJ
            ...
            public final AnonymousClass24 A6f(Bundle bundle) {
                return C2758qI.A00(bundle);
            }
        };
    }

    @MetaExoPlayerCustomization(type = {"FEATURE_LOGIC"}, value = "Language is not normalized")
    public C2758qI(C09492p c09492p) {
        this.A0T = c09492p.A0R;
        this.A0U = c09492p.A0S;
        if (MetaExoPlayerUpgradeConfig.A03(EnumC2358jX.A0k)) {
            this.A0V = C5C.A0k(c09492p.A0T);
        } else {
            this.A0V = c09492p.A0T;
        }
        this.A0H = c09492p.A0F;
        this.A0E = c09492p.A0C;
        this.A04 = c09492p.A03;
        this.A0D = c09492p.A0B;
        this.A05 = this.A0D != -1 ? this.A0D : this.A04;
        this.A0R = c09492p.A0P;
        this.A0P = c09492p.A0N;
        this.A0Q = c09492p.A0O;
        this.A0S = c09492p.A0Q;
        this.A0W = c09492p.A0U;
        this.A0B = c09492p.A09;
        this.A0X = c09492p.A0V == null ? Collections.emptyList() : c09492p.A0V;
        this.A0O = c09492p.A0M;
        this.A0M = c09492p.A0K;
        this.A0L = c09492p.A0J;
        this.A0A = c09492p.A08;
        this.A01 = c09492p.A00;
        this.A0F = c09492p.A0D == -1 ? 0 : c09492p.A0D;
        this.A02 = c09492p.A01 == -1.0f ? 1.0f : c09492p.A01;
        this.A0Y = c09492p.A0W;
        this.A0I = c09492p.A0G;
        this.A0N = c09492p.A0L;
        this.A06 = c09492p.A04;
        this.A0G = c09492p.A0E;
        this.A0C = c09492p.A0A;
        this.A08 = c09492p.A06 == -1 ? 0 : c09492p.A06;
        this.A09 = c09492p.A07 != -1 ? c09492p.A07 : 0;
        this.A03 = c09492p.A02;
        this.A0J = c09492p.A0H;
        this.A0K = c09492p.A0I;
        if (c09492p.A05 != 0 || this.A0O == null) {
            this.A07 = c09492p.A05;
        } else {
            this.A07 = 1;
        }
    }

    public static C2758qI A00(Bundle bundle) {
        C09492p c09492p = new C09492p();
        AnonymousClass44.A02(bundle);
        c09492p.A0y((String) A02(bundle.getString(A0p), A0c.A0T)).A0z((String) A02(bundle.getString(A0r), A0c.A0U)).A10((String) A02(bundle.getString(A0s), A0c.A0V)).A0n(bundle.getInt(A13, A0c.A0H)).A0k(bundle.getInt(A0z, A0c.A0E)).A0a(bundle.getInt(A0e, A0c.A04)).A0j(bundle.getInt(A0w, A0c.A0D)).A0w((String) A02(bundle.getString(A0g), A0c.A0R)).A0v((Metadata) A02((Metadata) bundle.getParcelable(A0u), A0c.A0P)).A0x((String) A02(bundle.getString(A0i), A0c.A0S)).A11((String) A02(bundle.getString(A11), A0c.A0W)).A0h(bundle.getInt(A0t, A0c.A0B));
        ...
        c09492p.A12(arrayList).A0u((DrmInitData) bundle.getParcelable(A0k)).A0s(bundle.getLong(A15, A0c.A0M)).A0r(bundle.getInt(A18, A0c.A0L)).A0f(bundle.getInt(A0o, A0c.A0A)).A0X(bundle.getFloat(A0n, A0c.A01)).A0l(bundle.getInt(A10, A0c.A0F)).A0Y(bundle.getFloat(A0x, A0c.A02)).A13(bundle.getByteArray(A0y)).A0o(bundle.getInt(A14, A0c.A0I));
        ...
        if (bundle2 != null) {
            ...
            c09492p.A0t(colorInfo);
        }
        c09492p.A0b(bundle.getInt(A0f, A0c.A06)).A0m(bundle.getInt(A12, A0c.A0G)).A0i(bundle.getInt(A0v, A0c.A0C)).A0d(bundle.getInt(A0l, A0c.A08)).A0e(bundle.getInt(A0m, A0c.A09)).A0Z(bundle.getInt(A0d, A0c.A03)).A0p(bundle.getInt(A16, A0c.A0J)).A0q(bundle.getInt(A17, A0c.A0K)).A0c(bundle.getInt(A0j, A0c.A07));
        return c09492p.A14();
    }

    public static String A03(int i10) {
        return A0q + A04(18, 1, 70) + Integer.toString(i10, 36);
    }
    ...
    public final C09492p A07() {
        return new C09492p(this);
    }
    ...
    @Deprecated
    public final C2758qI A09(DrmInitData drmInitData) {
        return A07().A0u(drmInitData).A14();
    }

    public final boolean A0A(C2758qI c2758qI) {
        if (this.A0X.size() != c2758qI.A0X.size()) {
            return false;
        }
        for (int i10 = 0; i10 < i; i10++) {
            if (!Arrays.equals(this.A0X.get(i10), c2758qI.A0X.get(i10))) {
                return false;
            }
        }
        return true;
    ...
    public final boolean equals(Object obj) {
        ...
        C2758qI c2758qI = (C2758qI) obj;
        if ((this.A00 == 0 || c2758qI.A00 == 0 || this.A00 == c2758qI.A00) && this.A0H == c2758qI.A0H && this.A0E == c2758qI.A0E && this.A04 == c2758qI.A04) {
            int i10 = this.A0D;
            int i11 = c2758qI.A0D;
            String[] strArr2 = A0a;
            if (strArr2[3].length() == strArr2[4].length()) {
                A0a[6] = "jlfxIixvC9PiZTWMdSrmDOSa0xGb4nh5";
                if (i10 == i11 && this.A0B == c2758qI.A0B && this.A0M == c2758qI.A0M && this.A0L == c2758qI.A0L && this.A0A == c2758qI.A0A && this.A0F == c2758qI.A0F && this.A0I == c2758qI.A0I && this.A06 == c2758qI.A06 && this.A0G == c2758qI.A0G && this.A0C == c2758qI.A0C && this.A08 == c2758qI.A08 && this.A09 == c2758qI.A09 && this.A03 == c2758qI.A03 && this.A0J == c2758qI.A0J && this.A0K == c2758qI.A0K && this.A07 == c2758qI.A07 && Float.compare(this.A01, c2758qI.A01) == 0 && Float.compare(this.A02, c2758qI.A02) == 0 && C5C.A1E(this.A0T, c2758qI.A0T) && C5C.A1E(this.A0U, c2758qI.A0U) && C5C.A1E(this.A0R, c2758qI.A0R)) {
                    boolean zA1E2 = C5C.A1E(this.A0S, c2758qI.A0S);
                    if (A0a[6].charAt(1) == 'l') {
                        String[] strArr3 = A0a;
                        strArr3[3] = "KdcHRf6dcCFTttKMl2Gj0X4Z";
                        strArr3[4] = "JmF49wuzlqjC0ZeQQsbCJHl9";
                        if (zA1E2) {
                            zA1E = C5C.A1E(this.A0W, c2758qI.A0W);
                            if (A0a[7].length() != 23) {
                                String[] strArr4 = A0a;
                                strArr4[5] = "7ZwCaC2vMYJJrC5vSvijmVTemVnn4Sby";
                                strArr4[1] = "7UklpW8WsZGkqbUQfANf7z94bQwnEZcP";
                                if (zA1E) {
                                    if (C5C.A1E(this.A0V, c2758qI.A0V)) {
                                        colorInfo = this.A0N;
                                        strArr = A0a;
                                        if (strArr[5].charAt(27) == strArr[1].charAt(27)) {
                                            ...
                                            if (!C5C.A1E(colorInfo, c2758qI.A0N)) {
                                            }
                                        }
                                    }
                                }
                        ...
                        if (A0a[7].length() != 23) {
                            ...
                            if (zA1E) {
                                if (C5C.A1E(this.A0V, c2758qI.A0V) && Arrays.equals(this.A0Y, c2758qI.A0Y) && C5C.A1E(this.A0P, c2758qI.A0P)) {
                                    colorInfo = this.A0N;
                                    strArr = A0a;
                                    if (strArr[5].charAt(27) == strArr[1].charAt(27)) {
                                        String[] strArr9 = A0a;
                                        ...
                                        if (!C5C.A1E(colorInfo, c2758qI.A0N) && C5C.A1E(this.A0O, c2758qI.A0O) && A0A(c2758qI) && C5C.A1E(this.A0Q, c2758qI.A0Q)) {
                                            return true;
                                        }
                                    }
                                }
    ...
    public final String toString() {
        ...
        return sbAppend.append(strA04).append(this.A0U).append(strA04).append(this.A0S).append(strA04).append(this.A0W).append(strA04).append(this.A0R).append(strA04).append(this.A05).append(strA04).append(this.A0V).append(A04(2, 3, 90)).append(this.A0L).append(strA04).append(this.A0A).append(strA04).append(this.A01).append(A04(14, 4, 78)).append(this.A06).append(strA04).append(this.A0G).append(A04(12, 2, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE)).toString();
    }
}
