...
public final class C5F extends AbstractC1337Ij {
    ...
    public final AbstractC1450Mt A0V;
    public final C2198gi A0W;
    public final VI A0X;
    public final AbstractC1733Yb A0Y;
    ...
    public C5F(C2198gi c2198gi, VA va2, AbstractC1733Yb abstractC1733Yb, AbstractC2363jd abstractC2363jd, C1604Sx c1604Sx, ZU zu, int i10, InterfaceC1739Yh interfaceC1739Yh, VI vi2, int i11, boolean z10, boolean z11, InterfaceC2018dm interfaceC2018dm, int i12, int i13) {
        C1456Na c1456NaA00;
        ...
        this.A02 = 0;
        this.A0R = true;
        this.A0l = new RunnableC2003dX(this);
        this.A0L = false;
        this.A0T = false;
        this.A01 = 0.0f;
        ...
        this.A0i = new AbstractC1224Dz() { // from class: com.facebook.ads.redexgen.X.5K
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.facebook.ads.redexgen.core.UN
            /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A0Y = abstractC1733Yb;
        this.A0U = i12;
        this.A08 = new Handler(Looper.getMainLooper());
        this.A09 = (InputMethodManager) c2198gi.getSystemService(A0L(12, 12, 28));
        this.A0V = C1451Mu.A01(c2198gi, va2, abstractC2363jd.A2E(), XB.A00(abstractC2363jd.A29().A0J().A05()), new HashMap(), false, true, abstractC2363jd.A2A());
        this.A0W = c2198gi;
        this.A0X = vi2;
        this.A0j = new C1204Df(this.A0W, this.A0X);
        ...
        A0O();
        A0N();
        C2198gi c2198gi2 = this.A0W;
        String videoUrl2 = abstractC2363jd.A29().A0H().A08();
        AbstractC1899br.A00(c2198gi2, this, videoUrl2);
        setupLayoutConfiguration(false);
        A0T();
        A0S();
        postDelayed(new C1320Hs(this), 1000L);
        if (C1648Up.A1z(this.A0W)) {
            VM vmA0B = this.A0W.A0B();
            C1235Ek c1235Ek = this.A0b;
            String videoUrl3 = super.A06.A2E();
            vmA0B.AKn(c1235Ek, videoUrl3, true);
        }
        if (C1648Up.A20(this.A0W)) {
            this.A0a = new C1245Eu(this.A0W, va2, this.A0b, super.A06.A2E(), false, this.A0c, null);
        } else {
            this.A0a = null;
        }
        A0Y(abstractC2363jd.A29());
        this.A0m = super.A06.A1m();
        this.A0n = super.A06.A1z();
        c2198gi.A0F().ACI(this.A0m, this.A0n, true);
    }

    public static /* synthetic */ float A03(C5F c5f, float f10) {
        float f11 = c5f.A01 + f10;
        c5f.A01 = f11;
        return f11;
    }
    ...
    private void A0O() {
        ...
        layoutParams.setMargins(0, AbstractC1733Yb.A00, A0t, 0);
    ...
    private void A0R() {
        postDelayed(new C1323Hv(this), C1648Up.A0P(this.A0W));
    }
    ...
    private void A0T() {
        View view = this.A0b;
        if (super.A06.A1e()) {
            view.setOnClickListener(new ViewOnClickListenerC2005dZ(this));
        }
        YB.A0J(view);
        YB.A0K(view);
        ...
        YB.A0K(mMediaView3);
        this.A0H = new C1947cd(this.A0W, null, super.A06, super.A08, super.A0B, super.A0D, super.A0A, getColors(), new I4(this));
        ...
        A0W();
        A0M();
        if (C1648Up.A17(this.A0W)) {
            this.A0B.setOnClickListener(new ViewOnClickListenerC1997dR(this));
            View mMediaView6 = this.A0Y;
            if (mMediaView6 != null) {
                this.A0Y.setCTAClickListener(new ViewOnClickListenerC1998dS(this));
            }
        }
    }
    ...
    private void A0Y(NR nr) {
        double dA00 = AbstractC1902bu.A00(nr);
    ...
    public void A0f(C4A c4a) {
        if (this.A0b.getState() == EnumC2140fm.A02 && C1648Up.A1e(this.A0W)) {
            postDelayed(new C1321Ht(this, c4a), 5000L);
        }
    }
    ...
    public void A0g(String str) {
        ...
        boolean zA02 = AbstractC1649Uq.A02(this.A0W);
        ...
        if (zA02 || this.A0W.A0E() == null) {
            m10 = new M3(this.A0W, i10);
        } else {
            m10 = new M3(this.A0W, this.A0W.A0E(), i10);
        }
        this.A0G = m10;
        this.A0G.setOnTouchListener(new ViewOnTouchListenerC1999dT(this));
    ...
    public void A0j(boolean z10) {
        ...
        String strA0L = A0L(48, 1, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE);
        if (z10) {
        ...
        duration.addUpdateListener(new C2001dV(this));
        ...
        animatorSet.addListener(new C2002dW(this, z10));
        if (this.A0n) {
    ...
    public final EnumC1447Mq A1D(String str) {
        if (!A0m()) {
            EnumC1447Mq enumC1447MqA02 = this.A0H.A02(str);
            String[] strArr = A0p;
            if (strArr[2].length() != strArr[3].length()) {
                throw new RuntimeException();
            }
            A0p[1] = "gDqV8VnRL5n4dziTmRcIoSoDocYisV3G";
            return enumC1447MqA02;
        }
    ...
    public final void A1H() {
        ...
        if (iA02 != 0) {
            ...
            if (iA02 < secondsForNextCta2) {
                ...
                new XO(iA02, new C1325Hx(this)).A07();
                return;
            }
        }
    ...
    public final void A1K(boolean z10) {
        if (this.A0b.getState() != EnumC2140fm.A06) {
            EnumC2085et enumC2085et = this.A0I;
            String[] strArr = A0p;
            if (strArr[4].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
    ...
    private void setUpBrowserControls(M3 m10) {
        YB.A0J(this.A0E);
        this.A0E = new M6(this.A0W, m10, true, this.A0n);
        if (this.A0m) {
            A0l(this.A0R, 1);
        }
        m10.setBrowserNavigationListener(this.A0E.getBrowserNavigationListener());
        YB.A0K(this.A0E);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
        layoutParams.weight = 0.1f;
        this.A0E.setListener(new C1326Hy(this));
        this.A0E.setOnTouchListener(new ViewOnTouchListenerC2000dU(this));
        this.A0A.addView(this.A0E, layoutParams);
        YB.A0J(this.A0F);
        this.A0F = new C1827ah(this.A0W, null, R.attr.progressBarStyleHorizontal);
