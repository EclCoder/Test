...
public final class C2521mE extends AbstractC1347Iu {
    ...
    public final List<C2521mE> A01;
    public final List<C2520mD> A02;
    ...
    public C2521mE(int i10, long j10) {
        super(i10);
        this.A00 = j10;
    ...
    public final C2521mE A06(int i10) {
        int size = this.A01.size();
        for (int i11 = 0; i11 < size; i11++) {
            C2521mE c2521mE = this.A01.get(i11);
            ...
            C2521mE c2521mE2 = c2521mE;
            int childrenSize = ((AbstractC1347Iu) c2521mE2).A00;
            if (childrenSize == i10) {
                return c2521mE2;
            }
        }
    ...
    public final C2520mD A07(int i10) {
        int size = this.A02.size();
        for (int i11 = 0; i11 < size; i11++) {
            C2520mD c2520mD = this.A02.get(i11);
            String[] strArr = A04;
            String str = strArr[2];
            ...
            int childrenSize2 = ((AbstractC1347Iu) c2520mD).A00;
    ...
    public final void A08(C2521mE c2521mE) {
        this.A01.add(c2521mE);
    }

    public final void A09(C2520mD c2520mD) {
        this.A02.add(c2520mD);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC1347Iu
    public final String toString() {
        return AbstractC1347Iu.A02(super.A00) + A04(13, 9, 29) + Arrays.toString(this.A02.toArray()) + A04(0, 13, 48) + Arrays.toString(this.A01.toArray());
    }
}
