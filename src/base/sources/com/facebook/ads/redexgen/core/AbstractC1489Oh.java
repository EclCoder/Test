...
public abstract class AbstractC1489Oh {
    public static C1488Og A00;
    ...
    public static C1488Og A00(C2194ge c2194ge) {
        if (A00 == null) {
            synchronized (C1488Og.class) {
                if (A00 == null) {
                    A00 = new C1488Og(new C2286iB(c2194ge.getSharedPreferences(ProcessUtils.getProcessSpecificName(A01(0, 36, 105), c2194ge), 0)));
                }
            }
        }
        return A00;
