...
public final class C2566nA implements F6, InterfaceC10295t {
    public int A00;
    public int A01;
    ...
    public C2566nA(Context context, Map<Integer, Long> initialBitrateEstimates, int i10, AnonymousClass45 anonymousClass45, boolean z10) {
        ...
        this.A0F = z10;
        if (context != null) {
            C09994p c09994pA03 = C09994p.A03(context);
            this.A00 = c09994pA03.A09();
            this.A04 = A00(this.A00);
            c09994pA03.A0A(new InterfaceC09974n() { // from class: com.facebook.ads.redexgen.X.nB
                @Override // com.facebook.ads.redexgen.core.InterfaceC09974n
    ...
    public static boolean A04(C10185i c10185i, boolean z10) {
        return z10 && !c10185i.A06(8);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC10295t
    public final synchronized void ADK(InterfaceC2694pF interfaceC2694pF, C10185i c10185i, boolean z10, int i10) {
        if (A04(c10185i, z10)) {
            this.A06 += (long) i10;
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC10295t
    public final synchronized void AGG(InterfaceC2694pF interfaceC2694pF, C10185i c10185i, boolean z10) {
        if (A04(c10185i, z10)) {
            AbstractC09823y.A08(this.A03 > 0);
            long nowMs = this.A0B.A6J();
            int i10 = (int) (nowMs - this.A07);
            this.A09 += (long) i10;
            this.A08 += this.A06;
            if (i10 > 0) {
                float f10 = (this.A06 * 8000.0f) / i10;
                FW fw = this.A0D;
                int sampleElapsedTimeMs = (int) Math.sqrt(this.A06);
                fw.A07(sampleElapsedTimeMs, f10);
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC10295t
    public final synchronized void AGH(@MetaExoPlayerCustomization InterfaceC2694pF interfaceC2694pF, C10185i c10185i, boolean z10, boolean z11) {
        if (A04(c10185i, z10)) {
            if (this.A03 == 0) {
