...
public final class C1202Dd extends ImageView implements InterfaceC2086eu {
    ...
    public final VI A03;
    public final AbstractC1216Dr A04;
    ...
    public C1202Dd(C2198gi c2198gi, VI vi2) {
        super(c2198gi);
        this.A04 = new AbstractC1216Dr() { // from class: com.facebook.ads.redexgen.X.3V
        ...
        A05();
        setOnClickListener(new ViewOnClickListenerC2104fC(this));
    }
    ...
    public final void AKV(C1235Ek c1235Ek) {
        if (this.A00 != null) {
            ...
            AbstractC1216Dr abstractC1216Dr = this.A04;
            String[] strArr = A06;
