...
public final class HJ {
    ...
    public final HJ A0B(List<String> list) {
        return new HJ(this.A05, this.A03, this.A06, this.A04, this.A07, this.A02, this.A00, this.A09, this.A0A, A02(AbstractC1312Hk.A02(list)));
    }
    ...
    public HJ(int i10, int i11, int i12, int i13, int i14, int i15, int i16, long j10, HI hi2, Metadata metadata) {
        this.A05 = i10;
        this.A03 = i11;
        this.A06 = i12;
        this.A04 = i13;
    ...
    public HJ(byte[] bArr, int i10) {
        ...
        c10044u.A08(i10 * 8);
        this.A05 = c10044u.A04(16);
        this.A03 = c10044u.A04(16);
        this.A06 = c10044u.A04(24);
        this.A04 = c10044u.A04(24);
        this.A07 = c10044u.A04(20);
        this.A08 = A01(this.A07);
        this.A02 = c10044u.A04(3) + 1;
        this.A00 = c10044u.A04(5) + 1;
        this.A01 = A00(this.A00);
        this.A09 = c10044u.A05(36);
        this.A0A = null;
        this.A0B = null;
    }
    ...
    public final long A05() {
        ...
        long j11 = ((long) this.A02) * j10;
        long blockSizeSamples = this.A00;
        return ((j11 * blockSizeSamples) / 8) + 64;
    }

    public final long A06() {
        return this.A09 == 0 ? C.TIME_UNSET : (this.A09 * 1000000) / ((long) this.A07);
    }

    public final long A07(long j10) {
        long sampleNumber = C5C.A0T((((long) this.A07) * j10) / 1000000, 0L, this.A09 - 1);
        return sampleNumber;
    }

    public final C2758qI A08(byte[] bArr, Metadata metadata) {
        bArr[4] = -128;
        int i10 = this.A04 > 0 ? this.A04 : -1;
        Metadata metadataA02 = A02(metadata);
        C09492p c09492pA0h = new C09492p().A11(A03(0, 10, 87)).A0h(i10);
        int maxInputSize = this.A02;
        C09492p c09492pA0b = c09492pA0h.A0b(maxInputSize);
        int maxInputSize2 = this.A07;
        return c09492pA0b.A0m(maxInputSize2).A12(Collections.singletonList(bArr)).A0v(metadataA02).A14();
    }

    public final HJ A09(HI hi2) {
        return new HJ(this.A05, this.A03, this.A06, this.A04, this.A07, this.A02, this.A00, this.A09, hi2, this.A0B);
    }
}
