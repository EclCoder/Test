...
public abstract class AbstractC1725Xt {
    ...
    public static String A03(Context context, Throwable th2) {
        int iA0M = C1648Up.A0M(context);
        int maxStacktraceLines = C1648Up.A03(context);
        return A06(th2, iA0M, maxStacktraceLines, C1648Up.A1h(context));
    }
    ...
    public static String A06(Throwable th2, int i10, int i11, boolean z10) {
        ...
        try {
            ...
            th2.printStackTrace(new PrintWriter(new C1724Xs(ql2)));
            ql2.flush();
            return qk2.toString();
    ...
    public static boolean A08(C1722Xq c1722Xq) {
        String middle = c1722Xq.A02();
        if (middle == null) {
            return false;
        }
        ...
        Iterator<String> it = c1722Xq.A00().iterator();
        while (it.hasNext()) {
            if (A0A(it.next())) {
                return true;
            }
