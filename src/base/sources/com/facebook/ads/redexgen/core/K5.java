...
public final class K5 {
    ...
    public int A05;
    public boolean A06;
    public final C10054v A07 = new C10054v();
    public final int[] A08 = new int[256];

    /* JADX INFO: Access modifiers changed from: private */
    public void A00(C10054v c10054v, int i10) {
        int totalLength;
        if (i10 < 4) {
            return;
        }
        ...
        if ((c10054v.A0I() & 128) != 0) {
            if (i11 < 7 || (totalLength = c10054v.A0K()) < 4) {
                return;
            }
            this.A01 = c10054v.A0M();
            this.A00 = c10054v.A0M();
        ...
        if (limit < position && i11 > 0) {
            ...
            c10054v.A0k(this.A07.A0l(), limit, iMin);
            this.A07.A0f(limit + iMin);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A01(C10054v c10054v, int i10) {
        if (i10 < 19) {
            return;
        }
        this.A05 = c10054v.A0M();
        this.A04 = c10054v.A0M();
        c10054v.A0g(11);
        this.A02 = c10054v.A0M();
        this.A03 = c10054v.A0M();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A02(C10054v c10054v, int i10) {
        if (i10 % 5 != 2) {
            return;
        }
        c10054v.A0g(2);
        ...
        for (int index = 0; index < i11; index++) {
            ...
            int i12 = (int) (((double) a10) + (((double) entryCount) * 1.402d));
            int g10 = (int) ((((double) a10) - (((double) (iA0I3 - 128)) * 0.34414d)) - (((double) (iA0I2 - 128)) * 0.71414d));
            int entryCount2 = c10054v.A0I() << 24;
            this.A08[iA0I] = entryCount2 | (C5C.A07(i12, 0, 255) << 16) | (C5C.A07(g10, 0, 255) << 8) | C5C.A07((int) (((double) a10) + (((double) (iA0I3 - 128)) * 1.772d)), 0, 255);
        }
        this.A06 = true;
    }

    public final C2708pT A06() {
        int iA0I;
        ...
        return new C09723o().A0D(Bitmap.createBitmap(iArr, this.A01, this.A00, Bitmap.Config.ARGB_8888)).A04(this.A02 / this.A05).A0A(0).A07(this.A03 / this.A04, 0).A09(0).A06(this.A01 / this.A05).A03(this.A00 / this.A04).A0H();
    }
