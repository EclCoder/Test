...
public final class C2438ks implements LR {
    ...
    public final LZ A02;
    public final InterfaceC1417Lm A04;
    public final T8 A05;
    ...
    public final C1406Lb A03 = new C1406Lb();
    ...
    private File A02(LX lx, String str, String str2, int i10, C1405La c1405La) throws Exception {
        LX lx2;
        String strAHU;
        LX lx3;
        String strAHU2;
        String strA03 = A03(Sdk$SDKError.b.INVALID_WATERFALL_PLACEMENT_ID_VALUE, 22, 17);
        try {
            String str3 = str;
            long jCurrentTimeMillis = System.currentTimeMillis();
            File file = new File(A01(this.A05), str2);
            final long jA0R = C1648Up.A0R(this.A05);
            C2432km c2432km = new C2432km(file, new AbstractC2437kr(jA0R) { // from class: com.facebook.ads.redexgen.X.8L
                ...
                @Override // com.facebook.ads.redexgen.core.AbstractC2437kr
                public final boolean A08(File file2, long j10, int i11) {
                    return j10 <= this.A00;
                }

                @Override // com.facebook.ads.redexgen.core.AbstractC2437kr, com.facebook.ads.redexgen.core.InterfaceC1407Lc
            ...
            if (c2432km.A09()) {
                if (this.A08) {
                    String str4 = A03(49, 22, 36) + c2432km.A00.getName();
                }
            ...
            if (this.A08) {
                String str5 = A03(71, 26, 76) + c2432km.A00.getName();
            }
            if (!c1405La.A04()) {
                return null;
            }
            ...
            for (int i11 = 0; i11 < this.A00; i11++) {
                try {
                    ...
                    str3 = str3;
                    try {
                        A05(t10, c2432km, str3, i10, i11, jCurrentTimeMillis);
                        break;
                    } catch (C1413Li e10) {
                        e = e10;
                        if (i11 == this.A00 - 1) {
                            A06(c2432km);
                            if (e instanceof C2433kn) {
                                throw ((C2433kn) e);
                            }
                            if (e instanceof C2426kg) {
                                throw ((C2426kg) e);
                            }
                        }
                    }
            ...
            int iA03 = c2432km.A03();
            c2432km.A06();
            long jCurrentTimeMillis2 = System.currentTimeMillis() - jCurrentTimeMillis;
            c1405La.A00().A5D(file, this.A04);
            this.A06.put(str3, file);
    ...
    static {
        A04();
        A0B = C2438ks.class.getSimpleName();
    }

    public C2438ks(T8 t10, LZ lz, InterfaceC1417Lm interfaceC1417Lm) {
        this.A05 = t10;
        this.A08 = lz.A02();
        this.A00 = lz.A00();
        this.A04 = interfaceC1417Lm;
        this.A01 = lz.A01();
        this.A02 = lz;
    }

    public static C2436kq A00(Context context, String str) throws C1413Li {
        try {
            ...
            while (true) {
                ...
                if (i10 != -1) {
                    ...
                    return new C2436kq(byteArrayOutputStream.toByteArray());
                }
            }
        } catch (IOException e10) {
            throw new C1413Li(A03(Sdk$SDKError.b.MRAID_JS_WRITE_FAILED_VALUE, 18, 78), e10);
        }
    }

    public static File A01(Context context) {
        return new File(context.getCacheDir(), A03(Sdk$SDKError.b.AD_CLOSED_MISSING_HEARTBEAT_VALUE, 15, 78));
    }
    ...
    private void A05(Context context, C2432km c2432km, String str, int i10, int i11, long j10) throws Exception {
        InterfaceC1416Ll c2427kh;
        int iA06;
        int iA07;
        String[] strArr;
        String strA03 = A03(263, 20, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE);
        String strA04 = A03(342, 22, 27);
        if (str.startsWith(strA04)) {
            String localUrl = str.substring(strA04.length());
            c2427kh = A00(context, localUrl);
        } else {
            String strA05 = A03(333, 9, 59);
            if (str.startsWith(strA05)) {
                String localUrl2 = str.substring(strA05.length());
                c2427kh = A00(context, localUrl2);
            } else {
                c2427kh = new C2427kh(str, i10);
            }
        }
        try {
            if (this.A08) {
                try {
                    try {
                        String str2 = A03(HttpStatusCodes.STATUS_CODE_SEE_OTHER, 15, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE) + str + A03(38, 11, 108) + i11;
                    } catch (C1413Li e10) {
                        e = e10;
                        iA06 = 0;
                        try {
                            if (c2427kh instanceof C2427kh) {
                                try {
                                    iA06 = ((C2427kh) c2427kh).A06();
                                } catch (Throwable th2) {
                                    th = th2;
                                    try {
                                        c2427kh.close();
                                    } catch (C1413Li | IllegalArgumentException e11) {
                                        if (this.A08) {
                            ...
                            try {
                                this.A05.A08().ABo(j10, System.currentTimeMillis() - j10, 0L, 0L, iA06, null);
                                throw e;
                            } catch (Throwable th3) {
                                th = th3;
                                c2427kh.close();
            ...
            int iA03 = c2432km.A03();
            int length = c2427kh.length();
            boolean z10 = length < 0;
            if (A0A[3].charAt(31) == '9') {
                A0A[3] = "O2qol2VIPsSIkPIIN6kN5hssl2djupr9";
                if (z10) {
                    boolean zA07 = A07(c2432km);
                    if (this.A08) {
                ...
                try {
                    try {
                        if (z10 || iA03 < length) {
                            ...
                            while (true) {
                                int i12 = c2427kh.read(buffer);
                                if (i12 == -1) {
                                    break;
                                } else {
                                    c2432km.A08(buffer, i12);
                                }
                            }
                            if (!z10 || c2432km.A03() == length) {
                                c2432km.A07();
                                iA07 = 0;
                                if (c2427kh instanceof C2427kh) {
                                    iA07 = ((C2427kh) c2427kh).A06();
                                }
                                InterfaceC1609Tc interfaceC1609TcA08 = this.A05.A08();
                                long jCurrentTimeMillis = System.currentTimeMillis() - j10;
                                long jA03 = c2432km.A03();
                                strArr = A0A;
                                ...
                                interfaceC1609TcA08.ABo(j10, jCurrentTimeMillis, jA03, 0L, iA07, null);
                                c2427kh.close();
                                return;
                            }
                            throw new C2433kn(A03(283, 20, 94));
                        }
                        c2427kh.close();
                        return;
                    } catch (C1413Li | IllegalArgumentException e13) {
                        if (this.A08) {
                            String str4 = A0B;
                            String[] strArr2 = A0A;
                    ...
                    InterfaceC1609Tc interfaceC1609TcA09 = this.A05.A08();
                    long jCurrentTimeMillis2 = System.currentTimeMillis() - j10;
                    long jA04 = c2432km.A03();
                    strArr = A0A;
                    if (strArr[2].length() != strArr[5].length()) {
                        A0A[0] = "LJMphR6GQubhlr";
                    } else {
                    ...
                    interfaceC1609TcA09.ABo(j10, jCurrentTimeMillis2, jA04, 0L, iA07, null);
                } catch (C1413Li e14) {
                    e = e14;
                    iA06 = 0;
                    if (c2427kh instanceof C2427kh) {
    ...
    private void A06(C2432km c2432km) {
        try {
            File fileA04 = c2432km.A04();
            if (fileA04.exists()) {
                c2432km.A06();
    ...
    private boolean A07(C2432km c2432km) {
        try {
            c2432km.A05();
            if (A0A[4].charAt(27) != 'R') {
                throw new RuntimeException();
    ...
    public final <T> LT<T> A08(LX lx, C1405La<T> c1405La) {
        Semaphore semaphore;
        if (c1405La.A03()) {
            File file = this.A06.get(lx.A09);
            if (file != null) {
                this.A04.AHV(lx.A09, true, lx);
                return c1405La.A00().A3x(file, this.A04);
            }
        ...
        try {
            semaphore.acquire();
            File fileA02 = A02(lx, str, extension, this.A01, c1405La);
            if (fileA02 != null) {
                LT<T> ltA3x = c1405La.A00().A3x(fileA02, this.A04);
                semaphore.release();
                synchronized (this.A07) {
                    this.A07.remove(extension);
                }
    ...
    public final LT<Bitmap> AIe(LX lx, boolean z10) {
        return A08(lx, new C1405La(new C2442kx(lx.A01, lx.A00, this.A02.A04(), this.A02.A03(), z10)));
    }
    ...
    public final File AIf(LX lx) {
        C1405La c1405La = new C1405La(new C2441kw());
        c1405La.A01(true);
        c1405La.A02(false);
        return (File) A08(lx, c1405La).A00();
    }

    @Override // com.facebook.ads.redexgen.core.LR
    public final String AIg(LX lx) {
        return (String) A08(lx, new C1405La(new C2440kv())).A00();
    }
    ...
    public final String AIh(LX lx) {
        C1405La c1405La = new C1405La(new C2440kv());
        c1405La.A01(true);
        c1405La.A02(false);
        return (String) A08(lx, c1405La).A00();
    }
}
