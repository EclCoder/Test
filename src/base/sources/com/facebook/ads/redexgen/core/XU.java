...
public abstract class XU {
    ...
    public static XT A00(T8 t10) {
        try {
            boolean isRooted = A07() || A06() || A08(A01(47, 2, 78));
            return isRooted ? XT.A03 : XT.A05;
        } catch (Throwable t11) {
            t10.A08().ABC(A01(40, 7, 92), AbstractC1610Td.A1M, new C1611Te(t11));
            return XT.A04;
        }
    }
    ...
    public static String A02(Context context, String str) throws PackageManager.NameNotFoundException, NoSuchAlgorithmException, CertificateException {
        ...
        for (Signature signature : signatureArr) {
            sb2.append(C1706Xa.A04(MessageDigest.getInstance(A01(31, 4, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE)).digest(A04(signature).getEncoded())));
            sb2.append(A01(26, 1, 14));
        }
        return sb2.toString();
    }

    public static String A03(T8 t10, String str) {
        try {
            return A02(t10, str);
        } catch (Exception e10) {
            t10.A08().ABC(A01(40, 7, 92), AbstractC1610Td.A1M, new C1611Te(e10));
            return null;
        }
    }
    ...
    public static boolean A08(String str) {
        for (String str2 : System.getenv(A01(27, 4, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE)).split(A01(25, 1, 37))) {
