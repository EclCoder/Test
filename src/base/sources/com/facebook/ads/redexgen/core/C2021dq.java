...
public final class C2021dq extends LinearLayout {
    public LinearLayout A00;
    public String A01;
    public boolean A02;
    public final int A03;
    public final C2198gi A04;
    public final C1892bk A05;
    ...
    public C2021dq(Cdo cdo) {
        super(cdo.A08);
        this.A02 = false;
        this.A01 = "";
        this.A04 = cdo.A08;
        this.A05 = new C1892bk(this.A04);
        this.A06 = new C1898bq(this.A04, cdo.A01, true, false, true);
        this.A03 = cdo.A00;
        this.A02 = cdo.A05;
        this.A01 = cdo.A04;
        A03(cdo);
    ...
    public /* synthetic */ C2021dq(Cdo cdo, GX gx) {
        this(cdo);
    }
    ...
    private void A02(Cdo cdo) {
        if (!TextUtils.isEmpty(cdo.A03)) {
            ...
            if (this.A02) {
                C1886be c1886be = new C1886be(getContext(), 0, -1, YM.PLAYABLE_ICON);
                c1886be.setLayoutParams(new LinearLayout.LayoutParams(A0B, A0B));
                this.A00.addView(c1886be);
            } else {
    ...
    public final void A04(InterfaceC2020dp interfaceC2020dp) {
        A00();
        postDelayed(new GX(this, interfaceC2020dp), this.A03);
    }
}
