...
public final class M3 extends AbstractC1844ay {
    ...
    static {
        ...
        A09 = false;
        A0A = false;
        A0D.add(A03(0, 4, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE));
        A0D.add(A03(4, 5, 62));
    }

    public M3(C2198gi c2198gi, Activity activity, InterfaceC1836aq interfaceC1836aq) {
        super(activity, c2198gi);
        this.A02 = -1L;
        this.A00 = -1L;
        this.A03 = -1L;
        this.A01 = -1L;
        A08(c2198gi, interfaceC1836aq);
    }

    public M3(C2198gi c2198gi, InterfaceC1836aq interfaceC1836aq) {
        super(c2198gi);
        this.A02 = -1L;
        this.A00 = -1L;
        this.A03 = -1L;
    ...
    public final C1839at A0H() {
        return new C1839at(new WeakReference(this.A04), new WeakReference(this.A06), new WeakReference(this.A05));
    }
    ...
    private void A08(C2198gi c2198gi, InterfaceC1836aq interfaceC1836aq) {
        this.A04 = c2198gi;
        this.A06 = interfaceC1836aq;
        this.A05 = new C1831al(this);
        A09 = AbstractC1649Uq.A03(this.A04);
        A0A = AbstractC1649Uq.A04(this.A04);
    ...
    public final WebChromeClient A0G() {
        return new C1838as(new WeakReference(this.A04), new WeakReference(this.A06), new WeakReference(this.A05));
    }
    ...
    public void setBrowserNavigationListener(InterfaceC1837ar interfaceC1837ar) {
        this.A07.A05(new WeakReference<>(interfaceC1837ar));
    }
}
