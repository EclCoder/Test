...
public class A1 {
    ...
    public A1(CopyOnWriteArrayList<DrmSessionEventListener.EventDispatcher.ListenerAndHandler> listenerAndHandlers, int i10, C2606no c2606no) {
        this.A02 = listenerAndHandlers;
        this.A00 = i10;
        this.A01 = c2606no;
    }

    public final A1 A00(int i10, C2606no c2606no) {
        return new A1(this.A02, i10, c2606no);
    }
}
