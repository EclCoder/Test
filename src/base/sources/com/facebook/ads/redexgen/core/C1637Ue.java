...
public class C1637Ue {
     ...
     */
    public static C1637Ue A04(File file) throws IOException {
        try {
            ...
            if (j10 != -360011992771067903L) {
                throw new IOException(String.format(Locale.US, A05(180, 27, 45), Long.valueOf(j10), -360011992771067903L));
            }
            ...
            if (randomAccessFile.length() < A02((int) j11)) {
                throw new IOException(String.format(Locale.US, A05(Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE, 63, 56), Long.valueOf(j11), Long.valueOf(file.length())));
            }
            long[] jArr = new long[(int) j11];
            for (int i10 = 0; i10 < jArr.length; i10++) {
                jArr[i10] = randomAccessFile.readLong();
            }
            return new C1637Ue(randomAccessFile, jArr, randomAccessFile.length());
        } catch (IOException unused) {
            if (0 != 0) {
                A07(null);
            }
            throw new IOException(String.format(Locale.US, A05(26, 24, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE), file.getCanonicalPath()));
        }
    }
    ...
    public C1637Ue(RandomAccessFile randomAccessFile, long[] jArr, long j10) throws IOException {
        ...
        for (int i12 = 1; i12 < this.A00; i12++) {
            if (jArr[i12 - 1] > jArr[i12]) {
                throw new IOException(String.format(Locale.US, A05(Sdk$SDKError.b.PLACEMENT_AD_TYPE_MISMATCH_VALUE, 50, 76), Integer.valueOf(i12 - 1), Long.valueOf(jArr[i12 - 1]), Integer.valueOf(i12), Long.valueOf(jArr[i12])));
            }
        }
        if (this.A00 > 0 && jArr[this.A00 - 1] > j10) {
            throw new IOException(String.format(Locale.US, A05(323, 50, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE), Integer.valueOf(this.A00 - 1), Long.valueOf(jArr[this.A00 - 1]), Long.valueOf(j10)));
        }
    }
    ...
    public static C1637Ue A03(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A05(TTAdConstant.PACKAGE_NAME_CODE, 3, 33));
        try {
            randomAccessFile.writeLong(-360011992771067903L);
            randomAccessFile.writeLong(C1638Uf.A03);
            randomAccessFile.write(new byte[C1638Uf.A03 * 8]);
            randomAccessFile.getFD().sync();
            return new C1637Ue(randomAccessFile, new long[C1638Uf.A03], randomAccessFile.length());
        } catch (IOException unused) {
