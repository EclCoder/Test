...
public abstract class XK {
            ...
            if (xmlPullParser.getEventType() == 2 && xmlPullParser.getName().equals(A06(76, 8, 97))) {
                for (int i10 = 0; i10 < i; i10++) {
                    if (xmlPullParser.getAttributeName(i10).equals(A06(45, 13, 17))) {
                        ...
                        int i11 = str2.charAt(20);
                        if (iCharAt == i11) {
                            throw new RuntimeException();
                        }
                        A02[2] = "E9WdjcV1cB";
                        int i12 = Integer.parseInt(attributeValue);
                        return i12;
                    }
                }
            }
    ...
    public static void A09(Context context) {
        ...
        A04 = XJ.A03;
        Executors.newSingleThreadExecutor().execute(new C1550Qu(context));
    }

    public static void A0A(T8 t10, Throwable th2) {
        t10.A08().ABC(A06(38, 7, 85), AbstractC1610Td.A1c, new C1611Te(th2));
    }
    ...
    public static boolean A0C(T8 t10) {
        ...
        if (cachedValue != null) {
            ...
            boolean z10 = true;
            try {
                xmlResourceParserOpenXmlResourceParser = t10.getAssets().openXmlResourceParser(A06(0, 19, 21));
