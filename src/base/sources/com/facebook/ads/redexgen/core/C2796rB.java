...
public class C2796rB {
    ...
    public final Map<String, C2807rN> A00;
    public final Set<C2807rN> A01;
    ...
    public Collection<C2807rN> A00() {
        return this.A01;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public Collection<C2807rN> A01() {
    ...
    public void A04() {
        this.A00.clear();
        Iterator<C2807rN> it = this.A01.iterator();
        while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A06(C2807rN c2807rN) {
        if (this.A01.add(c2807rN)) {
            this.A00.remove(c2807rN.A02);
            return true;
        }
        return false;
    }
