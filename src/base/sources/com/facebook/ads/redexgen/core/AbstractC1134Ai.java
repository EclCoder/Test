...
public abstract class AbstractC1134Ai<E> implements Collection<E> {
    ...
    public boolean contains(E element) {
        AbstractC1134Ai<E> abstractC1134Ai = this;
        if ((abstractC1134Ai instanceof Collection) && abstractC1134Ai.isEmpty()) {
            return false;
        }
        Iterator<E> it = abstractC1134Ai.iterator();
        while (it.hasNext()) {
            if (C2772qY.A0C(it.next(), element)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean containsAll(Collection<? extends Object> elements) {
        C2772qY.A09(elements, A0A(77, 8, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE));
    ...
    public static final CharSequence A08(AbstractC1134Ai abstractC1134Ai, Object obj) {
        return obj == abstractC1134Ai ? A0A(0, 17, 33) : String.valueOf(obj);
    }
    ...
    public <T> T[] toArray(T[] array) {
        C2772qY.A09(array, A0A(72, 5, 90));
        return (T[]) AbstractC2774qa.A03(this, array);
    }
    ...
    public final String toString() {
        return C0d.A03(this, A0A(17, 2, 49), A0A(70, 1, 109), A0A(71, 1, 15), 0, null, new AZ() { // from class: com.facebook.ads.redexgen.X.1t
            ...
            public final Object AAK(Object obj) {
                return AbstractC1134Ai.A08(this.A00, obj);
            }
        }, 24, null);
    }
}
