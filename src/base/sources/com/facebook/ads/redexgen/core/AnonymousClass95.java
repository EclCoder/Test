...
public final class AnonymousClass95 {
    ...
    public AnonymousClass95(AnonymousClass93 anonymousClass93) {
        this.A0V = (AnonymousClass93) AbstractC09823y.A01(anonymousClass93);
        if (C5C.A02 >= 18) {
            try {
    ...
    private void A07(long j10) {
        AnonymousClass92 anonymousClass92 = (AnonymousClass92) AbstractC09823y.A01(this.A0O);
    ...
    private void A08(long j10) {
        if (this.A0R && this.A0P != null && j10 - this.A09 >= 500000) {
            try {
                this.A0E = (((long) ((Integer) C5C.A0f((Integer) this.A0P.invoke(AbstractC09823y.A01(this.A0N), new Object[0]))).intValue()) * 1000) - this.A06;
    ...
    private void A09(long j10) {
        AudioTrack audioTrack = (AudioTrack) AbstractC09823y.A01(this.A0N);
    ...
    private boolean A0A() {
        return this.A0T && ((AudioTrack) AbstractC09823y.A01(this.A0N)).getPlayState() == 2 && A00() == 0;
    }
    ...
    public final int A0C(long j10) {
        int bytesPending = (int) (j10 - (A00() * ((long) this.A03)));
        return this.A01 - bytesPending;
    }

    public final long A0D(boolean z10) {
        long jA0Q;
        if (((AudioTrack) AbstractC09823y.A01(this.A0N)).getPlayState() == 3) {
            A04();
        }
    ...
    public final void A0F() {
        ((AnonymousClass92) AbstractC09823y.A01(this.A0O)).A05();
    }
    ...
    public final boolean A0J() {
        return ((AudioTrack) AbstractC09823y.A01(this.A0N)).getPlayState() == 3;
    }
    ...
    public final boolean A0N(long j10) {
        int playState = ((AudioTrack) AbstractC09823y.A01(this.A0N)).getPlayState();
        if (this.A0T) {
            if (playState == 2) {
                this.A0Q = false;
                String[] strArr = A0Y;
