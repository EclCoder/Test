...
public final class C11058t extends Exception {
    public static byte[] A03;
    public final int A00;
    public final C2758qI A01;
    ...
    public C11058t(int i10, int i11, int i12, int i13, C2758qI c2758qI, boolean z10, Exception exc, int i14) {
        ...
        super(sbAppend2.append(strA01).append(i12).append(strA01).append(i13).append(A00(15, 28, 19)).append(i14).append(strA00).append(c2758qI).append(z10 ? A00(1, 14, 30) : A00(0, 0, 74)).toString(), exc);
        this.A00 = i10;
        this.A02 = z10;
        this.A01 = c2758qI;
    }
