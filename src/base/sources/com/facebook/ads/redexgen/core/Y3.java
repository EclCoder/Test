...
public final class Y3<T> implements InterfaceC1635Uc<T> {
    ...
    public synchronized boolean A06(Y8 y10) {
        if (!this.A02.remove(y10)) {
            return false;
        }
        if (y10.A6X() > 0 && y10.A01().A02.A05(y10.A01().A01).equals(this.A01)) {
            this.A01 = y10.A00().A02;
        }
        return true;
    }
    ...
    public Y3(UZ uz, InterfaceC1640Uh interfaceC1640Uh) throws IOException {
        this.A05 = new C1642Uj(uz.A04(A00(515, 4, 103)), interfaceC1640Uh);
        this.A04 = new UT(new File(uz.A05(), A00(509, 6, 60)));
        this.A00 = this.A04.A03();
        A05(interfaceC1640Uh);
        this.A01 = this.A00;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    private void A02(int i10, int i11) throws IOException {
        this.A00 = new UU(i10, i11);
    ...
    public synchronized void A03(Y8 y10) throws C1644Ul {
        if (!this.A03) {
            if (A06(y10)) {
                if (y10.A6X() == 0) {
                    return;
                }
                if (this.A00.A04(y10.A00().A02) == 0) {
                    try {
                        Iterator<C1639Ug> it = y10.A00.iterator();
                        while (it.hasNext()) {
                            if (it.next().A00 == this.A05.A07() && this.A05.A0D()) {
                                A02(this.A05.A06(), 0);
                            } else {
                                A02(this.A05.A06(), y10.A00().A00);
                                break;
                            }
                        }
                        ...
                        throw new C1644Ul(A00(361, 30, 22), e10);
                    }
                }
                throw new C1644Ul(A00(0, 54, 30));
            }
            throw new C1644Ul(A00(466, 43, 59));
        }
        throw new C1644Ul(A00(427, 39, 60));
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    private void A05(InterfaceC1640Uh interfaceC1640Uh) throws IOException {
        ...
        if (uu.A04(recordSequenceStart) > 0) {
            ...
            interfaceC1640Uh.AIc(String.format(locale, A00(54, 102, 13), numValueOf, Integer.valueOf(recordSequenceStart3.A03()), Integer.valueOf(uu.A02()), Integer.valueOf(uu.A03())));
            this.A00 = uu;
            return;
        }
        while (iA02 < recordSequenceStart.A02()) {
            if (this.A05.A0D()) {
                ...
                interfaceC1640Uh.AIc(String.format(locale2, A00(156, 101, 70), numValueOf2, Integer.valueOf(recordSequenceStart5.A03()), Integer.valueOf(uu.A02())));
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y8 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T>$RecordFileBasedFetch */
    @Override // com.facebook.ads.redexgen.core.InterfaceC1635Uc
    public final synchronized InterfaceC1634Ub A6W(byte[] bArr, int[] iArr) throws C1644Ul {
        Y3<T>.RecordFileBasedFetch y10;
        if (!this.A03) {
            int i10 = 0;
            int i11 = 0;
            try {
                ...
                while (true) {
                    UX uxA0A = this.A05.A0A(this.A01.A02(), this.A01.A03(), bArr, i10, iArr, i11);
                ...
                y10 = new Y8(this, arrayList, mayHaveMoreData);
                this.A02.add(y10);
                if (!arrayList.isEmpty()) {
                    UU uu = y10.A01().A02;
                    int storageOffset6 = y10.A01().A01;
                    this.A01 = uu.A05(storageOffset6);
                }
            } catch (IOException e10) {
                throw new C1644Ul(A00(306, 29, 84), e10);
            }
        } else {
            throw new C1644Ul(A00(391, 36, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE));
        }
        return y10;
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.core.InterfaceC1635Uc
    public final synchronized int A8s() throws C1644Ul {
        int iA09;
        if (!this.A03) {
            try {
                iA09 = this.A05.A09();
                ...
                throw new C1644Ul(A00(335, 26, 57), e10);
            }
        } else {
            throw new C1644Ul(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.core.InterfaceC1635Uc
    public final synchronized void AKH(byte[] bArr) throws C1644Ul {
        if (!this.A03) {
            try {
                this.A05.A0C(bArr);
            } catch (IOException e10) {
                throw new C1644Ul(A00(257, 25, 62), e10);
            }
        } else {
            throw new C1644Ul(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.facebook.ads.redexgen.core.InterfaceC1635Uc
    public final synchronized void clear() throws C1644Ul {
        try {
            this.A05.A0B();
            A02(this.A05.A06(), 0);
            this.A02.clear();
        } catch (IOException e10) {
            throw new C1644Ul(A00(282, 24, 87), e10);
        }
    }
