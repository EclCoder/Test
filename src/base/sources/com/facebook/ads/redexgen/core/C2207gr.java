...
public final class C2207gr implements InterfaceC1590Sj {
    ...
    public final Map<String, AbstractC1588Sh> A00 = new HashMap();
     ...
     */
    @Override // com.facebook.ads.redexgen.core.InterfaceC1590Sj
    public final synchronized String AIb() {
        StringBuilder sb2;
        sb2 = new StringBuilder();
        Iterator<AbstractC1588Sh> it = this.A00.values().iterator();
        if (it.hasNext()) {
            it.next();
