...
public final class C2454l9 implements LH {
    ...
    public boolean A02;
    public boolean A03;
    public final C10054v A04 = new C10054v(32);
    public final L8 A05;

    public C2454l9(L8 l10) {
        this.A05 = l10;
    }

    @Override // com.facebook.ads.redexgen.core.LH
    public final void A5B(C10054v c10054v, int i10) {
        boolean z10 = (i10 & 1) != 0;
        int iA09 = -1;
        if (z10) {
            iA09 = c10054v.A09() + c10054v.A0I();
        }
        ...
        while (c10054v.A07() > 0) {
            if (this.A00 < 3) {
                if (this.A00 == 0) {
                    ...
                    c10054v.A0f(c10054v.A09() - 1);
                    if (iA0I == 255) {
                        this.A03 = true;
                        return;
                    }
                }
                int iMin = Math.min(c10054v.A07(), 3 - this.A00);
                c10054v.A0k(this.A04.A0l(), this.A00, iMin);
                this.A00 += iMin;
                if (this.A00 == 3) {
                    this.A04.A0f(0);
                    this.A04.A0e(3);
                ...
                int iMin2 = Math.min(c10054v.A07(), this.A01 - this.A00);
                c10054v.A0k(this.A04.A0l(), this.A00, iMin2);
                this.A00 += iMin2;
