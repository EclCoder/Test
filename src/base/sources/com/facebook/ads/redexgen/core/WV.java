...
public final class WV implements V8 {
    ...
    public WV(C2194ge c2194ge, ZH zh2) {
        this.A00 = c2194ge;
        this.A01 = zh2;
    }

    public static JSONArray A01(C2194ge c2194ge, JSONArray jSONArray, JSONArray jSONArray2) {
        int i10 = 0;
        if (jSONArray != null) {
        ...
        return A02(c2194ge, jSONArray, jSONArray2, i10);
    }

    public static JSONArray A02(C2194ge c2194ge, JSONArray jSONArray, JSONArray jSONArray2, int i10) {
        if (jSONArray == null) {
            return jSONArray2;
        }
        if (jSONArray2 == null) {
        ...
        while (true) {
            if ((limit >= length && i11 >= eventsIdx) || i10 <= 0) {
                break;
            }
            ...
            if (limit < length && jSONObject == null) {
                try {
                    ...
                    d10 = jSONObject.getDouble(strA00);
                } catch (JSONException e10) {
                    if (c2194ge.A05().AAO()) {
                        Log.e(A04, A00(273, 33, 107) + limit, e10);
                    }
                    jSONObject = null;
            ...
            if (i11 < eventsIdx && jSONObject2 == null) {
                try {
                    ...
                    d11 = jSONObject2.getDouble(strA00);
                } catch (JSONException e11) {
                    if (c2194ge.A05().AAO()) {
                        Log.e(A04, A00(306, 25, 86) + i11, e11);
                    }
                    jSONObject2 = null;
                    String[] strArr = A03;
    ...
    private JSONObject A03() {
        ...
        if (AbstractC1650Ur.A0P(this.A00) && (jSONArrayA03 = C1612Tf.A03(this.A00)) != null && jSONArrayA03.length() > 0) {
            C2194ge c2194ge = this.A00;
            if (A03[2].length() != 5) {
                throw new RuntimeException();
            }
            String[] strArr = A03;
            ...
            jSONArrayA6s = A01(c2194ge, jSONArrayA03, jSONArrayA6s);
        }
        JSONObject jSONObject = null;
        String[] strArr2 = A03;
    ...
    private JSONObject A04(int i10) {
        ...
        Pair<JSONObject, JSONArray> tokensAndEvents = this.A01.A9I(i10);
        JSONObject jSONObject = (JSONObject) tokensAndEvents.first;
        JSONArray jSONArrayA02 = (JSONArray) tokensAndEvents.second;
        if (AbstractC1650Ur.A0P(this.A00) && (jSONArrayA04 = C1612Tf.A04(this.A00, (iA08 = AbstractC1650Ur.A08(this.A00)))) != null && jSONArrayA04.length() > 0) {
    ...
    public final JSONObject A5L() {
        int eventLimit = AbstractC1650Ur.A0F(this.A00);
        return eventLimit > 0 ? A04(eventLimit) : A03();
    }

    @Override // com.facebook.ads.redexgen.core.V8
    public final boolean AAb() {
        int eventCount = AbstractC1650Ur.A0F(this.A00);
        if (eventCount < 1) {
            return false;
        }
        int iA82 = this.A01.A82();
        int eventLimit = C1612Tf.A00(this.A00);
        return iA82 + eventLimit > eventCount;
    }

    @Override // com.facebook.ads.redexgen.core.V8
    public final void ACu() {
        int iA50 = this.A01.A50(AbstractC1650Ur.A0G(this.A00));
        if (iA50 > 0) {
            this.A00.A08().ABC(A00(379, 8, 37), AbstractC1610Td.A10, new C1611Te(A00(28, 44, 62) + iA50));
        }
        C1612Tf.A0F(this.A00);
    }
    ...
    public final boolean ADf(JSONArray jSONArray) {
        ...
        boolean z10 = true;
        boolean zA0P = AbstractC1650Ur.A0P(this.A00);
        for (int errorCode = 0; errorCode < jSONArray.length(); errorCode++) {
            try {
                ...
                if (A00(393, 26, 39).equals(eventId)) {
                    C1648Up.A0V(this.A00).A36(jSONObject.getString(A00(419, 14, 16)));
                    this.A00.A04().ACP();
                } else {
                    int i10 = jSONObject.getInt(A00(375, 4, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL));
                    if (i10 == 1) {
                        if (this.A00.A05().AAO()) {
                        ...
                        if (i10 >= 1000 && i10 < 2000) {
                            if (this.A00.A05().AAO()) {
                                Log.e(A04, A00(236, 37, 69) + i10 + strA01 + eventId + strA00);
                            }
                            A06(eventId);
                            z10 = false;
                        } else if (i10 >= 2000) {
                            if (A03[5].length() == 16) {
                                ...
                                if (i10 < 3000) {
                                    if (this.A00.A05().AAO()) {
                                        Log.e(A04, A00(195, 41, 103) + i10 + strA01 + eventId + strA00);
                                    }
                                    if (this.A01.A5q(eventId)) {
                                    }
                                }
                            } else if (i10 < 3000) {
                                if (this.A00.A05().AAO()) {
                ...
                if (this.A00.A05().AAO()) {
                    Log.e(A04, A00(331, 44, 14) + errorCode + strA00, e10);
                }
                z10 = false;
            }
        }
