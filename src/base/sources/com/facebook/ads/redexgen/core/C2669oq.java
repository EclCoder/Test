...
public final class C2669oq implements G2, GR, InterfaceC10647c {
    ...
    public final void AGS(long j10, long j11, C2758qI c2758qI, MediaFormat mediaFormat) {
        if (this.A00 != null) {
            G2 g10 = this.A00;
            ...
            g10.AGS(j10, j11, c2758qI, mediaFormat);
        }
        if (this.A01 != null) {
            this.A01.AGS(j10, j11, c2758qI, mediaFormat);
        }
    }
}
