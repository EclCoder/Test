...
public abstract class C1F extends C7M implements View.OnTouchListener {
    ...
    public C1F(C2198gi c2198gi, AttributeSet attributeSet) {
    ...
    public C1F(C2198gi c2198gi, AttributeSet attributeSet, int i10) {
    ...
    public void setLayoutManager(R2 r10) {
        if (r10 instanceof C2268hr) {
            super.setLayoutManager(r10);
            this.A01 = (C2268hr) r10;
            return;
        }
        throw new IllegalArgumentException(A09(0, 50, 59));
    }

    public void setSnapDelegate(InterfaceC2033e2 interfaceC2033e2) {
        this.A02 = interfaceC2033e2;
    }
}
