...
public final class XC {
    ...
    public static int A00(C2198gi c2198gi, int i10) {
        return WN.A00(c2198gi).getInt(A01(0, 21, 52), i10);
    }

    public static String A02(C2198gi c2198gi, String str) {
        int iA00 = A00(c2198gi, -1);
        if (iA00 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C2198gi c2198gi, String str, String str2) {
        if (c2198gi == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c2198gi, str);
    ...
    public final RewardedVideoAd A07(C2198gi c2198gi, String str, String str2) {
        if (c2198gi == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c2198gi, str);
    ...
    public final void A08(C2198gi c2198gi, boolean z10) {
        int i10 = 0;
        String strA01 = A01(0, 21, 52);
        if (!z10) {
            int lastNonChainedAds = WN.A00(c2198gi).getInt(strA01, 0);
            i10 = lastNonChainedAds + 1;
        }
        WN.A00(c2198gi).edit().putInt(strA01, i10).apply();
    }

    public final boolean A09(C2198gi c2198gi, String str, int i10) {
        if (i10 <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c2198gi, i10 - 1);
