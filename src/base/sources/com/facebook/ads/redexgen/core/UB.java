...
public final class UB {
    ...
    public static synchronized XT A00(T8 t10) {
        if (A01 == null) {
            A01 = XU.A00(t10);
        }
        return A01;
    ...
    public static void A06(T8 t10, String str, Map<String, String> params) {
        String strA03;
        if (A0A(t10)) {
            strA03 = C1695Wn.A03(str);
        } else {
            strA03 = A00;
        }
        if (strA03 != null) {
    ...
    public static void A07(T8 t10, boolean z10) {
        if (!A05.compareAndSet(0, 1)) {
            return;
        }
        A00(t10);
        try {
            SharedPreferences sharedPreferencesA00 = WN.A00(t10);
            C1621To c1621To = new C1621To(t10);
            String str = Build.FINGERPRINT + A02(0, 1, 19) + c1621To.A06();
            A00 = sharedPreferencesA00.getString(str, null);
            FutureTask futureTask = new FutureTask(new UA(t10, c1621To, sharedPreferencesA00, str));
    ...
    public static void A08(T8 t10, boolean z10, String str) {
        if (A0A(t10)) {
            A09(t10, z10, str);
        } else {
            A07(t10, z10);
    ...
    public static void A09(T8 t10, boolean z10, String str) {
        if (str == null) {
            str = t10.getPackageName();
        }
        if (A0B(str)) {
            return;
        }
        A00(t10);
        C1695Wn c1695Wn = new C1695Wn(t10, str);
        try {
            c1695Wn.A06();
            FutureTask futureTask = new FutureTask(new U9(c1695Wn, str));
            Executors.newSingleThreadExecutor().submit(futureTask);
            if (z10) {
                futureTask.get();
            }
