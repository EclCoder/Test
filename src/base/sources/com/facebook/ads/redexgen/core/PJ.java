...
public abstract class PJ extends RelativeLayout implements InterfaceC1740Yi {
    ...
    public final ViewOnSystemUiVisibilityChangeListenerC1729Xx A0B;
    public final InterfaceC1739Yh A0C;
    public final AbstractC2363jd A0D;
    public final C2198gi A0E;
    public final VA A0F;
    public final VI A0G;
    ...
    public abstract AbstractC1733Yb A0b();
    ...
    public PJ(C2198gi c2198gi, VA va2, InterfaceC1739Yh interfaceC1739Yh, AbstractC2363jd abstractC2363jd) {
        super(c2198gi);
        this.A09 = false;
        this.A06 = false;
        this.A05 = false;
        ...
        this.A0B = new ViewOnSystemUiVisibilityChangeListenerC1729Xx(this);
    ...
    private void A0R() {
        this.A02 = AbstractC1808aO.A01(this.A0E, true, this.A0D, this.A0G, this.A0C, EnumC1806aM.A03, AbstractC1805aL.A00(this.A0D));
        YB.A0K(this.A02);
    }

    private void A0S() {
        this.A03 = AbstractC1808aO.A02(this.A0E, EnumC1806aM.A03, this.A0D);
    ...
    private void A0Y(C1456Na c1456Na, boolean z10) {
        ...
        if (this.A0D.A1a()) {
            ...
            this.A0H.A0D(c1456Na, ViewOnClickListenerC1396Kr.A05(this.A0D));
        }
    ...
    public final void A0c() {
        if (this.A00 == null || !(this.A00 instanceof AbstractC1911c3)) {
            return;
        }
        if (A0j()) {
            ((AbstractC1911c3) this.A00).A1G();
        } else {
            ((AbstractC1911c3) this.A00).A1F();
        }
    }
    ...
    public final void A0f(View view, boolean z10, int i10) {
        ...
        this.A00 = view;
        this.A0B.A05(EnumC1728Xw.A02);
        A0T();
        C1456Na colorInfo = A0O(i10);
        A0Y(colorInfo, z10);
        ...
        if (this.A0C != null) {
            ...
            if (z10) {
                this.A0B.A05(EnumC1728Xw.A03);
            }
        }
    }

    public final void A0g(C1560Re c1560Re) {
        this.A0B.A04(c1560Re.A05().getWindow());
        ...
        this.A0H.setToolbarListener(new PT(this, c1560Re));
    }

    public final void A0h(C1560Re c1560Re) {
        AlphaAnimation alphaAnimation = new AlphaAnimation(1.0f, 0.0f);
        alphaAnimation.setDuration(200L);
        alphaAnimation.setAnimationListener(new AnimationAnimationListenerC1752Yu(this, this, c1560Re));
    ...
    public InterfaceC1739Yh getAudienceNetworkListener() {
        return this.A0C;
    }
    ...
    public void setImpressionRecordingFlag(Y2 y10) {
        y10.A05();
