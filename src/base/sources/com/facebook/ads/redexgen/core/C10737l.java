...
public final class C10737l extends AbstractC2363jd implements Serializable {
    ...
    public C10737l(List<NR> list) {
        super(list);
    }

    public static C10737l A00(JSONObject jSONObject, C2198gi c2198gi) {
        C10737l c10737l = new C10737l(AbstractC2363jd.A08(jSONObject, c2198gi, new C2350jK()));
        c10737l.A2I(jSONObject);
        c10737l.A1N(A01(0, 14, 106));
        return c10737l;
    }
    ...
    public final int A0o() {
        ...
        C1470No c1470NoA07 = A29().A0H().A07();
        String[] strArr = A01;
        if (strArr[2].charAt(16) == strArr[1].charAt(16)) {
            throw new RuntimeException();
        }
