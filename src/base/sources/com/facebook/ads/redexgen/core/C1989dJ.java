...
public final class C1989dJ {
    ...
    public WeakReference<C1982dC> A00;
    public WeakReference<InterfaceC1345Is> A01 = new WeakReference<>(null);
    public boolean A02 = false;
    public final C2198gi A03;
    public final C1969cz A04;
    ...
    public C1989dJ(C2198gi c2198gi, C1982dC c1982dC, VA va2, C1969cz c1969cz, String str, String str2) {
        this.A03 = c2198gi;
        this.A00 = new WeakReference<>(c1982dC);
    ...
    private void A04() {
        InterfaceC1345Is uxListener = this.A01.get();
        if (uxListener == null) {
            return;
        }
        uxListener.close();
    ...
    private void A07() {
        ...
        uxListener.AKD();
        if (C1648Up.A1z(this.A03)) {
            this.A03.A0B().ADb();
        }
    }

    private void A08() {
        InterfaceC1345Is uxActionsJavascriptListener = this.A01.get();
    ...
    private void A0A(C1982dC c1982dC, String str) throws JSONException {
        ...
        String key = jSONObject.optString(A01(54, 3, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE), A01(7, 7, 34));
        String string = sharedPreferencesA00.getString(A01(14, 4, 0) + key, strA02);
        if (string != null) {
            strA02 = string;
        }
        c1982dC.A0g(storageValue, strA02);
    }

    private void A0B(C1982dC c1982dC, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        ...
        WN.A00(this.A03).edit().putString(A01(14, 4, 0) + jSONObject.optString(A01(54, 3, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE), A01(7, 7, 34)), strOptString).apply();
        c1982dC.A0f(strOptString2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0C(EnumC1987dH enumC1987dH, String str) throws JSONException {
        switch (enumC1987dH.ordinal()) {
            case 0:
        ...
        switch (enumC1987dH.ordinal()) {
            ...
            case 4:
                ...
                break;
            case 6:
                c1982dC.A0i(A03(new JSONObject(str)));
                break;
            case 17:
                A0B(c1982dC, str);
                break;
    ...
    private void A0D(EnumC1987dH enumC1987dH, String str) throws JSONException {
        InterfaceC1345Is interfaceC1345Is = this.A01.get();
        if (interfaceC1345Is == null) {
        }
        switch (enumC1987dH.ordinal()) {
            case 12:
                A0E(interfaceC1345Is, str);
                break;
            case 13:
                interfaceC1345Is.AE4();
                break;
            case 14:
                interfaceC1345Is.AFz();
                break;
            case 15:
                A0G(interfaceC1345Is, str);
                break;
            case 16:
                A0F(interfaceC1345Is, str);
                break;
        }
    }

    private void A0E(InterfaceC1345Is interfaceC1345Is, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        String STATE_KEY = A01(87, 5, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE);
        interfaceC1345Is.AEu(jSONObject.optBoolean(STATE_KEY, false));
    }

    private void A0F(InterfaceC1345Is interfaceC1345Is, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        String PAUSED_BY_USER_KEY = A01(62, 12, 5);
        interfaceC1345Is.AGX(jSONObject.optBoolean(PAUSED_BY_USER_KEY, false));
    }

    private void A0G(InterfaceC1345Is interfaceC1345Is, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        String STARTED_BY_USER_KEY = A01(74, 13, 98);
        interfaceC1345Is.AGZ(jSONObject.optBoolean(STARTED_BY_USER_KEY, false));
    }
    ...
    private void A0I(JSONObject jSONObject) {
        ...
        if (TextUtils.isEmpty(productUrl)) {
            interfaceC1345Is.A9f();
        } else {
            interfaceC1345Is.A9g(productUrl);
        }
    }
    ...
    private void A0K(JSONObject jSONObject) {
        ...
        String key = jSONObject.optString(A01(43, 11, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE));
    ...
    private void A0M(JSONObject jSONObject) {
        ...
        interfaceC1345Is.AGo(strOptString);
    }

    public final void A0N(InterfaceC1345Is interfaceC1345Is) {
        this.A01 = new WeakReference<>(interfaceC1345Is);
    }
    ...
    public void postMessage(String str) {
        Y4.A00(new RunnableC1986dG(this, str));
    }
}
