...
public abstract class AbstractC2774qa {
    ...
    public static final Object[] A02(Collection<?> collection) {
        C2772qY.A09(collection, A00(0, 10, 17));
        ...
        while (true) {
            ...
            if (i10 >= objArrCopyOf.length) {
                ...
                C2772qY.A08(objArrCopyOf2, A00(10, 11, 103));
            ...
            if (size == 0) {
                ...
                if (!it.hasNext()) {
                    ...
                    if (size <= length) {
                        ...
                        C2772qY.A07(objNewInstance, A00(21, 62, 11));
