...
public final class C1303Hb {
    ...
    public C1303Hb(int i10, byte[] bArr, int i11, int i12) {
        this.A01 = i10;
        this.A03 = bArr;
        this.A02 = i11;
        this.A00 = i12;
    ...
    public final boolean equals(Object obj) {
        ...
        C1303Hb c1303Hb = (C1303Hb) obj;
        String[] strArr = A04;
        if (strArr[6].length() == strArr[3].length()) {
            throw new RuntimeException();
        }
        A04[1] = "oBkTGyhCOE";
        if (this.A01 == c1303Hb.A01 && this.A02 == c1303Hb.A02 && this.A00 == c1303Hb.A00 && Arrays.equals(this.A03, c1303Hb.A03)) {
            return true;
        }
        return false;
    }
