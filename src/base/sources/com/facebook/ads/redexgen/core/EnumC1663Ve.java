...
public enum EnumC1663Ve {
    A06(-1, 100, 1, 0),
    A07(-1, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL, 2, 1),
    A08(-1, HttpStatusCodes.STATUS_CODE_MULTIPLE_CHOICES, 3, 2),
    A09(-1, 400, 4, 3),
    A0A(-1, 50, 5, 4),
    A0B(-1, -1, 6, 5);
    ...
    EnumC1663Ve(int i10, int i11, int i12, int i13) {
        this.A03 = i10;
        this.A01 = i11;
        this.A02 = i12;
        this.A00 = i13;
    ...
    @Nullable
    public static EnumC1663Ve A00(int i10) {
        for (EnumC1663Ve enumC1663Ve : values()) {
            if (enumC1663Ve.A00 == i10) {
                return enumC1663Ve;
            }
        }
        return null;
