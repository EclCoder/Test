...
public abstract class NQ implements Serializable {
    ...
    public static NQ A03(JSONObject jSONObject, C2198gi c2198gi) {
        ...
        if (zHas) {
            try {
                nqA00 = C2357jT.A00(jSONObject, c2198gi);
        ...
        if (nqA00 == null) {
            zHas = false;
            nqA00 = C10737l.A00(jSONObject, c2198gi);
        }
        nqA00.A1Q(zHas);
        nqA00.A0a(z10);
        return nqA00;
    ...
    private void A0P(JSONObject jSONObject) {
        ...
        boolean zA1p = A1p();
        String strA04 = A04(1648, 30, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE);
        if (zA1p) {
        ...
        A0J(jSONObject.optString(A04(1627, 21, 101), A04(Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE, 22, 100)));
    ...
    public final String A0w() {
        ...
        switch (b10) {
            case 0:
                return A04(834, 37, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE);
            case 1:
                return EnumC2091ez.A04.A03();
            case 2:
                return EnumC2090ey.A03.A03();
            default:
                return A04(0, 0, 51);
        }
    }
    ...
    public final void A1P(JSONObject jSONObject) {
        ...
        A0A(jSONObject.optString(A04(1038, 26, 51), strA05));
        A0U(jSONObject.optBoolean(A04(871, 23, 73), false));
        A0V(jSONObject.optBoolean(A04(894, 37, Sdk$SDKError.b.TPAT_ERROR_VALUE), false));
        ...
        A0S(jSONObject.optBoolean(A04(TTAdConstant.DOWNLOAD_APP_INFO_CODE, 26, 37), false));
        A0b(jSONObject.optBoolean(A04(433, 33, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL), false));
        ...
        A0M(jSONObject.optString(A04(1778, 22, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE), A04(180, 15, 43)));
        A0N(jSONObject.optString(A04(1800, 16, 29), A04(260, 27, 4)));
        this.A0a = jSONObject.optBoolean(A04(1006, 14, 36));
        this.A0b = jSONObject.optBoolean(A04(1020, 18, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE));
        this.A0Z = jSONObject.optBoolean(A04(979, 27, Sdk$SDKError.b.TPAT_ERROR_VALUE), true);
        ...
        this.A0W = jSONObject.optString(A04(1830, 41, 59), A04(644, Sdk$SDKError.b.TPAT_ERROR_VALUE, 45));
        this.A0E = jSONObject.optString(A04(1082, 23, 67), A04(1393, 15, 24));
        this.A0q = jSONObject.optBoolean(A04(1340, 29, 87), false);
        this.A0y = jSONObject.optBoolean(A04(1943, 30, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE), false);
        ...
        JSONObject creditLineImageI18NJson = jSONObject.optJSONObject(A04(931, 22, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE));
        if (creditLineImageI18NJson != null) {
            this.A08 = C1457Nb.A00(creditLineImageI18NJson);
        }
    }
