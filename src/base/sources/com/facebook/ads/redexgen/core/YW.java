...
public final class YW {
    ...
    public static Map<String, String> A01(@Nullable C2198gi c2198gi) {
        Window window;
        ...
        try {
            map.put(A00(40, 3, 0), String.valueOf(A04(c2198gi)));
            ...
            if (activityA0E != null && (window = activityA0E.getWindow()) != null) {
                ...
                String strA00 = A00(1, 1, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE);
            ...
            InterfaceC1609Tc interfaceC1609TcA08 = c2198gi.A08();
            int type3 = AbstractC1610Td.A2T;
            interfaceC1609TcA08.ABC(A00(43, 5, 77), type3, new C1611Te(e10));
        }
        return map;
    }

    public static boolean A03(C2198gi c2198gi) {
        return !YC.A04(A01(c2198gi));
    }

    public static boolean A04(C2198gi c2198gi) {
        KeyguardManager keyguardManager = (KeyguardManager) c2198gi.getSystemService(A00(32, 8, 57));
