...
public final class C1682Vz extends C1568Rm implements DefaultMediaViewVideoRendererApi {
    ...
    static {
        A0K();
        A0K = C1682Vz.class.getSimpleName();
    }
    ...
    private C2143fp A08() {
        return new C2143fp(this.A01, 50, true, new WeakReference(this.A0A), this.A04);
    }

    private void A0C() {
        if (this.A07 != null) {
            C10536r c10536r = this.A07;
            if (A0J[6].charAt(16) != 'd') {
                throw new RuntimeException();
            }
            A0J[5] = "Ntv0Vby76dSesAjQjgB6ptCIElpzOEzL";
            ((C2082eq) c10536r.getVideoView()).setViewImplInflationListener(this.A0F);
        }
    }
        ...
        if (this.A07 != null) {
            this.A07.getVideoView().setOnTouchListener(new View.OnTouchListener() { // from class: com.facebook.ads.redexgen.X.VQ
                ...
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    return C1682Vz.A0U(view, motionEvent);
                }
            });
        }
    }
    ...
    private void A0F() {
        if (this.A07 != null) {
            ((C2082eq) this.A07.getVideoView()).setViewImplInflationListener(null);
        }
    }
    ...
    public void A0G() {
        ...
        if (this.A09 != null) {
            if (this.A02 != null && this.A02.getHideMediaControls() != null && this.A02.getHideMediaControls().booleanValue() && !C1648Up.A1Z(this.A04)) {
    ...
    public void A0H() {
        ...
        if (!C1648Up.A1a(this.A04)) {
            InterfaceC1424Lt interfaceC1424LtA0F = this.A04.A0F();
            String[] strArr = A0J;
        ...
        if (this.A03 != null) {
            ...
            if (nativeOptions != null && this.A02.getUnMuteVolume() != null && this.A02.getUnMuteVolume().booleanValue() && !C1648Up.A1a(this.A04)) {
    ...
    private void A0I() {
        ...
        if (this.A07 != null) {
            EnumC2140fm state = this.A07.getState();
            String[] strArr = A0J;
            if (strArr[7].length() != strArr[1].length()) {
                throw new RuntimeException();
            }
            A0J[4] = "z79LrkWpr7afRwAllWq14kp6jWBswbkV";
            if (state == EnumC2140fm.A05) {
                this.A0E = true;
            }
        }
        this.A0B.A0V();
    ...
    public void A0Q(UK uk2, VV vv) {
        ...
        if (uk2 != null && uk2.getAdCoverImage() != null) {
            C1660Vb adCoverImage = uk2.getAdCoverImage();
            String[] strArr = A0J;
            if (strArr[0].charAt(7) != strArr[3].charAt(7)) {
                throw new RuntimeException();
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0R(EnumC2085et enumC2085et) {
        if (this.A07 != null) {
            this.A07.A0e(enumC2085et, 24);
        } else {
    ...
    private boolean A0S() {
        ...
        if (!C1648Up.A1Y(this.A04)) {
            this.A04.A0F().ABf();
        }
        return (this.A02 == null || this.A02.getDisableFullScreen() == null || !this.A02.getDisableFullScreen().booleanValue() || C1648Up.A1Y(this.A04)) ? false : true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0T() {
        if (this.A07 == null || this.A07.getState() == EnumC2140fm.A06) {
            return false;
        }
        return this.A06 == EnumC1664Vf.A05 || this.A06 == EnumC1664Vf.A03;
    }
    ...
    public final void initialize(Context context, MediaViewVideoRenderer mediaViewVideoRenderer, MediaViewVideoRendererApi mediaViewVideoRendererApi, int i10) {
        VX vxA04;
        ((C1568Rm) mediaViewVideoRendererApi.getAdComponentViewApi()).A00(this);
        ...
        ((C1581Rz) mediaViewVideoRendererApi).A06(vxA04);
        this.A04 = C1571Rp.A03(context);
        ...
        int i11 = 0;
        while (true) {
            int i12 = this.A01.getChildCount();
            if (A0J[2].length() == 26) {
                throw new RuntimeException();
            }
            ...
            if (i11 < i12) {
                ...
                if (childAt instanceof C10536r) {
                    this.A07 = (C10536r) childAt;
                } else {
                    i11++;
                }
            }
    ...
    public final void onPrepared() {
        boolean zA0s = C1648Up.A0s(this.A04);
        boolean zA0S = A0S();
