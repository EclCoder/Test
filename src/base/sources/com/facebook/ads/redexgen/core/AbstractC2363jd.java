...
public abstract class AbstractC2363jd extends NQ implements Serializable {
    ...
    public AbstractC2363jd(List<NR> list) {
        this.A0P = list;
    }
    ...
    public static List<NR> A08(JSONObject jSONObject, C2198gi c2198gi, InterfaceC1460Ne interfaceC1460Ne) {
        JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(A05(156, 8, 28));
        if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() > 0) {
            return NZ.A01(jSONArrayOptJSONArray, jSONObject, c2198gi, interfaceC1460Ne);
        }
        List<AdInfo> adInfoList = new ArrayList<>();
        NR nrA00 = NR.A00(jSONObject);
        interfaceC1460Ne.A3y(nrA00, jSONObject);
    ...
    private final void A0D(C1462Ng c1462Ng) {
        this.A07 = c1462Ng;
    }

    private void A0E(C1465Nj c1465Nj) {
        this.A08 = c1465Nj;
    }

    private final void A0F(C1468Nm c1468Nm) {
        this.A09 = c1468Nm;
    }

    private void A0G(C1474Ns c1474Ns) {
        this.A0A = c1474Ns;
    }
    ...
    public final C1462Ng A2A() {
        return this.A07;
    }

    public final C1465Nj A2B() {
        return this.A08;
    }

    public final C1468Nm A2C() {
        return this.A09;
    }

    public final C1474Ns A2D() {
        return this.A0A;
    }
    ...
    public final void A2H(InterfaceC1739Yh interfaceC1739Yh) {
        byte b10;
        String strA10 = A10();
        switch (strA10.hashCode()) {
            case -1364000502:
                ...
                break;
            case 604727084:
                if (!strA10.equals(A05(Sdk$SDKError.b.AD_CLOSED_TEMPLATE_ERROR_VALUE, 12, 82))) {
                    b10 = -1;
                } else {
                    b10 = 0;
                }
        ...
        switch (b10) {
            case 0:
                interfaceC1739Yh.A4j(A05(183, 45, 79));
                break;
            case 1:
                break;
            default:
        ...
        interfaceC1739Yh.A4j(EnumC2091ez.A08.A03());
    }

    public final void A2I(JSONObject jSONObject) {
        String strA05;
        A0D(C1462Ng.A00(jSONObject.optJSONObject(A05(301, 16, 74))));
        A0R = jSONObject.optJSONObject(A05(144, 12, 40));
        C1467Nl c1467NlA06 = new C1467Nl().A06(jSONObject.optString(A05(591, 5, 77)));
        String strA06 = A05(297, 4, 95);
        if (jSONObject.optJSONObject(strA06) != null) {
            strA05 = jSONObject.optJSONObject(strA06).optString(A05(614, 3, 109));
        } else {
            strA05 = A05(0, 0, 15);
        }
        A0F(c1467NlA06.A05(strA05).A04(jSONObject.optString(A05(0, 19, 64))).A07(AbstractC1469Nn.A03(jSONObject)).A08());
        JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A05(370, 6, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE));
        JSONObject layoutObject = jSONObjectOptJSONObject != null ? jSONObjectOptJSONObject.optJSONObject(A05(376, 8, 8)) : null;
        C1456Na c1456NaA01 = C1456Na.A01(layoutObject);
        String[] strArr = A0T;
        ...
        A0C(new NN(c1456NaA01, C1456Na.A01(jSONObjectOptJSONObject != null ? jSONObjectOptJSONObject.optJSONObject(A05(361, 9, 71)) : null)));
        A0G(AbstractC1469Nn.A01(jSONObject));
        A0E(AbstractC1469Nn.A00(jSONObject));
        ...
        String strOptString = jSONObject.optString(A05(249, 2, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE));
        A0H(strOptString);
        A0U.put(strOptString, jSONObject.optString(A05(269, 28, 97)));
        this.A0O = jSONObject.optBoolean(A05(526, 26, 47), false);
        this.A0N = jSONObject.optBoolean(A05(497, 29, Sdk$SDKError.b.TPAT_ERROR_VALUE), false);
