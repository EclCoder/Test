...
public class C2234hI implements InterfaceC1971d1 {
    ...
    public C2234hI(C2228hC c2228hC, UK uk2, NativeAd nativeAd) {
        this.A01 = c2228hC;
        this.A02 = uk2;
        this.A00 = nativeAd;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC1971d1
    public final void AAn() {
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC1971d1
    public final void ADm(AnonymousClass62 anonymousClass62) {
        new Handler(Looper.getMainLooper()).postDelayed(new C2235hJ(this, anonymousClass62), 1L);
    }
