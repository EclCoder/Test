...
public class C2396kA extends AbstractRunnableC1685Wc {
    ...
    public C2396kA(N8 n10, String str) {
        this.A00 = n10;
        this.A01 = str;
    }
    ...
    public final void A07() {
        ...
        try {
            ...
            if (this.A00.A0J(this.A01)) {
                ((C1461Nf) this.A00.A02.A05().get(this.A01)).A04((int) (System.currentTimeMillis() / 1000));
                this.A00.A02.A07(this.A01);
                this.A00.A02.A06();
                this.A00.A08();
            }
        } catch (InterruptedException e10) {
            this.A00.A03.A08().ABC(strA00, AbstractC1610Td.A1B, new C1611Te(e10));
        } catch (JSONException e11) {
            this.A00.A0M();
            this.A00.A03.A08().ABC(strA00, AbstractC1610Td.A1A, new C1611Te(e11));
        }
    }
}
