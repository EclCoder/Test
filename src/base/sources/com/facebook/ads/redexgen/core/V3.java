...
public final class V3 implements AudienceNetworkExportedActivityApi {
    ...
    private boolean A03(V2 v10) {
        String callingPackage = this.A00.getCallingPackage();
        if (callingPackage != null) {
            String callingPackage2 = v10.A04;
        ...
        A02(12);
        if (v10.A00 instanceof C2312id) {
            ((C2312id) v10.A00).A0F().A0F().AHu();
        }
        if (v10.A00 instanceof C2309iZ) {
            InterfaceC1424Lt interfaceC1424LtA0F = ((C2309iZ) v10.A00).A0H().A0F();
            if (A02[6].charAt(24) == 'N') {
    ...
    public final void onCreate(Bundle bundle) {
        C2198gi c2198giA05 = C1571Rp.A05(this.A00, UUID.randomUUID().toString());
        ...
        OG og2 = v2A04 != null ? v2A04.A00 : null;
        if (v2A04 != null && (og2 instanceof C2309iZ)) {
            ...
            C2309iZ c2309iZ = (C2309iZ) og2;
            c2309iZ.A0G().A01().A0J(this.A00);
            c2309iZ.A0M(this.A00.getIntent().getIntExtra(A00(0, 26, 101), -1), 0L);
        } else if (v2A04 != null && (og2 instanceof C2312id)) {
            if (!A03(v2A04)) {
                return;
            }
            C2312id c2312id = (C2312id) og2;
            c2312id.A0E().A05().A0J(this.A00);
            c2312id.A0J();
        } else {
            c2198giA05.A0F().AII();
            A02(13);
