...
public final class C2534md implements H9 {
    ...
    public boolean A09;
    public boolean A0A;
    public final C10054v A0C = new C10054v(4);
    public final C10054v A0B = new C10054v(9);
    public final C10054v A0E = new C10054v(11);
    public final C10054v A0D = new C10054v();
    public final C2533mc A0F = new C2533mc();
    public int A01 = 1;
    ...
    private C10054v A01(InterfaceC2549ms interfaceC2549ms) throws IOException {
        ...
        interfaceC2549ms.readFully(this.A0D.A0l(), 0, this.A02);
        return this.A0D;
    }
    ...
    private void A02() {
        if (!this.A0A) {
            this.A06.AJ7(new C2544mn(C.TIME_UNSET));
            this.A0A = true;
        }
    }

    private void A03(InterfaceC2549ms interfaceC2549ms) throws IOException {
        interfaceC2549ms.AK3(this.A00);
        this.A00 = 0;
        this.A01 = 3;
    }

    @RequiresNonNull({"extractorOutput"})
    private boolean A04(InterfaceC2549ms interfaceC2549ms) throws IOException {
        if (!interfaceC2549ms.AHR(this.A0B.A0l(), 0, 9, true)) {
            return false;
        }
        this.A0B.A0f(0);
        C10054v c10054v = this.A0B;
        String[] strArr = A0G;
        if (strArr[5].charAt(7) == strArr[0].charAt(7)) {
            throw new RuntimeException();
        }
        ...
        if (z10 && this.A07 == null) {
            this.A07 = new C2536mf(this.A06.AKS(8, 1));
        }
        if (hasAudio && this.A08 == null) {
            this.A08 = new C2531ma(this.A06.AKS(9, 2));
        }
        this.A06.A6O();
    ...
    @RequiresNonNull({"extractorOutput"})
    private boolean A05(InterfaceC2549ms interfaceC2549ms) throws IOException {
        long j10;
        boolean z10 = true;
        boolean zA00 = false;
        long jA00 = A00();
        if (this.A03 == 8 && this.A07 != null) {
            A02();
            zA00 = this.A07.A00(A01(interfaceC2549ms), jA00);
        } else if (this.A03 == 9 && this.A08 != null) {
            A02();
            zA00 = this.A08.A00(A01(interfaceC2549ms), jA00);
        } else if (this.A03 == 18) {
            boolean wasConsumed = this.A0A;
            if (!wasConsumed) {
                zA00 = this.A0F.A00(A01(interfaceC2549ms), jA00);
                long timestampUs = this.A0F.A0D();
                if (timestampUs != C.TIME_UNSET) {
                    this.A06.AJ7(new C2545mo(this.A0F.A0E(), this.A0F.A0F(), timestampUs));
                    this.A0A = true;
                }
            } else {
                interfaceC2549ms.AK3(this.A02);
                z10 = false;
            }
        } else {
            interfaceC2549ms.AK3(this.A02);
    ...
    private boolean A06(InterfaceC2549ms interfaceC2549ms) throws IOException {
        if (!interfaceC2549ms.AHR(this.A0E.A0l(), 0, 11, true)) {
            return false;
        }
        this.A0E.A0f(0);
    ...
    public final int AHL(InterfaceC2549ms interfaceC2549ms, HV hv) throws IOException {
        ...
        while (true) {
            switch (this.A01) {
                case 1:
                    if (!A04(interfaceC2549ms)) {
                        return -1;
                    }
                    break;
                    break;
                case 2:
                    A03(interfaceC2549ms);
                    break;
                case 3:
                    boolean zA06 = A06(interfaceC2549ms);
                    String[] strArr = A0G;
                    ...
                    break;
                case 4:
                    boolean zA05 = A05(interfaceC2549ms);
    ...
    public final boolean AK5(InterfaceC2549ms interfaceC2549ms) throws IOException {
        interfaceC2549ms.AGt(this.A0C.A0l(), 0, 3);
        this.A0C.A0f(0);
        if (this.A0C.A0K() != 4607062) {
            return false;
        }
        interfaceC2549ms.AGt(this.A0C.A0l(), 0, 2);
        this.A0C.A0f(0);
        if ((this.A0C.A0M() & 250) != 0) {
            return false;
        }
        interfaceC2549ms.AGt(this.A0C.A0l(), 0, 4);
        this.A0C.A0f(0);
        int dataOffset = this.A0C.A0C();
        interfaceC2549ms.AIl();
        interfaceC2549ms.A47(dataOffset);
        interfaceC2549ms.AGt(this.A0C.A0l(), 0, 4);
        this.A0C.A0f(0);
