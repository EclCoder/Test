...
public final class C1759Zb extends RelativeLayout {
    public final int A00;
    public final int A01;
    public final C1488Og A02;
    public final C2198gi A03;
    public final InterfaceC1763Zf A04;
    ...
    public C1759Zb(C1758Za c1758Za) {
        super(c1758Za.A0B);
        this.A03 = c1758Za.A0B;
        this.A02 = AbstractC1489Oh.A00(this.A03.A02());
        this.A04 = c1758Za.A02;
        this.A01 = c1758Za.A0A ? A0E : A0F;
        this.A00 = c1758Za.A0A ? A0B : A0C;
        this.A05 = c1758Za.A07;
        setFocusable(true);
        View viewA01 = A01(c1758Za);
        View viewA00 = A00(c1758Za);
    ...
    private View A00(C1758Za c1758Za) {
        ...
        subtitleView.setText(c1758Za.A06);
        ...
        if (c1758Za.A08) {
            ...
            if (!TextUtils.isEmpty(c1758Za.A04)) {
                ...
                new LM(c1892bk, this.A03).A05(A0F, A0F).A07(c1758Za.A04);
                linearLayout2.addView(c1892bk, iconParams);
            }
            C1765Zh c1765Zh = new C1765Zh(this.A03);
            c1765Zh.setData(c1758Za.A03, YM.CHECKMARK);
            c1765Zh.setSelected(true);
            linearLayout2.addView(c1765Zh, new LinearLayout.LayoutParams(-2, -2));
            linearLayout.addView(linearLayout2);
        }
        return linearLayout;
    }

    private View A01(C1758Za c1758Za) {
        LinearLayout linearLayout = new LinearLayout(getContext());
