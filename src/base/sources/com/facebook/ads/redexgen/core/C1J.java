...
public class C1J extends C7M {
    ...
    public C1J(C2198gi c2198gi) {
        super(c2198gi);
        setCarouselLayoutManager(c2198gi);
    }

    public AbstractC1269Ft getFullscreenCarouselRecyclerViewAdapter() {
        getAdapter();
        if (0 != 0) {
            getAdapter();
            return null;
    ...
    public C2268hr getLayoutManager() {
        return (C2268hr) super.getLayoutManager();
    }
    ...
    private void setCarouselLayoutManager(C2198gi c2198gi) {
        C2268hr c2268hr = new C2268hr(c2198gi, 0, false);
        if (Build.VERSION.SDK_INT >= 24) {
            c2268hr.A1T(true);
        }
        super.setLayoutManager(c2268hr);
    }
