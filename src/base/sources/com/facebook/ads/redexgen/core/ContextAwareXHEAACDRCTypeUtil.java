...
public final class ContextAwareXHEAACDRCTypeUtil {
    ...
    @JvmStatic
    public static final int A00(int i10, int i11, int i12) {
        if (A00.A01(i10) && !GlobalSystemVolumeHolder.A01.A00()) {
            return i10;
        }
        if (A02(i11, i12)) {
            return 1;
    ...
    private final boolean A01(int i10) {
        return -1 <= i10 && i10 < 7;
    }

    @JvmStatic
    public static final boolean A02(int i10, int i11) {
