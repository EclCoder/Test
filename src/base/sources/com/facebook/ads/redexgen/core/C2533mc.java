...
public final class C2533mc extends AbstractC1322Hu {
    ...
    public final boolean A0C(C10054v c10054v, long j10) {
        int i10;
        if (A00(c10054v) != 2) {
            return false;
        }
        String strA05 = A05(c10054v);
        if (A04[2].charAt(14) == 'f') {
            throw new RuntimeException();
        }
        A04[2] = "yhTvZHDsLiRhvHdxFLG6a7MHjxNmCRFd";
        if (!A04(30, 10, 28).equals(strA05) || c10054v.A07() == 0 || A00(c10054v) != 8) {
            return false;
        }
        HashMap<String, Object> mapA08 = A08(c10054v);
    ...
    public static Boolean A01(C10054v c10054v) {
        return Boolean.valueOf(c10054v.A0I() == 1);
    }

    public static Double A02(C10054v c10054v) {
        return Double.valueOf(Double.longBitsToDouble(c10054v.A0P()));
    }

    public static Object A03(C10054v c10054v, int i10) {
        switch (i10) {
            case 0:
                return A02(c10054v);
            case 1:
    ...
    public static String A05(C10054v c10054v) {
        int iA0M = c10054v.A0M();
        int iA09 = c10054v.A09();
        c10054v.A0g(iA0M);
        return new String(c10054v.A0l(), iA09, iA0M);
    }

    public static ArrayList<Object> A06(C10054v c10054v) {
        int iA0L = c10054v.A0L();
        ArrayList<Object> arrayList = new ArrayList<>(iA0L);
        for (int i10 = 0; i10 < iA0L; i10++) {
            int count = A00(c10054v);
            Object objA03 = A03(c10054v, count);
            if (objA03 != null) {
    ...
    public static Date A07(C10054v c10054v) {
        Date date = new Date((long) A02(c10054v).doubleValue());
        c10054v.A0g(2);
        return date;
    }

    public static HashMap<String, Object> A08(C10054v c10054v) {
        int iA0L = c10054v.A0L();
    ...
    public static HashMap<String, Object> A09(C10054v c10054v) {
        ...
        while (true) {
            ...
            Object objA03 = A03(c10054v, iA00);
            if (objA03 != null) {
                map.put(strA05, objA03);
            }
        }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC1322Hu
    public final boolean A0B(C10054v c10054v) {
        return true;
    }
