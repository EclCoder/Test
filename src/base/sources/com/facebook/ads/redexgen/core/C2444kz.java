...
public final class C2444kz implements H9 {
    ...
    private int A00(InterfaceC2549ms interfaceC2549ms) throws IOException {
        AbstractC09823y.A08(this.A02 != -1);
        return ((LL) AbstractC09823y.A01(this.A06)).AIt(interfaceC2549ms, this.A02 - interfaceC2549ms.A8n()) ? -1 : 0;
    }
    ...
    private void A04(InterfaceC2549ms interfaceC2549ms) throws IOException {
        AbstractC09823y.A08(interfaceC2549ms.A8n() == 0);
        int i10 = this.A00;
        if (A08[5].length() != 13) {
    ...
    private void A05(InterfaceC2549ms interfaceC2549ms) throws IOException {
        LN wavFormat = LP.A02(interfaceC2549ms);
        if (wavFormat.A03 == 17) {
            this.A06 = new C2446l1(this.A04, this.A05, wavFormat);
        } else if (wavFormat.A03 == 6) {
            this.A06 = new C2445l0(this.A04, this.A05, wavFormat, A01(Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE, 15, 82), -1);
        } else if (wavFormat.A03 == 7) {
            this.A06 = new C2445l0(this.A04, this.A05, wavFormat, A01(Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE, 15, 60), -1);
        } else {
            int iA00 = AbstractC1313Hl.A00(wavFormat.A03, wavFormat.A01);
            if (iA00 != 0) {
                this.A06 = new C2445l0(this.A04, this.A05, wavFormat, A01(142, 9, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), iA00);
            } else {
    ...
    private void A06(InterfaceC2549ms interfaceC2549ms) throws IOException {
        this.A03 = LP.A00(interfaceC2549ms);
        this.A01 = 2;
    }

    private void A07(InterfaceC2549ms interfaceC2549ms) throws IOException {
        Pair<Long, Long> pairA01 = LP.A01(interfaceC2549ms);
        ...
        if (jA8O != -1 && this.A02 > jA8O) {
            AbstractC09904g.A07(A01(100, 12, 18), A01(2, 27, 100) + this.A02 + A01(0, 2, 89) + jA8O);
            this.A02 = jA8O;
        }
        ((LL) AbstractC09823y.A01(this.A06)).AA8(this.A00, this.A02);
        this.A01 = 4;
    }

    public static /* synthetic */ H9[] A08() {
        return new H9[]{new C2444kz()};
    }
    ...
    public final boolean AK5(InterfaceC2549ms interfaceC2549ms) throws IOException {
        return LP.A06(interfaceC2549ms);
    }
}
