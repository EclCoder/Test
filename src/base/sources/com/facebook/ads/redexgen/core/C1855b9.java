...
public final class C1855b9 {
    ...
    public C1855b9(Map<String, String> extraData) {
        this.A00 = extraData;
    }

    public final C1855b9 A02(Y2 y10) {
        if (y10 != null) {
            this.A00.put(A00(11, 5, 48), AbstractC1709Xd.A01(y10.A04()));
        }
        return this;
    }

    public final C1855b9 A03(C2143fp c2143fp) {
        if (c2143fp != null) {
            this.A00.putAll(c2143fp.A0S());
        }
        return this;
    }

    public final C1855b9 A04(String str) {
