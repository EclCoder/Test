...
public final class C2563n7 {
    ...
    public final InterfaceExecutorC1252Fb A02;
    ...
    public C2563n7(InterfaceExecutorC1252Fb interfaceExecutorC1252Fb) {
        this.A02 = interfaceExecutorC1252Fb;
    }

    @MetaExoPlayerCustomization(type = {"MERGED"})
    public C2563n7(String str) {
        this(AbstractC1251Fa.A00(C5C.A0u(A06(0, 17, 64) + str), new AnonymousClass49() { // from class: com.facebook.ads.redexgen.X.n8
    ...
    private final <T extends FL> long A00(Looper looper, T t10, FI<T> fi2, int i10) {
        AbstractC09823y.A08(looper != null);
        this.A01 = null;
        long jElapsedRealtime = SystemClock.elapsedRealtime();
        new FK(this, looper, t10, fi2, i10, jElapsedRealtime).A06(0L);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.FI != com.facebook.ads.androidx.media3.exoplayer.upstream.Loader$Callback<T extends com.facebook.ads.redexgen.X.FL> */
    public final <T extends FL> long A08(T t10, FI<T> fi2, int i10) {
        Looper looper = (Looper) AbstractC09823y.A02(Looper.myLooper());
        return A00(looper, t10, fi2, i10);
    }

    public final void A09() {
        ((FK) AbstractC09823y.A02(this.A00)).A07(false);
    }
