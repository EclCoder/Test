...
public final class AD extends C2739pz {
    ...
    static {
        ...
        A0A = C5C.A0h(1004);
        A0B = C5C.A0h(GeofenceStatusCodes.GEOFENCE_REQUEST_TOO_FREQUENT);
        A09 = C5C.A0h(1006);
    }

    public AD(int i10, Throwable th2, int i11) {
        this(i10, th2, null, i11, null, -1, null, 4, false);
    }

    public AD(int i10, Throwable th2, String str, int i11, String str2, int i12, C2758qI c2758qI, int i13, boolean z10) {
        this(A06(i10, th2, str, str2, i12, c2758qI, i13), th2, i11, i10, str2, i12, c2758qI, i13, null, SystemClock.elapsedRealtime(), z10);
    }
    ...
    public AD(Bundle bundle) {
        ...
        if (bundle2 == null) {
            ...
            c2758qI = (C2758qI) C2758qI.A0b.A6f(bundle2);
        }
        this.A04 = c2758qI;
    ...
    public AD(String str, Throwable th2, int i10, int i11, String str2, int i12, C2758qI c2758qI, int i13, C3C c3c, long j10, boolean z10) {
        super(str, th2, i10, j10);
        AbstractC09823y.A07(!z10 || i11 == 1);
        AbstractC09823y.A07(th2 != null || i11 == 3);
        this.A03 = i11;
        this.A06 = str2;
        this.A02 = i12;
        this.A04 = c2758qI;
    ...
    public static AD A04(Throwable th2, String str, int i10, C2758qI c2758qI, int i11, boolean z10, int i12) {
        int i13 = i11;
        if (c2758qI == null) {
            i13 = 4;
        }
        return new AD(1, th2, null, i12, str, i10, c2758qI, i13, z10);
    }

    public static String A06(@MetaExoPlayerCustomization(type = {"NEW_METHOD_ARGS"}, value = "Throwable cause - linked with Error reporting") int i10, Throwable th2, String str, String str2, int i11, C2758qI c2758qI, int i12) {
        String message;
        String strA05;
        if (str == null) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                StringBuilder sbAppend3 = sbAppend2.append(message3).append(c2758qI);
                String message4 = A05(23, 19, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE);
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            String message6 = A05(42, 2, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE);
