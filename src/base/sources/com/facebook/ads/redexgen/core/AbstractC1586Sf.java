...
public abstract class AbstractC1586Sf {
    ...
    public static SX A02(T8 t10) {
        ...
        Method methodA02;
        Object objA01;
        Method methodA03 = AbstractC1587Sg.A02(A00, A04(257, 29, 2), Context.class);
        if (methodA03 == null || (objA00 = AbstractC1587Sg.A00(null, methodA03, t10)) == null || ((Integer) objA00).intValue() != 0 || (methodA02 = AbstractC1587Sg.A02(A04(65, 57, 83), A04(232, 20, 98), Context.class)) == null || (objA01 = AbstractC1587Sg.A00(null, methodA02, t10)) == null) {
            return null;
        }
        Method methodA01 = AbstractC1587Sg.A01(objA01.getClass(), A04(252, 5, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE), new Class[0]);
        Method methodA04 = AbstractC1587Sg.A01(objA01.getClass(), A04(286, 24, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE), new Class[0]);
        if (methodA01 == null || methodA04 == null) {
            return null;
        }
        String str = (String) AbstractC1587Sg.A00(objA01, methodA01, new Object[0]);
        Boolean bool = (Boolean) AbstractC1587Sg.A00(objA01, methodA04, new Object[0]);
        if (str != null) {
    ...
    public static SX A00(T8 t10) {
        ...
        throw new IllegalStateException(A04(0, 43, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE));
    }
    ...
    public static SX A03(T8 t10) {
        ServiceConnectionC1585Se serviceConnectionC1585Se = new ServiceConnectionC1585Se();
        Intent intent = new Intent(A04(Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE, 51, 31));
        intent.setPackage(A04(43, 22, 97));
        if (t10.bindService(intent, serviceConnectionC1585Se, 1)) {
            try {
                final IBinder iBinderA02 = serviceConnectionC1585Se.A02();
                ...
                SX sx = new SX(r10.A02(), r10.A03(), SW.A07);
                t10.unbindService(serviceConnectionC1585Se);
                return sx;
            } catch (Throwable th2) {
                try {
                    t10.A08().ABC(A04(Sdk$SDKError.b.AD_LOAD_FAIL_PLACEMENT_ID_MISMATCH_VALUE, 7, 73), AbstractC1610Td.A1Q, new C1611Te(th2));
                } finally {
                    t10.unbindService(serviceConnectionC1585Se);
                }
            }
