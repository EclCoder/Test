...
public abstract class CC implements InterfaceC2429kj<Character> {
    ...
    public static C1C A02(final char match) {
        return new C2S(match) { // from class: com.facebook.ads.redexgen.X.1C
            ...
            public static String A00(int i10, int i11, int i12) {
                ...
                for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
                    byte b10 = (byte) ((bArrCopyOfRange[i13] ^ i12) ^ Sdk$SDKError.b.INVALID_INDEX_URL_VALUE);
                    if (A02[2].length() != 26) {
    ...
    public static String A04(char c10) {
        String strA06 = A06(0, 16, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE);
        char[] cArr = {'\\', 'u', 0, 0, 0, 0};
        int i10 = 0;
