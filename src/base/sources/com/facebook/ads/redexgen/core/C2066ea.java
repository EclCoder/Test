...
public final class C2066ea {
    ...
    public C2066ea(C2198gi c2198gi, ZU zu, String str, InterfaceC1739Yh interfaceC1739Yh) {
        this.A01 = c2198gi;
        this.A03 = zu;
        this.A04 = str;
    ...
    public final void A06() {
        if (!TextUtils.isEmpty(this.A04)) {
            AsyncTaskC2169gF asyncTaskC2169gF = new AsyncTaskC2169gF(this.A01, new HashMap());
            asyncTaskC2169gF.A07(new F8(this));
            asyncTaskC2169gF.executeOnExecutor(this.A00, this.A04);
        }
    }
}
