...
public class C1838as extends WebChromeClient {
    ...
    public final WeakReference<C2198gi> A00;
    public final WeakReference<InterfaceC1836aq> A01;
    public final WeakReference<C1831al> A02;
    ...
    public C1838as(WeakReference<C2198gi> weakReference, WeakReference<InterfaceC1836aq> weakReference2, WeakReference<C1831al> weakReference3) {
    ...
    private boolean A02(ValueCallback valueCallback) {
        C2198gi c2198gi = this.A00.get();
        if (c2198gi != null && c2198gi.A0E() != null && M3.A09) {
            if (M3.A08 != null) {
            ...
            try {
                ...
                c2198gi.A0E().startActivityForResult(Intent.createChooser(intent, A00(3, 12, 84)), 1001);
                return true;
            } catch (Exception e10) {
                c2198gi.A08().ABD(A00(80, 8, 33), AbstractC1610Td.A2d, new C1611Te(e10));
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        C1831al c1831al = this.A02.get();
        if (!TextUtils.isEmpty(strMessage) && consoleMessage.messageLevel() == ConsoleMessage.MessageLevel.LOG && c1831al != null) {
            c1831al.A04(strMessage);
            return true;
        }
        return true;
    }
    ...
    public final void onProgressChanged(WebView webView, int i10) {
        ...
        C1831al timingLogger = this.A02.get();
        if (timingLogger != null) {
            timingLogger.A03();
        }
        InterfaceC1836aq interfaceC1836aq = this.A01.get();
        if (interfaceC1836aq != null) {
            interfaceC1836aq.AFY(i10);
        }
    }
    ...
    public final void onReceivedTitle(WebView webView, String str) {
        ...
        InterfaceC1836aq listener = this.A01.get();
        if (listener != null) {
            listener.AFb(str);
        }
    }
