...
public final class C2327iu implements WC {
    ...
    public C2327iu(C2198gi c2198gi, String str, EnumC1673Vq enumC1673Vq, AdSize adSize, int i10) {
        this.A08 = c2198gi;
        this.A0D = str;
        this.A0A = enumC1673Vq;
        this.A06 = adSize;
        this.A04 = i10;
        ...
        this.A0C = new Q9<C2327iu>(this) { // from class: com.facebook.ads.redexgen.X.7e
            {
                super(this);
            }
            ...
            public final void A07() {
                C2327iu c2327iuA08 = A08();
                if (c2327iuA08 == null) {
                    return;
                }
                if (YV.A02(c2327iuA08.A08)) {
                    c2327iuA08.A07();
                } else {
                    c2327iuA08.A05.postDelayed(c2327iuA08.A0C, 5000L);
                }
            }
        };
    ...
    private List<C2380ju> A04() {
        C1629Tw c1629Tw = this.A01;
        final ArrayList arrayList = new ArrayList(c1629Tw.A02());
        for (C1627Tu c1627TuA04 = c1629Tw.A04(); c1627TuA04 != null; c1627TuA04 = c1629Tw.A04()) {
            N1 n1A00 = this.A07.A00(this.A08, AdPlacementType.NATIVE);
            if (n1A00 != null && n1A00.A8k() == AdPlacementType.NATIVE) {
                final C2380ju nativeAdapter = (C2380ju) n1A00;
                nativeAdapter.A0L(this.A08, new AbstractC2328iv() { // from class: com.facebook.ads.redexgen.X.7f
                    @Override // com.facebook.ads.redexgen.core.NG
                    public final void AEw(C2380ju c2380ju) {
                        arrayList.add(nativeAdapter);
                    }
                }, this.A09, new O8(c1627TuA04.A04(), c1629Tw.A05(), this.A0D, c1629Tw.A05().A0C()), UK.A0K());
            }
        }
        return arrayList;
    }
    ...
    public final void A07() {
        try {
            this.A0B.A0Q(new WA(this.A08, this.A0D, this.A06 != null ? new C1719Xn(this.A06.getWidth(), this.A06.getHeight()) : null, this.A0A, this.A04, new C1677Vu(this.A08, null, null, null), AbstractC1725Xt.A01(C1648Up.A0N(this.A08)), this.A02, null, new C2317ij()));
        } catch (C1671Vn e10) {
            ADp(C1670Vm.A02(e10));
        }
    }
    ...
    public final void AG7(RG rg2) {
        C1629Tw c1629TwA00 = rg2.A00();
        if (c1629TwA00 != null) {
            if (this.A03) {
                long jA0A = c1629TwA00.A05().A0A();
                if (jA0A == 0) {
                    jA0A = 1800000;
                }
            ...
            if (this.A00 != null) {
                ...
                if (zIsEmpty) {
                    this.A00.ADp(C1670Vm.A01(AdErrorType.NO_FILL, A03(0, 0, 63)));
                    return;
                } else {
