...
public final class C2782qk {
    ...
    public /* synthetic */ C2782qk(AbstractC2773qZ abstractC2773qZ) {
        this();
    }
    ...
    public final int A02(Collection<?> collection) {
        C2772qY.A09(collection, A00(31, 1, 39));
        int i10 = 1;
    ...
    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C2772qY.A09(collection, A00(31, 1, 39));
        C2772qY.A09(collection2, A00(50, 5, 95));
        ...
        while (it2.hasNext()) {
            if (!C2772qY.A0C(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
