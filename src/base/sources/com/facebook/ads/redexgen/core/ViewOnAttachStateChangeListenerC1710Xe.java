...
public final class ViewOnAttachStateChangeListenerC1710Xe extends AbstractC2805rL implements View.OnAttachStateChangeListener {
    ...
    public ViewOnAttachStateChangeListenerC1710Xe(View view, C2194ge c2194ge) {
        this.A00 = view;
        this.A01 = c2194ge;
        ...
        if (A05()) {
            try {
                ...
                this.A01.A08().ABC(A00(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 14, 83), 3600, new C1611Te(A00(0, 45, 1) + th2.getMessage()));
            }
        }
    }
    ...
    public final void A04() {
        try {
            ...
            this.A01.A08().ABC(A00(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 14, 83), 3600, new C1611Te(A00(45, 48, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE) + th2.getMessage()));
        }
    }
    ...
    public final void onViewDetachedFromWindow(View view) {
        try {
            ...
            this.A01.A08().ABC(A00(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 14, 83), 3600, new C1611Te(A00(93, 44, 25) + th2.getMessage()));
        }
    }
}
