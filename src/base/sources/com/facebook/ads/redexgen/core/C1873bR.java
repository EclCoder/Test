...
public final class C1873bR extends RelativeLayout {
    public Runnable A00;
    public boolean A01;
    public boolean A02;
    ...
    public C1873bR(C2198gi c2198gi, AbstractC2363jd abstractC2363jd, ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr, int i10, boolean z10) {
        super(c2198gi);
        this.A01 = false;
        this.A02 = false;
    ...
    public void A04() {
        this.A07.A0F().ADH();
        this.A05.animate().translationY(A0D).setDuration(300L).setListener(new C1872bQ(this)).start();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A05() {
        this.A05.animate().translationY(0.0f).setDuration(300L).setListener(new C1871bP(this)).start();
    }
    ...
    private void A07() {
        new YJ(100, 500, this.A07, new C1399Ku(this)).A00(this.A05);
    }
    ...
    private C1892bk getAppIcon() {
        C1892bk c1892bk = new C1892bk(this.A07);
        YB.A0N(c1892bk, 0);
        new LM(c1892bk, this.A07).A05(A0F, A0F).A07(this.A06.A2C().A01());
        RelativeLayout.LayoutParams iconViewParams = new RelativeLayout.LayoutParams(A0F, A0F);
        iconViewParams.addRule(9);
        c1892bk.setLayoutParams(iconViewParams);
        return c1892bk;
    }
    ...
    private LinearLayout getRatingCountAndStar() {
        ...
        C1895bn c1895bn = new C1895bn(this.A07, -16777216, -16777216);
        ...
        linearLayout.addView(c1895bn, layoutParams);
        return linearLayout;
    }
