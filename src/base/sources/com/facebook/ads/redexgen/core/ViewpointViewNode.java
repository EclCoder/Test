...
public final class ViewpointViewNode implements DspViewableNode {
    ...
    public static final C2793r8 A03;
    public static final WeakHashMap<View, ViewpointViewNode> A04;
    public final WeakReference<View> A00;

    public /* synthetic */ ViewpointViewNode(View view, AbstractC2773qZ abstractC2773qZ) {
        this(view);
    }
    ...
    public final boolean A9Y(Rect rect, Rect rect2, Rect rect3) {
        C2772qY.A09(rect, A01(13, 20, 52));
        C2772qY.A09(rect2, A01(0, 13, 81));
        C2772qY.A09(rect3, A01(33, 12, 85));
        View view = this.A00.get();
        if (view == null) {
            return false;
        }
        return AbstractC2792r7.A00(view, rect, rect2, rect3);
    }
    ...
    public final boolean equals(Object other) {
        ...
        if (other != null) {
            ...
            return C2772qY.A0C(cls, getClass()) && (view = this.A00.get()) != null && view == ((ViewpointViewNode) other).A00.get();
        }
        return false;
    }
