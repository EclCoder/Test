...
public class C1230Ef {
    ...
    public C1230Ef(Spatializer spatializer) {
        this.A02 = spatializer;
        this.A03 = spatializer.getImmersiveAudioLevel() != 0;
    }

    public static C1230Ef A00(Context context) {
        AudioManager audioManager = (AudioManager) context.getSystemService(A01(0, 5, 33));
        if (audioManager == null) {
            return null;
        }
        return new C1230Ef(audioManager.getSpatializer());
    }

    public final void A03(C11159h c11159h, Looper looper) {
        if (this.A00 != null || this.A01 != null) {
            return;
        }
        this.A00 = new C1229Ee(this, c11159h);
    ...
    public final boolean A07(C2764qQ c2764qQ, C2758qI c2758qI) {
        int i10;
        if (A01(5, 14, 28).equals(c2758qI.A0W) && c2758qI.A06 == 16) {
            i10 = 12;
        } else {
            i10 = c2758qI.A06;
        }
        AudioFormat.Builder encoding = new AudioFormat.Builder().setEncoding(2);
        int linearChannelCount = C5C.A01(i10);
        AudioFormat.Builder channelMask = encoding.setChannelMask(linearChannelCount);
        if (c2758qI.A0G != -1) {
            int linearChannelCount2 = c2758qI.A0G;
            channelMask.setSampleRate(linearChannelCount2);
        }
        Spatializer spatializer = this.A02;
        AudioAttributes audioAttributes = c2764qQ.A01().A00;
