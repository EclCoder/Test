...
public final class X6 {
    ...
    private int A00(C2198gi c2198gi) {
        PackageInfo packageInfo;
        try {
            PackageManager packageManager = c2198gi.getPackageManager();
    ...
    public static Intent A02(C2198gi c2198gi, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.addCategory(A07(Sdk$SDKError.b.PLACEMENT_SLEEP_VALUE, 33, 20));
        intentA01.addFlags(268435456);
        intentA01.putExtra(A07(288, 34, 93), c2198gi.getPackageName());
        intentA01.putExtra(A07(494, 14, 41), false);
        if (C1648Up.A24(c2198gi)) {
    ...
    public static Intent A03(C2198gi c2198gi, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.setPackage(A07(Sdk$SDKError.b.MRAID_UNRECOGNIZED_COMMAND_VALUE, 19, 35));
        intentA01.putExtra(A07(259, 8, 30), c2198gi.getPackageName());
        intentA01.putExtra(A07(694, 7, 6), true);
        return intentA01;
    }

    public static Uri A04(C2198gi c2198gi, Uri uri) {
        boolean zEquals = A07(688, 6, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE).equals(uri.getScheme());
        String strA07 = A07(587, 26, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE);
        if (zEquals) {
    ...
    private final EnumC1447Mq A05(C2198gi c2198gi, Uri uri, String str, Map<String, String> map) throws C1700Ws {
        boolean zA05 = AbstractC1649Uq.A05(c2198gi);
        boolean isInAppBrowserEnabled = A0F(uri);
        if (isInAppBrowserEnabled && zA05) {
            A0C(c2198gi, uri, str, map);
            EnumC1447Mq enumC1447Mq = EnumC1447Mq.A08;
            if (A01[7].length() == 30) {
        ...
        c2198gi.A0F().A9x(zA05);
        A0A(c2198gi, uri);
        return EnumC1447Mq.A07;
    }

    public static EnumC1447Mq A06(X6 x10, C2198gi c2198gi, Uri uri, String str, Map<String, String> extraData) throws C1700Ws {
        boolean z10 = A0F(uri) && A07(701, 15, 8).equals(uri.getHost());
        boolean isGooglePlayWebLink = A07(688, 6, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE).equals(uri.getScheme());
        if (!isGooglePlayWebLink && !z10) {
            return x10.A05(c2198gi, uri, str, extraData);
        }
        try {
            x10.A0B(c2198gi, uri, str);
            return EnumC1447Mq.A03;
        } catch (X4 unused) {
            return x10.A05(c2198gi, uri, str, extraData);
        }
    }
    ...
    private void A0A(C2198gi c2198gi, Uri uri) throws C1700Ws {
        C1702Wu.A0D(c2198gi, A02(c2198gi, uri));
    }

    private final void A0B(C2198gi c2198gi, Uri uri, String str) throws C1700Ws, X4 {
        if (A0H(c2198gi)) {
            if (C1648Up.A1I(c2198gi)) {
                ...
                if (!TextUtils.isEmpty(queryParameter)) {
                    ...
                    AbstractC1482Oa.A03(queryParameter, strA07, packageName);
                }
            }
            boolean z10 = (c2198gi.A0H().A01() && C1648Up.A1g(c2198gi)) || (C1648Up.A25(c2198gi) && A0I(c2198gi));
            if (!z10) {
                boolean shouldTryToOpenSplitScreen = C1648Up.A2S(c2198gi);
                if (shouldTryToOpenSplitScreen) {
                    boolean shouldTryToOpenSplitScreen2 = C1702Wu.A0E(c2198gi, A03(c2198gi, uri));
                    if (shouldTryToOpenSplitScreen2) {
                        return;
                    }
                }
            }
            boolean zA0M = A0M(c2198gi, uri, str);
            if (A01[3].charAt(29) != 'Z') {
            ...
            boolean shouldTryToOpenSplitScreen3 = A0K(c2198gi, uri);
            if (shouldTryToOpenSplitScreen3) {
                return;
            }
            Intent intentA02 = A02(c2198gi, uri);
            intentA02.setPackage(A07(Sdk$SDKError.b.MRAID_UNRECOGNIZED_COMMAND_VALUE, 19, 35));
            if (Build.VERSION.SDK_INT >= 24 && z10) {
                intentA02.addFlags(268472320);
            }
            C1702Wu.A0D(c2198gi, intentA02);
            return;
        }
        throw new X4();
    }

    private void A0C(C2198gi c2198gi, Uri uri, String str, Map<String, String> map) {
        AdActivityIntent adActivityIntentA05 = C1702Wu.A05(c2198gi);
        ...
        if (map != null) {
            ...
            String strA011 = A07(726, 8, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL);
        ...
        try {
            C1702Wu.A0B(c2198gi, adActivityIntentA05);
        } catch (C1700Ws e10) {
            ...
            c2198gi.A08().ABC(A07(168, 11, 110), AbstractC1610Td.A0D, new C1611Te(cause2));
            Log.e(A07(149, 17, 28), A07(50, 90, 84), cause2);
        }
    }

    public static void A0D(X6 x10, C2198gi c2198gi, Uri uri, String str) {
        x10.A0N(c2198gi, uri, str);
    }

    public static void A0E(X6 x10, C2198gi c2198gi, Uri uri, String str) throws C1700Ws {
        A06(x10, c2198gi, uri, str, null);
    }
    ...
    private boolean A0G(C2198gi c2198gi) {
        if (!C1648Up.A1F(c2198gi)) {
            return false;
        }
        int deviceFBVersion = C1648Up.A0E(c2198gi);
        int iA00 = A00(c2198gi);
    ...
    private boolean A0H(C2198gi c2198gi) {
        Intent playStoreIntent = new Intent(A07(186, 26, 10), XB.A00(A07(548, 34, 3)));
        Iterator<ResolveInfo> it = c2198gi.getPackageManager().queryIntentActivities(playStoreIntent, 0).iterator();
        do {
        ...
        } while (!it.next().activityInfo.applicationInfo.packageName.equals(A07(Sdk$SDKError.b.MRAID_UNRECOGNIZED_COMMAND_VALUE, 19, 35)));
        return true;
    }
    ...
    public static boolean A0I(C2198gi c2198gi) {
        String strA07;
        String strA08;
        int identifier;
        boolean z10 = Build.VERSION.SDK_INT >= 24;
        boolean zA0J = A0J(c2198gi);
        String[] strArr = A01;
        if (strArr[5].charAt(7) != strArr[0].charAt(7)) {
            throw new RuntimeException();
        }
        ...
        if (onAndAboveNOS) {
            ...
            if (strArr3[5].charAt(7) != strArr3[0].charAt(7)) {
                ...
                if (identifier != 0) {
                    z12 = Resources.getSystem().getBoolean(identifier);
                }
            } else {
                String[] strArr4 = A01;
                strArr4[2] = "";
            ...
            appResizingSupported = XK.A0C(c2198gi);
            z11 &= z12 && supportsSplitScreenMultiWindow && appResizingSupported;
        }
        c2198gi.A0F().AC6(zA0J, z11, z12, supportsSplitScreenMultiWindow, appResizingSupported);
        return z11;
    }

    public static boolean A0J(C2198gi c2198gi) {
        ActivityInfo activityInfo;
        try {
            Activity activityA0E = c2198gi.A0E();
            PackageManager packageManager = c2198gi.getPackageManager();
            ...
            c2198gi.A0F().AC5(e10.getMessage());
        }
        return false;
    }

    public static boolean A0K(C2198gi c2198gi, Uri uri) {
        String strA07 = A07(Sdk$SDKError.b.MRAID_UNRECOGNIZED_COMMAND_VALUE, 19, 35);
        if (!C1648Up.A1H(c2198gi)) {
            return false;
        }
        ...
        try {
            ...
            if (packageInfo != null && !TextUtils.isEmpty(packageInfo.versionName)) {
                ...
                if (Integer.parseInt(strArrSplit[0]) < C1648Up.A0G(c2198gi)) {
                    c2198gi.A0F().ABH(3);
                    return false;
                }
            }
            Intent intent = new Intent(A07(186, 26, 10));
            String packageName = c2198gi.getPackageName();
            intent.setPackage(strA07);
            Uri hsdpUri = A04(c2198gi, uri);
            if (hsdpUri == null) {
                return false;
            }
    ...
    private boolean A0L(C2198gi c2198gi, Uri uri, String str) throws C1700Ws {
        try {
            Activity activityA0E = c2198gi.A0E();
            String string = uri.toString();
            if (activityA0E != null && !TextUtils.isEmpty(string)) {
                Intent fbIntent = new Intent();
                if (C1648Up.A1G(c2198gi)) {
                    String strA06 = AbstractC2363jd.A06(str);
                ...
                if (!C1702Wu.A0E(c2198gi, fbIntent)) {
            ...
            c2198gi.A0F().ABG(e10.getMessage());
            return false;
        }
    }

    private boolean A0M(C2198gi c2198gi, Uri uri, String str) throws C1700Ws {
        return A0G(c2198gi) && A0L(c2198gi, uri, str);
    }

    private final boolean A0N(C2198gi c2198gi, Uri uri, String str) {
        return C1702Wu.A0G(c2198gi, uri, str);
    }

    public static boolean A0O(X6 x10, C2198gi c2198gi, Uri uri, String str) {
        try {
            A0E(x10, c2198gi, uri, str);
            return true;
        } catch (C1700Ws e10) {
            Throwable cause = e10.getCause();
            C1700Ws cause2 = e10;
            ...
            c2198gi.A08().ABC(A07(168, 11, 110), AbstractC1610Td.A05, new C1611Te(cause2));
            return false;
        }
    }
}
