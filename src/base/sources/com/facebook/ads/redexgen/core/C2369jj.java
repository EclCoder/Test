...
public final class C2369jj extends N3 {
    ...
    public NE A03;
    public NF A04;
    public EnumC1663Ve A05;
    public String A06;
    public WeakReference<C2245hT> A07;
    ...
    public C2369jj(C2198gi c2198gi, N4 n10, C2143fp c2143fp, C2380ju c2380ju) {
    ...
    private JSONObject A04(View view) throws JSONException {
        ...
        boolean z10 = false;
        jSONObject.putOpt(A01(129, 6, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE), String.format(Locale.US, A01(Sdk$SDKError.b.AD_IS_PLAYING_VALUE, 12, 61), Integer.valueOf(view.getTop()), Integer.valueOf(view.getLeft())));
    ...
    private void A07(Map<String, String> map) {
        if (this.A02 != null && (this.A02.getNativeAdLayoutApi() instanceof C2227hB)) {
            C2227hB c2227hB = (C2227hB) this.A02.getNativeAdLayoutApi();
            if (c2227hB.A07()) {
                map.put(A01(87, 7, 108), Boolean.TRUE.toString());
            }
            boolean zA06 = c2227hB.A06();
            if (A0H[2].charAt(5) == '8') {
                throw new RuntimeException();
            }
            String[] strArr = A0H;
    ...
    public final void A08(Map<String, String> map) {
        ...
        if (this.A05 != null) {
            map.put(A01(Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE, 3, 69), String.valueOf(this.A05.A05()));
        }
        if (this.A09) {
            map.put(A01(Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE, 3, 87), Boolean.TRUE.toString());
        }
        if (this.A0D) {
            map.put(A01(Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE, 3, 99), Boolean.TRUE.toString());
        }
        if (this.A0A) {
            map.put(A01(Sdk$SDKError.b.TPAT_ERROR_VALUE, 5, 83), Boolean.TRUE.toString());
        }
        ...
        if (this.A0C) {
            map.put(A01(Sdk$SDKError.b.INVALID_INDEX_URL_VALUE, 3, 87), Boolean.TRUE.toString());
        }
        if (this.A03 != null) {
        ...
        if (this.A01 != null) {
            ...
            map.put(A01(94, 4, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE), String.valueOf((int) (this.A01.getHeight() / XX.A02)));
        }
        if (this.A04 != null) {
        ...
        if (this.A0E) {
            map.put(A01(107, 5, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE), Boolean.TRUE.toString());
        }
        A07(map);
        A06(map);
        this.A0F.A0O(map);
    ...
    public final void A0C(NE ne2) {
        this.A03 = ne2;
    }

    public final void A0D(NF nf2) {
        this.A04 = nf2;
    }

    public final void A0E(EnumC1663Ve enumC1663Ve) {
        this.A05 = enumC1663Ve;
    }
    ...
    public final void A0G(WeakReference<C2245hT> weakReference) {
