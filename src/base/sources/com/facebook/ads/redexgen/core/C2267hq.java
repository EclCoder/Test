...
public class C2267hq extends RF {
    ...
    public C2267hq(Context context) {
    ...
    public void A0I(View view, RH rh2, RD rd2) {
        ...
        if (time > 0) {
            int distance = -iA0O;
            int dy2 = -iA03;
            rd2.A04(distance, dy2, time, this.A04);
        }
    }
    ...
    public final int A0N(int i10, int i11, int i12, int i13, int i14) {
        switch (i14) {
            ...
            case 1:
                return i13 - i11;
            default:
                throw new IllegalArgumentException(A04(Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE, 93, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE));
        }
    }
