...
public final class C2245hT extends C1568Rm implements AdOptionsViewApi, InterfaceC1804aK {
    ...
    public C2245hT(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i10, AdOptionsView adOptionsView) {
        this.A05 = false;
        this.A04 = false;
        this.A03 = false;
        ...
        this.A0A.A1e(this);
        C2380ju c2380juA12 = this.A0A.A12();
        if (c2380juA12 != null && c2380juA12.A0R() && !c2380juA12.A0P()) {
            this.A07.setVisibility(8);
            return;
        }
        EnumC1708Xc.A04(this.A08, EnumC1708Xc.A0C);
        if (A0C()) {
            A05();
            return;
        }
    ...
    public C2245hT(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
        this(context, nativeAdBase, nativeAdLayout, AdOptionsView.Orientation.HORIZONTAL, 23, adOptionsView);
    }

    private ImageView A00(YM ym2) {
    ...
    public static YM A01(AbstractC2363jd abstractC2363jd) {
        if (AbstractC1805aL.A00(abstractC2363jd) == EnumC1809aP.A02) {
            return YM.AD_CHOICE_COLLAPSED_PILL;
        }
        return YM.CREDIT_LINE_COLLAPSED_PILL;
    }

    public static YM A02(AbstractC2363jd abstractC2363jd) {
        if (AbstractC1805aL.A00(abstractC2363jd) == EnumC1809aP.A02) {
    ...
    private void A05() {
        C1807aN c1807aNA02 = AbstractC1808aO.A02(this.A0A.A15(), EnumC1806aM.A05, this.A0A.A13());
        c1807aNA02.setBackgroundColor(-2145637581);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, -2);
        this.A07.addView(c1807aNA02, layoutParams);
    }
    ...
    private void A06() {
        ...
        if (this.A00 != null && this.A09 != null && this.A0A.A13() != null) {
            this.A02 = AbstractC1808aO.A03(this.A0A.A15(), EnumC1806aM.A05, this.A0A.A13(), this.A00, A02(this.A0A.A13()), this.A09, this);
            if (this.A0A.A13().A2Q()) {
                this.A02.A0A();
            }
        }
    ...
    public final void A0E(YM ym2) {
        if (this.A01 != null) {
            this.A01.setImageBitmap(YN.A01(ym2));
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1804aK
