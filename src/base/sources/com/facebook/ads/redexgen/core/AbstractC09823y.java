...
public abstract class AbstractC09823y {
    ...
    public static int A00(int i10, int i11, int i12) {
        if (i10 < i11 || i10 >= i12) {
            throw new IndexOutOfBoundsException(String.format(A04(0, 31, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE), Integer.valueOf(i10), Integer.valueOf(i11), Integer.valueOf(i12)));
        }
        return i10;
    }
