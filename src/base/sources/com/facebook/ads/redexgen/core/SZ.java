    ...
    */
    public static com.facebook.ads.redexgen.core.SX A01(com.facebook.ads.redexgen.core.T8 r5, com.facebook.ads.redexgen.core.SX r6) {
        /*
            ...
            if (r0 == 0) goto L29
        Lc:
            com.facebook.ads.redexgen.X.SX r0 = com.facebook.ads.redexgen.core.AbstractC1586Sf.A00(r5)     // Catch: java.lang.Throwable -> L11
            return r0
        L11:
            r0 = move-exception
            com.facebook.ads.redexgen.X.Tc r5 = r5.A08()
            int r4 = com.facebook.ads.redexgen.core.AbstractC1610Td.A1Q
    ...
    public static SX A02(T8 t10, SX sx, SY sy) {
        C1582Sa c1582SaA00 = null;
        try {
            if (AbstractC1647Uo.A06(t10) && (sx == null || TextUtils.isEmpty(sx.A03()))) {
                c1582SaA00 = AbstractC1583Sb.A00(t10.getContentResolver());
            }
        } catch (Throwable th2) {
            t10.A08().ABC(A04(12, 7, 84), AbstractC1610Td.A1S, new C1611Te(th2));
        }
        if (c1582SaA00 != null && c1582SaA00.A01 != null) {
            A03.set(c1582SaA00.A01);
            sy.A05(c1582SaA00.A01);
        }
        if (sx == null && c1582SaA00 != null && !TextUtils.isEmpty(c1582SaA00.A00)) {
            return new SX(c1582SaA00.A00, c1582SaA00.A02, SW.A04);
        }
        return sx;
    }
    ...
    public static void A07(T8 t10) {
        ...
        try {
            ...
            if (jA01 > 0 && System.currentTimeMillis() - jA01 < AbstractC1647Uo.A00(t10)) {
                return;
            }
            if (AbstractC1647Uo.A07(t10)) {
                advertisingIdInfo = A01(t10, A02(t10, null, sy));
            } else {
                advertisingIdInfo = A02(t10, A01(t10, null), sy);
            }
            ...
            t10.A08().ABC(A04(12, 7, 84), AbstractC1610Td.A1R, new C1611Te(t11));
        }
    }
    ...
    public static boolean A08() {
        ...
        boolean updated3 = XD.A05(strA05);
        if (updated3) {
            String strA01 = XD.A01(strA05);
