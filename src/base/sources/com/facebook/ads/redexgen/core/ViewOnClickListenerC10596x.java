...
public final class ViewOnClickListenerC10596x extends PZ implements View.OnClickListener, View.OnTouchListener {
    ...
    public ViewOnClickListenerC10596x(C1560Re c1560Re, C2198gi c2198gi, VA va2, InterfaceC1739Yh interfaceC1739Yh, String str, int i10) {
        super(c1560Re, c2198gi, va2, interfaceC1739Yh, false);
        this.A00 = 0;
        this.A01 = 0;
        this.A03 = false;
        this.A07 = new RunnableC1742Yk(this);
        this.A08 = str;
        this.A05 = new Handler(Looper.getMainLooper());
        this.A06 = (InputMethodManager) c2198gi.getSystemService(A05(Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE, 12, 70));
        this.A04 = i10;
    }

    public static /* synthetic */ int A02(ViewOnClickListenerC10596x viewOnClickListenerC10596x) {
        int i10 = viewOnClickListenerC10596x.A00;
        viewOnClickListenerC10596x.A00 = i10 + 1;
        return i10;
    }
    ...
    private void A07() {
        ...
        if (AdPlacementType.NATIVE.name().equals(this.A08)) {
            super.A08.A0E(A05(80, 32, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE), null);
            ...
            super.A08.A0E(EnumC2091ez.A04.A03(), null);
        }
    }
    ...
    public final InterfaceC1836aq A0F() {
        return new C1511Pd(this);
    }
    ...
    public final void A0G() {
        ...
        super.A07.setOnTouchListener(new View.OnTouchListener() { // from class: com.facebook.ads.redexgen.X.Yj
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return ViewOnClickListenerC10596x.A0B(view, motionEvent);
            }
        });
    ...
    public final void A0H() {
        ...
        translateAnimation.setAnimationListener(new AnimationAnimationListenerC1744Ym(this));
    ...
    @Override // com.facebook.ads.redexgen.core.PZ, com.facebook.ads.redexgen.core.InterfaceC1740Yi
    public final void AAu(Intent intent, Bundle bundle, C1560Re c1560Re) {
        super.AAu(intent, bundle, c1560Re);
    ...
    public final void onAttachedToWindow() {
        ...
        translateAnimation.setFillAfter(true);
        translateAnimation.setAnimationListener(new AnimationAnimationListenerC1743Yl(this));
        startAnimation(translateAnimation);
    }
    ...
    public final boolean onTouch(View view, MotionEvent motionEvent) {
        switch (motionEvent.getActionMasked()) {
            ...
            case 1:
                ...
                A0I(A05(Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE, 30, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE));
                return false;
            default:
                return false;
        }
