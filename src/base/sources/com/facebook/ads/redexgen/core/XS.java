...
public final class XS {
    ...
    public XS(C2198gi c2198gi, AbstractC2363jd abstractC2363jd, XQ xq) {
        this.A03 = c2198gi;
        this.A04 = xq;
        this.A02 = abstractC2363jd;
    }

    public static XS A00(C2198gi c2198gi, AbstractC2363jd abstractC2363jd, XQ xq) {
        Object creativeAsCtaLoggingHelper = c2198gi.A0I();
        if (creativeAsCtaLoggingHelper == null) {
            creativeAsCtaLoggingHelper = new XS(c2198gi, abstractC2363jd, xq);
            c2198gi.A0P(creativeAsCtaLoggingHelper);
        }
        return (XS) creativeAsCtaLoggingHelper;
    }

    public static boolean A01(C2198gi c2198gi) {
        return C1648Up.A1g(c2198gi) && X6.A0I(c2198gi);
    }

    /* JADX WARN: Code duplicated, block: B:19:0x0051  */
    public final XR A02(AbstractC2363jd abstractC2363jd) {
        boolean z10;
        if (C1648Up.A1m(this.A03)) {
            z10 = abstractC2363jd.A1e() && A01(this.A03);
            return new XR(z10, z10);
        }
        boolean zA1e = abstractC2363jd.A1e();
        if (zA1e) {
