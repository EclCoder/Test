...
public final class C1382Kd extends AbstractC1861bF {
    ...
    private void A04() {
        ...
        YB.A0K(this.A05);
        this.A05.setLayoutParams(AbstractC1861bF.A0B);
    ...
    static {
        ...
        A0R = (int) (C1500Os.A08 * 21.0f);
        A0S = (int) (C1500Os.A08 * 12.0f);
        A0T = (int) (C1500Os.A08 * 10.0f);
    }

    public C1382Kd(C2198gi c2198gi, ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr, int i10, boolean z10, C1456Na c1456Na, boolean z11, String str, VA va2, InterfaceC1739Yh interfaceC1739Yh, C2143fp c2143fp, Y2 y10, C1462Ng c1462Ng, boolean z12, String str2, boolean z13) {
        super(c2198gi, viewOnClickListenerC1396Kr, i10, c1456Na, z11, str, va2, interfaceC1739Yh, c2143fp, y10, c1462Ng, z12, str2);
        this.A0C = false;
        this.A00 = 0;
        this.A01 = 0;
        this.A0A = true;
        ...
        this.A09 = new C1894bm(this.A0H, A0V, 5, A0U, -1);
        ...
        this.A07 = c1456Na;
        this.A0I = C1648Up.A17(c2198gi);
        YB.A0U(this, c2198gi);
        this.A0B = C1648Up.A2c(this.A0H);
        A0A();
        if (z13) {
    ...
    public C1382Kd(C2198gi c2198gi, ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr, int i10, boolean z10, C1456Na c1456Na, boolean z11, String str, VA va2, InterfaceC1739Yh interfaceC1739Yh, C2143fp c2143fp, Y2 y10, AbstractC2363jd abstractC2363jd) {
        this(c2198gi, viewOnClickListenerC1396Kr, i10, z10, c1456Na, false, str, va2, interfaceC1739Yh, c2143fp, y10, abstractC2363jd.A2A(), abstractC2363jd.A1k(), abstractC2363jd.A13(), abstractC2363jd.A1t());
    }
    ...
    private final void A0C() {
        super.A06.setLayoutParams(AbstractC1861bF.A0B);
        A04();
        A03();
        if (!super.A03) {
            A02();
        ...
        YB.A0J(super.A06);
        if (!super.A03) {
            ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr = super.A08;
            if (A0K[5].length() == 26) {
                throw new RuntimeException();
            }
            A0K[5] = "AjTT";
        ...
        addView(super.A06);
        if (!super.A03) {
            ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr2 = super.A08;
            if (A0K[4].length() != 24) {
                addView(viewOnClickListenerC1396Kr2);
            } else {
