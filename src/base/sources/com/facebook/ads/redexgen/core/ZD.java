...
public final class ZD implements UR {
    ...
    public final InterfaceC1635Uc<V7> A01;
    public final InterfaceC1635Uc<V7> A02;
    ...
    public final int A0B(int i10, Set<String> set, Set<String> set2) {
        String strA00 = A00(412, 7, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL);
        int i11 = 0;
        int[] iArr = new int[30];
        ...
        try {
            ...
            while (((InterfaceC1634Ub) linkedList.getLast()).ACO()) {
                Arrays.fill(iArr, 0);
                linkedList.add(this.A02.A6W(bArr, iArr));
            ...
            while (it.hasNext()) {
                ...
                try {
                    String string = next.getString(A00(423, 2, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE));
                    try {
                        if (set.contains(string)) {
                            ...
                            if (i12 < i10) {
                                try {
                                    ...
                                    A05(AbstractC1610Td.A2L, e);
                                    return i11;
                                } catch (JSONException e11) {
                                    e = e11;
                                    try {
                                        if (this.A00.A05().AAO()) {
                                            Log.e(A05, A00(198, 47, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE), e);
                                        }
                                        A05(AbstractC1610Td.A2P, e);
                                    } catch (C1644Ul e12) {
                                        e = e12;
                                        if (this.A00.A05().AAO()) {
                                            Log.e(A05, A00(130, 68, 89), e);
                            ...
                            try {
                                if (set2.contains(string)) {
                                    if (this.A00.A05().AAO()) {
                                        String str = A00(39, 16, 55) + string + A00(0, 11, 44) + next.optString(A00(471, 4, 24), A00(475, 7, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE));
                                    }
                                    it.remove();
                                }
    ...
    public ZD(C2194ge c2194ge) throws IOException {
        this.A00 = c2194ge;
        this.A01 = new Y3(UZ.A00(A00(11, 28, 27), c2194ge), new ZF(this));
        this.A02 = new Y3(UZ.A00(A00(Sdk$SDKError.b.MRAID_UNRECOGNIZED_COMMAND_VALUE, 37, 96), c2194ge), new ZE(this));
    }
    ...
    public void A04(int i10, String str) {
        ...
        c1611Te.A05(1);
        this.A00.A08().ABD(A00(425, 15, 3), i10, c1611Te);
    }

    private void A05(int i10, Throwable th2) {
        this.A00.A08().ABC(A00(425, 15, 3), i10, new C1611Te(th2));
    }

    public static byte[] A07(T8 t10, String str, V7 v10) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(A00(423, 2, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE), str);
            ...
            jSONObject.put(A00(450, 12, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE), Y1.A03(v10.A03()));
            jSONObject.put(A00(440, 10, 20), v10.A07());
            jSONObject.put(A00(419, 4, 55), new JSONObject(v10.A09()));
            jSONObject.put(A00(412, 7, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL), 0);
    ...
    public final List<JSONObject> A0C(int i10) {
        ...
        try {
            InterfaceC1634Ub interfaceC1634UbA6W = this.A01.A6W(bArr, eventSizes);
            linkedList2.add(interfaceC1634UbA6W);
            int iA6X = interfaceC1634UbA6W.A6X();
            ...
            while (noLimit && (iA6X < i10 || totalFetched != 0)) {
                ...
                interfaceC1634UbA6W = this.A01.A6W(bArr, eventSizes);
                linkedList2.add(interfaceC1634UbA6W);
                linkedList = A01(linkedList, bArr, eventSizes);
            }
            ...
            while (noLimit) {
                ((InterfaceC1634Ub) it2.next()).A5p();
            }
        } catch (C1644Ul e10) {
            boolean noLimit = this.A00.A05().AAO();
            if (noLimit) {
                Log.e(A05, A00(359, 53, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE), e10);
            }
            A05(AbstractC1610Td.A2M, e10);
        }
        return linkedList;
    }
