...
public final class SA implements NativeBannerAdApi {
    ...
    public SA(NativeAdBaseApi nativeAdBaseApi) {
        ...
        this.A00.A1i(EnumC1673Vq.A05);
    }

    private void A02(ImageView imageView, NativeAdBaseApi nativeAdBaseApi) {
        UK ukA0L = UK.A0L(nativeAdBaseApi);
        C2220h4 c2220h4 = new C2220h4(this, imageView, ukA0L);
        C1660Vb c1660VbA19 = ukA0L.getAdIcon();
        if (c1660VbA19 != null) {
            Bitmap bitmapA0N = ukA0L.A14().A0N(c1660VbA19.getUrl());
            Context context = imageView.getContext();
            String[] strArr = A02;
            if (strArr[2].charAt(21) == strArr[6].charAt(21)) {
                A02[4] = "oesEo3u5gOmbsNZfXjsimFyw8pPXYbZZ";
                C2198gi c2198giA03 = C1571Rp.A03(context);
                if (bitmapA0N != null) {
                    Drawable drawableA05 = UK.A05(c2198giA03, bitmapA0N, ukA0L.A1t(), ukA0L.A1I());
                    UK.A0f(drawableA05, imageView);
                    imageView.post(new C2219h3(this, ukA0L, drawableA05));
                    return;
                } else {
                    C2220h4 c2220h5 = null;
                    S7 loadImageTask = new S7(c2198giA03, c2220h4, ukA0L.A1t(), c2220h5);
                    loadImageTask.execute(new S9(c1660VbA19.getUrl(), ukA0L.A1I(), c2220h5));
                    return;
                }
            }
        } else {
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, List<View> clickableViews) {
        if (mediaView != null) {
            ((C2228hC) mediaView.getMediaViewApi()).A0X(this.A00, true);
        }
