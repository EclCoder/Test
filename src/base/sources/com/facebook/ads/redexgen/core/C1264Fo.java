...
public final class C1264Fo {
    ...
    public Handler A04;
    public Pair<Long, C2758qI> A05;
    public Pair<Surface, C10094z> A06;
    ...
    public final ArrayDeque<Pair<Long, C2758qI>> A0E = new ArrayDeque<>();
    public int A00 = -1;
    public boolean A09 = true;
    public long A02 = C.TIME_UNSET;
    public C2711pW A07 = C2711pW.A06;
    ...
    public C1264Fo(G7 g10, AnonymousClass10 anonymousClass10, boolean z10) {
        this.A0D = g10;
    ...
    public static boolean A04(long j10) {
        if (MetaExoPlayerUpgradeConfig.A03(EnumC2358jX.A1w)) {
            return j10 > 50000;
        }
        int releaseLowerThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC2359jY.A08);
        int releaseUpperThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC2359jY.A07);
    ...
    public final MediaFormat A06(MediaFormat mediaFormat) {
        if (C5C.A02 >= 29 && this.A0C.A0q.getApplicationContext().getApplicationInfo().targetSdkVersion >= 29) {
            mediaFormat.setInteger(A01(0, 16, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE), 0);
        }
        return mediaFormat;
    }

    public final Surface A07() {
        AbstractC09823y.A01(null);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x010e, code lost:
        ...
        r30.A0C.A0S(r24, r2, (com.facebook.ads.redexgen.core.C2758qI) r30.A05.second, null);
     */
    ...
    */
    public final void A0B(long r31, long r33) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1264Fo.A0B(long, long):void");
    }

    public final void A0C(Surface surface, C10094z c10094z) {
        if (this.A06 != null && ((Surface) this.A06.first).equals(surface) && ((C10094z) this.A06.second).equals(c10094z)) {
            return;
        }
        this.A06 = Pair.create(surface, c10094z);
        if (A0G()) {
            AbstractC09823y.A01(null);
            new AnonymousClass50(surface, c10094z.A03(), c10094z.A02());
            throw new NullPointerException(A01(108, 20, 7));
        }
    }

    /* JADX WARN: Type inference failed for: r1v0, types: [com.facebook.ads.redexgen.X.4I] */
    public final void A0D(C2758qI c2758qI) {
        AbstractC09823y.A01(null);
        final int i10 = c2758qI.A0L;
        final int i11 = c2758qI.A0A;
        new Object(i10, i11) { // from class: com.facebook.ads.redexgen.X.4I
            ...
            public final C4I A00(float f10) {
                this.A00 = f10;
                return this;
            }
            ...
            public final C4J A01() {
                return new Object(this.A02, this.A01, this.A00, this.A03) { // from class: com.facebook.ads.redexgen.X.4J
                    ...
                    {
                        AbstractC09823y.A09(i > 0, A00(33, 32, 18) + i);
                        AbstractC09823y.A09(i > 0, A00(0, 33, 109) + i);
                        this.A02 = i;
                        this.A01 = i;
                        this.A00 = f;
                        this.A03 = j;
    ...
    public final boolean A0H() {
        return this.A06 == null || !((C10094z) this.A06.second).equals(C10094z.A03);
    }
    ...
    public final boolean A0J(C2758qI c2758qI, long j10) throws AD {
        AbstractC09823y.A08(!A0G());
        if (!this.A09) {
            return false;
        }
        if (this.A08 == null) {
        ...
        this.A04 = C5C.A0Y();
        this.A0C.A26(c2758qI.A0N);
        try {
            if (!AnonymousClass10.A0h() && c2758qI.A0F != 0) {
                CopyOnWriteArrayList<C4H> copyOnWriteArrayList = this.A08;
                C1263Fn.A00(c2758qI.A0F);
            ...
            throw this.A0C.A1S(e10, c2758qI, 7000);
        }
    }

    public final boolean A0K(C2758qI c2758qI, long j10, boolean z10) {
        AbstractC09823y.A02(null);
