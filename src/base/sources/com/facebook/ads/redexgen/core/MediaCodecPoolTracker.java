...
public abstract class MediaCodecPoolTracker {
    ...
    public abstract void A06(C2349jJ c2349jJ, int i10);

    public abstract void A07(EnumC2351jL enumC2351jL, int i10);

    public abstract void A08(EnumC2351jL enumC2351jL, int i10);

    public abstract void A09(EnumC2351jL enumC2351jL, int i10);

    public abstract void A0A(boolean z10, String str, EnumC2351jL enumC2351jL, int i10);

    private final long A02() {
        return CF.A00().ACf();
    }

    public final C2349jJ A05(boolean z10, String str, EnumC2351jL enumC2351jL) {
        C2772qY.A09(str, A03(0, 9, 21));
        C2772qY.A09(enumC2351jL, A03(9, 6, 108));
        return new C2349jJ(A02(), z10, str, enumC2351jL);
    }
}
