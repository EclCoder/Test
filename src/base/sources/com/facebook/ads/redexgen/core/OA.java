...
public abstract class OA {
    ...
    public static AdSettings.IntegrationErrorMode A00(C2198gi c2198gi) {
        ...
        if (integrationErrorMode == integrationErrorMode2 && !A03(c2198gi)) {
    ...
    public static boolean A03(C2198gi c2198gi) {
        return (c2198gi.getApplicationInfo().flags & 2) != 0;
    }
}
