...
public abstract class NI {
     ...
     */
    public static C2368ji A01(@Nullable C2198gi c2198gi, JSONObject jSONObject, String str, boolean z10, int i10, int i11) {
        boolean zOptBoolean;
        int iOptInt;
        ...
        XI.A04(c2198gi, A02(0, 23, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE));
        String strOptString = jSONObject.optString(A02(479, 10, 1));
        int iOptInt4 = jSONObject.optInt(A02(Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE, 12, 106), 0);
        String strOptString2 = jSONObject.optString(A02(253, 13, 18));
        String strA02 = AbstractC1709Xd.A02(jSONObject, A02(266, 12, 52));
        Uri uriA00 = TextUtils.isEmpty(strA02) ? null : XB.A00(strA02);
        String strA03 = AbstractC1709Xd.A02(jSONObject, A02(128, 4, 54));
        String strA01 = AbstractC1727Xv.A01(strA03);
        String strA04 = AbstractC1709Xd.A02(jSONObject, A02(101, 15, 34));
        String strA05 = AbstractC1709Xd.A02(jSONObject, A02(593, 5, 82));
        String strA06 = AbstractC1709Xd.A02(jSONObject, A02(585, 8, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE));
        String strA07 = AbstractC1709Xd.A02(jSONObject, A02(386, 8, 111));
        String strA08 = AbstractC1709Xd.A02(jSONObject, A02(539, 14, 32));
        String strA09 = AbstractC1709Xd.A02(jSONObject, A02(403, 16, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE));
        String strA010 = AbstractC1709Xd.A02(jSONObject, A02(553, 21, 41));
        String strA011 = AbstractC1709Xd.A02(jSONObject, A02(87, 14, 99));
        String strA012 = AbstractC1709Xd.A02(jSONObject, A02(459, 20, 94));
        String strA013 = AbstractC1709Xd.A02(jSONObject, A02(443, 16, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE));
        String strA014 = AbstractC1709Xd.A02(jSONObject, A02(426, 17, 38));
        String strA015 = AbstractC1709Xd.A02(jSONObject, A02(Sdk$SDKError.b.OMSDK_DOWNLOAD_JS_ERROR_VALUE, 14, 16));
        C10747m c10747mA00 = C10747m.A00(jSONObject, c2198gi);
        C1660Vb c1660VbA00 = C1660Vb.A00(jSONObject.optJSONObject(A02(394, 4, 38)));
        C1660Vb c1660VbA01 = C1660Vb.A00(jSONObject.optJSONObject(A02(398, 5, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE)));
        C1661Vc c1661VcA00 = C1661Vc.A00(jSONObject.optJSONObject(A02(574, 11, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE)));
        String strA016 = AbstractC1709Xd.A02(jSONObject, A02(598, 15, 10));
        boolean zOptBoolean4 = jSONObject.optBoolean(A02(238, 15, 64));
        boolean zOptBoolean5 = jSONObject.optBoolean(A02(Sdk$SDKError.b.MRAID_JS_COPY_FAILED_VALUE, 19, 54));
        ...
        C1660Vb c1660VbA02 = jSONObjectOptJSONObject != null ? C1660Vb.A00(jSONObjectOptJSONObject) : null;
        String strA017 = AbstractC1709Xd.A02(jSONObject, A02(68, 19, 95));
        EnumC1452Mv enumC1452MvA00 = AbstractC1454Mx.A00(jSONObject);
        Collection<String> collectionA03 = AbstractC1454Mx.A03(c2198gi, jSONObject);
        String strA018 = AbstractC1709Xd.A02(jSONObject, A02(686, 9, 20));
        ...
        String strA020 = AbstractC1709Xd.A02(jSONObject, A02(653, 9, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL));
        String strA021 = A02(613, 22, 83);
        EnumC1664Vf enumC1664Vf = jSONObject.has(strA021) ? jSONObject.optBoolean(strA021) ? EnumC1664Vf.A05 : EnumC1664Vf.A04 : EnumC1664Vf.A03;
        String strA022 = A02(190, 29, 111);
        if (A01[2].charAt(6) != 'o') {
            ...
            zOptBoolean3 = jSONObject.optBoolean(A02(353, 33, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE), false);
            iOptInt3 = jSONObject.optInt(A02(Sdk$SDKError.b.MRAID_UNRECOGNIZED_COMMAND_VALUE, 31, 12), 1);
            arrayList = null;
        } else {
            zOptBoolean = jSONObject.optBoolean(strA022);
            iOptInt = jSONObject.optInt(A02(154, 36, 107), 100);
        ...
        try {
            ...
            if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() > 0) {
                ...
                for (int i12 = 0; i12 < length; i12++) {
                    try {
                        arrayList2.add(A01(c2198gi, jSONArrayOptJSONArray.getJSONObject(i12), str, true, i12, length));
                    } catch (JSONException e10) {
                        e = e10;
                        arrayList = arrayList2;
                        c2198gi.A08().ABC(A02(419, 7, 72), AbstractC1610Td.A2A, new C1611Te(e));
                        Log.e(C2380ju.A0E, A02(23, 30, 97), e);
                        return new C2368ji(strA017, strA01, strA03, strA04, strA05, strA06, strA07, strA08, strA09, strA010, strA011, strA012, strA013, strA014, strA015, c1660VbA02, c10747mA00, c1660VbA00, c1660VbA01, c1661VcA00, strA018, strA020, jOptLong, enumC1664Vf, z10, i10, i11, arrayList, str, strOptString, iOptInt4, strOptString2, uriA00, strA016, zOptBoolean4, zOptBoolean5, iOptInt6, iOptInt5, iOptInt7, iOptInt8, enumC1452MvA00, collectionA03, iOptInt, zOptBoolean, iOptInt9, zOptBoolean2, iOptInt2, zOptBoolean3, iOptInt3);
                    }
                }
                arrayList = arrayList2;
            }
    ...
    public static C2368ji A00(C2198gi c2198gi, JSONObject jSONObject, String str) {
        return A01(c2198gi, jSONObject, str, false, -1, 0);
    }
}
