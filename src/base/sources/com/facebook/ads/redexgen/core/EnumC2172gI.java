...
public abstract class EnumC2172gI {
    ...
    public static final /* synthetic */ EnumC2172gI[] A02;
    public static final EnumC2172gI A03;
    public static final EnumC2172gI A04;
    public static final EnumC2172gI A05;
    public static final EnumC2172gI A06;
    public static final EnumC2172gI A07;
    public static final EnumC2172gI A08;
    ...
    static {
        ...
        final int i10 = 0;
        A03 = new EnumC2172gI(strA02, i10) { // from class: com.facebook.ads.redexgen.X.Ci
            @Override // com.facebook.ads.redexgen.core.EnumC2172gI
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i11) {
                return AbstractC2173gJ.A00(jSONArray.optJSONArray(i11), jSONArray2.optJSONArray(i11));
            }
            ...
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC2173gJ.A00(jSONObject.optJSONArray(str), jSONObject2.optJSONArray(str));
            }
        };
        final String strA03 = A02(5, 7, 74);
        final int i11 = 1;
        A04 = new EnumC2172gI(strA03, i11) { // from class: com.facebook.ads.redexgen.X.Ch
            @Override // com.facebook.ads.redexgen.core.EnumC2172gI
        ...
        final int i12 = 2;
        A05 = new EnumC2172gI(strA04, i12) { // from class: com.facebook.ads.redexgen.X.Cg
        ...
        final int i13 = 3;
        A06 = new EnumC2172gI(strA05, i13) { // from class: com.facebook.ads.redexgen.X.Cf
        ...
        final int i14 = 4;
        A07 = new EnumC2172gI(strA06, i14) { // from class: com.facebook.ads.redexgen.X.Ce
            @Override // com.facebook.ads.redexgen.core.EnumC2172gI
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i15) {
                return AbstractC2173gJ.A02(jSONArray.optJSONObject(i15), jSONArray2.optJSONObject(i15));
            }
            ...
            @Override // com.facebook.ads.redexgen.core.EnumC2172gI
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC2173gJ.A02(jSONObject.optJSONObject(str), jSONObject2.optJSONObject(str));
            }
        };
        final String strA07 = A02(27, 6, 50);
        final int i15 = 5;
        A08 = new EnumC2172gI(strA07, i15) { // from class: com.facebook.ads.redexgen.X.Cd
            @Override // com.facebook.ads.redexgen.core.EnumC2172gI
    ...
    public EnumC2172gI(String str, int i10) {
        super(str, i10);
    }

    public static EnumC2172gI A00(JSONArray jSONArray, int i10) {
        for (EnumC2172gI type : values()) {
    ...
    public static EnumC2172gI A01(JSONObject jSONObject, String str) {
        for (EnumC2172gI type : values()) {
            String[] strArr = A01;
    ...
    public static /* synthetic */ EnumC2172gI[] A04() {
        return new EnumC2172gI[]{A03, A04, A05, A06, A07, A08};
    }

    public static EnumC2172gI valueOf(String str) {
        return (EnumC2172gI) Enum.valueOf(EnumC2172gI.class, str);
    }

    public static EnumC2172gI[] values() {
        return (EnumC2172gI[]) A02.clone();
    }
}
