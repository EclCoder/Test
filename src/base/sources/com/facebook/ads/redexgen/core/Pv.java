...
public class Pv extends ViewGroup {
    ...
    public static final C1526Pu A0w;
    public static final Comparator<C1519Pn> A0x;
    public int A00;
    public PS A01;
    public float A02;
    public float A03;
    ...
    public final C1519Pn A0p;
    public final Runnable A0q;
    public final ArrayList<C1519Pn> A0r;
    ...
    private C1519Pn A03() {
        ...
        float f12 = 0.0f;
        boolean z10 = true;
        C1519Pn c1519Pn = null;
        int i11 = 0;
        while (i11 < this.A0r.size()) {
            C1519Pn c1519Pn2 = this.A0r.get(i11);
            if (!z10 && c1519Pn2.A02 != i10 + 1) {
                c1519Pn2 = this.A0p;
                c1519Pn2.A00 = f11 + f12 + f10;
                c1519Pn2.A02 = i10 + 1;
                c1519Pn2.A01 = this.A01.A00(c1519Pn2.A02);
                i11--;
            }
            f11 = c1519Pn2.A00;
            float f13 = c1519Pn2.A01 + f11;
            String[] strArr = A0t;
    ...
    public final void addTouchables(ArrayList<View> arrayList) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 0 && (c1519PnA07 = A07(childAt)) != null && c1519PnA07.A02 == this.A00) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (childAt.getVisibility() != 8 && (c1520Po2 = (C1520Po) childAt.getLayoutParams()) != null && c1520Po2.A05) {
                int i15 = c1520Po2.A04 & 7;
                int i16 = c1520Po2.A04 & Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE;
                ...
                if (c1520Po2.width != -2) {
                    i17 = 1073741824;
                    i12 = c1520Po2.width != -1 ? c1520Po2.width : paddingLeft;
                } else {
                    i12 = paddingLeft;
                }
                if (c1520Po2.height != -2) {
                    i18 = 1073741824;
                    i13 = c1520Po2.height != -1 ? c1520Po2.height : measuredHeight;
                } else {
                    i13 = measuredHeight;
                }
        ...
        for (int i19 = 0; i19 < childCount2; i19++) {
            ...
            if (childAt2.getVisibility() != 8 && ((c1520Po = (C1520Po) childAt2.getLayoutParams()) == null || !c1520Po.A05)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * c1520Po.A00), 1073741824), this.A0A);
            }
        }
    }
            ...
            switch (motionEvent.getAction() & 255) {
                ...
                case 1:
                    if (this.A0i) {
                        ...
                        C1519Pn c1519PnA03 = A03();
                        A0O(A01(c1519PnA03.A02, ((scrollX / clientWidth) - c1519PnA03.A00) / (c1519PnA03.A01 + (this.A0M / clientWidth)), xVelocity, (int) (motionEvent.getX(motionEvent.findPointerIndex(this.A08)) - this.A03)), true, true, xVelocity);
                        zA0U = A0U();
                    }
                    if (zA0U) {
                        Ph.A07(this);
    ...
    public Pv(Context context) {
        ...
        this.A0g = true;
        this.A0l = false;
        this.A0q = new RunnableC1518Pl(this);
        this.A0P = 0;
        A0D();
    }
    ...
    private int A01(int i10, float f10, int i11, int i12) {
        ...
        if (targetPage2 > 0) {
            C1519Pn lastItem = this.A0r.get(0);
            ArrayList<C1519Pn> arrayList = this.A0r;
            int targetPage3 = this.A0r.size();
            C1519Pn c1519Pn = arrayList.get(targetPage3 - 1);
            int i13 = lastItem.A02;
            int targetPage4 = c1519Pn.A02;
    ...
    private final C1519Pn A04(int i10) {
        for (int i11 = 0; i11 < i; i11++) {
            C1519Pn c1519Pn = this.A0r.get(i11);
            int i12 = c1519Pn.A02;
            if (A0t[6].charAt(18) == '5') {
                throw new RuntimeException();
            }
    ...
    private final C1519Pn A05(int i10, int i11) {
        C1519Pn c1519Pn = new C1519Pn();
        c1519Pn.A02 = i10;
        c1519Pn.A03 = this.A01.A04(this, i10);
        c1519Pn.A01 = this.A01.A00(i10);
        if (i11 < 0 || i11 >= this.A0r.size()) {
            this.A0r.add(c1519Pn);
        } else {
            this.A0r.add(i11, c1519Pn);
        }
        return c1519Pn;
    }

    private final C1519Pn A06(View view) {
        while (true) {
    ...
    private final C1519Pn A07(View view) {
        for (int i10 = 0; i10 < i; i10++) {
            C1519Pn c1519Pn = this.A0r.get(i10);
            if (this.A01.A08(view, c1519Pn.A03)) {
                return c1519Pn;
            }
        }
        return null;
    ...
    private void A0A() {
        int i10 = 0;
        while (i10 < i) {
            if (!((C1520Po) getChildAt(i10).getLayoutParams()).A05) {
                removeViewAt(i10);
                i10--;
            }
            i10++;
    ...
    private final void A0D() {
        ...
        Ph.A0B(this, new C2277i1(this));
        if (Ph.A00(this) == 0) {
            Ph.A09(this, 1);
        }
        Ph.A0C(this, new C2278i2(this));
    }

    private void A0E(int i10) {
        List<InterfaceC1522Pq> list = this.A0d;
        String[] strArr = A0t;
        if (strArr[5].charAt(3) == strArr[3].charAt(3)) {
            throw new RuntimeException();
        }
    ...
    private final void A0G(int i10) {
        ...
        int iCharAt;
        int curIndex4;
        C1519Pn c1519PnA04 = null;
        if (this.A00 != i10) {
            c1519PnA04 = A04(this.A00);
            this.A00 = i10;
        }
        if (this.A01 == null) {
            A0B();
        ...
        if (N == this.A0G) {
            ...
            int i16 = 0;
            while (i16 < curIndex) {
                C1519Pn c1519Pn2 = this.A0r.get(i16);
                int i17 = c1519Pn2.A02;
                int curIndex5 = this.A00;
                if (i17 >= curIndex5) {
                    int i18 = c1519Pn2.A02;
            ...
            if (ii3 != null) {
                ...
                for (int i20 = curIndex9 - 1; i20 >= 0; i20--) {
                    if (f12 >= f10 && i20 < pos) {
                        ...
                        int curIndex10 = c1519Pn.A02;
                        if (i20 == curIndex10 && !c1519Pn.A04) {
                            this.A0r.remove(i19);
                            this.A01.A07(this, i20, c1519Pn.A03);
                            i19--;
                            i16--;
                            c1519Pn = i19 >= 0 ? this.A0r.get(i19) : null;
                        }
                    } else if (c1519Pn != null) {
                        int curIndex11 = c1519Pn.A02;
                        if (i20 == curIndex11) {
                            f12 += c1519Pn.A01;
                            i19--;
                            c1519Pn = i19 >= 0 ? this.A0r.get(i19) : null;
                        ...
                        if (extraWidthLeft >= leftWidthNeeded && i21 > startPos) {
                            ...
                            if (i21 == curIndex19) {
                                ...
                                if (itemIndex < curIndex20) {
                                    C1519Pn ii4 = this.A0r.get(itemIndex);
                                    String[] strArr6 = A0t;
                                ...
                                C1519Pn c1519PnA05 = A05(i21, itemIndex);
                                itemIndex++;
                                extraWidthLeft += c1519PnA05.A01;
                                size = this.A0r.size();
                                if (A0t[0].length() != 15) {
                            ...
                            C1519Pn c1519PnA09 = A05(i21, itemIndex);
                            itemIndex++;
                            extraWidthLeft += c1519PnA09.A01;
                            size = this.A0r.size();
                            if (A0t[0].length() != 15) {
                                A0t[0] = "BbpcE6tkf1K6OjJ";
                                if (itemIndex < size) {
                ...
                A0Q(ii3, i16, c1519PnA04);
                childCount = getChildCount();
                for (i11 = 0; i11 < childCount; i11++) {
                    View childAt = getChildAt(i11);
                    c1520Po = (C1520Po) childAt.getLayoutParams();
                    c1520Po.A01 = i11;
                    if (c1520Po.A05 && c1520Po.A00 == 0.0f && (c1519PnA08 = A07(childAt)) != null) {
                        c1520Po.A00 = c1519PnA08.A01;
                        String[] strArr8 = A0t;
                        ...
                        if (iCharAt3 == curIndex22) {
                            ...
                            int curIndex23 = c1519PnA08.A02;
                            c1520Po.A02 = curIndex23;
                        }
                    }
                }
                A0B();
            ...
            while (i11 < childCount) {
                ...
                c1520Po = (C1520Po) childAt3.getLayoutParams();
                c1520Po.A01 = i11;
                if (c1520Po.A05) {
                }
            }
        ...
        String resName2 = A08(77, 9, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE);
        ...
        String resName5 = A08(29, 22, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE);
    ...
    private final void A0I(int i10, float f10, int i11) {
        ...
        if (this.A0D > 0) {
            ...
            for (int childCount = 0; childCount < i12; childCount++) {
                ...
                C1520Po lp2 = (C1520Po) childAt.getLayoutParams();
        ...
        if (0 != 0) {
            ...
            for (int i14 = 0; i14 < childCount2; i14++) {
                ...
                if (!((C1520Po) childAt2.getLayoutParams()).A05) {
                    childAt2.getLeft();
                    getClientWidth();
                    throw new NullPointerException(A08(450, 13, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE));
                }
            }
        }
        this.A0e = true;
    ...
    private void A0M(int i10, boolean z10, int i11, boolean z11) {
        C1519Pn c1519PnA04 = A04(i10);
        int destX = 0;
        if (c1519PnA04 != null) {
            destX = (int) (getClientWidth() * Math.max(this.A02, Math.min(c1519PnA04.A00, this.A07)));
        }
        if (z10) {
            A0J(destX, 0, i11);
            if (z11) {
    ...
    private void A0Q(C1519Pn c1519Pn, int i10, C1519Pn c1519Pn2) {
        float f10;
        float f11;
        int pos;
        C1519Pn c1519Pn3;
        ...
        if (c1519Pn2 != null) {
            int width2 = c1519Pn2.A02;
            int N2 = c1519Pn.A02;
            if (width2 < N2) {
                int itemIndex = 0;
                float fA00 = c1519Pn2.A00 + c1519Pn2.A01 + f10;
                int i11 = width2 + 1;
                while (i11 <= N) {
                    ...
                    C1519Pn c1519Pn5 = this.A0r.get(itemIndex);
                    while (true) {
                        c1519Pn4 = c1519Pn5;
                        int i12 = c1519Pn4.A02;
                        String[] strArr = A0t;
                        String str = strArr[4];
                        String str2 = strArr[2];
                        ...
                        if (width3 == N4) {
                            ...
                            itemIndex++;
                            c1519Pn5 = this.A0r.get(itemIndex);
                            String[] strArr2 = A0t;
                ...
                if (width2 > N7) {
                    ...
                    int i13 = N8 - 1;
                    float fA01 = c1519Pn2.A00;
                    int itemIndex2 = width2 - 1;
                    while (itemIndex2 >= N && i13 >= 0) {
                        C1519Pn c1519Pn6 = this.A0r.get(i13);
                        String[] strArr4 = A0t;
                        ...
                        while (true) {
                            c1519Pn3 = c1519Pn6;
                            int N10 = c1519Pn3.A02;
                            if (itemIndex2 >= N10 || i13 <= 0) {
                                break;
                            }
                            i13--;
                            c1519Pn6 = this.A0r.get(i13);
                        }
                        while (itemIndex2 > N) {
                            fA01 -= this.A01.A00(itemIndex2) + f10;
                            itemIndex2--;
                        }
                        fA01 -= c1519Pn3.A01 + f10;
                        c1519Pn3.A00 = fA01;
                        itemIndex2--;
                    }
                }
        ...
        int size = this.A0r.size();
        float offset = c1519Pn.A00;
        int N11 = c1519Pn.A02;
        int itemCount = N11 - 1;
        int N12 = c1519Pn.A02;
        this.A02 = N12 == 0 ? c1519Pn.A00 : -3.4028235E38f;
        int N13 = iA01 - 1;
        if (c1519Pn.A02 == N13) {
            float f12 = c1519Pn.A00;
            if (A0t[6].charAt(18) != 53) {
                String[] strArr6 = A0t;
                strArr6[5] = "UG1gT2jUNjrId2t7MfTS74a15LtMOaPg";
                strArr6[3] = "2ozfqeZF2OaiC2JUfBmasK4DPIGaXMZO";
                f11 = (f12 + c1519Pn.A01) - 1.0f;
            } else {
                f11 = (f12 + c1519Pn.A01) - 1.0f;
            }
        } else {
        ...
        while (pos >= 0) {
            C1519Pn c1519Pn7 = this.A0r.get(pos);
            while (itemCount > N) {
                offset -= this.A01.A00(itemCount) + f10;
                itemCount--;
            }
            float f13 = c1519Pn7.A01 + f10;
            String[] strArr9 = A0t;
        ...
        float fA02 = c1519Pn.A00 + c1519Pn.A01 + f10;
        int N17 = c1519Pn.A02;
        int i14 = N17 + 1;
        int pos2 = i10 + 1;
        while (pos2 < size) {
            C1519Pn c1519Pn8 = this.A0r.get(pos2);
            while (i14 < N) {
            ...
            int N18 = iA01 - 1;
            if (c1519Pn8.A02 == N18) {
                this.A07 = (c1519Pn8.A01 + fA02) - 1.0f;
            }
            c1519Pn8.A00 = fA02;
            fA02 += c1519Pn8.A01 + f10;
            pos2++;
            i14++;
        }
        this.A0l = false;
    ...
    private void A0R(boolean z10) {
        ...
        for (int i10 = 0; i10 < this.A0r.size(); i10++) {
            C1519Pn c1519Pn = this.A0r.get(i10);
            boolean needPopulate2 = c1519Pn.A04;
            if (needPopulate2) {
                z11 = true;
                c1519Pn.A04 = false;
            }
    ...
    private boolean A0X(float f10) {
        ...
        C1519Pn c1519Pn = this.A0r.get(0);
        C1519Pn c1519Pn2 = this.A0r.get(this.A0r.size() - 1);
        if (c1519Pn.A02 != 0) {
            rightAbsolute = false;
            f12 = c1519Pn.A00 * clientWidth;
        }
        if (c1519Pn2.A02 != this.A01.A01() - 1) {
            leftAbsolute = false;
            float leftBound3 = c1519Pn2.A00;
    ...
    private boolean A0Z(int i10) {
        ...
        int i11 = c1519PnA03.A02;
        float f11 = ((i10 / currentPage) - c1519PnA03.A00) / (c1519PnA03.A01 + f10);
        this.A0e = false;
    ...
    private final boolean A0a(int i10) {
        ...
        if (viewFindFocus == this) {
            ...
            if (!z10) {
                ...
                Log.e(A08(HttpStatusCodes.STATUS_CODE_MULTIPLE_CHOICES, 9, 73), A08(Sdk$SDKError.b.ASSET_FAILED_TO_DELETE_VALUE, 72, 43) + sb2.toString());
                viewFindFocus = null;
            }
        }
        boolean zA0V = false;
        ...
        if (size < (adapterCount6 * 2) + 1) {
            ...
            if (A0t[0].length() == 15) {
                ...
                while (i11 < adapterCount) {
                    c1519Pn = this.A0r.get(i11);
                    newPos = this.A01.A02(c1519Pn.A03);
                    if (newPos != -1) {
                        if (newPos == -2) {
                            this.A0r.remove(i11);
                            i11--;
                            ...
                            this.A01.A07(this, c1519Pn.A02, c1519Pn.A03);
                            z10 = true;
                            i14 = this.A00;
                            adapterCount5 = c1519Pn.A02;
                ...
                if (z10) {
                    ...
                    for (newCurrItem = 0; newCurrItem < childCount; newCurrItem++) {
                        c1520Po = (C1520Po) getChildAt(newCurrItem).getLayoutParams();
                        if (!c1520Po.A05) {
                            c1520Po.A00 = 0.0f;
                        }
                    }
    ...
    public final void addFocusables(ArrayList<View> views, int i10, int i11) {
        ...
        if (descendantFocusability != 393216) {
            ...
            while (true) {
                ...
                if (focusableCount == 0 && (c1519PnA07 = A07(childAt)) != null) {
                    int descendantFocusability3 = c1519PnA07.A02;
    ...
    public final void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        ...
        C1520Po c1520Po = (C1520Po) layoutParams;
        boolean z10 = c1520Po.A05;
        String[] strArr = A0t;
        if (strArr[4].charAt(21) != strArr[2].charAt(21)) {
            throw new RuntimeException();
        }
        A0t[6] = "0hKurRTmjdCHvNVYXWivI507L49T3Iz9";
        c1520Po.A05 = z10 | A0c(view);
        if (this.A0h) {
            if (c1520Po == null || !c1520Po.A05) {
                c1520Po.A03 = true;
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C1520Po) && super.checkLayoutParams(layoutParams);
    }
        ...
        if (accessibilityEvent.getEventType() == 4096) {
            ...
            if (A0t[0].length() == 15) {
                ...
                for (int i10 = 0; i10 < childCount; i10++) {
                    ...
                    if (childCount2 == 0) {
                        C1519Pn c1519PnA07 = A07(childAt);
                        String[] strArr3 = A0t;
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        return new C1520Po(getContext(), attributeSet);
    }
    ...
    public final int getChildDrawingOrder(int i10, int i11) {
        ...
        int index = ((C1520Po) this.A0b.get(result).getLayoutParams()).A01;
        return index;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A0M > 0 && this.A0S != null && this.A0r.size() > 0 && this.A01 != null) {
            ...
            int firstPos = 0;
            C1519Pn c1519Pn = this.A0r.get(0);
            float marginOffset = c1519Pn.A00;
            int itemCount = this.A0r.size();
            int i10 = this.A0r.get(itemCount - 1).A02;
            for (int i11 = c1519Pn.A02; i11 < i10; i11++) {
                while (i11 > c1519Pn.A02 && firstPos < itemCount) {
                    firstPos++;
                    c1519Pn = this.A0r.get(firstPos);
                }
                if (i11 == c1519Pn.A02) {
                    f10 = (c1519Pn.A00 + c1519Pn.A01) * pos;
                    float marginOffset2 = c1519Pn.A00;
                    marginOffset = marginOffset2 + c1519Pn.A01 + f11;
                } else {
        ...
        while (true) {
            ...
            if (paddingTop < scrollX) {
                ...
                if (childAt.getVisibility() != 8) {
                    C1520Po c1520Po = (C1520Po) childAt.getLayoutParams();
                    if (c1520Po.A05) {
                        int count3 = c1520Po.A04 & 7;
                        int childTop2 = c1520Po.A04 & Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE;
                        switch (count3) {
                            case 1:
                ...
                while (paddingBottom3 < scrollX) {
                    ...
                    if (childAt2.getVisibility() != count2) {
                        C1520Po c1520Po2 = (C1520Po) childAt2.getLayoutParams();
                        if (!c1520Po2.A05 && (c1519PnA07 = A07(childAt2)) != null) {
                            int i15 = vgrav + ((int) (childLeft2 * c1519PnA07.A00));
                            if (c1520Po2.A03) {
                                c1520Po2.A03 = false;
                                int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (childLeft2 * c1520Po2.A00), 1073741824);
    ...
    public final boolean onRequestFocusInDescendants(int i10, Rect rect) {
        ...
        while (i11 != childCount) {
            ...
            if (count2 == 0 && (c1519PnA07 = A07(childAt)) != null) {
                int index = c1519PnA07.A02;
                int count3 = this.A00;
    ...
    public void setOffscreenPageLimit(int i10) {
        if (i10 < 1) {
            Log.w(A08(HttpStatusCodes.STATUS_CODE_MULTIPLE_CHOICES, 9, 73), A08(Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE, 31, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE) + i10 + A08(51, 26, 45) + 1);
            i10 = 1;
        }
        if (i10 != this.A0L) {
            this.A0L = i10;
    ...
    @Deprecated
    public void setOnPageChangeListener(InterfaceC1522Pq interfaceC1522Pq) {
        this.A0Y = interfaceC1522Pq;
    }
    ...
    public void setPageMarginDrawable(int i10) {
        setPageMarginDrawable(AbstractC1506Oy.A00(getContext(), i10));
    }
