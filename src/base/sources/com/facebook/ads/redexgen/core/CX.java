...
public final class CX {
    ...
    private void A05() {
        ConnectivityManager connectivityManager = (ConnectivityManager) AbstractC09823y.A01((ConnectivityManager) this.A03.getSystemService(A02(Sdk$SDKError.b.MRAID_JS_CALL_EMPTY_VALUE, 12, 37)));
    ...
    public final int A09() {
        ...
        if (this.A05.A09()) {
            if (C5C.A02 >= 23) {
                intentFilter.addAction(A02(269, 42, Sdk$SDKError.b.TPAT_ERROR_VALUE));
            } else {
        ...
        if (this.A05.A0B()) {
            ...
            intentFilter.addAction(A02(Sdk$SDKError.b.MRAID_JS_WRITE_FAILED_VALUE, 39, 17));
        }
