...
public abstract class AbstractC1393Ko {
    ...
    public static void A04(C10054v c10054v) throws C3K {
        int iA09 = c10054v.A09();
        if (A05(c10054v)) {
            return;
        }
        c10054v.A0f(iA09);
        throw C3K.A01(A02(2, 21, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE) + c10054v.A0T(), null);
    }

    public static boolean A05(C10054v c10054v) {
