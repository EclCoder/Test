...
public final class C2308iY implements T5 {
    public long A00;
    ...
    public C2308iY(C2198gi c2198gi, InterstitialAd interstitialAd, String str) {
        this(c2198gi, interstitialAd, str, new C2317ij());
    }

    public C2308iY(C2198gi c2198gi, InterstitialAd interstitialAd, String str, U3 u10) {
        this.A0A = c2198gi;
        this.A0B = str;
    ...
    public final void A0D(InterstitialAd interstitialAd) {
        if (interstitialAd == null && !C1648Up.A0u(this.A0A)) {
            return;
        }
        this.A01 = interstitialAd;
    }
