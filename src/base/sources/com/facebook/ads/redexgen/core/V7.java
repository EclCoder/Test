...
public final class V7 {
    ...
    public V7(T8 t10, String str, double d10, String str2, Map<String, String> map, VC vc2, VD vd2, boolean z10) {
        this.A05 = str;
        this.A00 = d10;
        this.A04 = str2;
        this.A02 = vc2;
        ...
        if (!TextUtils.isEmpty(strA01) && (z10 || vd2 == VD.A0C)) {
            map2.put(A00(6, 21, 46), strA01);
        }
        if (A0B()) {
            Map<String, String> extraData = t10.A04().A6w();
            map2.put(A00(0, 6, 111), AbstractC1709Xd.A01(extraData));
        }
