...
public abstract class AbstractC1675Vs {
    ...
    public static EnumC1673Vq A00(DisplayMetrics displayMetrics) {
        ...
        if (XY.A04(i10, screenHeight)) {
            return EnumC1673Vq.A0I;
        }
        if (screenHeight > i10) {
            EnumC1673Vq enumC1673Vq = EnumC1673Vq.A0K;
            String[] strArr = A00;
            String str = strArr[5];
        ...
        return EnumC1673Vq.A0H;
    }

    public static void A01(DisplayMetrics displayMetrics, View view, EnumC1672Vp enumC1672Vp) {
        int iCeil;
        int i10 = (int) (displayMetrics.widthPixels / displayMetrics.density);
        int screenWidth = enumC1672Vp.A04();
        if (i10 >= screenWidth) {
            iCeil = displayMetrics.widthPixels;
        } else {
            int screenWidth2 = enumC1672Vp.A04();
            iCeil = (int) Math.ceil(screenWidth2 * displayMetrics.density);
        }
        int screenWidth3 = enumC1672Vp.A03();
