...
public final class C10536r extends C1235Ek {
    ...
    static {
        A03();
        A0H = C10536r.class.getSimpleName();
    }

    public C10536r(C2198gi c2198gi) {
        super(c2198gi);
        ...
        this.A09 = new NL(this, c2198gi);
        this.A0A = c2198gi;
        A02();
    }

    public C10536r(C2198gi c2198gi, AttributeSet attributeSet) {
    ...
    public C10536r(C2198gi c2198gi, AttributeSet attributeSet, int i10) {
    ...
    private void A04(Intent intent) {
        if (this.A05 == null) {
            A05(A01(Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE, 25, 92));
            return;
        }
        ...
        intent.putExtra(A01(Sdk$SDKError.b.MRAID_UNRECOGNIZED_COMMAND_VALUE, 8, 97), WK.A09);
        ...
        intent.putExtra(A01(Sdk$SDKError.b.AD_IS_PLAYING_VALUE, 24, 99), XX.A00(this.A0A));
    ...
    private void A05(String str) {
        this.A0A.A08().ABC(A01(198, 7, 74), AbstractC1610Td.A28, new C1611Te(AdErrorType.PARSER_FAILURE.getDefaultErrorMessage(), A01(90, 7, 92) + str));
    ...
    public final void A0s() {
        AdActivityIntent adActivityIntentA05 = C1702Wu.A05(this.A0A);
        A04(adActivityIntentA05);
        try {
            A0i(false, 6);
            setVisibility(8);
            C1702Wu.A0B(this.A0A, adActivityIntentA05);
        } catch (Exception e10) {
            this.A0A.A08().ABC(A01(176, 11, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE), AbstractC1610Td.A0D, new C1611Te(e10));
            Log.e(A01(97, 17, 97), A01(0, 90, 103), e10);
        }
    }

    public InterfaceC1753Yv getListener() {
        return this.A03;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.C1235Ek, android.view.ViewGroup, android.view.View
    ...
    public void setAdEventManager(VA va2) {
        this.A02 = va2;
    }
    ...
    public void setClientToken(String str) {
        ...
        this.A05 = c4l;
        if (this.A05 != null && C1648Up.A20(this.A0A)) {
            if (str != null) {
                c1245Eu2 = new C1245Eu(this.A0A, this.A02, this, str, false, this.A05, null);
            }
            this.A04 = c1245Eu2;
            return;
        }
    ...
    public void setListener(InterfaceC1753Yv interfaceC1753Yv) {
        this.A03 = interfaceC1753Yv;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.C1235Ek
