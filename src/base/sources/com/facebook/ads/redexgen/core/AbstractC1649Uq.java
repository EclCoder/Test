...
public abstract class AbstractC1649Uq {
    ...
    public static boolean A02(Context context) {
        return C1648Up.A0V(context).A38(A00(0, 47, Sdk$SDKError.b.TPAT_ERROR_VALUE), true);
    }

    public static boolean A03(Context context) {
        return C1648Up.A0V(context).A38(A00(47, 47, 99), false);
    }

    public static boolean A04(Context context) {
        return C1648Up.A0V(context).A38(A00(139, 46, 41), false);
    }

    public static boolean A05(Context context) {
        return C1648Up.A0V(context).A38(A00(ModuleDescriptor.MODULE_VERSION, 15, 30), false);
    }

    public static boolean A06(Context context) {
        return C1648Up.A0V(context).A38(A00(94, 45, 72), false);
    }
}
