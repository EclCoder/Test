...
public final class C1898bq extends LinearLayout {
    ...
    public C1898bq(C2198gi c2198gi, C1456Na c1456Na, boolean z10, int i10, int i11, int i12) {
        super(c2198gi);
        setOrientation(1);
    ...
    public C1898bq(C2198gi c2198gi, C1456Na c1456Na, boolean z10, boolean z11, boolean z12) {
        int i10 = z11 ? 18 : 22;
        int i11 = z11 ? 14 : 16;
        int i12 = A07;
        this(c2198gi, c1456Na, z10, i10, i11, z12 ? i12 / 2 : i12);
    }
    ...
    public final void A03(C1456Na c1456Na, boolean z10) {
        this.A02.setTextColor(c1456Na.A07(z10));
        this.A01.setTextColor(c1456Na.A05(z10));
        this.A00.setTextColor(c1456Na.A06(z10));
    }
    ...
    public void setCTAClickListener(ViewOnClickListenerC1396Kr viewOnClickListenerC1396Kr) {
        ViewOnClickListenerC1901bt viewOnClickListenerC1901btA03 = AbstractC1902bu.A03(viewOnClickListenerC1396Kr, A00(0, 9, 20));
        this.A02.setOnClickListener(viewOnClickListenerC1901btA03);
        this.A00.setOnClickListener(viewOnClickListenerC1901btA03);
        this.A01.setOnClickListener(viewOnClickListenerC1901btA03);
    }
