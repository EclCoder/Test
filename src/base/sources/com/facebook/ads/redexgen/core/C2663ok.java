...
public class C2663ok implements AnonymousClass78 {
    ...
    public long A00;
    public long A01;
    public C2737px A02 = C2737px.A06;
    public boolean A03;
    public final AnonymousClass45 A04;

    public C2663ok(AnonymousClass45 anonymousClass45) {
    ...
    public long A8p() {
        ...
        if (this.A03) {
            ...
            long j10 = jA6J - positionUs;
            if (this.A02.A01 == 1.0f) {
                long positionUs2 = C5C.A0O(j10);
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass78
    public void AJd(C2737px c2737px) {
        if (this.A03) {
            long jA8p = A8p();
            String[] strArr = A05;
