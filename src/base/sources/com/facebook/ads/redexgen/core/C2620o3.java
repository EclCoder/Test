...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.o3, reason: case insensitive filesystem */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C2620o3 implements CJ {
    public static byte[] A02;
    public static final SparseArray<Constructor<? extends CH>> A03;
    public final C2414kT A00;
    ...
    public static Constructor<? extends CH> A03(Class<?> cls) {
        try {
            return cls.asSubclass(CH.class).getConstructor(C2747q7.class, C2414kT.class, Executor.class);
    ...
    public C2620o3(C2414kT c2414kT, Executor executor) {
        this.A00 = (C2414kT) AbstractC09823y.A01(c2414kT);
        this.A01 = (Executor) AbstractC09823y.A01(executor);
    }
    ...
    public static SparseArray<Constructor<? extends CH>> A00() {
        ...
        try {
            sparseArray.put(2, A03(Class.forName(A02(Sdk$SDKError.b.PLACEMENT_AD_TYPE_MISMATCH_VALUE, 75, 80))));
        } catch (ClassNotFoundException unused2) {
        }
        try {
            sparseArray.put(1, A03(Class.forName(A02(282, 86, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE))));
    ...
    private CH A01(DownloadRequest downloadRequest, int i10) {
        ...
        if (constructor != null) {
            try {
                return constructor.newInstance(new C09542u().A00(downloadRequest.A00).A04(downloadRequest.A04).A02(downloadRequest.A01).A05(), this.A00, this.A01);
            } catch (Exception e10) {
    ...
    public final CH A5M(DownloadRequest downloadRequest) {
        ...
        switch (iA0B) {
            ...
            case 3:
            default:
                throw new IllegalArgumentException(A02(Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE, 18, 52) + iA0B);
            case 4:
                return new C2615nx(new C09542u().A00(downloadRequest.A00).A02(downloadRequest.A01).A05(), this.A00, this.A01);
        }
    }
}
