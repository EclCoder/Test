...
public class C2494ln<K> implements Iterator<K> {
    ...
    public C2494ln(final C2O this$1, final Iterator val$entryIterator) {
    ...
    public final void remove() {
        AbstractC2428ki.A0F(this.A00 != null, A00(0, 50, 26));
