...
public final class C2415kU implements C5W {
    ...
    public C2415kU(MP mp2, long j10, int i10) {
        AbstractC09823y.A0A(j10 > 0 || j10 == -1, A00(Sdk$SDKError.b.INVALID_INDEX_URL_VALUE, 48, 72));
        if (j10 != -1 && j10 < CacheDataSource.DEFAULT_MAX_CACHE_FILE_SIZE) {
            AbstractC09904g.A07(A00(0, 13, 24), A00(13, 102, 75));
        }
        this.A09 = (MP) AbstractC09823y.A01(mp2);
    ...
    private void A03(C10185i c10185i) throws IOException {
        this.A05 = this.A09.AK8((String) C5C.A0f(c10185i.A08), c10185i.A04 + this.A00, c10185i.A03 != -1 ? Math.min(c10185i.A03 - this.A00, this.A01) : -1L);
        FileOutputStream fileOutputStream = new FileOutputStream(this.A05);
        if (this.A07 > 0) {
            if (this.A04 == null) {
                this.A04 = new C1445Mo(fileOutputStream, this.A07);
            } else {
    ...
    public final void AGk(C10185i c10185i) throws IOException {
        AbstractC09823y.A01(c10185i.A08);
        if (c10185i.A03 == -1 && c10185i.A06(2)) {
            this.A03 = null;
            return;
        }
        this.A03 = c10185i;
        this.A01 = c10185i.A06(4) ? this.A08 : Long.MAX_VALUE;
        this.A00 = 0L;
        try {
            A03(c10185i);
        } catch (IOException e10) {
            throw new C2417kW(e10);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.C5W
    public final void write(byte[] bArr, int i10, int i11) throws C2417kW {
        C10185i c10185i = this.A03;
        if (c10185i == null) {
            return;
        }
        int i12 = 0;
