...
public abstract class AbstractC09161g extends AE {
    ...
    public final C2679p0 A0o;
    public final C2679p0 A0p;
    public final C10616z A0q;
    public final A6 A0r;
    public final BT A0s;
    ...
    public abstract int A1g(B0 b10, B3 b11, C2758qI c2758qI, C2758qI c2758qI2);

    public abstract int A1h(BT bt, A6 a10, C2758qI c2758qI) throws BX;

    public abstract List<B3> A1l(BT bt, C2758qI c2758qI, boolean z10) throws BX;

    public abstract void A1u(C2679p0 c2679p0);

    public abstract void A1v(@MetaExoPlayerCustomization B0 b10, MediaFormat mediaFormat) throws AD;

    public abstract void A1w(B3 b10, B0 b11, C2758qI c2758qI, MediaCrypto mediaCrypto) throws BX;
    ...
    public abstract boolean A23(long j10, long j11, B0 b10, ByteBuffer byteBuffer, int i10, int i11, long j12, boolean z10, boolean z11) throws AD;
    ...
    public AbstractC09161g(int i10, C2354jQ c2354jQ, MediaCodecRendererMetaParameters mediaCodecRendererMetaParameters, BT bt, A6 a10, boolean z10, boolean z11, int i11, int i12) {
        super(i10);
        this.A09 = C.TIME_UNSET;
        this.A08 = C.TIME_UNSET;
        this.A0k = false;
        this.A0i = false;
        AbstractC09823y.A08(C5C.A02 >= 16);
        this.A0z = (C2354jQ) AbstractC09823y.A01(c2354jQ);
        this.A0y = (MediaCodecRendererMetaParameters) AbstractC09823y.A01(mediaCodecRendererMetaParameters);
        this.A0s = (BT) AbstractC09823y.A01(bt);
        this.A0r = a10;
        this.A0x = z10;
        this.A0v = z11;
        this.A0m = i11;
        this.A0l = i12;
        this.A0o = new C2679p0(0);
        this.A0p = C2679p0.A02();
        this.A0q = new C10616z();
        ...
        this.A10 = MetaExoPlayerUpgradeConfig.A03(EnumC2358jX.A1g);
    }
    ...
    private int A0w(String str) {
        ...
        if (C5C.A02 <= 25) {
            ...
            if (A12[0].length() == 4) {
                ...
                if (strA0x.equals(str) && (C5C.A06.startsWith(A0x(681, 7, 108)) || C5C.A06.startsWith(A0x(653, 7, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE)) || C5C.A06.startsWith(A0x(660, 7, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE)) || C5C.A06.startsWith(A0x(674, 7, 4)))) {
                    return 2;
                }
                if (C5C.A02 < 24) {
    ...
    private ByteBuffer A0y(int i10) {
        return this.A0F.A8J(i10);
    }

    private ByteBuffer A0z(int i10) {
        return this.A0F.A8e(i10);
    }

    private List<B3> A10(boolean z10) throws BX {
        String alternativeMimeType;
        List<B3> listA1l = A1l(this.A0s, this.A0g, z10);
        if (listA1l.isEmpty() && z10) {
            listA1l = A1l(this.A0s, this.A0g, false);
            if (!listA1l.isEmpty()) {
                AbstractC09904g.A07(A0x(Sdk$SDKError.b.AD_RESPONSE_RETRY_AFTER_VALUE, 18, 67), A0x(Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE, 40, 101) + this.A0g.A0W + A0x(0, 58, 73) + listA1l + A0x(58, 1, 35));
            }
        }
        if (listA1l.isEmpty() && this.A0j && (alternativeMimeType = C1150Ba.A0P(this.A0g)) != null) {
    ...
    private void A16(B3 b10, MediaCrypto mediaCrypto) throws Exception {
        B0 b0A0K = null;
        String str = b10.A03;
        try {
            if (this.A10) {
            ...
            new C2629oC().A00();
            b0A0K = B7.A02().A0K(A22(), this.A0z, this.A0y.getA00(), EnumC2351jL.A05, str);
            try {
                this.A0J = str;
                AnonymousClass54.A00();
                AnonymousClass54.A02(A0x(701, 14, 16));
                try {
                    A1w(b10, b0A0K, this.A0g, mediaCrypto);
                    AnonymousClass54.A00();
                    AnonymousClass54.A02(A0x(821, 10, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE));
                    b0A0K.start();
                    AnonymousClass54.A00();
    ...
    private void A17(B3 b10, B3 b11, MediaCrypto mediaCrypto) throws Exception {
        int iA00 = MetaExoPlayerUpgradeConfig.A00(EnumC2359jY.A06);
        if (iA00 >= 0) {
            try {
                A16(b11, mediaCrypto);
                return;
                ...
                if (b11 == b10) {
                    AbstractC09904g.A07(A0x(Sdk$SDKError.b.AD_RESPONSE_RETRY_AFTER_VALUE, 18, 67), A0x(590, 63, 38));
                    Thread.sleep(iA00);
                    A16(b11, mediaCrypto);
                    return;
                }
    ...
    private void A18(BC bc2) {
        this.A0I = bc2;
        if (bc2.A02 != C.TIME_UNSET) {
            this.A0Z = true;
        }
    }
    ...
    private boolean A19() {
        ...
        boolean z10 = this.A08 == C.TIME_UNSET || System.currentTimeMillis() - this.A08 <= ((long) this.A0l);
        if (this.A08 == C.TIME_UNSET) {
            AbstractC09904g.A07(A0x(Sdk$SDKError.b.AD_RESPONSE_RETRY_AFTER_VALUE, 18, 67), A0x(95, 21, 98));
            try {
                this.A0L = null;
                A1n();
    ...
    private boolean A1A() throws AD {
        ...
        if (this.A0e) {
            ...
            if (this.A03 == 1) {
                for (int i10 = 0; i10 < this.A0g.A0X.size(); i10++) {
                    this.A0o.A02.put(this.A0g.A0X.get(i10));
                }
                this.A03 = 2;
            }
            iPosition = this.A0o.A02.position();
            boolean zA03 = MetaExoPlayerUpgradeConfig.A03(EnumC2358jX.A0z);
        ...
        if (this.A0o.A05()) {
            ...
            try {
                ...
                C2758qI c2758qI = this.A0g;
                int adaptiveReconfigurationBytes = e10.getErrorCode();
                throw A1S(e10, c2758qI, C5C.A02(adaptiveReconfigurationBytes));
            }
        }
        ...
        try {
            long j10 = this.A0o.A01;
            boolean bufferEncrypted5 = this.A0o.A04();
            if (bufferEncrypted5) {
                this.A0u.add(Long.valueOf(j10));
            }
            this.A0A = Math.max(this.A0A, j10);
            this.A0o.A0B();
            A1u(this.A0o);
            if (skipIfSampleTooLarge) {
                this.A0F.AHK(this.A05, 0, this.A0o.A05, j10, 0);
            } else {
                this.A0F.AHI(this.A05, 0, this.A0o.A02.limit(), j10, 0);
            }
            A13();
            this.A0U = true;
            this.A03 = 0;
            ...
            C2758qI c2758qI2 = this.A0g;
            int adaptiveReconfigurationBytes2 = e11.getErrorCode();
            throw A1S(e11, c2758qI2, C5C.A02(adaptiveReconfigurationBytes2));
        }
    }
    ...
    private boolean A1C(int i10) throws AD {
        C10616z c10616zA1U = A1U();
        this.A0p.A0A();
        int iA1R = A1R(c10616zA1U, this.A0p, i10 | 4);
        if (iA1R == -5) {
            A1s(c10616zA1U.A00);
            return true;
        }
    ...
    private boolean A1D(long j10) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            if (this.A0u.get(i10).longValue() == j10) {
                this.A0u.remove(i10);
                return true;
            }
        }
    ...
    private boolean A1E(long j10, long j11) throws AD {
        boolean z10;
        ...
        if (this.A0P && this.A0V) {
            try {
                z10 = false;
                try {
                    processedOutputBuffer = A23(j10, j11, this.A0F, this.A0K, this.A06, this.A0n.flags, this.A0n.presentationTimeUs, this.A0c, this.A0Y);
    ...
    private boolean A1F(MediaCrypto mediaCrypto, boolean z10) throws BA {
        if (this.A0L == null) {
            try {
                List<B3> listA10 = A10(z10);
                if (this.A0v) {
                ...
                throw new BA(this.A0g, e10, z10, -49998);
            }
        }
        if (!this.A0i && A21()) {
        ...
        if (!this.A0L.isEmpty()) {
            ...
            do {
                ...
                try {
                    ...
                    AbstractC09904g.A0A(A0x(Sdk$SDKError.b.AD_RESPONSE_RETRY_AFTER_VALUE, 18, 67), A0x(156, 30, 18) + b3PeekFirst2, e11);
                    this.A0L.removeFirst();
                    BA ba2 = new BA(this.A0g, e11, z10, b3PeekFirst2);
                    if (this.A0H == null) {
                        this.A0H = ba2;
                    } else {
                        this.A0H = this.A0H.A00(ba2);
                    }
                }
            } while (!this.A0L.isEmpty());
            throw this.A0H;
        }
        throw new BA(this.A0g, (Throwable) null, z10, -49999);
    }

    public static boolean A1G(C2758qI c2758qI) {
        return c2758qI.A07 == 0 || c2758qI.A07 == 2;
    }

    public static boolean A1H(B3 b10) {
        String str = b10.A03;
        if (C5C.A02 <= 17) {
            String name = A0x(566, 24, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE);
            if (!name.equals(str)) {
    ...
    public static boolean A1I(String str) {
                ...
                if (A0x(787, 6, 102).equals(C5C.A03)) {
                    ...
                    if (strArr[6].length() != strArr[5].length()) {
                        if (!A0x(450, 31, 59).equals(str)) {
                            if (A0x(481, 38, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE).equals(str)) {
                            }
                        }
                    } else {
                        String[] strArr2 = A12;
        ...
        if (!A0x(541, 25, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE).equals(str)) {
            if (C5C.A02 <= 19) {
                if (A0x(787, 6, 102).equals(C5C.A03)) {
                    strArr = A12;
                    if (strArr[6].length() != strArr[5].length()) {
    ...
    public static boolean A1K(String str) {
        if (C5C.A02 >= 18 && (C5C.A02 != 18 || (!A0x(382, 15, 68).equals(str) && !A0x(397, 22, 77).equals(str)))) {
            if (C5C.A02 == 19 && C5C.A06.startsWith(A0x(667, 7, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE))) {
    ...
    public static boolean A1L(String str, C2758qI c2758qI) {
        return C5C.A02 < 21 && c2758qI.A0X.isEmpty() && A0x(306, 25, 22).equals(str);
    }

    public static boolean A1M(String str, C2758qI c2758qI) {
        return C5C.A02 <= 18 && c2758qI.A06 == 1 && A0x(281, 25, 33).equals(str);
    }

    private boolean A1N(boolean z10) throws AD {
        if (this.A0D == null || (!z10 && this.A0x)) {
            return false;
        }
        ...
        C11229q c11229q = (C11229q) AbstractC09823y.A01(this.A0D.A80());
        C11229q c11229qA80 = this.A0D.A80();
        C2758qI c2758qI = this.A0g;
        int drmSessionState = c11229q.A00;
        throw A1S(c11229qA80, c2758qI, drmSessionState);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AE
    public void A1a(long j10, boolean z10) throws AD {
        this.A0X = false;
        this.A0a = false;
        if (this.A0F != null) {
            A1m();
    ...
    @Override // com.facebook.ads.redexgen.core.AE
    public void A1c(C2758qI[] c2758qIArr, long j10, long j11) throws AD {
    }
    ...
    public void A1m() throws AD {
        ...
        if (this.A0R) {
            ...
            A12[0] = "8Nzt";
            if ((z10 && this.A0V) || A20() || this.A04 != 0) {
                A1n();
                A1p();
            } else {
                this.A0F.flush();
    ...
    public void A1n() {
        ...
        if (this.A0F != null) {
            this.A0h.A03++;
            try {
                B7.A02().A0L(A22(), this.A0z, this.A0y.getA00(), EnumC2351jL.A05, this.A0J, this.A0F);
                this.A0F = null;
                InterfaceC11249s interfaceC11249s = this.A0D;
                String[] strArr = A12;
                if (strArr[6].length() == strArr[5].length()) {
                    String[] strArr2 = A12;
                    strArr2[7] = "JSCNcek9dAkyOPO1KkbpJsRj9JD6rmzz";
                    strArr2[1] = "RONQ7IAwO8Bcbv1Krrdz5fvlVLwlovmm";
                    if (interfaceC11249s != null && this.A0E != this.A0D) {
                        try {
                            this.A0D.AHc(null);
                            return;
                        } finally {
        ...
        try {
            ...
            if (this.A0m > 0 && (this.A09 == C.TIME_UNSET || System.currentTimeMillis() - this.A09 <= this.A0m)) {
                if (this.A09 == C.TIME_UNSET) {
                    String strA0x = A0x(Sdk$SDKError.b.AD_RESPONSE_RETRY_AFTER_VALUE, 18, 67);
                    String mimeType2 = A0x(59, 36, 3);
                    AbstractC09904g.A07(strA0x, mimeType2);
    ...
    public void A1r(C2758qI c2758qI) {
    }
    ...
    public void A1s(C2758qI c2758qI) throws AD {
        ...
        C2758qI c2758qI2 = this.A0g;
        this.A0g = c2758qI;
        C2758qI oldFormat3 = this.A0g;
        DrmInitData drmInitData2 = oldFormat3.A0O;
        if (c2758qI2 == null) {
            drmInitData = null;
        } else {
            drmInitData = c2758qI2.A0O;
        }
        if (!C5C.A1E(drmInitData2, drmInitData)) {
            C2758qI oldFormat4 = this.A0g;
            if (oldFormat4.A0O != null) {
                if (this.A0r != null) {
                    A6 a10 = this.A0r;
                    C2758qI oldFormat5 = this.A0g;
                    this.A0E = a10.A3C(null, oldFormat5);
                    String[] strArr = A12;
        ...
        if (this.A0E == this.A0D) {
            ...
            if (strArr4[4].length() == strArr4[3].length()) {
                if (b12 != null) {
                    ...
                    b11 = this.A0G;
                    oldFormat = this.A0g;
                    switch (A1g(b10, b11, c2758qI2, oldFormat)) {
                        case 0:
                            break;
                        case 1:
                            z11 = true;
                        ...
                        case 3:
                            ...
                            if (this.A02 == 2) {
                                if (this.A02 == 1) {
                                    oldFormat2 = this.A0g;
                                    if (oldFormat2.A0L == c2758qI2.A0L) {
                                        C2758qI oldFormat6 = this.A0g;
                                        if (oldFormat6.A0A == c2758qI2.A0A) {
                                        }
                                    }
                                }
                            }
                        ...
                        case 3:
                            ...
                            if (this.A02 == 2) {
                                if (this.A02 == 1) {
                                    oldFormat2 = this.A0g;
                                    if (oldFormat2.A0L == c2758qI2.A0L) {
                                        C2758qI oldFormat7 = this.A0g;
                                        z10 = oldFormat7.A0A == c2758qI2.A0A;
                                    }
                                }
                            }
                            this.A0M = z10;
    ...
    public void A1t(C2758qI c2758qI) throws AD {
    }

    public void A1z(String str, C2758qI c2758qI) throws AD {
        A1t(c2758qI);
    }
    ...
    public final boolean A24(C2758qI c2758qI) {
        if (c2758qI == null || !this.A0k || !A0x(838, 10, 89).equalsIgnoreCase(c2758qI.A0W)) {
            return false;
        }
        return true;
    }

    public boolean A25(B3 b10) {
        return true;
    }
    ...
    public boolean AAe() {
        if (this.A0g == null) {
            super.A0B = EnumC2324ir.A07;
        } else if (this.A0e) {
            super.A0B = EnumC2324ir.A0A;
        } else if (!A1d() && !A1B()) {
            super.A0B = EnumC2324ir.A06;
        }
        if (this.A0g != null) {
            ...
            if (!z10 && (A1d() || A1B() || (this.A07 != C.TIME_UNSET && SystemClock.elapsedRealtime() < this.A07))) {
                return true;
            }
        }
        return false;
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2667oo
    public void AIX(long j10, long j11) throws AD {
        if (this.A0a) {
            A1o();
            return;
        }
    ...
    public final int AKM(C2758qI c2758qI) throws AD {
        try {
            return A1h(this.A0s, this.A0r, c2758qI);
        } catch (BX e10) {
            throw A1S(e10, c2758qI, 4002);
        }
    }

    @Override // com.facebook.ads.redexgen.core.AE, com.facebook.ads.redexgen.core.InterfaceC10777p
