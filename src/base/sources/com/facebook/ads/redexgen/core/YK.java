...
public final class YK implements V8 {
    ...
    public YK(C2194ge c2194ge, ZD zd2) {
        this.A00 = c2194ge;
        this.A01 = zd2;
    }

    private void A02(Set<String> eventsToRetry, Set<String> eventsToDelete) {
        int iA0B = this.A01.A0B(AbstractC1650Ur.A0G(this.A00), eventsToRetry, eventsToDelete);
        if (iA0B > 0) {
            this.A00.A08().ABC(A00(405, 15, 38), AbstractC1610Td.A10, new C1611Te(A00(28, 44, 75) + iA0B));
        }
    }
    ...
    public final JSONObject A5L() {
        ...
        int iA0F = AbstractC1650Ur.A0F(this.A00);
        ...
        if (AbstractC1650Ur.A0P(this.A00) && (jSONArrayA04 = C1612Tf.A04(this.A00, (iA08 = AbstractC1650Ur.A08(this.A00)))) != null) {
    ...
    public final void ADe(JSONArray jSONArray) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            try {
                ...
                if (C1612Tf.A0I(string)) {
                    C1612Tf.A0B(this.A00, string);
                } else {
                    hashSet.add(string);
                }
            } catch (JSONException e10) {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                if (A00(363, 26, 65).equals(string)) {
                    C1648Up.A0V(this.A00).A36(jSONObject.getString(A00(389, 14, 97)));
                    this.A00.A04().ACP();
                } else {
                    int i11 = jSONObject.getInt(A00(353, 4, 94));
                    if (i11 == 1) {
                        if (this.A00.A05().AAO()) {
                            String str = A00(Sdk$SDKError.b.AD_ALREADY_FAILED_VALUE, 25, 105) + string + A00(13, 14, 87);
                        }
                        if (zA0P) {
                            C1612Tf.A0D(string);
                        }
                        ...
                        if (i11 >= 1000 && i11 < 2000) {
                            if (this.A00.A05().AAO()) {
                                Log.e(A04, A00(272, 37, 30) + i11 + strA01 + string + strA00);
                            }
                            if (C1612Tf.A0I(string)) {
                                C1612Tf.A0B(this.A00, string);
                            } else {
                            ...
                            if (this.A00.A05().AAO()) {
                                Log.e(A04, A00(231, 41, 103) + i11 + strA01 + string + strA00);
                            }
                            eventsToDelete.add(string);
                            if (zA0P) {
                                C1612Tf.A0D(string);
                ...
                if (this.A00.A05().AAO()) {
                    String eventId = A04;
                    Log.e(eventId, A00(Sdk$SDKError.b.ASSET_FAILED_TO_DELETE_VALUE, 44, 108) + i10 + strA00, e10);
                }
                z10 = false;
            }
        }
