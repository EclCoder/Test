...
public abstract class AbstractC09924i {
    ...
    public static void A02(MediaFormat mediaFormat, ColorInfo colorInfo) {
        if (colorInfo != null) {
            ...
            A04(mediaFormat, A00(0, 11, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE), colorInfo.A01);
            A05(mediaFormat, A00(43, 15, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE), colorInfo.A04);
        }
    }
