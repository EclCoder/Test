...
public enum EnumC2359jY {
    ...
    public static EnumC2359jY[] valuesCustom() {
        EnumC2359jY[] enumC2359jYArrValuesCustom = values();
        if (A01[0].charAt(28) == 't') {
            throw new RuntimeException();
        }
        A01[7] = "Z";
        return (EnumC2359jY[]) enumC2359jYArrValuesCustom.clone();
    }
}
