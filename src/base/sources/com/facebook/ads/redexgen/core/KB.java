...
public final class KB extends AbstractC1911c3 {
    ...
    public final VI A0O;
    public final C1892bk A0P;
    public final C1894bm A0Q;
    public final C1915c7 A0R;
    ...
    public KB(C1915c7 c1915c7) {
        ...
        this.A0T = new EA() { // from class: com.facebook.ads.redexgen.X.6D
            ...
            public final void A03(C4K c4k) {
                this.A00.A0S.A0e(EnumC2085et.A02, 20);
            }
        };
        this.A0V = new RunnableC1941cX(this);
        this.A0N = c1915c7.A06();
        this.A0R = c1915c7;
        ...
        YB.A0K(this.A0F);
        AbstractC1899br.A00(this.A0R.A06(), this, this.A0R.A05().A29().A0H().A08());
    ...
    private RelativeLayout A07(String str, int i10) {
        ...
        YB.A0V(relativeLayout, YB.A06(i10, 30));
    ...
    private C1892bk A0D() {
        C1892bk c1892bk = new C1892bk(this.A0N);
        YB.A0N(c1892bk, 0);
        int i10 = (int) (this.A00 * 0.13f);
        new LM(c1892bk, this.A0N).A05(i10, i10).A07(this.A0R.A05().A2C().A01());
        return c1892bk;
    }

    private C1894bm A0E() {
        C1894bm c1894bm = new C1894bm(this.A0N, A0Y, 5, 0, -1);
        c1894bm.setRating(getRating());
        return c1894bm;
    }

    private C1235Ek A0G() {
        C1235Ek c1235Ek = new C1235Ek(this.A0R.A06());
        this.A0A = new C4L(this.A0N, getAdEventManager(), c1235Ek, this.A0R.A05().A2E(), 0, 0, true, null, null);
        if (C1648Up.A20(this.A0N)) {
            this.A09 = new C1245Eu(this.A0N, getAdEventManager(), c1235Ek, this.A0R.A05().A2E(), false, this.A0A, null);
        } else {
            String[] strArr = A0X;
            if (strArr[2].length() == strArr[4].length()) {
                throw new RuntimeException();
        ...
        c1235Ek.setRoundedCornerVideoView(44.0f);
        return c1235Ek;
    }

    private void A0K() {
        this.A0F.setOnClickListener(new ViewOnClickListenerC1943cZ(this));
        if (this.A0R.A05().A1p()) {
            this.A0M.setOnClickListener(new ViewOnClickListenerC1944ca(this));
        } else {
            this.A0H.setOnClickListener(new ViewOnClickListenerC1945cb(this));
        }
    }

    private void A0L() {
        if (this.A0R.A05().A2M()) {
            this.A06 = A00(this.A0N, this.A0R.A05(), this.A0O, EnumC1806aM.A06, this.A0R.A0C());
            YB.A0K(this.A06);
        } else {
            if (!this.A0R.A05().A1p()) {
                return;
            }
            this.A05 = AbstractC1489Oh.A00(this.A0N.A02());
            this.A04 = A03();
            YB.A0K(this.A04);
            A0O();
        }
    ...
    private void A0M() {
        if (this.A0R.A05().A2W()) {
            this.A07 = A01(this.A0N, EnumC1806aM.A06);
            YB.A0K(this.A07);
        }
    }
    ...
    private void A0O() {
        if (this.A04 != null) {
            this.A04.setOnClickListener(new ViewOnClickListenerC1942cY(this));
        }
        A0T(8);
    }
    ...
    public void A0P() {
        ...
        C1468Nm c1468NmA2C = this.A0R.A05().A2C();
        if (this.A05 != null && this.A05.A0O(this.A0N.A02(), true)) {
            this.A0R.A0C().AAo(this.A0R.A05().A2E(), c1468NmA2C);
        } else {
            if (TextUtils.isEmpty(c1468NmA2C.A00())) {
                return;
            }
            X6.A0O(new X6(), this.A0N, XB.A00(c1468NmA2C.A00()), this.A0R.A05().A2E());
        }
    }
    ...
    private void A0Y(int i10) {
        ...
        if (this.A0R.A05().A2U()) {
            ...
            layoutParams.addRule(9);
            layoutParams.setMargins(i11, XV.A0r, 0, 0);
        } else {
            layoutParams.addRule(12);
            layoutParams.addRule(9);
            layoutParams.setMargins(i11, 0, 0, XV.A0b);
        }
    ...
    private void A0e(int i10) {
        ...
        if (i10 == 1) {
            ...
            layoutParams.setMargins(XV.A0n, 0, XV.A0n, i11);
    ...
    private void A0g(int i10) {
        ...
        if (i10 == 1) {
            ...
            layoutParams.setMargins(i12, i13, topMargin, 0);
            if (i10 == 2) {
                layoutParams.addRule(15);
            } else {
                layoutParams.addRule(14);
        ...
        if (XL.A03((float) dA0k)) {
            i12 = (int) (this.A01 * 0.2f);
            topMargin = (int) (this.A01 * 0.1f);
            i11 = (int) (this.A01 * 0.15f);
        } else {
            ...
            if (strArr6[7].charAt(31) != strArr6[3].charAt(31)) {
                ...
                if (zA05) {
                    topMargin = (int) (this.A01 * 0.1f);
                    i12 = topMargin;
                    i11 = (int) (this.A01 * 0.32f);
                } else if (XL.A04((float) dA0k)) {
                    i12 = (int) (this.A01 * 0.15f);
                    topMargin = (int) (this.A01 * 0.1f);
                    i11 = (int) (this.A01 * 0.27f);
                } else {
                    i12 = (int) (this.A01 * 0.15f);
                    topMargin = (int) (this.A01 * 0.1f);
                    i11 = (int) (this.A01 * 0.215f);
                }
            }
            throw new RuntimeException();
        }
    ...
    private void A0i(int i10) {
        ...
        if (i10 == 1) {
            ...
            layoutParams.setMargins(bottomMargin, 0, XV.A0n, i11);
        } else {
