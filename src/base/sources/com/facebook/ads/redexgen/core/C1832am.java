...
public final class C1832am extends LinearLayout {
    ...
    public C1832am(C2198gi c2198gi) {
        super(c2198gi);
        this.A03 = c2198gi;
        A01();
    }
    ...
    public void setSubtitle(@Nullable String str) {
        ...
        if (A00(0, 5, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE).equals(uriA00.getScheme())) {
