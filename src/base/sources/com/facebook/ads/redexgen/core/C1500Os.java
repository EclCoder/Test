...
public class C1500Os extends FrameLayout {
    public int A00;
    public int A01;
    public boolean A02;
    public boolean A03;
    ...
    public final InterfaceC1501Ot A06;
    ...
    public static final InterfaceC1502Ou A0A = new C2284i9();

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public C1500Os(Context context, AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        this.A04 = new Rect();
        this.A05 = new Rect();
        this.A06 = new C2285iA(this);
    ...
    public C1500Os(Context context) {
        this(context, null);
    }

    public C1500Os(Context context, AttributeSet attributeSet) {
    ...
    public final void onMeasure(int i10, int i11) {
        if (!(A0A instanceof C2284i9)) {
            ...
            switch (mode2) {
                case Integer.MIN_VALUE:
                case 1073741824:
                    i11 = View.MeasureSpec.makeMeasureSpec(Math.max((int) Math.ceil(A0A.A8X(this.A06)), View.MeasureSpec.getSize(i11)), mode2);
                    break;
            }
    ...
    public void setCardBackgroundColor(int i10) {
        A0A.AJJ(this.A06, ColorStateList.valueOf(i10));
    }
