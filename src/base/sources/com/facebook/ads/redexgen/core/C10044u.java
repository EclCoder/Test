...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.4u, reason: invalid class name and case insensitive filesystem */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C10044u {
    ...
    public C10044u(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public C10044u(byte[] bArr, int i10) {
        this.A00 = bArr;
        this.A02 = i10;
    }

    private void A00() {
        AbstractC09823y.A08(this.A03 >= 0 && (this.A03 < this.A02 || (this.A03 == this.A02 && this.A01 == 0)));
    }
    ...
    public final void A0C(C10054v c10054v) {
        A0E(c10054v.A0l(), c10054v.A0A());
        A08(c10054v.A09() * 8);
    }
    ...
    public final void A0F(byte[] bArr, int i10, int i11) {
        ...
        if (to7 + i16 > 8) {
            ...
            int to9 = this.A01;
            bArr[i12] = (byte) (b11 | (bitsLeft3 << to9));
            int to10 = this.A01;
            this.A01 = to10 - 8;
        }
        int to11 = this.A01;
        ...
        int to14 = 8 - i16;
        bArr[i12] = (byte) (bitsLeft4 | ((byte) (i18 << to14)));
        int to15 = this.A01;
        if (to15 == 8) {
            this.A01 = 0;
            int to16 = this.A03;
