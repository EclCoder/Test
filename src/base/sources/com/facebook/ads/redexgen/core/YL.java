...
public abstract class YL {
    ...
    public static Bitmap A00(C2198gi c2198gi, Bitmap bitmap, int i10) throws RSRuntimeException {
        ...
        try {
            renderScriptCreate = RenderScript.create(c2198gi);
    ...
    public static Bitmap A01(C2198gi c2198gi, Bitmap bitmap, int i10, int i11) {
        ...
        if (width != 0 && height != 0) {
            ...
            try {
                bitmapCreateBitmap = A00(c2198gi, bitmapCreateBitmap, i10);
                if (i11 != 1) {
                ...
                return new Q5().A02(bitmapCreateBitmap, i10);
            }
        }
        return null;
    }
