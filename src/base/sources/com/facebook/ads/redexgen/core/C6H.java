...
public final class C6H extends AbstractC1379Ka {
    ...
    public C2198gi A03;
    public XO A04;
    public AbstractC1733Yb A05;
    public AbstractC1911c3 A06;
    public C1927cJ A07;
    public C2053eM A08;
    public C2059eS A09;
    public DA A0A;
    ...
    public final InterfaceC1739Yh A0E;
    public final InterfaceC1889bh A0F;
    public final C1890bi A0G;
    public final C1915c7 A0H;
    public final C1235Ek A0I;
    public final DZ A0J;
    ...
    public C6H(C1915c7 c1915c7) {
        super(c1915c7, false);
        this.A0D = new Handler(Looper.getMainLooper());
        this.A0C = false;
        this.A0B = false;
        this.A03 = c1915c7.A06();
        this.A05 = c1915c7.A0B();
        this.A0H = c1915c7;
        ...
        A0A();
        this.A0E = c1915c7.A0C();
        AbstractC1899br.A00(c1915c7.A06(), this, getAdInfo().A0H().A08());
        this.A0I = A02(c1915c7);
        YB.A0K(this.A0I);
        getAdDetailsView().bringToFront();
        if (!A04()) {
            this.A0J = A03(c1915c7);
        } else {
            this.A0J = null;
        }
        ...
        A1S();
        this.A08 = new C2053eM(this.A03, c1915c7.A07(), getAdDataBundle());
        this.A0F = new KW(this);
        this.A0G = A01(c1915c7);
        XR xrA02 = super.A08.A02(getAdDataBundle());
        this.A03.A0H().A00(xrA02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(super.A08);
        if (xrA02.A00) {
            this.A0I.getVideoImplView().setOnClickListener(new ViewOnClickListenerC1918cA(this));
        } else if (C1648Up.A1L(getAdContextWrapper())) {
            AbstractC1858bC.A00(this.A0I.getVideoImplView(), C1648Up.A1M(getAdContextWrapper()), new ViewOnClickListenerC1919cB(this));
        }
        if (c1915c7.A05().A1o()) {
            if (this.A0H.A05().A1r()) {
                this.A06 = new KB(c1915c7);
            } else {
                this.A06 = new KD(c1915c7);
            }
            View view = this.A06;
    ...
    private C1890bi A01(C1915c7 c1915c7) {
        if (this.A0J != null) {
            return new C1890bi(c1915c7, getAdDataBundle(), this.A0I, this.A0J, getAdDetailsView(), this.A0E, this.A0F);
        }
        return new C1890bi(c1915c7, getAdDataBundle(), this.A0I, this.A0E, this.A0F, getAdDetailsView());
    }

    private C1235Ek A02(C1915c7 c1915c7) {
        RelativeLayout.LayoutParams layoutParams;
        C1235Ek c1235Ek = (C1235Ek) c1915c7.A02();
        if (c1235Ek == null) {
            c1235Ek = new C1235Ek(this.A03);
        }
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
        if (getAdDataBundle().A1u()) {
            c1235Ek.getVideoView().setPadding(c1235Ek.getVideoView().getPaddingLeft(), c1235Ek.getVideoView().getPaddingTop(), c1235Ek.getVideoView().getPaddingRight(), c1235Ek.getVideoView().getPaddingBottom() + A0Y);
        }
        layoutParams2.addRule(13);
        addView(c1235Ek, layoutParams2);
        int iA1Q = A1Q(c1915c7.A0B());
        this.A02 = (ImageView) c1915c7.A03();
        if (this.A02 != null) {
            if (!A04()) {
                ImageView imageView = this.A02;
                int i10 = AbstractC1379Ka.A0J;
                int toolbarHeight = AbstractC1379Ka.A0J;
                imageView.setPadding(i10, toolbarHeight, AbstractC1379Ka.A0J, AbstractC1379Ka.A0J);
                layoutParams = new RelativeLayout.LayoutParams(AbstractC1379Ka.A0K, AbstractC1379Ka.A0K);
                layoutParams.setMargins(0, iA1Q, AbstractC1379Ka.A0I, 0);
                layoutParams.addRule(11);
            } else {
                layoutParams = new RelativeLayout.LayoutParams(AbstractC1911c3.A0A, AbstractC1911c3.A0A);
                int i11 = XV.A0b;
                int toolbarHeight2 = XV.A0r;
                layoutParams.setMargins(i11, toolbarHeight2, XV.A0b, XV.A0Z);
                layoutParams.addRule(9);
            }
            layoutParams.addRule(10);
            c1235Ek.addView(this.A02, layoutParams);
        }
        return c1235Ek;
    }

    private DZ A03(C1915c7 c1915c7) {
        DZ dzA0E = c1915c7.A0E();
        if (dzA0E == null) {
            return null;
        }
        dzA0E.A08(-1, AbstractC1379Ka.A0C, false);
        dzA0E.setPadding(AbstractC1379Ka.A0N, AbstractC1379Ka.A0N, AbstractC1379Ka.A0N, AbstractC1379Ka.A0N);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC1379Ka.A0M);
    ...
    private void A06() {
        this.A07 = new C1927cJ(this.A0H.A06(), getAdDataBundle(), this.A0H.A08(), this.A0D, this.A0H.A0C());
        addView(this.A07.A0C(getCtaButton()));
    }

    private void A07() {
        YB.A0d(this.A02, getCtaButton(), getAdDetailsView(), this.A01, this.A0G, this.A0H.A0B());
        for (InterfaceC2086eu interfaceC2086eu : this.A0I.getPlugins()) {
            if (interfaceC2086eu instanceof AnonymousClass34) {
                this.A0I.A0g(interfaceC2086eu);
                return;
            }
        }
    }
    ...
    private void A09() {
        ...
        ViewOnClickListenerC1396Kr ctaButton = getCtaButton();
    ...
    private void A0B() {
        ...
        YB.A0L(this.A05);
        Pair<EnumC2052eL, View> pairA03 = this.A08.A03(getCtaButton());
        this.A00 = (View) pairA03.second;
        A0F((EnumC2052eL) pairA03.first);
    ...
    private void A0E(RelativeLayout relativeLayout) {
        ...
        layoutParams.addRule(9);
        C1892bk c1892bk = new C1892bk(this.A03);
        YB.A0N(c1892bk, 0);
        YB.A0K(c1892bk);
        new LM(c1892bk, this.A03).A05(A0Q, A0Q).A07(getAdDataBundle().A2C().A01());
        ...
        C1894bm c1894bm = new C1894bm(c2198gi, i10, 5, A0V, -1);
        c1894bm.setGravity(16);
        ...
        linearLayout.addView(c1894bm, ratingCountParams);
        ...
        iconParams.addRule(1, c1892bk.getId());
        ...
        relativeLayout.addView(c1892bk, layoutParams);
        if (TextUtils.isEmpty(getAdDataBundle().A29().A0I().A0C())) {
            linearLayout.setVisibility(8);
            return;
        }
        linearLayout.setVisibility(0);
        c1894bm.setRating(Float.parseFloat(getAdDataBundle().A29().A0I().A0C()));
        ...
        if (!getAdDataBundle().A1s()) {
            ...
            formattingRatingCount = AbstractC1712Xg.A01(Integer.parseInt(getAdDataBundle().A29().A0I().A09()));
        }
    ...
    private void A0F(EnumC2052eL enumC2052eL) {
        if (!getAdDataBundle().A29().A0K().A02().isEmpty()) {
            if (getAdDataBundle().A29().A0K().A03()) {
                this.A09 = new C2059eS(this.A03, getAdDataBundle(), this.A0E, getCtaButton(), this.A0D, this.A0H.A08());
    ...
    private void A0G(EnumC2052eL enumC2052eL) {
        if (this.A00 == null) {
        }
        this.A0I.A0h(false);
        ...
        switch (enumC2052eL) {
            ...
            case A02:
                ...
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.setMargins(AbstractC1379Ka.A0L, AbstractC1379Ka.A0L, AbstractC1379Ka.A0L, AbstractC1379Ka.A0L);
    ...
    public final void A1H(NR nr, String str, double d10, Bundle bundle) {
        ...
        if (bundle.getBoolean(A04(33, 24, Sdk$SDKError.b.TPAT_ERROR_VALUE), false)) {
            this.A0G.A07(this);
        }
        if (A04()) {
            boolean z10 = getAdDetailsView() instanceof LK;
    ...
    public final void A1I(C4K c4k) {
        super.A1I(c4k);
        if (A04()) {
            AbstractC2363jd adDataBundle = getAdDataBundle();
    ...
    public final void A1J(E1 e10) {
        ...
        if (A04()) {
            this.A03.A0F().AKh(XL.A00((float) this.A0H.A05().A0k()), getResources().getConfiguration().orientation, true, false, AbstractC1450Mt.A0C(this.A0H.A04()));
        }
    ...
    public final void A1K(C4A c4a, int i10) {
        ...
        if ((getAdDetailsView() instanceof LK) && !this.A0H.A05().A1r()) {
            ...
            ((LK) getAdDetailsView()).A0s(((remainingVideoTimeInMillis * i10) + currentPosMs) / 1000);
        }
    }
    ...
    public final AbstractC1861bF A1R(C1915c7 c1915c7, NR nr, String str) {
        ...
        if (A04()) {
            return new C1900bs((float) dA0k, str, c1915c7.A06(), getColors(), c1915c7.A05(), c1915c7.A0C(), getCtaButton(), AbstractC1379Ka.A0G, false, c1915c7.A07(), c1915c7.A0F(), c1915c7.A0A(), c1915c7.A0E(), c1915c7.A08(), false).A03();
        }
        return new C1382Kd(c1915c7.A06(), getCtaButton(), AbstractC1379Ka.A0H, nr.A0I().A00() == NW.A05, getColors(), nr.A0J().A06(), str, c1915c7.A07(), c1915c7.A0C(), c1915c7.A0F(), c1915c7.A0A(), c1915c7.A05());
    }
    ...
    public final void A1Z() {
        ...
        if (this.A0H.A0B() != null) {
            AbstractC1733Yb abstractC1733YbA0B = this.A0H.A0B();
            if (A0L[4].charAt(31) == 'A') {
                throw new RuntimeException();
            }
            A0L[2] = "qVUXWES3bTCAG5k5pbCpCu4g17099rEp";
            abstractC1733YbA0B.setVisibility(8);
    ...
    public final void A1a(int i10) {
        if (!A04()) {
            return;
        }
        this.A03.A0F().AKj(i10);
        this.A0I.A0Z(i10);
        A1V(i10, this.A0I, (RelativeLayout) this.A0I.getVideoView());
    }
    ...
    public final void A1b(C4L c4l) {
        if (this.A06 != null) {
            ...
            this.A06.A1C();
            AbstractC1911c3 abstractC1911c3 = this.A06;
            String[] strArr = A0L;
            if (strArr[3].charAt(21) == strArr[6].charAt(21)) {
                throw new RuntimeException();
            }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.A06 != null) {
            ...
            if (abstractC1911c3.getVisibility() == 0) {
                getAdDetailsView().setVisibility(8);
                return;
            }
        }
    ...
    public void setVideoAdViewListener(InterfaceC2028dx interfaceC2028dx) {
        if (this.A06 instanceof KB) {
            ((KB) this.A06).setVideoAdViewListener(interfaceC2028dx);
        }
        if (this.A06 instanceof KD) {
            ((KD) this.A06).setVideoAdViewListener(interfaceC2028dx);
        }
    }
}
