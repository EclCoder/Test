...
public final class C1410Lf {
    ...
    public static List<File> A01(File file) {
        ...
        if (fileArrListFiles != null) {
            ...
            Collections.sort(listAsList, new C1409Le());
            return listAsList;
        }
        return linkedList;
    }
    ...
    public static void A04(File file) throws IOException {
        ...
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A00(Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE, 3, 98));
        long size = length - 1;
