...
public final class C2642oP implements AnonymousClass93 {
    ...
    public final /* synthetic */ C2639oM A00;

    public static String A00(int i10, int i11, int i12) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A01, i10, i10 + i11);
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            bArrCopyOfRange[i13] = (byte) ((bArrCopyOfRange[i13] ^ i12) ^ Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE);
        }
    ...
    public C2642oP(C2639oM c2639oM) {
        this.A00 = c2639oM;
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass93
    public final void AEM(long j10) {
        AbstractC09904g.A07(A00(2, 16, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), A00(18, 41, 39) + j10);
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass93
    public final void AFN(long j10) {
        if (this.A00.A0I != null) {
            C2639oM c2639oM = this.A00;
            String[] strArr = A02;
    ...
    public final void AFP(long j10, long j11, long j12, long j13) {
        ...
        if (!C2639oM.A0v) {
            String message = A00(2, 16, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE);
            AbstractC09904g.A07(message, string);
            return;
        }
