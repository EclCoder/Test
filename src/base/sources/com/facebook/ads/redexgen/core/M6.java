...
public final class M6 extends LinearLayout implements InterfaceC1841av {
    ...
    public C1833an A05;
    public InterfaceC1840au A06;
    public String A07;
    public final WebView A08;
    public final C2198gi A09;
    public final InterfaceC1837ar A0A;
    ...
    static {
        ...
        A0M = new ViewOnTouchListenerC1822ac();
    ...
    public M6(C2198gi c2198gi, WebView webView) {
        this(c2198gi, webView, false, false);
    }

    public M6(C2198gi c2198gi, WebView webView, boolean z10, boolean z11) {
        super(c2198gi);
        this.A0A = new M7(this);
        this.A08 = webView;
        this.A09 = c2198gi;
        this.A0B = AbstractC1649Uq.A06(c2198gi);
        this.A0D = z10;
        this.A0C = z11;
        A08();
        if (z11) {
    ...
    private void A08() {
        ...
        this.A01.setOnClickListener(new ViewOnClickListenerC1823ad(this));
        addView(this.A01, layoutParams);
        if (this.A0B && !C1648Up.A2w(this.A09)) {
            ...
            this.A00.setOnClickListener(new ViewOnClickListenerC1824ae(this));
            addView(this.A00, backButtonParams);
        }
        this.A05 = new C1833an(this.A09);
        ...
        if (C1648Up.A2w(this.A09) && !this.A0D) {
        ...
        if (this.A0B && !C1648Up.A2w(this.A09)) {
            ...
            this.A02.setOnClickListener(new ViewOnClickListenerC1825af(this));
        ...
        this.A03.setOnClickListener(new ViewOnClickListenerC1826ag(this));
    ...
    private void A09() {
        ...
        boolean zA0k = C1648Up.A0k(this.A09);
        if (!zA0k && (packageManager = this.A09.getPackageManager()) != null) {
            List<ResolveInfo> listQueryIntentActivities = packageManager.queryIntentActivities(new Intent(A06(46, 26, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE), A0L), C.DEFAULT_BUFFER_SEGMENT_SIZE);
            if (listQueryIntentActivities.isEmpty()) {
                ...
                if (resolveInfo.activityInfo != null) {
                    ...
                    if (A0F[2].length() != 9) {
                        ...
                        if (A06(72, 18, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE).equals(resolveInfo2.activityInfo.packageName)) {
                            externalBrowserBitmap = YN.A01(YM.BROWSER_LAUNCH_CHROME);
                        } else {
                            externalBrowserBitmap = getExternalBrowserBitmap();
                        }
                    } else if (A06(72, 18, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE).equals(resolveInfo2.activityInfo.packageName)) {
                        externalBrowserBitmap = YN.A01(YM.BROWSER_LAUNCH_CHROME);
                    } else {
                        externalBrowserBitmap = getExternalBrowserBitmap();
                    }
