...
public abstract class R2 {
    ...
    public int A0C;
    public int A0D;
    public final RN A0G = new C2260hj(this);
    public final RN A0H = new C2258hh(this);
    ...
    public abstract int A1f(int i10, RA ra2, RH rh2);

    public abstract int A1g(int i10, RA ra2, RH rh2);

    public abstract int A1h(RH rh2);

    public abstract int A1i(RH rh2);

    public abstract int A1j(RH rh2);

    public abstract int A1k(RH rh2);

    public abstract int A1l(RH rh2);

    public abstract int A1m(RH rh2);

    public abstract Parcelable A1n();

    public abstract View A1p(View view, int i10, RA ra2, RH rh2);

    public abstract R3 A1q();

    public abstract void A1r(int i10);

    public abstract void A1s(int i10, int i11, RH rh2, R0 r10);

    public abstract void A1t(int i10, R0 r10);

    public abstract void A1u(Parcelable parcelable);

    public abstract void A1w(RA ra2, RH rh2);

    public abstract void A1z(C7M c7m, RH rh2, int i10);
    ...
    private final int A08(RA ra2, RH rh2) {
        return 0;
    }
    ...
    private final void A0G(View view, int i10) {
        A0H(view, i10, (R3) view.getLayoutParams());
    }

    private final void A0H(View view, int i10, R3 r10) {
        ...
        this.A01.A0H(view, i10, r10, rkA0F.A0g());
    }
    ...
    private void A0L(RA ra2, int i10, View view) {
        RK rkA0F = C7M.A0F(view);
        if (rkA0F.A0l()) {
            return;
        }
    ...
    private final void A0M(RA ra2, RH rh2, AccessibilityEvent accessibilityEvent) {
    ...
    private final void A0N(RA ra2, RH rh2, Q6 q10) {
        ...
        Q3 collectionInfo = Q3.A00(A0t(ra2, rh2), A0s(ra2, rh2), A0R(ra2, rh2), A08(ra2, rh2));
        q10.A0P(collectionInfo);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0O(RF rf2) {
        if (this.A02 == rf2) {
            this.A02 = null;
        }
    }
    ...
    private final boolean A0R(RA ra2, RH rh2) {
        return false;
    }

    private final boolean A0S(RA ra2, RH rh2, int i10, Bundle bundle) {
        if (this.A03 == null) {
            return false;
        }
        int hScroll = 0;
    ...
    private final boolean A0T(RA ra2, RH rh2, View view, int i10, Bundle bundle) {
        return false;
    }

    private boolean A0U(C7M c7m, int i10, int i11) {
    ...
    public final void A14(int i10, int i11) {
        ...
        for (int i14 = 0; i14 < iA0Y; i14++) {
            View viewA0v = A0v(i14);
            Rect rect = this.A03.A0p;
            A0J(viewA0v, rect);
    ...
    public final void A16(int i10, RA ra2) {
        View view = A0v(i10);
        A0C(i10);
        ra2.A0T(view);
    }
    ...
    public final void A1C(View view, int i10, int i11) {
        ...
        int iA03 = A03(A0j(), A0k(), A0g() + A0h() + r10.leftMargin + r10.rightMargin + i12, r10.width, A22());
        int iA0Z = A0Z();
        int iA0a = A0a();
        int widthSpec = A0i();
        int iA04 = A03(iA0Z, iA0a, widthSpec + A0f() + r10.topMargin + r10.bottomMargin + i13, r10.height, A23());
        if (A1Y(view, iA03, iA04, r10)) {
    ...
    public final void A1D(View view, int i10, int i11, int i12, int i13) {
        R3 r10 = (R3) view.getLayoutParams();
        Rect rect = r10.A03;
        view.layout(rect.left + i10 + r10.leftMargin, rect.top + i11 + r10.topMargin, (i12 - rect.right) - r10.rightMargin, (i13 - rect.bottom) - r10.bottomMargin);
    }

    public final void A1E(View view, Q6 q10) {
        RK rkA0F = C7M.A0F(view);
        if (rkA0F != null) {
            boolean zA0g = rkA0F.A0g();
            if (A0J[4].charAt(12) == 'v') {
            ...
            if (!zA0g && !this.A01.A0K(rkA0F.A0H)) {
                A1M(this.A03.A0r, this.A03.A0s, view, q10);
            }
        }
    }

    public final void A1F(View view, RA ra2) {
        A0F(view);
        ra2.A0T(view);
    }
    ...
    public final void A1H(Q6 q10) {
        A0N(this.A03.A0r, this.A03.A0s, q10);
    }

    public final void A1I(RA ra2) {
        int iA0E = ra2.A0E();
        for (int i10 = iA0E - 1; i10 >= 0; i10--) {
            View viewA0F = ra2.A0F(i10);
    ...
    public void A1L(RA ra2, RH rh2, int i10, int i11) {
        this.A03.A1c(i10, i11);
    }

    public void A1M(RA ra2, RH rh2, View view, Q6 q10) {
        Q4 itemInfo = Q4.A00(A23() ? A0r(view) : 0, 1, A22() ? A0r(view) : 0, 1, false, false);
        q10.A0Q(itemInfo);
    }

    public final void A1N(RF rf2) {
        if (this.A02 != null) {
            RF rf3 = this.A02;
            if (A0J[4].charAt(12) == 'v') {
                throw new RuntimeException();
    ...
    public final void A1S(C7M c7m, RA ra2) {
        this.A07 = false;
        A1y(c7m, ra2);
    }
    ...
    public final boolean A1Y(View view, int i10, int i11, R3 r10) {
        if (!view.isLayoutRequested()) {
            ...
            if (z10 && A0Q(view.getWidth(), i10, r10.width) && A0Q(view.getHeight(), i11, r10.height)) {
                return false;
            }
        }
        return true;
    ...
    public boolean A1a(R3 r10) {
        return r10 != null;
    }

    public final boolean A1b(C7M c7m, View view, Rect rect, boolean z10) {
        return A1c(c7m, view, rect, z10, false);
    }

    public final boolean A1c(C7M c7m, View view, Rect rect, boolean z10, boolean z11) {
        int[] scrollAmount = A0W(view, rect);
        int i10 = scrollAmount[0];
        int i11 = scrollAmount[1];
        if ((z11 && !A0U(c7m, i10, i11)) || (i10 == 0 && i11 == 0)) {
            return false;
        }
        if (z10) {
            c7m.scrollBy(i10, i11);
        } else {
            c7m.A1e(i10, i11);
        }
        return true;
    ...
    public final boolean A1d(C7M c7m, RH rh2, View view, View view2) {
        return A0V(c7m, view, view2);
    }

    public final boolean A1e(C7M c7m, ArrayList<View> views, int i10, int i11) {
        return false;
    }
    ...
    public View A1o(int i10) {
        ...
        for (int i11 = 0; i11 < iA0Y; i11++) {
            ...
            if (rkA0F != null) {
                ...
                if (childCount == i10 && !rkA0F.A0l() && (this.A03.A0s.A07() || !rkA0F.A0g())) {
                    return child;
                }
            }
        }
    ...
    public void A1y(C7M c7m, RA ra2) {
    }
