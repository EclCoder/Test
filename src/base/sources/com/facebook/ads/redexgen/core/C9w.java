...
public final class C9w implements InterfaceC2614nw {
     ...
     */
    public static C1160Bk A01(Cursor cursor) {
        byte[] blob = cursor.getBlob(14);
        C8 c8A02 = new C8((String) AbstractC09823y.A01(cursor.getString(0)), Uri.parse((String) AbstractC09823y.A01(cursor.getString(2)))).A01(cursor.getString(1)).A02(A09(cursor.getString(3)));
        if (blob.length <= 0) {
            blob = null;
        }
        DownloadRequest downloadRequestA05 = c8A02.A04(blob).A00(cursor.getString(4)).A03(cursor.getBlob(5)).A05();
        C6 c10 = new C6();
        c10.A01 = cursor.getLong(13);
        c10.A00 = cursor.getFloat(12);
        int i10 = cursor.getInt(6);
        return new C1160Bk(downloadRequestA05, i10, cursor.getLong(7), cursor.getLong(8), cursor.getLong(9), cursor.getInt(10), i10 == 4 ? cursor.getInt(11) : 0, c10);
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static C1160Bk A02(Cursor cursor) {
        DownloadRequest downloadRequestA05 = new C8((String) AbstractC09823y.A01(cursor.getString(0)), Uri.parse((String) AbstractC09823y.A01(cursor.getString(2)))).A01(A05(cursor.getString(1))).A02(A09(cursor.getString(3))).A00(cursor.getString(4)).A03(cursor.getBlob(5)).A05();
        C6 c10 = new C6();
        c10.A01 = cursor.getLong(13);
        c10.A00 = cursor.getFloat(12);
        int i10 = cursor.getInt(6);
    ...
    static {
        A0B();
        A07 = A07(3, 4);
        A08 = new String[]{A04(607, 2, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE), A04(625, 9, 108), A04(739, 3, 12), A04(709, 11, 1), A04(566, 16, 36), A04(586, 4, 41), A04(684, 5, 42), A04(654, 13, 81), A04(725, 14, 8), A04(552, 14, 17), A04(698, 11, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), A04(590, 14, 52), A04(634, 18, 59), A04(536, 16, 16), A04(615, 10, 25)};
    }
    ...
    private List<C1160Bk> A08(SQLiteDatabase sQLiteDatabase) {
        ArrayList arrayList = new ArrayList();
        if (!C5C.A19(sQLiteDatabase, this.A04)) {
            return arrayList;
        }
        Cursor cursorQuery = sQLiteDatabase.query(this.A04, new String[]{A04(607, 2, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE), A04(720, 5, 15), A04(739, 3, 12), A04(709, 11, 1), A04(566, 16, 36), A04(586, 4, 41), A04(684, 5, 42), A04(654, 13, 81), A04(725, 14, 8), A04(552, 14, 17), A04(698, 11, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), A04(590, 14, 52), A04(634, 18, 59), A04(536, 16, 16)}, null, null, null, null, null);
    ...
    public static List<StreamKey> A09(String str) {
        ...
        for (String str2 : C5C.A1O(str, A04(412, 1, 1))) {
            ...
            AbstractC09823y.A08(strArrA1O.length == 3);
            ...
            try {
                ...
                if (iA00 != 3) {
                    ...
                    try {
                        ...
                        List<C1160Bk> listA08 = iA00 == 2 ? A08(writableDatabase) : new ArrayList<>();
                        ...
                        Iterator<C1160Bk> it = listA08.iterator();
                        while (it.hasNext()) {
    ...
    private void A0C(C1160Bk c1160Bk, SQLiteDatabase sQLiteDatabase) {
        byte[] bArr = c1160Bk.A07.A06 == null ? C5C.A07 : c1160Bk.A07.A06;
        ContentValues contentValues = new ContentValues();
        contentValues.put(A04(607, 2, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE), c1160Bk.A07.A02);
        contentValues.put(A04(625, 9, 108), c1160Bk.A07.A03);
        contentValues.put(A04(739, 3, 12), c1160Bk.A07.A00.toString());
        contentValues.put(A04(709, 11, 1), A06(c1160Bk.A07.A04));
        contentValues.put(A04(566, 16, 36), c1160Bk.A07.A01);
        contentValues.put(A04(586, 4, 41), c1160Bk.A07.A05);
        contentValues.put(A04(684, 5, 42), Integer.valueOf(c1160Bk.A02));
        contentValues.put(A04(654, 13, 81), Long.valueOf(c1160Bk.A05));
        contentValues.put(A04(725, 14, 8), Long.valueOf(c1160Bk.A06));
        contentValues.put(A04(552, 14, 17), Long.valueOf(c1160Bk.A04));
        contentValues.put(A04(698, 11, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), Integer.valueOf(c1160Bk.A03));
        contentValues.put(A04(590, 14, 52), Integer.valueOf(c1160Bk.A01));
        contentValues.put(A04(634, 18, 59), Float.valueOf(c1160Bk.A00()));
        contentValues.put(A04(536, 16, 16), Long.valueOf(c1160Bk.A01()));
        contentValues.put(A04(615, 10, 25), bArr);
        sQLiteDatabase.replaceOrThrow(this.A04, null, contentValues);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC1173Bx
    public final C1160Bk A7q(String str) throws C5N {
        A0A();
        try {
            ...
            try {
                ...
                C1160Bk c1160BkA01 = A01(cursorA00);
                if (cursorA00 != null) {
                    cursorA00.close();
                }
                return c1160BkA01;
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1173Bx
    public final C2621o4 A7r(int... iArr) throws C5N {
        A0A();
        return new C2621o4(A00(A07(iArr), null));
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2614nw
    public final void AHF(C1160Bk c1160Bk) throws C5N {
        A0A();
        try {
            SQLiteDatabase writableDatabase = this.A01.getWritableDatabase();
            A0C(c1160Bk, writableDatabase);
        } catch (SQLiteException e10) {
            throw new C5N(e10);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2614nw
    public final void AJq(int i10) throws C5N {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
            contentValues.put(A04(698, 11, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), Integer.valueOf(i10));
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2614nw
    public final void AJr(String str, int i10) throws C5N {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
            contentValues.put(A04(698, 11, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), Integer.valueOf(i10));
