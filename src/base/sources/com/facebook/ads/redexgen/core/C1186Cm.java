...
public final class C1186Cm implements InterfaceC2148fu {
    ...
    public C1186Cm(HttpURLConnection httpURLConnection, byte[] bArr) {
        try {
            this.A00 = httpURLConnection.getResponseCode();
            this.A01 = httpURLConnection.getURL().toString();
        } catch (IOException e10) {
            Log.e(getClass().getSimpleName(), A00(0, 13, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE), e10);
        }
        this.A02 = httpURLConnection.getHeaderFields();
        this.A03 = bArr;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2148fu
