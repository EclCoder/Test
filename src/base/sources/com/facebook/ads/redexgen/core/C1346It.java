...
public class C1346It extends AbstractC1844ay {
    ...
    public final /* synthetic */ C1982dC A00;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int iA01 = A00(dynamicWebViewHeight, height, i11);
        if ((z11 || z10) && Math.abs((iA00 / iA01) - f10) > 1.0E-7d) {
            boolean z12 = false;
            if (z11) {
                iA01 = (int) (iA00 / f10);
                z12 = true;
        ...
        setMeasuredDimension(iA00, iA01);
    }
    ...
    public C1346It(C1982dC c1982dC, C2198gi c2198gi) {
        super(c2198gi);
        this.A00 = c1982dC;
    ...
    public final WebChromeClient A0G() {
        return new C1977d7(this.A00);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC1844ay
    public final WebViewClient A0H() {
        return new C1978d8(this.A00);
    }
