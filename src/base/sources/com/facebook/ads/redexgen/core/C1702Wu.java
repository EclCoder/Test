...
public final class C1702Wu {
    ...
    public static final Set<C2198gi> A06;
    ...
    static {
        A08();
        A02 = C1702Wu.class.getPackage();
        A04 = A02 + A07(40, 22, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE);
        A03 = A02 + A07(0, 19, 56);
    ...
    public static int A00(C2198gi c2198gi, Intent intent) throws C1700Ws {
        Intent intentA01 = A01(intent);
        int usedContext = 0;
        try {
            Activity activityA00 = ActivityUtils.A00();
            if (activityA00 == null) {
                activityA00 = c2198gi.A0E();
                usedContext = 1;
            }
            if (activityA00 != null) {
            ...
            c2198gi.startActivity(intentA01);
            return 2;
        } catch (ActivityNotFoundException e10) {
            throw new C1700Ws(e10);
        }
    }
    ...
    public static C2198gi A04(Intent intent) {
        String stringExtra = intent.getStringExtra(A03);
        if (stringExtra != null) {
            for (C2198gi c2198gi : A06) {
                String adId = c2198gi.A0F().getId();
    ...
    public static AdActivityIntent A05(C2198gi c2198gi) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c2198gi.getApplicationContext(), A06());
        adActivityIntent.putExtra(A03, c2198gi.A0F().getId());
        A06.add(c2198gi);
    ...
    public static Class A06() {
        if (ProcessUtils.isRemoteRenderingProcess()) {
            try {
                return Class.forName(A07(Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE, 59, 72));
    ...
    public static void A09(Activity activity, Intent intent) throws C1700Ws {
        try {
    ...
    public static void A0B(C2198gi c2198gi, AdActivityIntent adActivityIntent) throws C1700Ws {
        Context launchContext;
        Context applicationContext = c2198gi.getApplicationContext();
        if (C1648Up.A2d(c2198gi) && (launchContext = c2198gi.A0E()) != null) {
        ...
        try {
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!A0I(c2198gi, adActivityIntent)) {
                    c2198gi.A0F().AIC();
                    return;
                }
                return;
    ...
    public static boolean A0D(C2198gi c2198gi, Intent intent) throws C1700Ws {
        A07.get();
        return A0F(c2198gi, intent, null);
    }

    public static boolean A0E(C2198gi c2198gi, Intent intent) throws C1700Ws {
        A07.get();
        if (0 != 0) {
            ...
            if (activityA0E != null) {
                ...
                try {
                    c2198gi.A0E();
                    throw new NullPointerException(A07(Sdk$SDKError.b.AD_IS_LOADING_VALUE, 22, 63));
                } catch (ActivityNotFoundException e10) {
                    throw new C1700Ws(e10);
                } catch (Exception e11) {
                    c2198gi.A08().ABC(A07(90, 8, 57), AbstractC1610Td.A07, new C1611Te(e11));
                    return false;
                }
            }
        }
    ...
    public static boolean A0F(C2198gi c2198gi, Intent intent, X3 x10) throws C1700Ws {
        if (A0C(intent, C1648Up.A0Z(c2198gi))) {
            return false;
        }
        Context context = c2198gi;
        if (A01[1].charAt(5) != 'g') {
            A01[2] = "mGLT8eS8inmCxtBfGXr0XCfYNSNKmj30";
            Context startContext = c2198gi.A0E();
            if (startContext != null) {
                context = startContext;
            } else {
                intent.addFlags(268435456);
            }
            if (x10 != null && !A0C(intent, C1648Up.A0b(c2198gi))) {
                c2198gi.A0C();
                try {
                    ...
                    c2198gi.A08().ABC(A07(90, 8, 57), AbstractC1610Td.A08, new C1611Te(e11));
                    return false;
                }
            }
            try {
                ...
                throw new C1700Ws(e12);
            }
        }
        throw new RuntimeException();
    }

    public static boolean A0G(C2198gi c2198gi, Uri uri, String str) throws ActivityNotFoundException {
        A08.get();
        return A0H(c2198gi, uri, str, null);
    }

    public static boolean A0H(C2198gi c2198gi, Uri uri, String str, X5 x10) throws ActivityNotFoundException {
        if (x10 == null || c2198gi.A0E() == null) {
            return false;
        }
    ...
    public static boolean A0I(C2198gi c2198gi, AdActivityIntent adActivityIntent) throws C1700Ws {
        Intent intentA01 = A01(adActivityIntent);
        try {
            Activity currentActivity = ActivityUtils.A00();
            if (currentActivity == null) {
                currentActivity = c2198gi.A0E();
            }
            if (currentActivity == null) {
                return false;
            }
