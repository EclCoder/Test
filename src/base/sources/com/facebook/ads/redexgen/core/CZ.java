...
public final class CZ implements InterfaceC2180gQ {
    ...
    public static final InterfaceC2178gO A06;
    public static final String A07;
    public long A00 = 0;
    public final InterfaceC2179gP A01;
    public final InterfaceC2185gV A02;
     ...
     */
    @Override // com.facebook.ads.redexgen.core.InterfaceC2180gQ
    ...
    public CZ(InterfaceC2179gP interfaceC2179gP, InterfaceC2185gV interfaceC2185gV) {
        this.A01 = interfaceC2179gP;
        this.A02 = interfaceC2185gV;
        Thread scheduler = new Thread(new RunnableC2181gR(this));
        scheduler.start();
    }
        ...
        while (true) {
            synchronized (this) {
                if (this.A00 == 0) {
                    ...
                    if (0 != 0) {
                        throw new NullPointerException(A00(Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE, 13, 31));
                    }
                    synchronized (this) {
                        if (this.A00 < jA5m2) {
