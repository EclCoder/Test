...
public final class Q6 {
    ...
    public static String A07(int i10) {
        switch (i10) {
            ...
            case 4:
                return A08(577, 13, 9);
            case 8:
                return A08(Sdk$SDKError.b.DEEPLINK_OPEN_FAILED_VALUE, 22, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE);
            case 16:
            ...
            case 8192:
                String strA09 = A08(534, 22, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE);
                String[] strArr3 = A03;
            ...
            case 32768:
                return A08(455, 12, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE);
            case C.DEFAULT_BUFFER_SEGMENT_SIZE /* 65536 */:
                return A08(357, 10, 0);
            case 131072:
                return A08(590, 20, 99);
            default:
                return A08(610, 14, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE);
        }
    ...
    public final String toString() {
        ...
        sb2.append(A08(Sdk$SDKError.b.MRAID_JS_DOES_NOT_EXIST_VALUE, 8, 52)).append(A05());
        sb2.append(A08(91, 22, 4)).append(A03());
        sb2.append(A08(Sdk$SDKError.b.PRIVACY_ICON_FALLBACK_ERROR_VALUE, 10, 41)).append(A06());
        sb2.append(A08(41, 13, 24)).append(A0C());
        sb2.append(A08(54, 11, 88)).append(A0D());
        sb2.append(A08(Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE, 13, 5)).append(A0G());
        sb2.append(A08(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 11, 97)).append(A0H());
        sb2.append(A08(Sdk$SDKError.b.AD_ALREADY_FAILED_VALUE, 12, 109)).append(A0L());
        sb2.append(A08(78, 13, 37)).append(A0E());
        sb2.append(A08(148, 17, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL)).append(A0I());
        sb2.append(A08(Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE, 11, 65)).append(A0F());
        sb2.append(A08(180, 12, 109)).append(A0J());
        StringBuilder builder3 = new StringBuilder().append(A08(PsExtractor.AUDIO_STREAM, 14, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE)).append(A0K());
