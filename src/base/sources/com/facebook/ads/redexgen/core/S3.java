...
public final class S3 implements NativeAdScrollViewApi {
    ...
    public S3(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i10, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i11) {
        if (nativeAdsManager.isLoaded()) {
            if (type != null || adViewProvider != null || i10 > 0) {
                this.A06 = C1571Rp.A03(context);
                this.A04 = nativeAdsManager;
                this.A03 = nativeAdViewAttributes;
                this.A01 = adViewProvider;
                this.A02 = type;
                this.A00 = i11;
                C2226hA c2226hA = new C2226hA(this);
                this.A05 = new C2225h9(context);
                if (this.A02 == null) {
                    if (i10 > 0) {
                        this.A05.A00(((int) XX.A02) * i10);
                    }
                } else {
                    this.A05.A00((int) (XX.A02 * this.A02.getHeight()));
                }
                this.A05.setAdapter(c2226hA);
                setInset(20);
                c2226hA.A09();
