...
public final class C1388Kj {
    ...
    public C1388Kj(String str, int i10, String str2, Set<String> classes) {
        this.A00 = i10;
        this.A01 = str;
        this.A02 = str2;
        this.A03 = classes;
    ...
    public static C1388Kj A00() {
        Set setEmptySet = Collections.emptySet();
        String strA02 = A02(0, 0, 5);
        return new C1388Kj(strA02, 0, strA02, setEmptySet);
    }

    public static C1388Kj A01(String str, int i10) {
        String strTrim;
        String strTrim2 = str.trim();
        AbstractC09823y.A07(!strTrim2.isEmpty());
        ...
        for (int i11 = 1; i11 < voiceStartIndex; i11++) {
            hashSet.add(strArrA1O[i11]);
        }
        return new C1388Kj(str2, i10, strTrim, hashSet);
    }
}
