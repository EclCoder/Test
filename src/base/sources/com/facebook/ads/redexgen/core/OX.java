...
public abstract class OX {
    ...
    public static Bundle A00(T8 t10) {
        Bundle bundle = new Bundle();
        A08(bundle, t10);
        String strA06 = A06(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 19, 81);
        Bundle data = A01(t10);
        bundle.putBundle(strA06, data);
        return bundle;
    }

    public static Bundle A01(T8 t10) {
        Bundle bundle = new Bundle();
        bundle.putBoolean(A06(67, 23, 65), AdSettings.isMixedAudience());
        bundle.putBoolean(A06(6, 27, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE), AdInternalSettings.isExplicitTestMode());
        String adTypeString = AdSettings.getTestAdType().getAdTypeString();
        if (adTypeString != null) {
            bundle.putString(A06(272, 20, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL), adTypeString);
        }
        ...
        String adTypeString4 = A06(204, 33, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE);
        ...
        bundle.putBoolean(A06(54, 13, 2), XY.A05(t10));
        return bundle;
    }

    public static Bundle A02(String str, C2308iY c2308iY) {
        Bundle bundle = new Bundle();
        A08(bundle, c2308iY.A05());
        bundle.putString(A06(451, 17, 16), c2308iY.A0A());
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c2308iY.A07());
        bundle.putString(A06(366, 19, 0), c2308iY.A08());
        bundle.putString(A06(404, 22, 98), c2308iY.A09());
        bundle.putString(A06(385, 19, 96), OT.A01(c2308iY.A0B()));
        RewardData rewardDataA03 = c2308iY.A03();
        if (rewardDataA03 != null) {
            OY.A00(bundle, rewardDataA03);
        }
        C2198gi c2198giA05 = c2308iY.A05();
        if (A01[7].charAt(1) != 'G') {
            throw new RuntimeException();
        }
        String[] strArr = A01;
        ...
        bundle.putBundle(A06(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 19, 81), A01(c2198giA05));
        return bundle;
    }

    public static Bundle A03(String str, C2293iI c2293iI) {
        Bundle bundle = new Bundle();
        A08(bundle, c2293iI.A0B);
        bundle.putString(A06(451, 17, 16), c2293iI.A0D);
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c2293iI.A05);
        bundle.putString(A06(366, 19, 0), c2293iI.A06);
        bundle.putString(A06(404, 22, 98), c2293iI.A07);
        AdExperienceType adExperienceType = c2293iI.A02;
        if (adExperienceType != null) {
            bundle.putString(A06(237, 22, 24), OS.A02(adExperienceType));
        }
        bundle.putBoolean(A06(90, 33, 27), c2293iI.A08);
        RewardData rewardData = c2293iI.A03;
        if (rewardData != null) {
            OY.A00(bundle, rewardData);
        }
        bundle.putBundle(A06(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 19, 81), A01(c2293iI.A0B));
        return bundle;
    }

    public static C2308iY A04(C2198gi c2198gi, Bundle bundle, String str) {
        ...
        String placement5 = A06(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 19, 81);
        ...
        C2308iY c2308iY = new C2308iY(c2198gi, null, string, new C2299iP(str, string4, bundle2));
        c2308iY.A0I(string3);
        c2308iY.A0H(string2);
        c2308iY.A0J(sdkVersion);
        String placement6 = A06(385, 19, 96);
        c2308iY.A0K(OT.A02(bundle.getString(placement6)));
        RewardData rewardDataA01 = OY.A01(bundle);
        if (rewardDataA01 != null) {
            c2308iY.A0F(rewardDataA01);
        }
        return c2308iY;
    }

    public static C2293iI A05(C2198gi c2198gi, Bundle bundle, String str) {
        String string = bundle.getString(A06(451, 17, 16));
        ...
        String rvPlacement7 = A06(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 19, 81);
        ...
        C2293iI c2293iI = new C2293iI(c2198gi, string, null, new C2299iP(str, string4, bundle2));
        c2293iI.A06 = adExperienceType;
        c2293iI.A05 = string2;
        c2293iI.A08 = z10;
        c2293iI.A02 = OS.A00(string3);
        c2293iI.A07 = mediationData;
        RewardData rewardDataA01 = OY.A01(bundle);
        if (rewardDataA01 != null) {
            c2293iI.A03 = rewardDataA01;
        }
        return c2293iI;
    }

    public static void A08(Bundle bundle, T8 t10) {
        bundle.putString(A06(344, 22, 96), A06(0, 6, 101));
        boolean zAAT = false;
        boolean isForcedFunnelLogging = t10 instanceof C2198gi;
        if (isForcedFunnelLogging) {
            zAAT = ((C2198gi) t10).A0F().AAT();
        }
        boolean isForcedFunnelLogging2 = TX.A0I(t10);
        bundle.putBoolean(A06(33, 21, 55), isForcedFunnelLogging2 || zAAT);
        bundle.putString(A06(330, 14, 30), t10.getPackageName());
        boolean isForcedFunnelLogging3 = AbstractC1651Us.A0G(t10);
        if (isForcedFunnelLogging3) {
            bundle.putString(A06(Sdk$SDKError.b.MRAID_JS_CALL_EMPTY_VALUE, 19, 51), new C1594Sn().A03(t10));
        }
    }
}
