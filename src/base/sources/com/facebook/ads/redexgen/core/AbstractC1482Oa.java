...
public abstract class AbstractC1482Oa {
    ...
    public static final AtomicReference<InterfaceC1484Oc> A05;
    ...
    public static void A02(String str, Bundle bundle) {
        ...
        if (0 != 0) {
            ...
            throw new NullPointerException(A00(29, 12, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE));
        }
