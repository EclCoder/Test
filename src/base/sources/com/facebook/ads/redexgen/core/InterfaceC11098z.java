...
public interface InterfaceC11098z {
    void A59(C2758qI c2758qI, int i10, int[] iArr) throws C11048s;
    ...
    boolean A9e(ByteBuffer byteBuffer, long j10, int i10) throws C11088y, C11058t;
    ...
    void AH2() throws C11088y;

    void AJG(C2764qQ c2764qQ);
    ...
    void AJV(InterfaceC11068v interfaceC11068v);

    void AJd(C2737px c2737px);
