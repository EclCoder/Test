...
public final class LV extends AbstractC1844ay {
    ...
    public final WeakReference<InterfaceC1847b1> A0A;
    ...
    public LV(C2198gi c2198gi, WeakReference<InterfaceC1847b1> weakReference, int i10, String str) {
        this(c2198gi, weakReference, i10, false);
        if (C1648Up.A1z(c2198gi)) {
            c2198gi.A02().A0B().AKo(this, str == null ? A02(0, 0, 91) : str, false, true);
            this.A06 = true;
        }
    }

    public LV(C2198gi c2198gi, WeakReference<InterfaceC1847b1> weakReference, int i10, boolean z10) {
        super(c2198gi);
        ...
        this.A02 = new C1421Lq(this);
        this.A03 = new C2143fp(this, i10, new WeakReference(this.A02), this.A09);
        setWebChromeClient(A0G());
        setWebViewClient(A0H());
        getSettings().setSupportZoom(false);
        getSettings().setCacheMode(1);
        addJavascriptInterface(new C1846b0(this, weakReference.get(), this.A03, this.A0B, this.A0C, this.A09), A02(0, 9, 46));
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC1844ay
    ...
    public final WebViewClient A0H() {
        return new C1849b3(this.A09, this.A0A, new WeakReference(this.A03), new WeakReference(this.A01), new WeakReference(this.A0C), new WeakReference(this), this.A0D, this.A0E, this.A04);
    }

    public final void A0K() {
        this.A09.A0F().AKq();
        this.A0B.set(true);
        new Handler(Looper.getMainLooper()).post(new C1412Lh(this.A03));
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC1844ay, android.webkit.WebView
