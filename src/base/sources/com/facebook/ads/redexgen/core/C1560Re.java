...
public final class C1560Re implements AudienceNetworkActivityApi, Repairable {
    ...
    public WK A07;
    public InterfaceC1740Yi A08;
    public AbstractC1761Zd A09;
    public C2046eF A0A;
    public String A0B;
    public String A0C;
    public boolean A0D;
    ...
    public final C1570Ro A0G;
    public final S1 A0H;
    public final SK A0I;
    public final C2198gi A0J;
    public final List<InterfaceC1566Rk> A0K = new ArrayList();
    public int A01 = -1;
    ...
    public C1560Re(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        this.A0E = audienceNetworkActivity;
        this.A0F = audienceNetworkActivityApi;
        this.A0J = C1571Rp.A02(audienceNetworkActivity);
        this.A0J.A0O(this);
        this.A0H = new S1(this.A0J, this.A0E);
        this.A0I = new SK(this.A0J, this.A0E);
        this.A0G = new C1570Ro(this, this.A0J, this.A0E);
    }

    private String A00() {
        if (this.A07 == null || this.A07.A03() == null) {
            return A01(138, 4, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE);
        }
        return this.A07.A03();
    }

    private void A03(Intent intent, Bundle bundle) {
        String strA01 = A01(Sdk$SDKError.b.INVALID_CSB_DATA_VALUE, 8, 90);
        String strA02 = A01(Sdk$SDKError.b.MRAID_JS_COPY_FAILED_VALUE, 8, 39);
        String strA03 = A01(165, 24, 85);
        if (bundle != null) {
            Bundle bundleA03 = C1702Wu.A03(bundle, DynamicLoaderImpl.class.getClassLoader());
    ...
    public final void A0A(InterfaceC1566Rk interfaceC1566Rk) {
        this.A0K.add(interfaceC1566Rk);
    }

    public final void A0B(InterfaceC1566Rk interfaceC1566Rk) {
        this.A0K.remove(interfaceC1566Rk);
    }
    ...
    public final void A0D(String str, C1468Nm c1468Nm) {
        if (this.A08 == null) {
            return;
        }
        AbstractC1761Zd abstractC1761Zd = this.A09;
        if (A0M[6].charAt(30) != 'X') {
            throw new RuntimeException();
        }
        A0M[0] = "nOOhjPgmgj4ymGbfbhDfGuv2YA";
        if (abstractC1761Zd == null) {
            this.A09 = AbstractC1762Ze.A02(this.A0J, this.A0J.A0A(), str, c1468Nm, this.A08, new C2244hS(this));
    ...
    public final void A0E(String str, UL ul2) {
        this.A0G.A08(str, ul2, this.A0B);
    }
    ...
    public final void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        X2.A00();
        if (0 != 0) {
            throw new NullPointerException(A01(142, 15, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE));
        }
    ...
    public final void finish(int i10) {
        if (i10 == 9 && (this.A08 instanceof C1280Ge)) {
            C1280Ge c1280Ge = (C1280Ge) this.A08;
            if (c1280Ge.A0e()) {
                if (this.A09 != null) {
                    YB.A0J(this.A09);
                }
        ...
        this.A0J.A0F().A3D(String.valueOf(A05().hashCode()), i10, A00());
        ...
        audienceNetworkActivityApi.finish(i10);
    }
    ...
    public final void onBackPressed() {
        ...
        if (this.A03 > this.A02) {
            ...
            Iterator<InterfaceC1566Rk> it = this.A0K.iterator();
            while (it.hasNext()) {
                if (it.next().AAI()) {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        if (this.A00 != configuration.orientation) {
            ...
            String strA01 = A01(Sdk$SDKError.b.AD_IS_PLAYING_VALUE, 14, 44);
            if (i10 == 1) {
                map.put(strA01, A01(157, 8, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE));
            } else {
    ...
    public final void onCreate(Bundle bundle) {
        YD.A02();
        this.A0I.A04();
        this.A05 = C1702Wu.A02(this.A0E.getIntent(), DynamicLoaderImpl.class.getClassLoader());
        C2198gi c2198giA04 = C1702Wu.A04(this.A05);
        if (c2198giA04 != null) {
            C2198gi startAdContext = this.A0J;
            startAdContext.A0M(c2198giA04);
        }
        A03(this.A05, bundle);
        C2198gi startAdContext2 = this.A0J;
        ...
        C2198gi startAdContext3 = this.A0J;
        VA vaA0A = startAdContext3.A0A();
        C2198gi startAdContext4 = this.A0J;
        this.A08 = new C1565Rj(this, intent, vaA0A, startAdContext4).A0M(this.A07, this.A06);
        if (this.A08 == null) {
            C2198gi startAdContext5 = this.A0J;
            startAdContext5.A08().ABC(A01(58, 11, 105), AbstractC1610Td.A0A, new C1611Te(A01(0, 58, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE)));
            A09();
            finish(7);
            return;
        }
    ...
    public final void onResume() {
        ...
        this.A04 = System.currentTimeMillis();
        if (this.A08 != null) {
            InterfaceC1740Yi interfaceC1740Yi = this.A08;
            if (A0M[5].charAt(17) != 'w') {
                throw new RuntimeException();
            }
            A0M[6] = "WHwDulcP2dZca7YA0PmotSPySBaz7ZXD";
            interfaceC1740Yi.AFi(false);
            if (this.A0D) {
    ...
    public final void onSaveInstanceState(Bundle bundle) {
        ...
        bundle2.putString(A01(Sdk$SDKError.b.MRAID_JS_COPY_FAILED_VALUE, 8, 39), this.A0B);
        bundle2.putString(A01(79, 11, 56), this.A0C);
        bundle2.putSerializable(A01(Sdk$SDKError.b.INVALID_CSB_DATA_VALUE, 8, 90), this.A07);
        C1702Wu.A0A(bundle, bundle2);
    }
