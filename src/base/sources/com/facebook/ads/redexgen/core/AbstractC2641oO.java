...
public abstract class AbstractC2641oO<E> extends AbstractCollection<E> implements Serializable {
    ...
    public final <T> T[] toArray(T[] tArr) {
        AbstractC2428ki.A04(tArr);
        int size = size();
        if (tArr.length < size) {
            Object[] objArrA0L = A0L();
            if (objArrA0L != null) {
                return (T[]) AbstractC2761qN.A02(objArrA0L, A0H(), A0G(), tArr);
            }
            tArr = (T[]) AbstractC2756qG.A05(tArr, size);
