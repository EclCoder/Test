...
public final class C1456Na implements Serializable {
    ...
    public C1456Na(int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, int i19) {
        this.A00 = i10;
        this.A01 = i11;
        this.A02 = i12;
        this.A03 = i13;
    ...
    public static C1456Na A01(JSONObject jSONObject) {
        return new C1456Na(A00(jSONObject, A02(37, 12, 27), A0B), A00(jSONObject, A02(57, 10, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE), A0C), A00(jSONObject, A02(152, 14, 101), -16777216), A00(jSONObject, A02(49, 8, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE), A0D), A00(jSONObject, A02(67, 9, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), A0E), A00(jSONObject, A02(76, 20, 103), -1), A00(jSONObject, A02(Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE, 14, 73), -1), A00(jSONObject, A02(Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE, 25, Sdk$SDKError.b.TPAT_ERROR_VALUE), A0G), A00(jSONObject, A02(166, 11, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE), -16777216), A00(jSONObject, A02(96, 17, 106), A0E));
    }
