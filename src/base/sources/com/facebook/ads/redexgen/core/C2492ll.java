...
public class C2492ll<K, V> implements Iterator<Map.Entry<K, Collection<V>>> {
    public static byte[] A03;

    @CheckForNull
    public Collection<V> A00;
    public final Iterator<Map.Entry<K, Collection<V>>> A01;
    public final /* synthetic */ C1169Bt A02;
    ...
    public C2492ll(final C1169Bt this$1) {
        this.A02 = this$1;
    ...
    public final void remove() {
        AbstractC2428ki.A0F(this.A00 != null, A00(0, 50, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE));
        this.A01.remove();
