...
public enum EnumC2784qp {
    ...
    public static EnumC2784qp[] valuesCustom() {
        EnumC2784qp[] enumC2784qpArrValuesCustom = values();
        if (A01[4].length() == 0) {
            throw new RuntimeException();
        }
        A01[5] = "kC8OQjnUJR";
        return (EnumC2784qp[]) enumC2784qpArrValuesCustom.clone();
    }
}
