...
public final class KD extends AbstractC1911c3 {
    public RelativeLayout A00;
    public RelativeLayout A01;
    public InterfaceC2028dx A02;
    public C1245Eu A03;
    public C1235Ek A04;
    public C4L A05;
    ...
    public KD(C1915c7 c1915c7) {
        ...
        this.A0D = new EA() { // from class: com.facebook.ads.redexgen.X.6F
            ...
            public final void A03(C4K c4k) {
                this.A00.A04.A0e(EnumC2085et.A02, 20);
            }
        };
    ...
    private LinearLayout A00() {
        ...
        if (!TextUtils.isEmpty(strA0C)) {
            YM ym2 = YM.RATINGS;
            AbstractC2363jd abstractC2363jdA05 = this.A0C.A05();
            String[] strArr = A0F;
            if (strArr[4].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
            A0F[2] = "";
            LinearLayout videoMetaDataLayout = A01(ym2, abstractC2363jdA05.A29().A0I().A0C());
    ...
    private LinearLayout A01(YM ym2, String str) {
        LinearLayout linearLayout = new LinearLayout(this.A0B);
        linearLayout.setOrientation(0);
        ...
        C1886be c1886be = new C1886be(this.A0C.A06(), 0, -1, ym2);
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(A0P, A0P);
        layoutParams2.gravity = 16;
        c1886be.setLayoutParams(layoutParams2);
    ...
    private final RelativeLayout A02(String str, int i10, YM ym2) {
        ...
        C1886be iconView = new C1886be(this.A0C.A06(), 0, -1, ym2);
    ...
    private C1235Ek A05() {
        C1235Ek c1235Ek = new C1235Ek(this.A0C.A06());
        YB.A0V(c1235Ek, YB.A06(436207616, A0Q));
        c1235Ek.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
        this.A05 = new C4L(this.A0B, getAdEventManager(), c1235Ek, this.A0C.A05().A2E(), 0, 0, true, null, null);
        if (C1648Up.A20(this.A0B)) {
            this.A03 = new C1245Eu(this.A0B, getAdEventManager(), c1235Ek, this.A0C.A05().A2E(), false, this.A05, null);
        } else {
            this.A03 = null;
        }
        return c1235Ek;
    ...
    private void A07() {
        ...
        this.A00.setOnClickListener(new ViewOnClickListenerC1939cV(this));
        this.A01.setOnClickListener(new ViewOnClickListenerC1940cW(this));
    }

    private void A08() {
        new VI(this.A0C.A05().A2E(), getAdEventManager()).A04(VH.A0f, null);
        AbstractC1899br.A00(this.A0C.A06(), this, this.A0C.A05().A29().A0H().A08());
        ...
        this.A04.A0e(EnumC2085et.A02, 20);
