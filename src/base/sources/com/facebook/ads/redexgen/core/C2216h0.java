...
public class C2216h0 extends AbstractRunnableC1685Wc {
    ...
    public static String A00(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            int i14 = (bArrCopyOfRange[i13] ^ i12) ^ Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE;
            if (A02[2].length() != 22) {
    ...
    public final void A07() {
        try {
            ...
            this.A00.A02.A0X(new C2218h2(this), new C1597Sq(this.A00.A04, this.A00.A03));
        } catch (JSONException unused) {
            this.A00.A00.post(new C2217h1(this));
        }
    }
}
