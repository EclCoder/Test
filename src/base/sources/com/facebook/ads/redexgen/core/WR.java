...
public class WR extends AbstractRunnableC1685Wc {
    ...
    public final void A07() {
        ...
        try {
            ...
            if (all.size() > 1) {
                VL.A06(this.A00, C2167gD.A00(this.A00), all);
            }
            sharedPreferences.edit().clear().apply();
            sharedPreferences.edit().putString(A00(45, 19, 34), this.A00.A09().A02()).putString(A00(64, 21, Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE), Y1.A03(this.A00.A09().A01())).apply();
        } catch (JSONException e10) {
            this.A00.A08().ABC(A00(31, 14, 46), 3502, new C1611Te(e10));
            sharedPreferences.edit().clear().apply();
        }
