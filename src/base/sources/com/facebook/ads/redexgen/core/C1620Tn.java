...
public final class C1620Tn {
    ...
    static {
        ...
        A09 = new String[]{A01(152, 1, 2), A01(153, 1, 107), A01(154, 1, AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL)};
    ...
    public static void A09(Context context) {
        ...
        ((ActivityManager) AbstractC2249hX.A00((ActivityManager) context.getSystemService(A01(16, 8, 108)))).getMemoryInfo(memoryInfo);
        A07.put(A01(61, 16, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE), String.valueOf(memoryInfo.availMem));
        A07.put(A01(140, 12, 58), String.valueOf(memoryInfo.totalMem));
    }

    public static void A0A(T8 t10) {
        try {
            Intent intentA00 = XA.A00(t10, null, new IntentFilter(A01(24, 37, 65)));
            if (intentA00 == null) {
                return;
            }
            int intExtra = intentA00.getIntExtra(A01(109, 5, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE), -1);
            int scale = intentA00.getIntExtra(A01(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 5, 78), -1);
            ...
            t10.A08().ABC(A01(102, 7, 96), AbstractC1610Td.A1T, new C1611Te(e10));
        }
    }

    public static synchronized void A0B(T8 t10) {
        A09(t10);
        A0A(t10);
        if (A04 == null) {
            A04 = (SensorManager) t10.getSystemService(A01(128, 6, 101));
            if (A04 == null) {
                return;
            }
        }
    ...
    public static void A0C(Map<String, String> map) {
        ...
        if (fArr2 != null) {
            ...
            for (int i11 = 0; i11 < iMin2; i11++) {
                map.put(A01(Sdk$SDKError.b.ASSET_WRITE_ERROR_VALUE, 9, 19) + A09[i11], String.valueOf(fArr2[i11]));
            }
        }
    }
}
