...
public final class NR implements Serializable {
    ...
    public static NR A00(JSONObject jSONObject) {
        ...
        nr.A06(ntA0K);
        nr.A0F(jSONObject.optBoolean(A01(685, 21, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE)));
        nr.A0A(new C1459Nd(AbstractC1709Xd.A04(jSONObject.optJSONArray(A01(Sdk$SDKError.b.WEBVIEW_ERROR_VALUE, 15, 95))), jSONObject.optLong(A01(252, 24, 57), 0L), jSONObject.optLong(A01(276, 44, 66), 0L), jSONObject.optBoolean(A01(476, 26, 75)), jSONObject.optBoolean(A01(397, 31, 46), false), jSONObject.optBoolean(A01(428, 34, 79), false)));
    ...
    private final void A09(C1458Nc c1458Nc) {
        this.A04 = c1458Nc;
    }

    private final void A0A(C1459Nd c1459Nd) {
        this.A05 = c1459Nd;
    }
    ...
    public final C1458Nc A0J() {
        return this.A04;
    }

    public final C1459Nd A0K() {
        return this.A05;
    }
