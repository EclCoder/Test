...
public final class C1642Uj implements Closeable {
    ...
    public final UZ A01;
    public final Deque<C1641Ui> A02 = new LinkedList();
    ...
    public final synchronized int A09() throws IOException {
        int iA01;
        if (this.A00) {
            throw new IOException(A02(Sdk$SDKError.b.INVALID_CSB_DATA_VALUE, 33, 31));
        }
        iA01 = 0;
        Iterator<C1641Ui> it = this.A02.iterator();
        while (it.hasNext()) {
            iA01 += it.next().A01();
        }
        return iA01;
    ...
    public C1642Uj(UZ uz, InterfaceC1640Uh interfaceC1640Uh) throws IOException {
        this.A01 = uz;
        A05(uz, interfaceC1640Uh);
        if (this.A02.isEmpty()) {
            A00();
        }
    }

    private C1641Ui A00() throws IOException {
        int iA00 = -1;
        if (!this.A02.isEmpty()) {
            iA00 = this.A02.getLast().A00();
        }
        int i10 = iA00 + 1;
        this.A02.add(new C1641Ui(i10, new C1638Uf(new File(this.A01.A05(), A01(i10)))));
    ...
    private void A04(int i10, File file) throws IOException {
        C1638Uf c1638Uf = new C1638Uf(file);
        c1638Uf.A05();
        this.A02.addFirst(new C1641Ui(i10, c1638Uf));
    }

    private void A05(UZ uz, InterfaceC1640Uh interfaceC1640Uh) throws IOException {
        ...
        if (fileArrListFiles != null) {
            ...
            for (File file : fileArrListFiles) {
                try {
                    ...
                    hashSet.add(file);
                    interfaceC1640Uh.AIc(String.format(Locale.US, A02(260, 39, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE), file.getCanonicalPath()));
                }
            }
            ...
            if (!zIsEmpty) {
                ...
                while (it.hasNext()) {
                    ...
                    if (iIntValue < i12) {
                        interfaceC1640Uh.AIc(String.format(Locale.US, A02(166, 61, 41), Integer.valueOf(iIntValue), Integer.valueOf(i12)));
                ...
                while (i10 >= i12) {
                    ...
                    try {
                        ...
                        interfaceC1640Uh.AId(String.format(Locale.US, A02(104, 62, 55), file2.getCanonicalPath(), Integer.valueOf(i10)), e10);
            ...
            for (Object obj : hashSet) {
                ...
                if (!file3.delete()) {
                    ...
                    if (A04[7].charAt(19) != 'm') {
                        ...
                        interfaceC1640Uh.AIc(String.format(locale, A02(40, 26, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), objArr));
                    } else {
                        A04[7] = "xgRJlHLuW2qx7z7dN03x9GIdgxBOKXSD";
                        objArr[0] = canonicalPath;
                        interfaceC1640Uh.AIc(String.format(locale, A02(38, 20, 82), objArr));
                    }
                }
            }
            return;
    ...
    public final synchronized boolean A0D() throws IOException {
        if (!this.A00) {
            ...
            C1641Ui first = this.A02.getFirst();
