...
public final class X9 implements OW {
    ...
    public final V2 A05(String str, Messenger messenger, String str2) {
        V2 v10 = new V2(str, messenger, str2);
        this.A00.put(str, v10);
        return v10;
    }
    ...
    public final void A07(int i10, String str, Bundle bundle, Messenger messenger) {
        try {
            ...
            if (bundle != null) {
                messageObtain.getData().putBundle(A01(0, 17, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE), bundle);
            }
    ...
    public final void A08(String str) {
        V2 v10 = this.A00.get(str);
        if (v10 != null && v10.A00 != null) {
