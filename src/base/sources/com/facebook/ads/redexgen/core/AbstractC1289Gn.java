...
public abstract class AbstractC1289Gn {
    ...
    public static int A00(C10044u c10044u) {
        int iA04 = c10044u.A04(5);
        if (iA04 == 31) {
            int audioObjectType = c10044u.A04(6);
            return audioObjectType + 32;
        }
        return iA04;
    }

    public static int A01(C10044u c10044u) throws C3K {
        ...
        if (iA04 == 15) {
            ...
            if (iA01 >= 24) {
                int frequencyIndex = c10044u.A04(24);
    ...
    public static C1288Gm A02(C10044u c10044u, boolean z10) throws C3K {
        int iA00 = A00(c10044u);
        int iA01 = A01(c10044u);
        int iA04 = c10044u.A04(4);
                ...
                case 23:
                    ...
                    switch (iA00) {
                        ...
                        case 23:
                            ...
                            if (iA05 == 2 || iA05 == 3) {
                                throw C3K.A00(A04(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 22, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE) + iA05);
                            }
                    }
                    break;
                case 5:
        ...
        if (channelCount != -1) {
            return new C1288Gm(iA01, channelCount, str);
        }
        throw C3K.A01(null, null);
    }

    public static C1288Gm A03(byte[] bArr) throws C3K {
        return A02(new C10044u(bArr), false);
    }
    ...
    public static void A06(C10044u c10044u, int i10, int i11) {
        boolean zA0H;
        String[] strArr;
        boolean frameLengthFlag = c10044u.A0H();
        if (frameLengthFlag) {
            AbstractC09904g.A07(A04(69, 7, 75), A04(76, 30, 66));
        }
        boolean frameLengthFlag2 = c10044u.A0H();
        if (!frameLengthFlag2) {
            zA0H = c10044u.A0H();
            if (i11 != 0) {
                if (i10 != 6 || i10 == 20) {
