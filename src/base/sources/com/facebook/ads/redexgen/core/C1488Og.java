...
public final class C1488Og {
    ...
    public final InterfaceC1494Om A00;
    ...
    static {
        A06();
        A03 = new String[]{A02(455, 7, 105), A02(462, 19, 99), A02(481, 25, 111), A02(PglCryptUtils.DECRYPT_FAILED, 15, 8), A02(616, 9, 64), A02(625, 21, 111), A02(646, 27, 69), A02(673, 17, 10), A02(543, 21, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE), A02(421, 16, 22), A02(437, 18, 6), A02(401, 20, 41), A02(699, 20, 93), A02(355, 14, 38), A02(564, 25, 2)};
    }

    public C1488Og(InterfaceC1494Om interfaceC1494Om) {
        this.A00 = interfaceC1494Om;
    }
    ...
    public static List<C1492Ok> A04(String str) throws JSONException {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            ...
            C1492Ok c1492Ok = new C1492Ok(jSONObject.getInt(A02(604, 12, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE)), jSONObject.getString(A02(593, 11, 55)), jSONObject.optString(A02(369, 16, 63)));
            Iterator<C1492Ok> it = A04(jSONObject.optString(A02(385, 16, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE))).iterator();
            while (it.hasNext()) {
                c1492Ok.A06(it.next());
            }
            arrayList.add(c1492Ok);
        }
        return arrayList;
    }
            ...
            if (!str.equals(A02(353, 2, 45))) {
                ...
                try {
                    ...
                    if (A04(jSONObject.getString(A02(673, 17, 10))).size() == 0) {
                        A08(AbstractC1610Td.A28, new C1611Te(A02(239, 20, 107)));
                        return null;
                    }
                    if (A04(jSONObject.getString(A02(PglCryptUtils.DECRYPT_FAILED, 15, 8))).size() == 0) {
                        A08(AbstractC1610Td.A25, new C1611Te(A02(Sdk$SDKError.b.AD_LOAD_FAIL_RETRY_AFTER_VALUE, 18, 45)));
                        return null;
                    }
                    return map;
                } catch (JSONException e10) {
                    A08(AbstractC1610Td.A27, new C1611Te(e10));
                    return null;
                }
            }
        }
    ...
    private final void A07() {
        C2287iC c2287iCA6I = this.A00.A6I();
        c2287iCA6I.A00(A02(521, 22, 15), 0L);
        c2287iCA6I.A02();
    }

    public static void A08(int i10, C1611Te c1611Te) {
        C2194ge sdkContext = T7.A00();
        if (sdkContext != null) {
            sdkContext.A08().ABC(A02(690, 9, 19), i10, c1611Te);
        }
    }
    ...
    public final C1492Ok A0A() {
        C1492Ok c1492Ok = new C1492Ok(A00());
        try {
            for (C1492Ok hideAdParent : A04(A03(A02(PglCryptUtils.DECRYPT_FAILED, 15, 8), A02(0, 0, 48)))) {
                c1492Ok.A06(hideAdParent);
            }
        } catch (JSONException e10) {
            A07();
            A08(AbstractC1610Td.A26, new C1611Te(e10));
        }
        return c1492Ok;
    }

    public final C1492Ok A0B() {
        C1492Ok c1492Ok = new C1492Ok(A01());
        try {
            for (C1492Ok reportAdParent : A04(A03(A02(673, 17, 10), A02(0, 0, 48)))) {
                c1492Ok.A06(reportAdParent);
            }
        } catch (JSONException e10) {
            A07();
            A08(AbstractC1610Td.A29, new C1611Te(e10));
        }
        return c1492Ok;
    }
    ...
    public final String A0D() {
        return A03(A02(401, 20, 41), A02(Sdk$SDKError.b.JSON_PARAMS_ENCODE_ERROR_VALUE, 38, 95));
    }
    ...
    public final String A0J() {
        return A03(A02(543, 21, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE), A02(200, 21, 1));
    }

    public final String A0K() {
        return A03(A02(625, 21, 111), A02(0, 38, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE));
    }
    ...
    public final void A0N(String str) {
        ...
        C2287iC c2287iCA6I = this.A00.A6I();
        for (String str2 : A03) {
            c2287iCA6I.A01(str2, mapA05.get(str2));
        }
        if (A02[1].length() == 0) {
            throw new RuntimeException();
        }
        ...
        strArr[5] = "LB7njF";
        c2287iCA6I.A00(A02(521, 22, 15), System.currentTimeMillis());
        c2287iCA6I.A02();
    }

    public final boolean A0O(Context context, boolean z10) {
        return (z10 || C1648Up.A2h(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
