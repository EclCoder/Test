...
public final class C7X extends AbstractC2318ik {
    ...
    public C7X(C2293iI c2293iI, String str) {
        super(c2293iI.A0B, str, A00(c2293iI));
        this.A01 = c2293iI;
    }

    public static C2292iH A00(C2293iI c2293iI) {
        return new C2292iH(c2293iI);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC2318ik
    ...
    public final void A09() {
        this.A00 = new C2309iZ(this.A01, this, A04());
    ...
    public final void A0F(Ad ad2, String str, AdExperienceType adExperienceType, boolean z10) {
        ...
        this.A01.A08 = z10;
        if (AbstractC1651Us.A09(this.A02) && AbstractC1651Us.A0B(this.A02)) {
            if (AbstractC1651Us.A0M(str)) {
                A05();
                return;
            } else {
                A09();
