...
public final class C2228hC extends C1568Rm implements MediaViewApi, Repairable, T4, InterfaceC1760Zc {
    ...
    public boolean A0J;
    public boolean A0K;
    public EnumC1577Rv A0B = EnumC1577Rv.A04;
    public int A01 = 0;
    public int A00 = 0;
    ...
    private void A06() {
        this.A0C.A0F().ABd();
        this.A0G = new C1879bX(this.A0C, false);
    ...
    private void A0B() {
        EnumC1708Xc.A04(this.A07, EnumC1708Xc.A0B);
        EnumC1708Xc.A04(this.A0F, EnumC1708Xc.A0B);
        EnumC1708Xc.A04(this.A09, EnumC1708Xc.A0B);
        EnumC1708Xc.A04(this.A03, EnumC1708Xc.A0B);
    }
    ...
    private void A0E(View view, UK uk2) {
        ...
        String strA1I = uk2.A1I();
        if (this.A07.getContext() == null) {
            return;
        }
        this.A0I = AbstractC2045eE.A01(this.A0C, strA1I);
        if (this.A0I != null) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
    ...
    private final void A0G(C2198gi c2198gi, AttributeSet attributeSet, int i10, int i11, MediaView mediaView) {
        this.A07 = mediaView;
        A0F(new ImageView(c2198gi, attributeSet, i10, i11));
        A0S(new C1851b5(c2198gi, attributeSet, i10, i11));
        this.A0E = new C0x(c2198gi, attributeSet, i10);
        A0A();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2198gi, attributeSet, i10, i11));
        A0B();
    }

    private final void A0H(C2198gi c2198gi, AttributeSet attributeSet, int i10, MediaView mediaView) {
        this.A07 = mediaView;
        A0F(new ImageView(c2198gi, attributeSet, i10));
        A0S(new C1851b5(c2198gi, attributeSet, i10));
        this.A0E = new C0x(c2198gi, attributeSet, i10);
        A0A();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2198gi, attributeSet, i10));
        A0B();
    }

    private final void A0I(C2198gi c2198gi, AttributeSet attributeSet, MediaView mediaView) {
        this.A07 = mediaView;
        A0F(new ImageView(c2198gi, attributeSet));
        A0S(new C1851b5(c2198gi, attributeSet));
        this.A0E = new C0x(c2198gi, attributeSet);
        A0A();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2198gi, attributeSet));
        A0B();
    }

    private final void A0J(C2198gi c2198gi, MediaView mediaView) {
        this.A07 = mediaView;
        A0F(new ImageView(c2198gi));
        A0S(new C1851b5(c2198gi));
        this.A0E = new C0x(c2198gi);
        A0A();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2198gi));
        A0B();
    }
    ...
    private void A0P(UK uk2) {
        if (this.A0G != null) {
            int iA0y = uk2.A0y();
            this.A0D = new XO(iA0y, new C2229hD(this, iA0y));
            this.A0D.A07();
        }
    }

    private void A0Q(final UK uk2, boolean z10) {
        if (this.A06 != null) {
        ...
        if (uk2.A13() != null && uk2.A13().A2U()) {
            ...
            C1789a5 c1789a5 = new C1789a5(this.A0C, EnumC1806aM.A05);
            ...
            if (z10) {
                ...
                layoutParams2.setMargins(i10, XV.A00, XV.A0U, XV.A0U);
            }
            this.A06.addView(c1789a5, layoutParams2);
            c1789a5.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.Ry
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.A00.A0Y(uk2, view);
                }
            });
    ...
    private void A0R(UK uk2, boolean z10, C1660Vb c1660Vb) {
        LM lmA04 = new LM(this.A04, this.A0C).A04();
        if (z10) {
            lmA04.A06(new C2236hK(this, uk2));
        }
        lmA04.A07(c1660Vb.getUrl());
    }

    private void A0S(C1851b5 c1851b5) {
        if (!this.A0K) {
            if (this.A0F != null) {
                this.A07.removeView(this.A0F);
            }
            c1851b5.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A07.addView(c1851b5, layoutParams);
            this.A0F = c1851b5;
            return;
        }
    ...
    public final void A0W(NativeAd nativeAd) {
        AbstractC2364je abstractC2364je;
        ViewParent parent;
        C2198gi adObjectContext = ((UK) nativeAd.getInternalNativeAd()).A16();
        ...
        if (ukA0L.A13() != null && ukA0L.A13().A1g()) {
            if (!TextUtils.isEmpty(ukA0L.A13().A29().A0H().A09())) {
                this.A0B = EnumC1577Rv.A05;
                ukA0L.A16().A0F().AJt(M5.A0A);
            } else {
                this.A0B = EnumC1577Rv.A03;
            ...
            ((C1581Rz) this.A09.getMediaViewVideoRendererApi()).A03();
            if (this.A03 != null) {
                this.A03.setVisibility(8);
                if (this.A03 instanceof C1842aw) {
                    ((C1842aw) this.A03).A04();
                } else {
                    ((C7M) this.A03).setAdapter(null);
                }
            }
            A01(false);
            this.A0H = new AnonymousClass62(this.A0C, this.A0C.A0A(), new C2234hI(this, ukA0L, nativeAd), ukA0L.A13(), A05(261, 31, 13), 4, ukA0L.A1E());
            EnumC1708Xc.A04(this.A0H, EnumC1708Xc.A0B);
            ...
            this.A0B = EnumC1577Rv.A02;
            ukA0L.A16().A0F().AJt(M5.A04);
            boolean z10 = ukA0L.A1C() == EnumC1663Ve.A0B;
            if (!C1648Up.A2v(this.A0C) || z10) {
                this.A03 = this.A0E;
                ((C0x) this.A03).setCurrentPosition(0);
                ((C0x) this.A03).setShowTextInCarousel(z10);
                if (z10) {
                    final C2198gi c2198gi = this.A0C;
                    final C0x c0x = (C0x) this.A03;
                    final List<UK> listA1N = ukA0L.A1N();
                    final C1662Vd c1662VdA1B = ukA0L.A1B();
                    abstractC2364je = new AbstractC2364je(c2198gi, c0x, listA1N, c1662VdA1B) { // from class: com.facebook.ads.redexgen.X.7r
                        public final C2198gi A00;
                        public final C1662Vd A01;

                        {
                            super(c0x, listA1N, c2198gi);
                            this.A00 = c2198gi;
                            this.A01 = c1662VdA1B == null ? new C1662Vd() : c1662VdA1B;
                        }

                        /* JADX INFO: Access modifiers changed from: private */
                        @Override // com.facebook.ads.redexgen.core.AbstractC1546Qq
                        /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
                        public final PX A0F(ViewGroup viewGroup, int i10) {
                            return new PX(new C1745Yn(this.A00, this.A01));
                        }

                        @Override // com.facebook.ads.redexgen.core.AbstractC1546Qq
                        /* JADX INFO: renamed from: A0Q */
                        public final void A0K(PX px, int i10) {
                            super.A0K(px, i10);
                            C1745Yn c1745Yn = (C1745Yn) px.A0p();
                            A0O(c1745Yn.getImageCardView(), i10);
                            if (((AbstractC2364je) this).A01.get(i10) != null) {
                                c1745Yn.setTitle(((AbstractC2364je) this).A01.get(i10).getAdHeadline());
                                c1745Yn.setSubtitle(((AbstractC2364je) this).A01.get(i10).getAdLinkDescription());
                                c1745Yn.setButtonText(((AbstractC2364je) this).A01.get(i10).getAdCallToAction());
                            }
                            UK uk2 = ((AbstractC2364je) this).A01.get(i10);
                            ArrayList arrayList = new ArrayList();
                            arrayList.add(c1745Yn);
                            uk2.A1V(c1745Yn, c1745Yn, arrayList);
                        }
                    };
                } else {
                    final C0x c0x2 = (C0x) this.A03;
                    final List<UK> listA1N2 = ukA0L.A1N();
                    final C2198gi c2198gi2 = this.A0C;
                    abstractC2364je = new AbstractC2364je(c0x2, listA1N2, c2198gi2) { // from class: com.facebook.ads.redexgen.X.7q
                        public final C2198gi A00;
                        ...
                        /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
                        public final PX A0F(ViewGroup viewGroup, int i10) {
                            return new PX(new C1751Yt(this.A00));
                        }
                        ...
                        public final void A0K(PX px, int i10) {
                            super.A0K(px, i10);
                            C1751Yt c1751Yt = (C1751Yt) px.A0p();
                            ZI imageView = (ZI) c1751Yt.getImageCardView();
                            imageView.setImageDrawable(null);
                            A0O(imageView, i10);
                            UK childAd = ((AbstractC2364je) this).A01.get(i10);
                            childAd.A16().A0L(this.A00);
                            childAd.A1U(c1751Yt, c1751Yt);
                        }
                    };
                }
                abstractC2364je.A0P(new C2233hH(this, ukA0L));
                ((C7M) this.A03).setAdapter(abstractC2364je);
            } else {
                A01(false);
                ...
                if (width == 0) {
                    ...
                    while (width == 0 && viewGroup != null) {
                        ...
                        boolean z11 = viewGroup.getParent() instanceof ViewGroup;
                        String[] strArr = A0M;
                        if (strArr[2].charAt(31) != strArr[0].charAt(31)) {
                            throw new RuntimeException();
                        }
                        ...
                        viewGroup = (ViewGroup) (z11 ? viewGroup.getParent() : null);
                    }
                }
                YB.A0J(this.A03);
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.addRule(13);
                this.A03 = new C1842aw(this.A0C);
                this.A07.addView(this.A03, layoutParams2);
                ((C1842aw) this.A03).A05(ukA0L, width);
                YB.A0K(this.A03);
                A01(true);
            }
            this.A02 = this.A03;
            ...
            if (zA0U) {
                ...
                if (strArr4[2].charAt(31) != strArr4[0].charAt(31)) {
                    ...
                    ((C1581Rz) this.A09.getMediaViewVideoRendererApi()).A04(nativeAd);
                    this.A09.setVisibility(0);
                    if (ukA0L.getAdCoverImage() != null) {
                        new LM(this.A07, this.A0C).A05(this.A07.getHeight(), this.A07.getWidth()).A06(new C2232hG(this, ukA0L)).A07(ukA0L.getAdCoverImage().getUrl());
                    }
                } else {
                    String[] strArr6 = A0M;
                ...
                new LM(this.A0F, this.A0C).A05(this.A07.getHeight(), this.A07.getWidth()).A06(new C2231hF(this, ukA0L)).A07(ukA0L.getAdCoverImage().getUrl());
                A0E(this.A0F, ukA0L);
            }
        }
        A0Q(ukA0L, false);
    ...
    public final void A0X(NativeAdBaseApi nativeAdBaseApi, boolean z10) {
        C2198gi c2198giA16 = ((UK) nativeAdBaseApi).A16();
        C2198gi adObjectContext = this.A0C;
        adObjectContext.A0L(c2198giA16);
        c2198giA16.A0O(this);
        this.A0K = true;
        ...
        this.A02 = this.A04;
        C1660Vb adIcon = ukA0L.getAdIcon();
        if (adIcon != null) {
            C1604Sx c1604SxA14 = ukA0L.A14();
            if (A0M[1].charAt(7) == 'A') {
                throw new RuntimeException();
            }
            String[] strArr = A0M;
            strArr[3] = "8vonm0Gh";
            strArr[7] = "EfYx5Mmt";
            Bitmap bitmapA0N = c1604SxA14.A0N(adIcon.getUrl());
            if (bitmapA0N != null) {
                this.A04.setImageBitmap(bitmapA0N);
                if (z10) {
                    this.A07.post(new C2237hL(this, ukA0L));
                }
            } else {
                A0R(ukA0L, z10, adIcon);
            }
        } else {
            InterfaceC1628Tv interfaceC1628TvA1A = ukA0L.A1A();
            AdErrorType adErrorType = AdErrorType.NATIVE_AD_IS_NOT_LOADED;
            c2198giA16.A0F().A3N(ukA0L.A11(), adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
            if (interfaceC1628TvA1A != null) {
                interfaceC1628TvA1A.ADp(C1670Vm.A00(adErrorType));
            }
            Log.e(A05(46, 17, Sdk$SDKError.b.TPAT_ERROR_VALUE), adErrorType.getDefaultErrorMessage());
            if (nativeAdBaseApi.isAdLoaded()) {
                C2198gi adObjectContext2 = this.A0C;
                adObjectContext2.A08().ABC(A05(258, 3, 44), AbstractC1610Td.A0W, new C1611Te(A05(PsExtractor.AUDIO_STREAM, 23, 42)));
            }
        }
        A0E(this.A04, ukA0L);
    ...
    public final /* synthetic */ void A0Y(UK uk2, View view) {
        this.A0C.A0F().AAy(EnumC1806aM.A05.name().toLowerCase(Locale.US));
        uk2.A1O();
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC1760Zc
    ...
    */
    public final int getMediaWidth() {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2228hC.A0M
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L35:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2228hC.A0M
            r0 = 1
            r1 = r1[r0]
            r0 = 7
            char r1 = r1.charAt(r0)
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2228hC.getMediaWidth():int");
    }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaView mediaView) {
        ...
        if (context instanceof C2198gi) {
            this.A0C = (C2198gi) context;
        } else {
            this.A0C = C1571Rp.A03(context);
        }
        this.A0C.A0O(this);
    ...
    public final boolean isVideoContent() {
        this.A0C.A0F().ABl();
        return this.A0B == EnumC1577Rv.A05;
    }

    @Override // com.facebook.ads.redexgen.core.C1568Rm, com.facebook.ads.internal.api.AdComponentViewApi
    ...
    @Override // com.facebook.ads.redexgen.core.C1568Rm, com.facebook.ads.internal.api.AdComponentView
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ((C1581Rz) this.A09.getMediaViewVideoRendererApi()).A07(null);
        } else {
            ((C1581Rz) this.A09.getMediaViewVideoRendererApi()).A07(new C2230hE(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0K) {
            ...
            ((C1581Rz) mediaViewVideoRenderer.getMediaViewVideoRendererApi()).A05(this.A0C.A0A());
            mediaViewVideoRenderer.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            ((C2228hC) this.A07.getMediaViewApi()).A0D(mediaViewVideoRenderer, layoutParams);
        ...
        throw new IllegalStateException(A05(Sdk$SDKError.b.AD_RESPONSE_EMPTY_VALUE, 43, 70));
    }
}
