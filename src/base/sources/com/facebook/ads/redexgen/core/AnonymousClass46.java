...
public abstract class AnonymousClass46 {
    ...
    static {
        ...
        A03 = new String[]{A02(0, 0, 27), A02(5, 1, Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE), A02(6, 1, 32), A02(7, 1, 41)};
    }

    public static Pair<Integer, Integer> A00(byte[] bArr) {
        C10054v c10054v = new C10054v(bArr);
        c10054v.A0f(9);
        int sampleRate = c10054v.A0I();
        c10054v.A0f(20);
        return Pair.create(Integer.valueOf(c10054v.A0L()), Integer.valueOf(sampleRate));
    }
    ...
    public static String A03(int i10, boolean z10, int i11, int i12, int[] iArr, int i13) {
        StringBuilder sb2 = new StringBuilder(C5C.A0n(A02(25, 17, 35), A03[i10], Integer.valueOf(i11), Integer.valueOf(i12), Character.valueOf(z10 ? 'H' : 'L'), Integer.valueOf(i13)));
