...
public final class C2469lO implements InterfaceC1400Kv {
    ...
    public final C10054v A09 = new C10054v(new byte[18]);
    public int A02 = 0;
    public long A05 = C.TIME_UNSET;

    public C2469lO(String str) {
        this.A0A = str;
    }
    ...
    private boolean A01(C10054v c10054v) {
        while (c10054v.A07() > 0) {
            this.A03 <<= 8;
    ...
    private boolean A02(C10054v c10054v, byte[] bArr, int i10) {
        ...
        while (c10054v.A07() > 0) {
            switch (this.A02) {
                case 0:
                    ...
                    break;
                case 1:
                    if (A02(c10054v, this.A09.A0l(), 18)) {
                        A00();
                        this.A09.A0f(0);
