...
public final class C2212gw {
    ...
    static {
        A02();
        A04 = C2212gw.class.getSimpleName();
    }

    public C2212gw(SR sr, C2194ge c2194ge) {
        this.A00 = sr;
        this.A00.A40(new C2214gy(this));
        this.A01 = new C1604Sx(c2194ge);
        A01();
    }
    ...
    public void A01() {
        ...
        this.A01.A0X(new C2213gx(this), new C1597Sq(A00(81, 36, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE), A00(Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE, 7, 50)));
    }
    ...
    private void A04(String str) {
        ...
        C1602Sv c1602Sv = new C1602Sv(str, -1, -1, A00(81, 36, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE), A00(Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE, 7, 50));
        c1602Sv.A02 = A00(Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE, 8, 106);
        this.A01.A0c(c1602Sv);
    }
    ...
    private void A05(String str) {
        ...
        C1600St c1600St = new C1600St(str, A00(81, 36, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE), A00(Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE, 7, 50));
        c1600St.A04 = true;
        c1600St.A02 = A00(Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE, 8, 106);
        this.A01.A0Y(c1600St);
    }
