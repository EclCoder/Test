...
public abstract class BO<E> extends AbstractC2641oO<E> implements Set<E> {
    ...
    public static int A03(int setSize) {
        ...
        AbstractC2428ki.A0E(iMax < 1073741824, A0B(18, 20, 20));
        return 1073741824;
    }
        ...
        switch (n10) {
            ...
            default:
                ...
                for (int j10 = 0; j10 < n10; j10++) {
                    Object objA00 = AbstractC2756qG.A00(objArrCopyOf[j10], j10);
                    int iHashCode = objA00.hashCode();
                    int tableSize = AbstractC2635oI.A00(iHashCode);
                    while (true) {
    ...
    public static <E> BO<E> A05(E e10, E e11) {
        return A04(2, e10, e11);
    }

    public static <E> BO<E> A06(E e10, E e11, E e12) {
    ...
    public static <E> BO<E> A0A(E e10) {
        return new AnonymousClass25(e10);
    }
    ...
    public boolean equals(@CheckForNull Object object) {
        ...
        return AbstractC2781qj.A09(this, object);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.BO != com.google.common.collect.ImmutableSet<E> */
    @Override // java.util.Collection, java.util.Set
    public int hashCode() {
        return AbstractC2781qj.A00(this);
    }
