...
public final class C2432km {
    public static byte[] A03;
    public File A00;
    public RandomAccessFile A01;
    public final InterfaceC1407Lc A02;
     ...
     */
    public final synchronized void A07() throws C2426kg {
        if (A09()) {
            return;
        }
        A06();
        ...
        if (!this.A00.renameTo(file)) {
            throw new C2426kg(A00(166, 20, 3) + this.A00 + A00(44, 4, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE) + file + A00(14, 16, 47));
        }
        this.A00 = file;
        try {
            this.A01 = new RandomAccessFile(this.A00, A00(256, 1, 61));
        } catch (IOException e10) {
            throw new C2426kg(A00(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 14, 50) + this.A00 + A00(0, 14, 69), e10);
        }
    }

    public C2432km(File file, InterfaceC1407Lc interfaceC1407Lc) throws C2426kg {
        try {
            if (interfaceC1407Lc != null) {
                this.A02 = interfaceC1407Lc;
                File directory = file.getParentFile();
                C1410Lf.A06(directory);
            ...
            throw new C2426kg(A00(186, 17, 54) + file + A00(0, 14, 69), e10);
        }
    }
    ...
    public final synchronized int A03() throws C2426kg {
        try {
        } catch (IOException e10) {
            throw new C2426kg(A00(Sdk$SDKError.b.TPAT_RETRY_FAILED_VALUE, 29, 78) + this.A00, e10);
        }
    ...
    public final synchronized void A05() throws C2426kg {
        try {
            this.A01.setLength(0L);
        } catch (IOException e10) {
            throw new C2426kg(A00(57, 16, 62), e10);
        }
    }

    public final synchronized void A06() throws C2426kg {
        try {
            this.A01.close();
            this.A02.AKR(this.A00);
        } catch (IOException e10) {
            throw new C2426kg(A00(104, 19, 93) + this.A00, e10);
        }
    }

    public final synchronized void A08(byte[] bArr, int i10) throws C2426kg {
        try {
            if (!A09()) {
                this.A01.seek(A03());
                this.A01.write(bArr, 0, i10);
            } else {
                throw new C2426kg(A00(73, 31, 71) + this.A00 + A00(30, 14, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE));
            }
        } catch (IOException e10) {
            throw new C2426kg(String.format(Locale.US, A00(Sdk$SDKError.b.AD_IS_LOADING_VALUE, 53, 72), Integer.valueOf(i10), this.A01, Integer.valueOf(bArr.length)), e10);
        }
    }
