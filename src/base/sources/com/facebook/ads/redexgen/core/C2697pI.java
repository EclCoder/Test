...
public class C2697pI extends SQLiteOpenHelper implements C5O {
    ...
    public C2697pI(Context context) {
    ...
    public static void A02(SQLiteDatabase sQLiteDatabase) {
        Cursor cursorQuery = sQLiteDatabase.query(A00(75, 13, 70), new String[]{A00(103, 4, 24), A00(71, 4, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE)}, null, null, null, null, null);
        while (cursorQuery.moveToNext()) {
            try {
                String string = cursorQuery.getString(0);
                String string2 = cursorQuery.getString(1);
                if (!A00(88, 15, Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE).equals(string2)) {
                    String str = A00(11, 5, 56) + string + A00(0, 11, 100) + string2;
                    try {
                        sQLiteDatabase.execSQL(str);
                    } catch (SQLException e10) {
                        String type = A00(32, 18, 71);
                        AbstractC09904g.A08(type, A00(16, 16, 55) + str, e10);
                    }
                }
            } catch (Throwable th2) {
                if (cursorQuery != null) {
