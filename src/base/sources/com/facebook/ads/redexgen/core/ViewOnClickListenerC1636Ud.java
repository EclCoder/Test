...
public class ViewOnClickListenerC1636Ud implements View.OnClickListener, View.OnLongClickListener, View.OnTouchListener, T4 {
    ...
    public ViewOnClickListenerC1636Ud(UK uk2, C2198gi c2198gi) {
        this.A01 = uk2;
        this.A00 = c2198gi;
    }

    public /* synthetic */ ViewOnClickListenerC1636Ud(UK uk2, C2198gi c2198gi, C1680Vx c1680Vx) {
        this(uk2, c2198gi);
    }

    private Map<String, String> A01() {
        Map<String, String> mapA05 = new C1855b9().A03(this.A01.A0U).A02(this.A01.A0j).A05();
    ...
    public final void A04() {
        if (this.A01.A08 != null) {
            ((C2227hB) this.A01.A08.getNativeAdLayoutApi()).A04(new ZX(this.A01.A0g));
        }
    }
    ...
    public final void onClick(View view) {
        ...
        try {
            ...
            if (!zA08) {
                Log.e(strA00, A00(83, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE, Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE));
            }
            int minimumElapsedTime = C1648Up.A0K(this.A01.A0g);
