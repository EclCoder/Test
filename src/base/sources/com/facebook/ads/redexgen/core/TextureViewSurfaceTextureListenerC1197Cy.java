...
public final class TextureViewSurfaceTextureListenerC1197Cy extends TextureView implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnSeekCompleteListener, TextureView.SurfaceTextureListener, InterfaceC2138fk {
    ...
    public EnumC2140fm A0C;
    public EnumC2140fm A0D;
    public InterfaceC2141fn A0E;
    public boolean A0F;
    public boolean A0G;
    public boolean A0H;
    public boolean A0I;
    ...
    static {
        A04();
        A0Q = TextureViewSurfaceTextureListenerC1197Cy.class.getSimpleName();
    }

    public TextureViewSurfaceTextureListenerC1197Cy(C2198gi c2198gi) {
        super(c2198gi);
        this.A0C = EnumC2140fm.A04;
        ...
        this.A0M = new C2135fh(this);
        this.A0I = false;
        this.A0N = c2198gi;
    }

    public TextureViewSurfaceTextureListenerC1197Cy(C2198gi c2198gi, AttributeSet attributeSet) {
    ...
    public TextureViewSurfaceTextureListenerC1197Cy(C2198gi c2198gi, AttributeSet attributeSet, int i10) {
    ...
    private final void A05(MediaPlayer mediaPlayer, Uri uri) {
        String strA03 = A03(Sdk$SDKError.b.AD_CLOSED_TEMPLATE_ERROR_VALUE, 15, 64);
    ...
    private boolean A06() {
        return (this.A0C == EnumC2140fm.A08 || this.A0C == EnumC2140fm.A07) ? false : true;
    }

    private boolean A07() {
        return this.A0C == EnumC2140fm.A07 || this.A0C == EnumC2140fm.A0A || this.A0C == EnumC2140fm.A05 || this.A0C == EnumC2140fm.A06;
    }
    ...
    private boolean A09() {
        ...
        try {
            ...
            this.A0N.A08().ABC(A03(384, 6, 110), AbstractC1610Td.A2H, new C1611Te(e10));
            return false;
        }
    }
    ...
    private boolean A0A(Surface surface) {
        ...
        try {
            ...
            this.A0N.A08().ABC(A03(384, 6, 110), AbstractC1610Td.A2I, new C1611Te(e10));
            return false;
        }
    }
    ...
    public final void AGr(boolean z10, int i10) {
        ...
        if (this.A06 != null) {
            ...
            this.A0J = z10;
            this.A06.pause();
            if (this.A0C != EnumC2140fm.A06) {
                setVideoState(EnumC2140fm.A05);
                return;
            }
            return;
        }
    ...
    public final void AK6(EnumC2085et enumC2085et, int i10) {
        ...
        this.A0J = false;
        this.A0D = EnumC2140fm.A0A;
        this.A0B = enumC2085et;
        if (this.A0C == EnumC2140fm.A0A || this.A0C == EnumC2140fm.A07 || this.A0C == EnumC2140fm.A04 || this.A0C == EnumC2140fm.A05 || this.A0C == EnumC2140fm.A06) {
            if (this.A06 == null) {
                setup(this.A07);
            } else {
                if (this.A03 > 0) {
                ...
                this.A06.start();
                if (this.A0C != EnumC2140fm.A07 || this.A0K) {
                    setVideoState(EnumC2140fm.A0A);
                }
            }
        }
        if (isAvailable()) {
    ...
    public final boolean onError(MediaPlayer mediaPlayer, int i10, int i11) {
        ...
        if (this.A01 > 0 && getState() == EnumC2140fm.A0A) {
            this.A01--;
            AKF(6);
            AK6(this.A0B, 10);
        } else {
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        ...
        if (this.A03 > 0) {
            int i10 = this.A03;
            int duration = ((MediaPlayer) AbstractC2249hX.A00(this.A06)).getDuration();
            if (A0P[3].length() != 17) {
                throw new RuntimeException();
            }
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i10, int i11) {
        ...
        if (!A0A(this.A08)) {
            ...
            this.A0N.A0F().A3i(4);
            destroy();
        } else if (this.A0C == EnumC2140fm.A05 && !this.A0J) {
            AK6(this.A0B, 7);
        }
    }
    ...
    public final void onWindowFocusChanged(boolean z10) {
        ...
        if (!z10) {
            if (this.A0C != EnumC2140fm.A05) {
                if (!this.A0N.A0H().A01()) {
                    boolean zA25 = C1648Up.A25(this.A0N);
                    if (A0P[2].length() != 22) {
                        throw new RuntimeException();
                    }
        ...
        EnumC2140fm enumC2140fm = this.A0C;
        EnumC2140fm enumC2140fm2 = EnumC2140fm.A05;
        if (A0P[6].length() == 4) {
            A0P[6] = "r8oy";
            if (enumC2140fm != enumC2140fm2) {
                return;
            }
        } else if (enumC2140fm != enumC2140fm2) {
            return;
        }
        if (!this.A0J) {
            EnumC2085et enumC2085et = this.A0B;
            if (A0P[3].length() != 17) {
                throw new RuntimeException();
            }
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        if (Build.VERSION.SDK_INT < 24) {
            ...
            Log.w(A0Q, A03(Sdk$SDKError.b.TPAT_ERROR_VALUE, 102, 21));
        }
    }
    ...
    public void setControlsAnchorView(View view) {
        this.A09 = view;
        view.setOnTouchListener(new ViewOnTouchListenerC2137fj(this));
    }
    ...
    public void setFullScreen(boolean z10) {
        this.A0H = z10;
        if (this.A0H && !this.A0G) {
            setOnTouchListener(new ViewOnTouchListenerC2136fi(this));
        }
    }
    ...
    public void setRequestedVolume(float f10) {
        this.A00 = f10;
        if (this.A06 == null || this.A0C == EnumC2140fm.A08) {
            return;
        }
        EnumC2140fm enumC2140fm = this.A0C;
        String[] strArr = A0P;
        ...
        if (enumC2140fm != EnumC2140fm.A04) {
    ...
    private void setVideoState(EnumC2140fm enumC2140fm) {
        if (enumC2140fm != this.A0C) {
            if (this.A0N.A05().AAO()) {
                String str = A03(356, 23, 106) + enumC2140fm;
            }
            this.A0C = enumC2140fm;
            if (this.A0E != null) {
                this.A0E.AGd(enumC2140fm);
            }
        }
    }
    ...
    public void setup(Uri uri) {
        ...
        try {
            if (((String) AbstractC2249hX.A00(uri.getScheme())).equals(A03(379, 5, 2))) {
                A05(mediaPlayer, uri);
            } else {
