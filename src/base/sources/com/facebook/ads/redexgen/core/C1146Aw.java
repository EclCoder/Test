...
public class C1146Aw<E> extends AbstractC2779qh<E> {
    public final /* synthetic */ Set A00;
    public final /* synthetic */ Set A01;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1146Aw(final Set val$set1, final Set val$set2) {
        super(null);
        this.A00 = val$set1;
        this.A01 = val$set2;
    }
    ...
    public final C4C<E> iterator() {
        return new AbstractC1171Bv<E>() { // from class: com.facebook.ads.redexgen.X.27
