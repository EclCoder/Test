...
public class C1298Gw {
    ...
    public C1298Gw(long j10, long j11, long j12, long j13, long j14, long j15, long j16) {
        this.A06 = j10;
        this.A07 = j11;
        this.A03 = j12;
        this.A01 = j13;
    ...
    public static long A05(long j10, long j11, long j12, long bytesToSkip, long confidenceInterval, long j13) {
        ...
        long j14 = (long) ((j10 - j11) * ((confidenceInterval - bytesToSkip) / (j12 - j11)));
        return C5C.A0T(((bytesToSkip + j14) - j13) - (j14 / 20), bytesToSkip, confidenceInterval - 1);
    }
