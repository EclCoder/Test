...
public final class C2299iP implements U3 {
    ...
    public C2299iP(String str, String str2, Bundle bundle) {
        this.A01 = str;
        this.A02 = str2;
        this.A00 = bundle;
    }
    ...
    public final TM A7m(T8 t10) {
        String[] stringArray = this.A00.getStringArray(A00(98, 27, Sdk$SDKError.b.TPAT_ERROR_VALUE));
        Integer numValueOf = Integer.valueOf(this.A00.getInt(A00(63, 35, 111), -1));
        if (numValueOf.intValue() == -1) {
            numValueOf = null;
        }
        Integer country = Integer.valueOf(this.A00.getInt(A00(Sdk$SDKError.b.INVALID_METRICS_ENDPOINT_VALUE, 33, 72), -1));
