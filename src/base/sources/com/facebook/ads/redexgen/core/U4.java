...
public final class U4 {
    ...
    public static long A01(T8 t10, String str) {
        try {
            ...
            if (A03.compareAndSet(false, true)) {
                t10.A08().ABC(A02(144, 7, 94), AbstractC1610Td.A1E, new C1611Te(e10));
            }
            return -1L;
        }
    }
    ...
    public static String A03(Context context) {
        try {
            Field buildType = Class.forName(context.getPackageName() + A02(0, 12, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE)).getDeclaredField(A02(37, 10, 101));
    ...
    public static String A04(Context context) {
        try {
            Field buildType = Class.forName(context.getPackageName() + A02(0, 12, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE)).getDeclaredField(A02(71, 5, 103));
    ...
    public static String A05(T8 t10, String str) {
        JSONObject jSONObject = new JSONObject();
        A07(t10, jSONObject, A02(174, 6, 83), String.valueOf(A08()));
        A07(t10, jSONObject, A02(97, 8, 100), String.valueOf(A01(t10, str)));
        A07(t10, jSONObject, A02(180, 15, 21), String.valueOf(A00()));
        A07(t10, jSONObject, A02(105, 18, 51), String.valueOf(AbstractC1697Wp.A00(t10)));
        A07(t10, jSONObject, A02(161, 13, 60), String.valueOf(A09(t10)));
        A07(t10, jSONObject, A02(Sdk$SDKError.b.OMSDK_JS_WRITE_FAILED_VALUE, 11, 111), A04(t10));
        A07(t10, jSONObject, A02(Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE, 10, 27), A03(t10));
        return jSONObject.toString();
    }

    public static void A07(T8 t10, JSONObject jSONObject, String str, String str2) {
        try {
