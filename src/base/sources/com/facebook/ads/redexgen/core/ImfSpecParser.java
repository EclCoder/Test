...
public final class ImfSpecParser {
    ...
    public static final List<ImfDataTrack> A01(String str) throws JSONException {
        C2772qY.A09(str, A00(29, 13, 101));
        ArrayList arrayList = new ArrayList();
        JSONArray jSONArray = new JSONObject(str).getJSONObject(A00(169, 17, Sdk$SDKError.b.INVALID_RI_ENDPOINT_VALUE)).getJSONArray(A00(0, 1, 105));
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            String string3 = jSONObject.getString(A00(Sdk$SDKError.b.ASSET_FAILED_INSUFFICIENT_SPACE_VALUE, 14, 42));
            C2772qY.A06(string2);
            C2772qY.A06(string3);
            C2340j7 c2340j7 = new C2340j7(string2, string3);
            JSONArray jSONArray2 = imfTrack.getJSONArray(A00(1, 12, 63));
            int length2 = jSONArray2.length();
            for (int i11 = 0; i11 < length2; i11++) {
                JSONObject dataTrack = jSONArray2.getJSONObject(i11);
                String strA00 = A00(151, 9, Sdk$SDKError.b.INVALID_ADS_ENDPOINT_VALUE);
                JSONObject jSONObject2 = dataTrack.getJSONObject(strA00).getJSONObject(A00(Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE, 9, Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE));
                String strA01 = A00(160, 9, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE);
                ...
                C2772qY.A06(string);
                arrayList.add(new ImfDataTrack(string, j10, j11, c2340j7, new C2339j6(jSONObject3.getDouble(A00(69, 9, Sdk$SDKError.b.PROTOBUF_SERIALIZATION_ERROR_VALUE)), jSONObject3.getDouble(A00(78, 9, 61)), jSONObject3.getDouble(A00(56, 13, 67)), jSONObject3.getDouble(A00(42, 14, 35)), jSONObject3.getDouble(A00(87, 15, 35)))));
            }
        }
        return arrayList;
    }
