...
public final class B3 {
    ...
    public B3(String str, String str2, String str3, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15) {
        this.A03 = (String) AbstractC09823y.A01(str);
        this.A02 = str2;
        this.A01 = str3;
    ...
    public static int A00(String str, String str2, int i10) {
        int i11;
        if (i10 <= 1 && ((C5C.A02 < 26 || i10 <= 0) && !A03(386, 10, 46).equals(str2) && !A03(281, 10, 102).equals(str2) && !A03(HttpStatusCodes.STATUS_CODE_MULTIPLE_CHOICES, 12, 21).equals(str2) && !A03(371, 15, 53).equals(str2) && !A03(TTAdConstant.VIDEO_COVER_URL_CODE, 12, 20).equals(str2) && !A03(396, 10, 52).equals(str2))) {
            String strA03 = A03(TTAdConstant.LANDING_PAGE_TYPE_CODE, 9, 47);
            String[] strArr = A0C;
            ...
            if (!strA03.equals(str2) && !A03(Sdk$SDKError.b.MRAID_UNRECOGNIZED_COMMAND_VALUE, 10, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE).equals(str2)) {
                    ...
                    if (!A03(332, 15, 4).equals(str2)) {
                        if (!A03(347, 15, 81).equals(str2) && !A03(362, 9, 99).equals(str2)) {
                            if (A03(291, 9, 49).equals(str2)) {
                                i11 = 6;
                            } else if (A03(Sdk$SDKError.b.DEEPLINK_OPEN_FAILED_VALUE, 10, 87).equals(str2)) {
                                i11 = 16;
                            } else {
                                i11 = 30;
                            }
                            AbstractC09904g.A07(A03(97, 14, 99), A03(10, 29, 107) + str + A03(6, 3, Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE) + i10 + A03(0, 4, Sdk$SDKError.b.INVALID_INDEX_URL_VALUE) + i11 + A03(260, 1, 72));
                            return i11;
                        }
                    }
                } else {
    ...
    private void A05(String str) {
        ...
        AbstractC09904g.A04(A03(97, 14, 99), sbAppend.append(strA03).append(this.A03).append(A03(4, 2, 43)).append(this.A02).append(strA03).append(C5C.A04).append(A03(260, 1, 72)).toString());
    }

    private void A06(String str) {
        StringBuilder sbAppend = new StringBuilder().append(A03(Sdk$SDKError.b.JSON_ENCODE_ERROR_VALUE, 11, 42)).append(str);
        String strA03 = A03(261, 3, 33);
        AbstractC09904g.A04(A03(97, 14, 99), sbAppend.append(strA03).append(this.A03).append(A03(4, 2, 43)).append(this.A02).append(strA03).append(C5C.A04).append(A03(260, 1, 72)).toString());
    }
    ...
    private boolean A0G(C2758qI c2758qI, boolean z10) {
        MediaCodecInfo.CodecProfileLevel[] codecProfileLevelArrA0V;
        int i10;
        int i11;
        boolean zA0L;
        Pair<Integer, Integer> pairA0B = C1150Ba.A0B(c2758qI);
        if (pairA0B == null) {
            return true;
        }
        ...
        if (strArr[6].charAt(25) == strArr[3].charAt(25)) {
            ...
            if (A03(733, 18, 30).equals(c2758qI.A0W)) {
                if (A03(724, 9, 92).equals(this.A02)) {
                    iIntValue = 8;
                    level = 0;
                } else if (A03(751, 10, Sdk$SDKError.b.TPAT_ERROR_VALUE).equals(this.A02)) {
                    iIntValue = 2;
                    level = 0;
                }
            }
            if (this.A0A) {
                ...
                A06(A03(PglCryptUtils.LOAD_SO_FAILED, 20, 18) + c2758qI.A0R + A03(4, 2, 43) + this.A01);
                return false;
            }
            if (A0C[2].length() == 8) {
    ...
    public static boolean A0J(String str) {
        if (C5C.A02 <= 22) {
            if ((A03(130, 10, 94).equals(C5C.A06) || A03(111, 8, 72).equals(C5C.A06)) && (A03(140, 22, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE).equals(str) || A03(162, 29, 74).equals(str))) {
                return true;
            }
        }
        return false;
    ...
    public static boolean A0K(String str) {
        if (A03(Sdk$SDKError.b.INVALID_CSB_DATA_VALUE, 26, 94).equals(str) && A03(527, 5, 83).equals(C5C.A03)) {
            return false;
        }
        return true;
    }
    ...
    public static boolean A0L(String str, int i10) {
        if (A03(751, 10, Sdk$SDKError.b.TPAT_ERROR_VALUE).equals(str) && 2 == i10) {
    ...
    public final C6L A0O(C2758qI c2758qI, C2758qI c2758qI2) {
        int i10 = C5C.A1E(c2758qI.A0W, c2758qI2.A0W) ? 0 : 0 | 8;
        if (this.A0A) {
            int discardReasons = c2758qI.A0F;
            if (discardReasons != c2758qI2.A0F) {
                i10 |= UserVerificationMethods.USER_VERIFY_ALL;
            }
            if (!this.A04) {
                int discardReasons2 = c2758qI.A0L;
                if (discardReasons2 == c2758qI2.A0L) {
                    int discardReasons3 = c2758qI.A0A;
                    if (discardReasons3 != c2758qI2.A0A) {
                        i10 |= 512;
                    }
                } else {
                    i10 |= 512;
            ...
            if (!C5C.A1E(c2758qI.A0N, c2758qI2.A0N)) {
                i10 |= 2048;
            }
            if (A0I(this.A03) && !c2758qI.A0A(c2758qI2)) {
                i10 |= 2;
            }
            if (i10 == 0) {
                String str = this.A03;
                int i11 = c2758qI.A0A(c2758qI2) ? 3 : 2;
                if (A0C[0].charAt(21) != 'A') {
                    throw new RuntimeException();
                }
                String[] strArr = A0C;
                ...
                return new C6L(str, c2758qI, c2758qI2, i11, 0);
            }
        } else {
            int discardReasons4 = c2758qI.A06;
            if (discardReasons4 != c2758qI2.A06) {
                i10 |= 4096;
            }
            int discardReasons5 = c2758qI.A0G;
            if (discardReasons5 != c2758qI2.A0G) {
                i10 |= 8192;
            }
            int discardReasons6 = c2758qI.A0C;
            if (discardReasons6 != c2758qI2.A0C) {
                i10 |= 16384;
            }
            if (i10 == 0 && A03(371, 15, 53).equals(this.A02)) {
                Pair<Integer, Integer> pairA0B = C1150Ba.A0B(c2758qI);
                Pair<Integer, Integer> pairA0B2 = C1150Ba.A0B(c2758qI2);
                if (pairA0B != null && pairA0B2 != null) {
                    ...
                    if (iIntValue == 42 && iIntValue2 == 42) {
                        return new C6L(this.A03, c2758qI, c2758qI2, 3, 0);
                    }
                }
            }
            if (!c2758qI.A0A(c2758qI2)) {
                i10 |= 32;
            }
            if (A0H(this.A02)) {
                i10 |= 2;
            ...
            if (i10 == 0) {
                return new C6L(this.A03, c2758qI, c2758qI2, 1, 0);
            }
        }
        return new C6L(this.A03, c2758qI, c2758qI2, 0, i10);
    }
    ...
    public final boolean A0P(int i10) {
        ...
        if (audioCapabilities == null) {
            A06(A03(433, 18, Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE));
            return false;
        }
    ...
    public final boolean A0R(int i10, int i11, double d10) {
        ...
        int i12 = C5C.A02;
        String strA03 = A03(9, 1, Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE);
        ...
        if (i12 >= 29) {
            ...
            if (iA00 == 1) {
                A06(A03(629, 19, 41) + i10 + strA04 + i11 + strA03 + d10);
                return false;
            }
        }
        if (!A0F(videoCapabilities, i10, i11, d10)) {
            if (i10 >= i11 || !A0K(this.A03) || !A0F(videoCapabilities, i11, i10, d10)) {
                A06(A03(669, 21, Sdk$SDKError.b.ASSET_RESPONSE_DATA_ERROR_VALUE) + i10 + strA04 + i11 + strA03 + d10);
                return false;
            }
    ...
    public final boolean A0S(C2758qI c2758qI) {
        String strA07;
        if (c2758qI.A0R == null || this.A02 == null || (strA07 = C3J.A07(c2758qI.A0R)) == null) {
            return true;
        }
        ...
        if (!codecMimeType.equals(strA07)) {
            ...
            String codecMimeType3 = c2758qI.A0R;
        ...
        return A0G(c2758qI, true);
    }

    public final boolean A0T(C2758qI c2758qI) {
        if (this.A0A) {
        ...
        Pair<Integer, Integer> profileLevel = C1150Ba.A0B(c2758qI);
        return profileLevel != null && ((Integer) profileLevel.first).intValue() == 42;
    }

    @Deprecated
    public final boolean A0U(C2758qI c2758qI, C2758qI c2758qI2, boolean z10) {
        if (!z10 && c2758qI.A0N != null) {
            ColorInfo colorInfo = c2758qI2.A0N;
            String[] strArr = A0C;
            ...
            A0C[2] = "CiueF8sE";
            if (colorInfo == null) {
                c2758qI2 = c2758qI2.A07().A0t(c2758qI.A0N).A14();
            }
        }
        int i10 = A0O(c2758qI, c2758qI2).A01;
        return i10 == 2 || i10 == 3;
    }
