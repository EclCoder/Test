...
public abstract class AbstractC1844ay extends WebView {
    ...
    static {
        A0C();
        A02 = AbstractC1844ay.class.getSimpleName();
    }

    public AbstractC1844ay(Activity activity, C2198gi c2198gi) {
        super(activity);
        A0E(c2198gi);
    }

    public AbstractC1844ay(C2198gi c2198gi) {
        super(c2198gi);
        A0E(c2198gi);
    }
    ...
    public static void A0D(int i10) {
        ...
        if (context != null) {
            context.A08().ABC(A0B(56, 8, 37), i10, new C1611Te(A0B(35, 10, 3)));
        }
    }
    ...
    private void A0F(String str) {
        loadUrl(A0B(45, 11, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE) + str);
    }
