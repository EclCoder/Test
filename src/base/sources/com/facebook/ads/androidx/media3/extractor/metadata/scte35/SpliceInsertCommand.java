...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public static SpliceInsertCommand A00(C10054v c10054v, long j10, AnonymousClass53 anonymousClass53) {
        ...
        if (!z10) {
            ...
            if (outOfNetworkIndicator && !z12) {
                jA00 = TimeSignalCommand.A00(c10054v, j10);
            }
            if (!outOfNetworkIndicator) {
                int componentCount = c10054v.A0I();
                listEmptyList = new ArrayList(componentCount);
                for (int i10 = 0; i10 < componentCount; i10++) {
                    int componentTag = c10054v.A0I();
                    long jA01 = C.TIME_UNSET;
                    if (!z12) {
                        jA01 = TimeSignalCommand.A00(c10054v, j10);
                    }
            ...
            if (autoReturn) {
                ...
                z13 = (jA0I & 128) != 0;
                jA0Q2 = (1000 * (((jA0I & 1) << 32) | c10054v.A0Q())) / 90;
            }
            iA0M = c10054v.A0M();
            iA0I = c10054v.A0I();
            iA0I2 = c10054v.A0I();
