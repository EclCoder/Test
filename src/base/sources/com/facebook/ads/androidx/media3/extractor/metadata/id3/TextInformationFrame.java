...
public final class TextInformationFrame extends Id3Frame {
    ...
    public TextInformationFrame(Parcel parcel) {
        this((String) AbstractC09823y.A01(parcel.readString()), parcel.readString(), MetaExoPlayerCustomizedCollections.A02((String[]) AbstractC09823y.A01(parcel.createStringArray())));
    }

    public /* synthetic */ TextInformationFrame(Parcel parcel, IJ ij2) {
        this(parcel);
    }
    ...
    public TextInformationFrame(String str, String str2, List<String> values) {
        super(str);
        AbstractC09823y.A07(!values.isEmpty());
        this.A00 = str2;
