...
import com.facebook.ads.redexgen.core.AbstractC09442k;
import com.facebook.ads.redexgen.core.AnonymousClass53;
import com.facebook.ads.redexgen.core.C2444kz;
import com.facebook.ads.redexgen.core.C2448l3;
import com.facebook.ads.redexgen.core.C2455lA;
import com.facebook.ads.redexgen.core.C2470lP;
import com.facebook.ads.redexgen.core.C2472lR;
import com.facebook.ads.redexgen.core.C2475lU;
import com.facebook.ads.redexgen.core.C2478lX;
import com.facebook.ads.redexgen.core.C2503lw;
import com.facebook.ads.redexgen.core.C2509m2;
import com.facebook.ads.redexgen.core.C2510m3;
import com.facebook.ads.redexgen.core.C2523mG;
import com.facebook.ads.redexgen.core.C2534md;
import com.facebook.ads.redexgen.core.C2537mg;
import com.facebook.ads.redexgen.core.C2542ml;
import com.facebook.ads.redexgen.core.C2758qI;
...
public final class DefaultExtractorsFactory implements HD {
    ...
    public List<C2758qI> A0A = MetaExoPlayerCustomizedCollections.A03(new C2758qI[0]);
    public boolean A0B;
    public boolean A0C;
    ...
    public static Constructor<? extends H9> A01() throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, InvocationTargetException {
        boolean isFlacNativeLibraryAvailable = Boolean.TRUE.equals(Class.forName(A00(Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE, 63, 62)).getMethod(A00(187, 11, 111), new Class[0]).invoke(null, new Object[0]));
    ...
    private void A06(int i10, List<H9> list) {
        ...
        switch (i10) {
            case 0:
                list.add(new C2478lX());
                return;
            case 1:
                list.add(new C2475lU());
                return;
            case 2:
            ...
            case 4:
                ...
                if (flacExtractor != null) {
                    ...
                    list.add(new C2537mg(this.A02));
                    return;
                }
            case 5:
                list.add(new C2534md());
                return;
            case 6:
            ...
            case 7:
                ...
                list.add(new C2523mG(i11 | i14));
                return;
            case 8:
                list.add(new C2509m2().A01(this.A03));
                list.add(new C2510m3(this.A06));
                return;
            case 9:
                list.add(new C2503lw());
                return;
            case 10:
                list.add(new C2455lA());
                return;
            case 11:
                list.add(new C2448l3(this.A08, new AnonymousClass53(0L), new C2470lP(this.A07, this.A0A), this.A09));
                return;
            case 12:
                list.add(new C2444kz());
                return;
            case 13:
            case 14:
            default:
    ...
    public final synchronized H9[] A5O(Uri uri, Map<String, List<String>> responseHeaders) {
        ...
        int fileType = AbstractC09442k.A02(responseHeaders);
        if (fileType != -1) {
            A06(fileType, extractors);
        }
        int iA00 = AbstractC09442k.A00(uri);
