...
import com.facebook.ads.redexgen.core.HandlerThreadC1259Fi;
...
public final class DummySurface extends Surface {
    ...
    public final HandlerThreadC1259Fi A02;
    ...
    public DummySurface(HandlerThreadC1259Fi handlerThreadC1259Fi, SurfaceTexture surfaceTexture, boolean z10) {
        super(surfaceTexture);
        this.A02 = handlerThreadC1259Fi;
        this.A01 = z10;
    }

    public static int A00(Context context) {
        String strEglQueryString;
        if (C5C.A02 < 26 && (A02(Sdk$SDKError.b.ASSET_FAILED_MAX_SPACE_EXCEEDED_VALUE, 7, 48).equals(C5C.A05) || A02(85, 6, Sdk$SDKError.b.ASSET_FAILED_STATUS_CODE_VALUE).equals(C5C.A06))) {
            return 0;
        }
    ...
    public static DummySurface A01(Context context, boolean z10) {
        A03();
        AbstractC09823y.A08(!z10 || A05(context));
        return new HandlerThreadC1259Fi().A04(z10 ? A03 : 0);
    }
