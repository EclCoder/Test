    ...
    public static class a {
        ...
        public final a a(JSONObject jSONObject) {
            ...
            if (jSONObject != null) {
                try {
                    if (jSONObject.has("c")) {
                        this.f11849a = (String) com.bykv.vk.openvk.preload.falconx.a.a.a(jSONObject, "c", String.class);
                    }
                    if (jSONObject.has("clean_type")) {
                        this.f11850b = jSONObject.optInt("clean_type");
                    }
                    if (jSONObject.has("version") && (jSONArrayOptJSONArray = jSONObject.optJSONArray("version")) != null && jSONArrayOptJSONArray.length() > 0) {
                        ...
                        for (int i10 = 0; i10 < jSONArrayOptJSONArray.length(); i10++) {
                            this.f11851c.add(Long.valueOf(jSONArrayOptJSONArray.optLong(i10)));
                        }
                    }
