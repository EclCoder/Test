...
public class GenericMediaHeaderTextAtom extends AbstractBox {
    ...
    public GenericMediaHeaderTextAtom() {
        super("text");
        this.unknown_1 = C.DEFAULT_BUFFER_SEGMENT_SIZE;
        this.unknown_5 = C.DEFAULT_BUFFER_SEGMENT_SIZE;
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_13 = bVar.h("method-execution", bVar.g("1", "setUnknown_7", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_7", "", "void"), Sdk$SDKError.b.ASSET_REQUEST_ERROR_VALUE);
        ajc$tjp_14 = bVar.h("method-execution", bVar.g("1", "getUnknown_8", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "", "", "", "int"), Sdk$SDKError.b.GZIP_ENCODE_ERROR_VALUE);
        ajc$tjp_15 = bVar.h("method-execution", bVar.g("1", "setUnknown_8", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_8", "", "void"), AdConfig.DEFAULT_PING_V2_INTERVAL_NORMAL);
        ajc$tjp_16 = bVar.h("method-execution", bVar.g("1", "getUnknown_9", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "", "", "", "int"), Sdk$SDKError.b.INVALID_LOG_ERROR_ENDPOINT_VALUE);
