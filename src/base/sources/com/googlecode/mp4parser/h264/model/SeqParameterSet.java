...
public class SeqParameterSet extends BitstreamElement {
    ...
    private static VUIParameters ReadVUIParameters(CAVLCReader cAVLCReader) {
        ...
        boolean bool = cAVLCReader.readBool("VUI: aspect_ratio_info_present_flag");
        vUIParameters.aspect_ratio_info_present_flag = bool;
        if (bool) {
            AspectRatio aspectRatioFromValue = AspectRatio.fromValue((int) cAVLCReader.readNBit(8, "VUI: aspect_ratio"));
        ...
        boolean bool2 = cAVLCReader.readBool("VUI: overscan_info_present_flag");
        ...
        boolean bool3 = cAVLCReader.readBool("VUI: video_signal_type_present_flag");
        ...
        if (bool3) {
            ...
            boolean bool4 = cAVLCReader.readBool("VUI: colour_description_present_flag");
        ...
        boolean bool5 = cAVLCReader.readBool("VUI: chroma_loc_info_present_flag");
        ...
        boolean bool6 = cAVLCReader.readBool("VUI: timing_info_present_flag");
        vUIParameters.timing_info_present_flag = bool6;
        if (bool6) {
        ...
        boolean bool7 = cAVLCReader.readBool("VUI: nal_hrd_parameters_present_flag");
        if (bool7) {
            vUIParameters.nalHRDParams = readHRDParameters(cAVLCReader);
        }
        boolean bool8 = cAVLCReader.readBool("VUI: vcl_hrd_parameters_present_flag");
        if (bool8) {
    ...
    private static void readScalingListMatrix(CAVLCReader cAVLCReader, SeqParameterSet seqParameterSet) {
        ...
        for (int i10 = 0; i10 < 8; i10++) {
            if (cAVLCReader.readBool("SPS: seqScalingListPresentFlag")) {
                ...
                if (i10 < 6) {
                    scalingListArr[i10] = ScalingList.read(cAVLCReader, 16);
                } else {
                    scalingListArr2[i10 - 6] = ScalingList.read(cAVLCReader, 64);
                }
            }
        }
    }
    ...
    private void writeHRDParameters(HRDParameters hRDParameters, CAVLCWriter cAVLCWriter) throws IOException {
        ...
        for (int i10 = 0; i10 <= hRDParameters.cpb_cnt_minus1; i10++) {
            cAVLCWriter.writeUE(hRDParameters.bit_rate_value_minus1[i10], "HRD: ");
            cAVLCWriter.writeUE(hRDParameters.cpb_size_value_minus1[i10], "HRD: ");
            cAVLCWriter.writeBool(hRDParameters.cbr_flag[i10], "HRD: ");
        }
    ...
    public void write(OutputStream outputStream) throws IOException {
        ...
        if (i10 == 100 || i10 == 110 || i10 == 122 || i10 == 144) {
            ...
            if (this.scalingMatrix != null) {
                for (int i11 = 0; i11 < 8; i11++) {
                    if (i11 < 6) {
                        cAVLCWriter.writeBool(this.scalingMatrix.ScalingList4x4[i11] != null, "SPS: ");
                        ...
                        int i12 = i11 - 6;
                        cAVLCWriter.writeBool(this.scalingMatrix.ScalingList8x8[i12] != null, "SPS: ");
        ...
        if (i13 == 0) {
            ...
            while (true) {
                ...
                cAVLCWriter.writeSE(iArr[i14], "SPS: ");
                i14++;
            }
        }
    ...
    public static SeqParameterSet read(InputStream inputStream) {
        ...
        seqParameterSet.constraint_set_2_flag = cAVLCReader.readBool(NpmRNZ.ZaGlzNgXP);
        ...
        if (i10 == 100 || i10 == 110 || i10 == 122 || i10 == 144) {
            ChromaFormat chromaFormatFromId = ChromaFormat.fromId(cAVLCReader.readUE("SPS: chroma_format_idc"));
            seqParameterSet.chroma_format_idc = chromaFormatFromId;
            if (chromaFormatFromId == ChromaFormat.YUV_444) {
        ...
        int ue2 = cAVLCReader.readUE("SPS: pic_order_cnt_type");
        seqParameterSet.pic_order_cnt_type = ue2;
        if (ue2 == 0) {
            ...
            int ue3 = cAVLCReader.readUE("SPS: num_ref_frames_in_pic_order_cnt_cycle");
            seqParameterSet.num_ref_frames_in_pic_order_cnt_cycle = ue3;
            seqParameterSet.offsetForRefFrame = new int[ue3];
            for (int i11 = 0; i11 < seqParameterSet.num_ref_frames_in_pic_order_cnt_cycle; i11++) {
                seqParameterSet.offsetForRefFrame[i11] = cAVLCReader.readSE("SPS: offsetForRefFrame [" + i11 + "]");
            }
        }
        ...
        boolean bool = cAVLCReader.readBool("SPS: frame_mbs_only_flag");
        seqParameterSet.frame_mbs_only_flag = bool;
        if (!bool) {
        ...
        boolean bool2 = cAVLCReader.readBool("SPS: frame_cropping_flag");
        seqParameterSet.frame_cropping_flag = bool2;
        if (bool2) {
    ...
    private static HRDParameters readHRDParameters(CAVLCReader cAVLCReader) {
        ...
        for (int i11 = 0; i11 <= hRDParameters.cpb_cnt_minus1; i11++) {
            hRDParameters.bit_rate_value_minus1[i11] = cAVLCReader.readUE("HRD: bit_rate_value_minus1");
            hRDParameters.cpb_size_value_minus1[i11] = cAVLCReader.readUE("HRD: cpb_size_value_minus1");
            hRDParameters.cbr_flag[i11] = cAVLCReader.readBool("HRD: cbr_flag");
        }
        ...
        hRDParameters.dpb_output_delay_length_minus1 = (int) cAVLCReader.readNBit(5, vHmGJpUTWNVV.JIyyNaVd);
