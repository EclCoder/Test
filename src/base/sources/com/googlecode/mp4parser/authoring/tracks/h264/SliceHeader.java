...
public class SliceHeader {
    ...
    public SliceHeader(InputStream inputStream, Map<Integer, SeqParameterSet> map, Map<Integer, PictureParameterSet> map2, boolean z10) {
        ...
        try {
            ...
            int ue2 = cAVLCReader.readUE("SliceHeader: pic_parameter_set_id");
            this.pic_parameter_set_id = ue2;
            PictureParameterSet pictureParameterSet = map2.get(Integer.valueOf(ue2));
            ...
            if (!this.sps.frame_mbs_only_flag) {
                boolean bool = cAVLCReader.readBool("SliceHeader: field_pic_flag");
