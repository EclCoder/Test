...
public abstract class x {
    ...
    public static void b(MediaFormat mediaFormat, pb.c cVar) {
        if (cVar != null) {
            d(mediaFormat, "color-transfer", cVar.f49832c);
            d(mediaFormat, "color-standard", cVar.f49830a);
            d(mediaFormat, "color-range", cVar.f49831b);
            a(mediaFormat, "hdr-static-info", cVar.f49833d);
        }
    }
