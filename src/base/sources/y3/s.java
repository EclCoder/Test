...
public final class s extends j {
    ...
    public List a(Bundle bundle, String key) {
        ...
        return gl.j.w0(n4.c.m(bundleA, key));
    }
    ...
    public List l(String value) {
        ...
        return gl.r.e(p1.f57275h.l(value));
    }
    ...
    public void h(Bundle bundle, String key, List list) {
        ...
        if (list != null) {
            n4.k.j(bundleA, key, gl.r.J0(list));
        } else {
            n4.k.k(bundleA, key);
        }
    }
    ...
    public boolean j(List list, List list2) {
        return gl.j.d(list != null ? (Long[]) list.toArray(new Long[0]) : null, list2 != null ? (Long[]) list2.toArray(new Long[0]) : null);
    }
}
