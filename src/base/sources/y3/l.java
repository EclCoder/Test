...
public final class l extends j {
    ...
    public List a(Bundle bundle, String key) {
        ...
        return gl.j.u0(n4.c.i(bundleA, key));
    }
    ...
    public List l(String value) {
        ...
        return gl.r.e(p1.f57278k.l(value));
    }
    ...
    public void h(Bundle bundle, String key, List list) {
        ...
        if (list != null) {
            n4.k.f(bundleA, key, gl.r.F0(list));
        } else {
            n4.k.k(bundleA, key);
        }
    }
    ...
    public boolean j(List list, List list2) {
        return gl.j.d(list != null ? (Float[]) list.toArray(new Float[0]) : null, list2 != null ? (Float[]) list2.toArray(new Float[0]) : null);
    }
}
