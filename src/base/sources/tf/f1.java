...
public class f1 extends e1 {
    ...
    static {
        ...
        I = sparseIntArray;
        sparseIntArray.put(R.id.gg_ad_container, 1);
        sparseIntArray.put(R.id.gg_ad_icon, 2);
    ...
    private f1(androidx.databinding.f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (AppCompatButton) objArr[5], (NativeAdView) objArr[1], (TextView) objArr[4], (ImageView) objArr[2], (TextView) objArr[3]);
        this.G = -1L;
