...
public class r5 extends q5 {
    ...
    static {
        ...
        sparseIntArray.put(R.id.no_video_message_tv, 6);
    }
    ...
    private r5(androidx.databinding.f fVar, View view, Object[] objArr) {
        super(fVar, view, 0, (Button) objArr[4], (ImageView) objArr[2], (Spinner) objArr[3], (TextView) objArr[6], (Toolbar) objArr[1], (RecyclerView) objArr[5]);
        this.H = -1L;
