...
public final class a implements Externalizable {
    ...
    public final void writeExternal(ObjectOutput objectOutput) throws IOException {
        byte b10 = this.f41826a;
        Object obj = this.f41827b;
        objectOutput.writeByte(b10);
        if (b10 != 1) {
            if (b10 == 2) {
                b bVar = (b) obj;
                c(bVar.f41829a, objectOutput);
                d(bVar.f41831c, objectOutput);
                d(bVar.f41832d, objectOutput);
                return;
            }
            if (b10 == 3) {
                ...
                objectOutput.writeUTF(((f) obj).f41854g.getID());
                return;
            }
        }
        f fVar = (f) obj;
        objectOutput.writeInt(fVar.f41848a.length);
        for (long j10 : fVar.f41848a) {
            c(j10, objectOutput);
        }
        for (ZoneOffset zoneOffset : fVar.f41849b) {
            d(zoneOffset, objectOutput);
        }
        objectOutput.writeInt(fVar.f41850c.length);
        for (long j11 : fVar.f41850c) {
            c(j11, objectOutput);
        }
        for (ZoneOffset zoneOffset2 : fVar.f41852e) {
            d(zoneOffset2, objectOutput);
        }
        objectOutput.writeByte(fVar.f41853f.length);
        for (e eVar : fVar.f41853f) {
            eVar.b(objectOutput);
        }
    }
    ...
    public final void readExternal(ObjectInput objectInput) throws IOException {
        ...
        if (b10 == 1) {
            ...
            e[] eVarArr = i18 == 0 ? f.f41845j : new e[i18];
    ...
    public static ZoneOffset b(DataInput dataInput) throws IOException {
        ...
        return b10 == 127 ? ZoneOffset.Z(dataInput.readInt()) : ZoneOffset.Z(b10 * 900);
    }
    ...
    public static long a(DataInput dataInput) {
        int i10 = dataInput.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED;
        if (i10 == 255) {
            return dataInput.readLong();
        }
        return (((long) (((i10 << 16) + ((dataInput.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED) << 8)) + (dataInput.readByte() & AdConfig.NETWORK_LOAD_LIMIT_DISABLED))) * 900) - 4575744000L;
    }

    public static void d(ZoneOffset zoneOffset, DataOutput dataOutput) throws IOException {
        int i10 = zoneOffset.f41603b;
