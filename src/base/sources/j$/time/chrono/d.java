...
public abstract class d implements b, j$.time.temporal.m, j$.time.temporal.o, Serializable {
    ...
    public /* bridge */ /* synthetic */ j$.time.temporal.m a(long j10, j$.time.temporal.t tVar) {
        return a(j10, tVar);
    }
    ...
    public b d(long j10, j$.time.temporal.t tVar) {
        ...
        switch (c.f41615a[((j$.time.temporal.b) tVar).ordinal()]) {
            case 1:
                return A(j10);
            case 2:
            ...
            case 8:
                ...
                return c(Math.addExact(i(aVar), j10), (j$.time.temporal.r) aVar);
            default:
                throw new j$.time.temporal.u("Unsupported unit: " + tVar);
        }
    }
    ...
    @Override // j$.time.temporal.m
    public b c(long j10, j$.time.temporal.r rVar) {
