...
public final class e0 implements Externalizable {
    ...
    public final void writeExternal(ObjectOutput objectOutput) throws IOException {
        byte b10 = this.f41618a;
        Object obj = this.f41619b;
        ...
        switch (b10) {
            ...
            case 2:
                g gVar = (g) obj;
                objectOutput.writeObject(gVar.f41622a);
                objectOutput.writeObject(gVar.f41623b);
                return;
            case 3:
                k kVar = (k) obj;
                objectOutput.writeObject(kVar.f41635a);
                objectOutput.writeObject(kVar.f41636b);
                objectOutput.writeObject(kVar.f41637c);
                return;
            case 4:
                x xVar = (x) obj;
                xVar.getClass();
                ...
                return;
            case 5:
                objectOutput.writeByte(((y) obj).f41666a);
                return;
            case 6:
                q qVar = (q) obj;
                objectOutput.writeObject(qVar.f41650a);
            ...
            case 9:
                h hVar = (h) obj;
                objectOutput.writeUTF(hVar.f41626a.q());
                objectOutput.writeInt(hVar.f41627b);
                objectOutput.writeInt(hVar.f41628c);
                objectOutput.writeInt(hVar.f41629d);
                return;
            default:
    ...
    public final void readExternal(ObjectInput objectInput) throws IOException {
        ...
        switch (b10) {
            ...
            case 2:
                ...
                break;
            case 3:
                objOf = ((e) objectInput.readObject()).E((ZoneOffset) objectInput.readObject()).D((j$.time.y) objectInput.readObject());
                break;
            case 4:
                ...
                v.f41658c.getClass();
                objOf = new x(j$.time.i.b0(i10, b11, b12));
                break;
            case 5:
                y yVar = y.f41664d;
            ...
            case 7:
                ...
                a0.f41613c.getClass();
                objOf = new c0(j$.time.i.b0(i12 + 1911, b15, b16));
                break;
            case 8:
                ...
                g0.f41624c.getClass();
                objOf = new i0(j$.time.i.b0(i13 - 543, b17, b18));
                break;
            case 9:
                int i14 = h.f41625e;
