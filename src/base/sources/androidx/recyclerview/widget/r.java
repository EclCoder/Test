...
class r {
    ...
    private int a(List list) {
        ...
        for (int size = list.size() - 1; size >= 0; size--) {
            if (((androidx.recyclerview.widget.a.b) list.get(size)).f6830a != 8) {
                z10 = true;
            } else if (z10) {
                return size;
            }
    ...
    private void c(List list, int i10, androidx.recyclerview.widget.a.b bVar, int i11, androidx.recyclerview.widget.a.b bVar2) {
        ...
        if (i13 <= i15) {
            bVar.f6831b = i15 + bVar2.f6833d;
        }
        int i16 = bVar2.f6831b;
        if (i16 <= i12) {
            bVar.f6833d = i12 + bVar2.f6833d;
        }
        bVar2.f6831b = i16 + i14;
        list.set(i10, bVar2);
        list.set(i11, bVar);
    }
    ...
    void e(List list, int i10, androidx.recyclerview.widget.a.b bVar, int i11, androidx.recyclerview.widget.a.b bVar2) {
        ...
        boolean z11 = false;
        if (i12 < i13) {
            if (bVar2.f6831b == i12 && bVar2.f6833d == i13 - i12) {
                z10 = false;
                z11 = true;
            } else {
                z10 = false;
            }
        } else if (bVar2.f6831b == i13 + 1 && bVar2.f6833d == i12 - i13) {
            z10 = true;
            z11 = true;
        } else {
            z10 = true;
        }
        int i14 = bVar2.f6831b;
        if (i13 < i14) {
            bVar2.f6831b = i14 - 1;
        } else {
            int i15 = bVar2.f6833d;
            if (i13 < i14 + i15) {
                bVar2.f6833d = i15 - 1;
                bVar.f6830a = 2;
                bVar.f6833d = 1;
        ...
        if (i16 <= i17) {
            ...
            if (i16 < i17 + i18) {
                bVarA = this.f7047a.a(2, i16 + 1, (i17 + i18) - i16, null);
                bVar2.f6833d = bVar.f6831b - bVar2.f6831b;
            }
        }
        if (z11) {
            list.set(i10, bVar2);
        ...
        if (z10) {
            if (bVarA != null) {
                int i19 = bVar.f6831b;
                if (i19 > bVarA.f6831b) {
                    bVar.f6831b = i19 - bVarA.f6833d;
                }
                int i20 = bVar.f6833d;
                if (i20 > bVarA.f6831b) {
                    bVar.f6833d = i20 - bVarA.f6833d;
                }
            }
            int i21 = bVar.f6831b;
            if (i21 > bVar2.f6831b) {
                bVar.f6831b = i21 - bVar2.f6833d;
            }
            int i22 = bVar.f6833d;
            if (i22 > bVar2.f6831b) {
                bVar.f6833d = i22 - bVar2.f6833d;
            }
        } else {
            if (bVarA != null) {
                int i23 = bVar.f6831b;
                if (i23 >= bVarA.f6831b) {
                    bVar.f6831b = i23 - bVarA.f6833d;
                }
                int i24 = bVar.f6833d;
                if (i24 >= bVarA.f6831b) {
                    bVar.f6833d = i24 - bVarA.f6833d;
                }
            }
            int i25 = bVar.f6831b;
            if (i25 >= bVar2.f6831b) {
                bVar.f6831b = i25 - bVar2.f6833d;
            }
            int i26 = bVar.f6833d;
            if (i26 >= bVar2.f6831b) {
                bVar.f6833d = i26 - bVar2.f6833d;
            }
        }
        list.set(i10, bVar2);
        if (bVar.f6831b != bVar.f6833d) {
            list.set(i11, bVar);
        } else {
            list.remove(i11);
        }
    ...
    void f(List list, int i10, androidx.recyclerview.widget.a.b bVar, int i11, androidx.recyclerview.widget.a.b bVar2) {
        ...
        if (i15 >= i16) {
            int i17 = bVar2.f6833d;
            if (i15 < i16 + i17) {
                bVar2.f6833d = i17 - 1;
                bVarA = this.f7047a.a(4, bVar.f6831b, 1, bVar2.f6832c);
            }
            i12 = bVar.f6831b;
            i13 = bVar2.f6831b;
            if (i12 <= i13) {
                ...
                if (i12 < i13 + i14) {
                    int i18 = (i13 + i14) - i12;
                    bVarA2 = this.f7047a.a(4, i12 + 1, i18, bVar2.f6832c);
                    bVar2.f6833d -= i18;
                }
            }
            list.set(i11, bVar);
        ...
        if (i12 <= i13) {
            ...
            if (i12 < i13 + i14) {
                int i19 = (i13 + i14) - i12;
                bVarA2 = this.f7047a.a(4, i12 + 1, i19, bVar2.f6832c);
                bVar2.f6833d -= i19;
            }
        }
        list.set(i11, bVar);
