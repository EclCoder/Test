...
public abstract class i {
    ...
    private static class d implements ActionMode.Callback {
        ...
        private final ActionMode.Callback f3428a;
        ...
        private void g(Menu menu) {
            Context context = this.f3429b.getContext();
            PackageManager packageManager = context.getPackageManager();
            boolean z10 = this.f3433f;
            ...
            if (!z10) {
                ...
                try {
                    ...
                    this.f3430c = cls2;
                    this.f3431d = cls2.getDeclaredMethod("removeItemAt", cls);
                    this.f3432e = true;
            ...
            try {
                Method declaredMethod = (this.f3432e && this.f3430c.isInstance(menu)) ? this.f3431d : menu.getClass().getDeclaredMethod("removeItemAt", cls);
                ...
                for (int i10 = 0; i10 < listC.size(); i10++) {
                    ...
                    menu.add(0, 0, i10 + 100, resolveInfo.loadLabel(packageManager)).setIntent(b(resolveInfo, this.f3429b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f3428a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f3428a.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f3428a.onDestroyActionMode(actionMode);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            g(menu);
            return this.f3428a.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    private static TextDirectionHeuristic d(TextView textView) {
        ...
        if (Build.VERSION.SDK_INT >= 28 && (textView.getInputType() & 15) == 3) {
            byte directionality = Character.getDirectionality(b.a(a.a(textView.getTextLocale()))[0].codePointAt(0));
    ...
    public static l0.c.a e(TextView textView) {
        if (Build.VERSION.SDK_INT >= 28) {
            return new l0.c.a(b.b(textView));
        }
        l0.c.a.C0663a c0663a = new l0.c.a.C0663a(new TextPaint(textView.getPaint()));
        c0663a.b(textView.getBreakStrategy());
        c0663a.c(textView.getHyphenationFrequency());
        c0663a.d(d(textView));
        return c0663a.a();
    }
    ...
    public static void l(TextView textView, l0.c cVar) {
    ...
    public static void n(TextView textView, l0.c.a aVar) {
