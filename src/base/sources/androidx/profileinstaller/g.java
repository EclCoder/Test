...
abstract class g {
    ...
    static boolean C(OutputStream outputStream, byte[] bArr, c[] cVarArr) throws IOException {
        if (Arrays.equals(bArr, i.f6579a)) {
            P(outputStream, cVarArr);
            return true;
        }
        if (Arrays.equals(bArr, i.f6580b)) {
            O(outputStream, cVarArr);
            return true;
        }
        if (Arrays.equals(bArr, i.f6582d)) {
            M(outputStream, cVarArr);
            return true;
        }
        if (Arrays.equals(bArr, i.f6581c)) {
            N(outputStream, cVarArr);
            return true;
        }
        if (!Arrays.equals(bArr, i.f6583e)) {
            return false;
        }
    ...
    private static j E(c[] cVarArr) throws IOException {
        ...
        try {
            ...
            int i10 = 2;
            for (c cVar : cVarArr) {
                d.q(byteArrayOutputStream, cVar.f6550c);
                d.q(byteArrayOutputStream, cVar.f6551d);
                d.q(byteArrayOutputStream, cVar.f6554g);
                String strJ = j(cVar.f6548a, cVar.f6549b, i.f6579a);
                int iK = d.k(strJ);
    ...
    private static void H(OutputStream outputStream, c cVar, String str) throws IOException {
        ...
        d.p(outputStream, cVar.f6552e);
        d.q(outputStream, cVar.f6553f);
        d.q(outputStream, cVar.f6550c);
        d.q(outputStream, cVar.f6554g);
        d.n(outputStream, str);
    }

    private static void I(OutputStream outputStream, c cVar) throws IOException {
        byte[] bArr = new byte[k(cVar.f6554g)];
        for (Map.Entry entry : cVar.f6556i.entrySet()) {
    ...
    private static void J(OutputStream outputStream, int i10, c cVar) throws IOException {
        byte[] bArr = new byte[l(i10, cVar.f6554g)];
        for (Map.Entry entry : cVar.f6556i.entrySet()) {
            int iIntValue = ((Integer) entry.getKey()).intValue();
            int iIntValue2 = ((Integer) entry.getValue()).intValue();
            int i11 = 0;
            for (int i12 = 1; i12 <= 4; i12 <<= 1) {
                if (i12 != 1 && (i12 & i10) != 0) {
                    if ((i12 & iIntValue2) == i12) {
                        int i13 = (cVar.f6554g * i11) + iIntValue;
                        int i14 = i13 / 8;
    ...
    private static void L(OutputStream outputStream, c[] cVarArr) throws IOException {
        ...
        for (c cVar : cVarArr) {
            String strJ = j(cVar.f6548a, cVar.f6549b, i.f6583e);
            d.p(outputStream, d.k(strJ));
            d.p(outputStream, cVar.f6556i.size());
            d.p(outputStream, cVar.f6555h.length);
            d.q(outputStream, cVar.f6550c);
            d.n(outputStream, strJ);
            Iterator it = cVar.f6556i.keySet().iterator();
            while (it.hasNext()) {
                d.p(outputStream, ((Integer) it.next()).intValue());
            }
            for (int i10 : cVar.f6555h) {
    ...
    private static void M(OutputStream outputStream, c[] cVarArr) throws IOException {
        ...
        for (c cVar : cVarArr) {
            int size = cVar.f6556i.size() * 4;
            String strJ = j(cVar.f6548a, cVar.f6549b, i.f6582d);
            d.p(outputStream, d.k(strJ));
            d.p(outputStream, cVar.f6555h.length);
    ...
    private static void Q(OutputStream outputStream, c[] cVarArr) throws IOException {
        ...
        long length2 = ((long) i.f6579a.length) + ((long) f6566a.length) + 4 + ((long) (arrayList.size() * 16));
        d.q(outputStream, arrayList.size());
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            j jVar = (j) arrayList.get(i10);
            d.q(outputStream, jVar.f6586a.g());
            d.q(outputStream, length2);
            if (jVar.f6589d) {
                byte[] bArr = jVar.f6588c;
                ...
                arrayList2.add(jVar.f6588c);
                d.q(outputStream, jVar.f6588c.length);
                d.q(outputStream, 0L);
                length = jVar.f6588c.length;
            }
            length2 += (long) length;
        }
    ...
    private static int a(c cVar) {
        Iterator it = cVar.f6556i.entrySet().iterator();
        int iIntValue = 0;
        while (it.hasNext()) {
    ...
    private static byte[] b(c[] cVarArr, byte[] bArr) throws IOException {
        ...
        int iK = 0;
        for (c cVar : cVarArr) {
            iK += d.k(j(cVar.f6548a, cVar.f6549b, bArr)) + 16 + (cVar.f6552e * 2) + cVar.f6553f + k(cVar.f6554g);
        }
        ...
        if (Arrays.equals(bArr, i.f6581c)) {
            ...
            while (i10 < length) {
                c cVar2 = cVarArr[i10];
                H(byteArrayOutputStream, cVar2, j(cVar2.f6548a, cVar2.f6549b, bArr));
                G(byteArrayOutputStream, cVar2);
                i10++;
            }
        } else {
            for (c cVar3 : cVarArr) {
                H(byteArrayOutputStream, cVar3, j(cVar3.f6548a, cVar3.f6549b, bArr));
            }
    ...
    private static c i(c[] cVarArr, String str) {
        ...
        for (int i10 = 0; i10 < cVarArr.length; i10++) {
            if (cVarArr[i10].f6549b.equals(strH)) {
                return cVarArr[i10];
            }
        }
        return null;
    ...
    static byte[] p(InputStream inputStream, byte[] bArr) {
        if (Arrays.equals(bArr, d.d(inputStream, bArr.length))) {
            return d.d(inputStream, i.f6580b.length);
        }
        throw d.c("Invalid magic");
    }

    private static void q(InputStream inputStream, c cVar) {
        int iAvailable = inputStream.available() - cVar.f6553f;
        int iH = 0;
        while (inputStream.available() > iAvailable) {
            iH += d.h(inputStream);
            cVar.f6556i.put(Integer.valueOf(iH), 1);
    ...
    static c[] r(InputStream inputStream, byte[] bArr, byte[] bArr2, c[] cVarArr) {
        if (Arrays.equals(bArr, i.f6584f)) {
            if (Arrays.equals(i.f6579a, bArr2)) {
        ...
        if (Arrays.equals(bArr, i.f6585g)) {
    ...
    private static void w(InputStream inputStream, c cVar) {
        BitSet bitSetValueOf = BitSet.valueOf(d.d(inputStream, d.a(cVar.f6554g * 2)));
        int i10 = 0;
        while (true) {
            int i11 = cVar.f6554g;
            if (i10 >= i11) {
            ...
            if (iO != 0) {
                Integer num = (Integer) cVar.f6556i.get(Integer.valueOf(i10));
                if (num == null) {
                    num = 0;
                }
                cVar.f6556i.put(Integer.valueOf(i10), Integer.valueOf(iO | num.intValue()));
            }
            i10++;
        }
    }
    ...
    private static c[] y(InputStream inputStream, String str, int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            c cVar = cVarArr[i12];
            q(inputStream, cVar);
            cVar.f6555h = n(inputStream, cVar.f6552e);
            w(inputStream, cVar);
        }
        return cVarArr;
    }
    ...
    private static j c(c[] cVarArr) throws IOException {
        ...
        for (int i11 = 0; i11 < cVarArr.length; i11++) {
            try {
                c cVar = cVarArr[i11];
                d.p(byteArrayOutputStream, i11);
                d.p(byteArrayOutputStream, cVar.f6552e);
                i10 = i10 + 4 + (cVar.f6552e * 2);
        ...
        throw d.c(trPLwhKZgZ.XKHNbe + i10 + ", does not match actual size " + byteArray.length);
    }
}
