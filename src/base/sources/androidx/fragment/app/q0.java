...
class q0 extends r0 {
    ...
    private static boolean v(Transition transition) {
        return (r0.i(transition.getTargetIds()) && r0.i(transition.getTargetNames()) && r0.i(transition.getTargetTypes())) ? false : true;
    }
    ...
    public void b(Object obj, ArrayList arrayList) {
        ...
        if (v(transition) || !r0.i(transition.getTargets())) {
            return;
        }
    ...
    public void s(Object obj, View view, ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            r0.d(targets, (View) arrayList.get(i10));
        }
        targets.add(view);
        arrayList.add(view);
    ...
    class b implements Transition.TransitionListener {
        ...
        final /* synthetic */ ArrayList f4242b;
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ((View) this.f4242b.get(i10)).setVisibility(0);
            }
        }
    ...
    class c implements Transition.TransitionListener {
        ...
        final /* synthetic */ Object f4246c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        final /* synthetic */ ArrayList f4247d;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        final /* synthetic */ Object f4248e;

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        final /* synthetic */ ArrayList f4249f;
        ...
        public void onTransitionStart(Transition transition) {
            ...
            if (obj != null) {
                q0.this.w(obj, this.f4245b, null);
            }
            Object obj2 = this.f4246c;
            if (obj2 != null) {
                q0.this.w(obj2, this.f4247d, null);
            }
            Object obj3 = this.f4248e;
            if (obj3 != null) {
                q0.this.w(obj3, this.f4249f, null);
            }
        }
