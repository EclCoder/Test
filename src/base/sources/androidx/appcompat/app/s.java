...
public class s {
    ...
    private static final Class[] f815b = {Context.class, AttributeSet.class};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final int[] f816c = {R.attr.onClick};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final int[] f817d = {R.attr.accessibilityHeading};

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final int[] f818e = {R.attr.accessibilityPaneTitle};

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final int[] f819f = {R.attr.screenReaderFocusable};

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final String[] f820g = {"android.widget.", "android.view.", "android.webkit."};

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private static final androidx.collection.u f821h = new androidx.collection.u();

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final Object[] f822a = new Object[2];
    ...
    private static class a implements View.OnClickListener {
        ...
        private void a(Context context) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f824b, View.class)) != null) {
                        this.f825c = method;
                        this.f826d = context;
                        return;
                    }
            ...
            int id2 = this.f823a.getId();
            if (id2 == -1) {
                str = "";
            } else {
                str = " with id '" + this.f823a.getContext().getResources().getResourceEntryName(id2) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.f824b + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.f823a.getClass() + str);
        }

        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            if (this.f825c == null) {
                a(this.f823a.getContext());
            }
            try {
                this.f825c.invoke(this.f826d, view);
    ...
    private void a(Context context, View view, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f817d);
        if (typedArrayObtainStyledAttributes.hasValue(0)) {
            q0.n0(view, typedArrayObtainStyledAttributes.getBoolean(0, false));
        }
        typedArrayObtainStyledAttributes.recycle();
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, f818e);
        if (typedArrayObtainStyledAttributes2.hasValue(0)) {
            q0.o0(view, typedArrayObtainStyledAttributes2.getString(0));
        }
        typedArrayObtainStyledAttributes2.recycle();
        TypedArray typedArrayObtainStyledAttributes3 = context.obtainStyledAttributes(attributeSet, f819f);
        if (typedArrayObtainStyledAttributes3.hasValue(0)) {
            q0.y0(view, typedArrayObtainStyledAttributes3.getBoolean(0, false));
        }
    ...
    private void b(View view, AttributeSet attributeSet) {
        ...
        if ((context instanceof ContextWrapper) && view.hasOnClickListeners()) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f816c);
    ...
    private View s(Context context, String str, String str2) {
        String str3;
        androidx.collection.u uVar = f821h;
        ...
        if (constructor == null) {
            ...
            constructor = Class.forName(str3, false, context.getClassLoader()).asSubclass(View.class).getConstructor(f815b);
            uVar.put(str, constructor);
        }
        constructor.setAccessible(true);
        return (View) constructor.newInstance(this.f822a);
    }
