...
abstract class d {
    ...
    static long a(RandomAccessFile randomAccessFile, a aVar) throws IOException {
        ...
        long j10 = aVar.f56634b;
        randomAccessFile.seek(aVar.f56633a);
    ...
    static a b(RandomAccessFile randomAccessFile) throws IOException {
        ...
        do {
            ...
            if (randomAccessFile.readInt() == iReverseBytes) {
                ...
                randomAccessFile.skipBytes(2);
                a aVar = new a();
                aVar.f56634b = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & 4294967295L;
                aVar.f56633a = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & 4294967295L;
                return aVar;
            }
            j10--;
        } while (j10 >= j12);
