...
public final class c extends b {
    ...
    public void c(InputStream input) throws IOException {
        ...
        this.f36945b = Double.longBitsToDouble(j10);
        tj.e.g(input, new byte[]{0, 0});
    }

    @Override // dj.b
    public void e(OutputStream output) throws IOException {
        s.h(output, "output");
        output.write(ByteBuffer.allocate(a() - 2).putLong(Double.doubleToRawLongBits(this.f36945b)).array());
