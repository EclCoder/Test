...
public abstract class d {
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i10 = 0; i10 < bVarArr.length; i10++) {
            if (bVarArr[i10].f37006a != bVarArr2[i10].f37006a || bVarArr[i10].f37007b.length != bVarArr2[i10].f37007b.length) {
                return false;
            }
        }
        return true;
    ...
    public static void j(b[] bVarArr, Path path) {
        ...
        char c10 = 'm';
        for (b bVar : bVarArr) {
            b.e(path, fArr, c10, bVar.f37006a, bVar.f37007b);
            c10 = bVar.f37006a;
        }
    }
    ...
    public static void k(b[] bVarArr, b[] bVarArr2) {
        for (int i10 = 0; i10 < bVarArr2.length; i10++) {
            bVarArr[i10].f37006a = bVarArr2[i10].f37006a;
            for (int i11 = 0; i11 < bVarArr2[i10].f37007b.length; i11++) {
                bVarArr[i10].f37007b[i11] = bVarArr2[i10].f37007b[i11];
            }
        }
    }
    ...
    public static class b {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private char f37006a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final float[] f37007b;
        ...
        b(b bVar) {
            this.f37006a = bVar.f37006a;
            float[] fArr = bVar.f37007b;
            this.f37007b = d.c(fArr, 0, fArr.length);
        }
    }
}
