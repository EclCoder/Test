...
public final class e extends g {
    ...
    protected ng.c c(Cursor cursor, Uri contentUri, String path, String str, String title, long j10) {
        ...
        return new ng.b(null, uriWithAppendedId, path, str, title, 0, false, 33, null);
    }

    @Override // rh.g
    protected String d() {
        String string = this.f51337d.getString(R.string.all_images);
